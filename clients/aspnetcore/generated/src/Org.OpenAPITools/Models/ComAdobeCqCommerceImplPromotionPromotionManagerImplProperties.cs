...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties : IEquatable<ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties>
    { 
        /// <summary>
        /// Gets or Sets CqCommercePromotionRoot
        /// </summary>
        [DataMember(Name="cq.commerce.promotion.root")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties other)
        {
            ...
            return 
                (
                    CqCommercePromotionRoot == other.CqCommercePromotionRoot ||
                    CqCommercePromotionRoot != null &&
                    CqCommercePromotionRoot.Equals(other.CqCommercePromotionRoot)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CqCommercePromotionRoot.GetHashCode();
                return hashCode;
            }
        }
