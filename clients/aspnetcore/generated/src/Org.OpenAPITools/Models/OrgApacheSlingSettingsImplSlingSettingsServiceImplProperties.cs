...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingSettingsImplSlingSettingsServiceImplProperties : IEquatable<OrgApacheSlingSettingsImplSlingSettingsServiceImplProperties>
    { 
        /// <summary>
        /// Gets or Sets SlingName
        /// </summary>
        [DataMember(Name="sling.name")]
        public ConfigNodePropertyString SlingName { get; set; }

        /// <summary>
        /// Gets or Sets SlingDescription
        /// </summary>
        [DataMember(Name="sling.description")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrgApacheSlingSettingsImplSlingSettingsServiceImplProperties)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (SlingName != null)
                    hashCode = hashCode * 59 + SlingName.GetHashCode();
                    if (SlingDescription != null)
                    hashCode = hashCode * 59 + SlingDescription.GetHashCode();
                return hashCode;
            }
        }
