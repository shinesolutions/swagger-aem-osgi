...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties : IEquatable<ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties>
    { 
        /// <summary>
        /// Gets or Sets Forcelocation
        /// </summary>
        [DataMember(Name="forcelocation")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties other)
        {
            ...
            return 
                (
                    Forcelocation == other.Forcelocation ||
                    Forcelocation != null &&
                    Forcelocation.Equals(other.Forcelocation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Forcelocation.GetHashCode();
                return hashCode;
            }
        }
