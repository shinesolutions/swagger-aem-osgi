...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties : IEquatable<ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="cq.wcm.msm.impl.actions.pagemove.prop_referenceUpdate")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties other)
        {
            ...
            return 
                ...
                (
                    CqWcmMsmImplActionsPagemovePropReferenceUpdate == other.CqWcmMsmImplActionsPagemovePropReferenceUpdate ||
                    CqWcmMsmImplActionsPagemovePropReferenceUpdate != null &&
                    CqWcmMsmImplActionsPagemovePropReferenceUpdate.Equals(other.CqWcmMsmImplActionsPagemovePropReferenceUpdate)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (CqWcmMsmImplActionsPagemovePropReferenceUpdate != null)
                    hashCode = hashCode * 59 + CqWcmMsmImplActionsPagemovePropReferenceUpdate.GetHashCode();
                return hashCode;
            }
        }
