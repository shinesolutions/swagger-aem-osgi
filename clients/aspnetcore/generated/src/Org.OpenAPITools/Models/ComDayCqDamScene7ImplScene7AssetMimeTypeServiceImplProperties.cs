...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties : IEquatable<ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties>
    { 
        /// <summary>
        /// Gets or Sets CqDamScene7AssetmimetypeserviceMapping
        /// </summary>
        [DataMember(Name="cq.dam.scene7.assetmimetypeservice.mapping")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties other)
        {
            ...
            return 
                (
                    CqDamScene7AssetmimetypeserviceMapping == other.CqDamScene7AssetmimetypeserviceMapping ||
                    CqDamScene7AssetmimetypeserviceMapping != null &&
                    CqDamScene7AssetmimetypeserviceMapping.Equals(other.CqDamScene7AssetmimetypeserviceMapping)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CqDamScene7AssetmimetypeserviceMapping.GetHashCode();
                return hashCode;
            }
        }
