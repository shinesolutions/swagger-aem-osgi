...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties : IEquatable<ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties>
    { 
        /// <summary>
        /// Gets or Sets BucketSize
        /// </summary>
        [DataMember(Name="bucketSize")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties other)
        {
            ...
            return 
                (
                    ...
                    BucketSize != null &&
                    BucketSize.Equals(other.BucketSize)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (BucketSize != null)
                    hashCode = hashCode * 59 + BucketSize.GetHashCode();
                return hashCode;
            }
        }
