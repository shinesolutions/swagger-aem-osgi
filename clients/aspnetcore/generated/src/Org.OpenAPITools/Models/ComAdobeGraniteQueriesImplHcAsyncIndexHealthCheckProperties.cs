...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties : IEquatable<ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties>
    { 
        /// <summary>
        /// Gets or Sets IndexingCriticalThreshold
        /// </summary>
        [DataMember(Name="indexing.critical.threshold")]
        public ConfigNodePropertyInteger IndexingCriticalThreshold { get; set; }

        /// <summary>
        /// Gets or Sets IndexingWarnThreshold
        /// </summary>
        [DataMember(Name="indexing.warn.threshold")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties other)
        {
            ...
            return 
                (
                    IndexingCriticalThreshold == other.IndexingCriticalThreshold ||
                    IndexingCriticalThreshold != null &&
                    IndexingCriticalThreshold.Equals(other.IndexingCriticalThreshold)
                ) && 
                (
                    IndexingWarnThreshold == other.IndexingWarnThreshold ||
                    IndexingWarnThreshold != null &&
                    IndexingWarnThreshold.Equals(other.IndexingWarnThreshold)
                ) && 
                (
                    HcTags == other.HcTags ||
                    HcTags != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IndexingCriticalThreshold.GetHashCode();
                    if (IndexingWarnThreshold != null)
                    hashCode = hashCode * 59 + IndexingWarnThreshold.GetHashCode();
                    if (HcTags != null)
