...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqHistoryImplHistoryServiceImplProperties : IEquatable<ComAdobeCqHistoryImplHistoryServiceImplProperties>
    { 
        /// <summary>
        /// Gets or Sets HistoryServiceResourceTypes
        /// </summary>
        [DataMember(Name="history.service.resourceTypes")]
        public ConfigNodePropertyArray HistoryServiceResourceTypes { get; set; }

        /// <summary>
        /// Gets or Sets HistoryServicePathFilter
        /// </summary>
        [DataMember(Name="history.service.pathFilter")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeCqHistoryImplHistoryServiceImplProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeCqHistoryImplHistoryServiceImplProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeCqHistoryImplHistoryServiceImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqHistoryImplHistoryServiceImplProperties other)
        {
            ...
            return 
                (
                    HistoryServiceResourceTypes == other.HistoryServiceResourceTypes ||
                    HistoryServiceResourceTypes != null &&
                    HistoryServiceResourceTypes.Equals(other.HistoryServiceResourceTypes)
                ) && 
                (
                    HistoryServicePathFilter == other.HistoryServicePathFilter ||
                    HistoryServicePathFilter != null &&
                    HistoryServicePathFilter.Equals(other.HistoryServicePathFilter)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + HistoryServiceResourceTypes.GetHashCode();
                    if (HistoryServicePathFilter != null)
                    hashCode = hashCode * 59 + HistoryServicePathFilter.GetHashCode();
                return hashCode;
            }
        }
