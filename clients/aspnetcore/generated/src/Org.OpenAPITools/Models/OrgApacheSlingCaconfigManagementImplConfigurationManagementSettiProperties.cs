...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties : IEquatable<OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties>
    { 
        /// <summary>
        /// Gets or Sets IgnorePropertyNameRegex
        /// </summary>
        [DataMember(Name="ignorePropertyNameRegex")]
        public ConfigNodePropertyArray IgnorePropertyNameRegex { get; set; }

        /// <summary>
        /// Gets or Sets ConfigCollectionPropertiesResourceNames
        /// </summary>
        [DataMember(Name="configCollectionPropertiesResourceNames")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties)obj);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties other)
        {
            ...
            return 
                (
                    IgnorePropertyNameRegex == other.IgnorePropertyNameRegex ||
                    IgnorePropertyNameRegex != null &&
                    IgnorePropertyNameRegex.Equals(other.IgnorePropertyNameRegex)
                ) && 
                (
                    ConfigCollectionPropertiesResourceNames == other.ConfigCollectionPropertiesResourceNames ||
                    ConfigCollectionPropertiesResourceNames != null &&
                    ConfigCollectionPropertiesResourceNames.Equals(other.ConfigCollectionPropertiesResourceNames)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IgnorePropertyNameRegex.GetHashCode();
                    if (ConfigCollectionPropertiesResourceNames != null)
                    hashCode = hashCode * 59 + ConfigCollectionPropertiesResourceNames.GetHashCode();
                return hashCode;
            }
        }
