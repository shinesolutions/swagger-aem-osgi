...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties : IEquatable<ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="contentcopyaction.order.style")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties other)
        {
            ...
            return 
                ...
                (
                    ContentcopyactionOrderStyle == other.ContentcopyactionOrderStyle ||
                    ContentcopyactionOrderStyle != null &&
                    ContentcopyactionOrderStyle.Equals(other.ContentcopyactionOrderStyle)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ContentcopyactionOrderStyle.GetHashCode();
                return hashCode;
            }
        }
