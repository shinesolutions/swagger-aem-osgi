...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties : IEquatable<ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties>
    { 
        /// <summary>
        /// Gets or Sets MimeAllowEmpty
        /// </summary>
        [DataMember(Name="mime.allowEmpty")]
        public ConfigNodePropertyBoolean MimeAllowEmpty { get; set; }

        /// <summary>
        /// Gets or Sets MimeAllowed
        /// </summary>
        [DataMember(Name="mime.allowed")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties other)
        {
            ...
            return 
                (
                    MimeAllowEmpty == other.MimeAllowEmpty ||
                    MimeAllowEmpty != null &&
                    MimeAllowEmpty.Equals(other.MimeAllowEmpty)
                ) && 
                (
                    MimeAllowed == other.MimeAllowed ||
                    MimeAllowed != null &&
                    MimeAllowed.Equals(other.MimeAllowed)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + MimeAllowEmpty.GetHashCode();
                    if (MimeAllowed != null)
                    hashCode = hashCode * 59 + MimeAllowed.GetHashCode();
                return hashCode;
            }
        }
