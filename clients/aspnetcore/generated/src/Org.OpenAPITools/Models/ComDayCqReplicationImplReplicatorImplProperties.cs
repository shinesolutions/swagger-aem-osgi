...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqReplicationImplReplicatorImplProperties : IEquatable<ComDayCqReplicationImplReplicatorImplProperties>
    { 
        /// <summary>
        /// Gets or Sets DistributeEvents
        /// </summary>
        [DataMember(Name="distribute_events")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqReplicationImplReplicatorImplProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqReplicationImplReplicatorImplProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqReplicationImplReplicatorImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqReplicationImplReplicatorImplProperties other)
        {
            ...
            return 
                (
                    DistributeEvents == other.DistributeEvents ||
                    DistributeEvents != null &&
                    DistributeEvents.Equals(other.DistributeEvents)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DistributeEvents != null)
                    hashCode = hashCode * 59 + DistributeEvents.GetHashCode();
                return hashCode;
            }
        }
