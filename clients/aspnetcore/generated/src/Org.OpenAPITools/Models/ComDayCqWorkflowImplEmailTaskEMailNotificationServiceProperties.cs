...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties : IEquatable<ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties>
    { 
        /// <summary>
        /// Gets or Sets NotifyOnupdate
        /// </summary>
        [DataMember(Name="notify.onupdate")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties other)
        {
            ...
            return 
                (
                    NotifyOnupdate == other.NotifyOnupdate ||
                    NotifyOnupdate != null &&
                    NotifyOnupdate.Equals(other.NotifyOnupdate)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NotifyOnupdate.GetHashCode();
