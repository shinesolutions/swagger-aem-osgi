...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties : IEquatable<ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties>
    { 
        /// <summary>
        /// Gets or Sets CqSocialConsoleAnalyticsComponents
        /// </summary>
        [DataMember(Name="cq.social.console.analytics.components")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImProperties other)
        {
            ...
            return 
                (
                    CqSocialConsoleAnalyticsComponents == other.CqSocialConsoleAnalyticsComponents ||
                    CqSocialConsoleAnalyticsComponents != null &&
                    CqSocialConsoleAnalyticsComponents.Equals(other.CqSocialConsoleAnalyticsComponents)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CqSocialConsoleAnalyticsComponents.GetHashCode();
                return hashCode;
            }
        }
