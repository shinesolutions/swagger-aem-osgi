...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties : IEquatable<ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="disabledForGroups")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqExperiencelogImplExperienceLogConfigServletProperties other)
        {
            ...
            return 
                ...
                (
                    DisabledForGroups == other.DisabledForGroups ||
                    DisabledForGroups != null &&
                    DisabledForGroups.Equals(other.DisabledForGroups)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DisabledForGroups.GetHashCode();
                return hashCode;
            }
        }
