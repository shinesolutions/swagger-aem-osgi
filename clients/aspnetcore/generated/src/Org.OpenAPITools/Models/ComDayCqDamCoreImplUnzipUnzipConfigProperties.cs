...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqDamCoreImplUnzipUnzipConfigProperties : IEquatable<ComDayCqDamCoreImplUnzipUnzipConfigProperties>
    { 
        /// <summary>
        /// Gets or Sets CqDamConfigUnzipMaxuncompressedsize
        /// </summary>
        [DataMember(Name="cq.dam.config.unzip.maxuncompressedsize")]
        public ConfigNodePropertyInteger CqDamConfigUnzipMaxuncompressedsize { get; set; }

        /// <summary>
        /// Gets or Sets CqDamConfigUnzipEncoding
        /// </summary>
        [DataMember(Name="cq.dam.config.unzip.encoding")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqDamCoreImplUnzipUnzipConfigProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqDamCoreImplUnzipUnzipConfigProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqDamCoreImplUnzipUnzipConfigProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqDamCoreImplUnzipUnzipConfigProperties other)
        {
            ...
            return 
                (
                    CqDamConfigUnzipMaxuncompressedsize == other.CqDamConfigUnzipMaxuncompressedsize ||
                    CqDamConfigUnzipMaxuncompressedsize != null &&
                    CqDamConfigUnzipMaxuncompressedsize.Equals(other.CqDamConfigUnzipMaxuncompressedsize)
                ) && 
                (
                    CqDamConfigUnzipEncoding == other.CqDamConfigUnzipEncoding ||
                    CqDamConfigUnzipEncoding != null &&
                    CqDamConfigUnzipEncoding.Equals(other.CqDamConfigUnzipEncoding)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CqDamConfigUnzipMaxuncompressedsize.GetHashCode();
                    if (CqDamConfigUnzipEncoding != null)
                    hashCode = hashCode * 59 + CqDamConfigUnzipEncoding.GetHashCode();
                return hashCode;
            }
        }
