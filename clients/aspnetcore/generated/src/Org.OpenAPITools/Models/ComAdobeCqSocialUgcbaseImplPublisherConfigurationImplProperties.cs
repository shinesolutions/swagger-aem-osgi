...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties : IEquatable<ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties>
    { 
        /// <summary>
        /// Gets or Sets IsPrimaryPublisher
        /// </summary>
        [DataMember(Name="isPrimaryPublisher")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties)obj);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialUgcbaseImplPublisherConfigurationImplProperties other)
        {
            ...
            return 
                (
                    IsPrimaryPublisher == other.IsPrimaryPublisher ||
                    IsPrimaryPublisher != null &&
                    IsPrimaryPublisher.Equals(other.IsPrimaryPublisher)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IsPrimaryPublisher.GetHashCode();
                return hashCode;
            }
        }
