...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties : IEquatable<OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties)obj);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Overrides != null)
                    hashCode = hashCode * 59 + Overrides.GetHashCode();
                    if (Enabled != null)
