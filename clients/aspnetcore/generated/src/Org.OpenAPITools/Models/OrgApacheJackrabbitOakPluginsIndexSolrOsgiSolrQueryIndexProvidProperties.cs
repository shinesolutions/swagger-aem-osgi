...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties : IEquatable<OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties>
    { 
        /// <summary>
        /// Gets or Sets QueryAggregation
        /// </summary>
        [DataMember(Name="query.aggregation")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties)obj);
        }

        /// <summary>
        /// Returns true if OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties other)
        {
            ...
            return 
                (
                    QueryAggregation == other.QueryAggregation ||
                    QueryAggregation != null &&
                    QueryAggregation.Equals(other.QueryAggregation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + QueryAggregation.GetHashCode();
                return hashCode;
            }
        }
