...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqImageInternalFontFontHelperProperties : IEquatable<ComDayCqImageInternalFontFontHelperProperties>
    { 
        /// <summary>
        /// Gets or Sets Fontpath
        /// </summary>
        [DataMember(Name="fontpath")]
        public ConfigNodePropertyArray Fontpath { get; set; }

        /// <summary>
        /// Gets or Sets OversamplingFactor
        /// </summary>
        [DataMember(Name="oversamplingFactor")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ComDayCqImageInternalFontFontHelperProperties)obj);
        }

        /// <summary>
        /// Returns true if ComDayCqImageInternalFontFontHelperProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ComDayCqImageInternalFontFontHelperProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqImageInternalFontFontHelperProperties other)
        {
            ...
            return 
                (
                    ...
                    Fontpath != null &&
                    Fontpath.Equals(other.Fontpath)
                ) && 
                (
                    OversamplingFactor == other.OversamplingFactor ||
                    OversamplingFactor != null &&
                    OversamplingFactor.Equals(other.OversamplingFactor)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Fontpath != null)
                    hashCode = hashCode * 59 + Fontpath.GetHashCode();
                    if (OversamplingFactor != null)
                    hashCode = hashCode * 59 + OversamplingFactor.GetHashCode();
                return hashCode;
            }
        }
