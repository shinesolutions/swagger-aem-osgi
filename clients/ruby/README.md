[![Build Status](https://img.shields.io/travis/shinesolutions/swagger-aem-osgi.svg)](http://travis-ci.org/shinesolutions/swagger-aem-osgi)
[![Published Version](https://badge.fury.io/rb/swagger_aem_osgi.svg)](https://rubygems.org/gems/swagger_aem_osgi)

swagger_aem_osgi
-----------

swagger_aem_osgi is a Ruby client generated from [Swagger AEM specification](https://github.com/shinesolutions/swagger-aem-osgi) using [Swagger Code Generator](https://github.com/swagger-api/swagger-codegen).
...
Learn more about swagger_aem_osgi:

* [Installation](https://github.com/shinesolutions/swagger-aem-osgi/tree/master/ruby#installation)
* [Error Handling](https://github.com/shinesolutions/swagger-aem-osgi/tree/master/ruby#error-handling)
* [Development](https://github.com/shinesolutions/swagger-aem-osgi/tree/master/ruby#development)
* [Testing](https://github.com/shinesolutions/swagger-aem-osgi/tree/master/ruby#testing)
* [Versions History](https://github.com/shinesolutions/swagger-aem-osgi/blob/master/docs/ruby/versions.md)

swagger_aem_osgi is part of [AEM OpenCloud](https://aemopencloud.io) platform.

Installation
------------

    gem install swagger_aem_osgi_osgi

swagger_aem_osgi)osgi will install some native dependencies, the following packages need to be available on your OS.
...
Any API error will be thrown as [SwaggerAemClient::ApiError](https://shinesolutions.github.io/swagger-aem-osgi/ruby/master/SwaggerAemClient/ApiError.html) .
