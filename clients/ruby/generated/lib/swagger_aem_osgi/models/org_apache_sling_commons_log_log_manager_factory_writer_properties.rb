...
module SwaggerAemOsgiClient
  class OrgApacheSlingCommonsLogLogManagerFactoryWriterProperties
    ...
    attr_accessor :org_apache_sling_commons_log_file_buffered
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::OrgApacheSlingCommonsLogLogManagerFactoryWriterProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::OrgApacheSlingCommonsLogLogManagerFactoryWriterProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'org_apache_sling_commons_log_file_buffered')
        self.org_apache_sling_commons_log_file_buffered = attributes[:'org_apache_sling_commons_log_file_buffered']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          org_apache_sling_commons_log_file_buffered == o.org_apache_sling_commons_log_file_buffered
    end
    ...
    def hash
      [org_apache_sling_commons_log_file, org_apache_sling_commons_log_file_number, org_apache_sling_commons_log_file_size, org_apache_sling_commons_log_file_buffered].hash
    end
