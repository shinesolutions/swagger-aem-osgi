...
module SwaggerAemOsgiClient
  class ComDayCqMailerDefaultMailServiceProperties
    ...
    attr_accessor :smtp_starttls

    attr_accessor :debug_email
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::ComDayCqMailerDefaultMailServiceProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::ComDayCqMailerDefaultMailServiceProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'smtp_user')
        self.smtp_user = attributes[:'smtp_user']
      end
      ...
      if attributes.key?(:'smtp_starttls')
        self.smtp_starttls = attributes[:'smtp_starttls']
      end

      if attributes.key?(:'debug_email')
        self.debug_email = attributes[:'debug_email']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          smtp_ssl == o.smtp_ssl &&
          smtp_starttls == o.smtp_starttls &&
          debug_email == o.debug_email
    end
    ...
    def hash
      [smtp_host, smtp_port, smtp_user, smtp_password, from_address, smtp_ssl, smtp_starttls, debug_email].hash
    end
