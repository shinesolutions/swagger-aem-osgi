...
module SwaggerAemOsgiClient
  class OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties
    ...
    attr_accessor :org_apache_sling_commons_log_names

    attr_accessor :org_apache_sling_commons_log_additiv
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'org_apache_sling_commons_log_names')
        self.org_apache_sling_commons_log_names = attributes[:'org_apache_sling_commons_log_names']
      end

      if attributes.key?(:'org_apache_sling_commons_log_additiv')
        self.org_apache_sling_commons_log_additiv = attributes[:'org_apache_sling_commons_log_additiv']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          org_apache_sling_commons_log_names == o.org_apache_sling_commons_log_names &&
          org_apache_sling_commons_log_additiv == o.org_apache_sling_commons_log_additiv
    end
    ...
    def hash
      [org_apache_sling_commons_log_level, org_apache_sling_commons_log_file, org_apache_sling_commons_log_pattern, org_apache_sling_commons_log_names, org_apache_sling_commons_log_additiv].hash
    end
