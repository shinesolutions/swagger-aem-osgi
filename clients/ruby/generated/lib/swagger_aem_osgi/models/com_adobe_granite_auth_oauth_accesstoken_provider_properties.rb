...
module SwaggerAemOsgiClient
  class ComAdobeGraniteAuthOauthAccesstokenProviderProperties
    ...
    attr_accessor :auth_token_provider_title

    attr_accessor :auth_token_provider_default_claims

    attr_accessor :auth_token_provider_endpoint

    attr_accessor :auth_access_token_request

    attr_accessor :auth_token_provider_keypair_alias

    attr_accessor :auth_token_provider_conn_timeout

    attr_accessor :auth_token_provider_so_timeout

    attr_accessor :auth_token_provider_client_id

    attr_accessor :auth_token_provider_scope

    attr_accessor :auth_token_provider_reuse_access_token

    attr_accessor :auth_token_provider_relaxed_ssl

    attr_accessor :token_request_customizer_type

    attr_accessor :auth_token_validator_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::ComAdobeGraniteAuthOauthAccesstokenProviderProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::ComAdobeGraniteAuthOauthAccesstokenProviderProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'auth_token_provider_title')
        self.auth_token_provider_title = attributes[:'auth_token_provider_title']
      end

      if attributes.key?(:'auth_token_provider_default_claims')
        self.auth_token_provider_default_claims = attributes[:'auth_token_provider_default_claims']
      end

      if attributes.key?(:'auth_token_provider_endpoint')
        self.auth_token_provider_endpoint = attributes[:'auth_token_provider_endpoint']
      end

      if attributes.key?(:'auth_access_token_request')
        self.auth_access_token_request = attributes[:'auth_access_token_request']
      end

      if attributes.key?(:'auth_token_provider_keypair_alias')
        self.auth_token_provider_keypair_alias = attributes[:'auth_token_provider_keypair_alias']
      end

      if attributes.key?(:'auth_token_provider_conn_timeout')
        self.auth_token_provider_conn_timeout = attributes[:'auth_token_provider_conn_timeout']
      end

      if attributes.key?(:'auth_token_provider_so_timeout')
        self.auth_token_provider_so_timeout = attributes[:'auth_token_provider_so_timeout']
      end

      if attributes.key?(:'auth_token_provider_client_id')
        self.auth_token_provider_client_id = attributes[:'auth_token_provider_client_id']
      end

      if attributes.key?(:'auth_token_provider_scope')
        self.auth_token_provider_scope = attributes[:'auth_token_provider_scope']
      end

      if attributes.key?(:'auth_token_provider_reuse_access_token')
        self.auth_token_provider_reuse_access_token = attributes[:'auth_token_provider_reuse_access_token']
      end

      if attributes.key?(:'auth_token_provider_relaxed_ssl')
        self.auth_token_provider_relaxed_ssl = attributes[:'auth_token_provider_relaxed_ssl']
      end

      if attributes.key?(:'token_request_customizer_type')
        self.token_request_customizer_type = attributes[:'token_request_customizer_type']
      end

      if attributes.key?(:'auth_token_validator_type')
        self.auth_token_validator_type = attributes[:'auth_token_validator_type']
      end
    end
