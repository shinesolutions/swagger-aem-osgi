  ...
  class ComAdobeOctopusNcommBootstrapProperties
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::ComAdobeOctopusNcommBootstrapProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::ComAdobeOctopusNcommBootstrapProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'request_retries')
        self.request_retries = attributes[:'request_retries']
      end

      if attributes.key?(:'launch_timeout')
        self.launch_timeout = attributes[:'launch_timeout']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          launch_timeout == o.launch_timeout
    end
    ...
    def hash
      [max_connections, max_requests, request_timeout, request_retries, launch_timeout].hash
    end
