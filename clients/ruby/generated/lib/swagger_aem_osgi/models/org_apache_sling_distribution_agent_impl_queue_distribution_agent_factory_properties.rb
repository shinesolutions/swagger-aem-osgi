...
module SwaggerAemOsgiClient
  class OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties
    ...
    attr_accessor :queue_provider_factory_target
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'queue_provider_factory_target')
        self.queue_provider_factory_target = attributes[:'queue_provider_factory_target']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          queue_provider_factory_target == o.queue_provider_factory_target &&
    ...
    def hash
      [name, title, details, enabled, service_name, log_level, allowed_roots, request_authorization_strategy_target, queue_provider_factory_target, package_builder_target, triggers_target, priority_queues].hash
    end
