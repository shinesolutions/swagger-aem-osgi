...
module SwaggerAemOsgiClient
  class OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfigurationImplProperties
    ...
    attr_accessor :token_cleanup_threshold
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerAemOsgiClient::OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfigurationImplProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerAemOsgiClient::OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfigurationImplProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'token_cleanup_threshold')
        self.token_cleanup_threshold = attributes[:'token_cleanup_threshold']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          token_cleanup_threshold == o.token_cleanup_threshold &&
    ...
    def hash
      [token_expiration, token_length, token_refresh, token_cleanup_threshold, password_hash_algorithm, password_hash_iterations, password_salt_size].hash
    end
