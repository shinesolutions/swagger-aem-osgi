...
# Unit tests for SwaggerAemOsgiClient::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties' do
  before do
  ...
  describe 'test an instance of ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties' do
    it 'should create an instance of ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties' do
      expect(@instance).to be_instance_of(SwaggerAemOsgiClient::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties)
    end
  end
  ...
  describe 'test attribute "identity_sync_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "idp_identifier"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
