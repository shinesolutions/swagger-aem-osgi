...
std::string ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorProperties::fromJsonString(std::string const& jsonString)
{
