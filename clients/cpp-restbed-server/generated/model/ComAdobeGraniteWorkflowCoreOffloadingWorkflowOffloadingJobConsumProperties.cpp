...
std::string ComAdobeGraniteWorkflowCoreOffloadingWorkflowOffloadingJobConsumProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteWorkflowCoreOffloadingWorkflowOffloadingJobConsumProperties::fromJsonString(std::string const& jsonString)
{
