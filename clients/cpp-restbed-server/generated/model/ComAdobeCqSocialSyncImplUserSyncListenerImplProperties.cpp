...
std::string ComAdobeCqSocialSyncImplUserSyncListenerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialSyncImplUserSyncListenerImplProperties::fromJsonString(std::string const& jsonString)
{
