...
std::string ComAdobeCqDamIpsImplReplicationTriggerReplicateOnModifyWorkerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqDamIpsImplReplicationTriggerReplicateOnModifyWorkerProperties::fromJsonString(std::string const& jsonString)
{
