...
std::string ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties::fromJsonString(std::string const& jsonString)
{
