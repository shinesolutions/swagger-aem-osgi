...
std::string ComDayCqWcmCoreImplLanguageManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmCoreImplLanguageManagerImplProperties::fromJsonString(std::string const& jsonString)
{
