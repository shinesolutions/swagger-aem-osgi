...
std::string ComAdobeCqDamProcessorNuiImplNuiAssetProcessorProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqDamProcessorNuiImplNuiAssetProcessorProperties::fromJsonString(std::string const& jsonString)
{
