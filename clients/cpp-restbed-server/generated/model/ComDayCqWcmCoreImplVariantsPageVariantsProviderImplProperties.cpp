...
std::string ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties::fromJsonString(std::string const& jsonString)
{
