...
std::string ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplInfo::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Pid", m_Pid);
...
void ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplInfo::fromJsonString(std::string const& jsonString)
{
...
void ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplInfo::setPid(std::string value)
{
    m_Pid = value;
}
...
void ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplInfo::setTitle(std::string value)
{
    m_Title = value;
}
...
void ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplInfo::setDescription(std::string value)
{
    m_Description = value;
}
