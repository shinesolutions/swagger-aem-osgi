...
std::string ComDayCqDamPimImplSourcingUploadProcessProductAssetsUploadProProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamPimImplSourcingUploadProcessProductAssetsUploadProProperties::fromJsonString(std::string const& jsonString)
{
