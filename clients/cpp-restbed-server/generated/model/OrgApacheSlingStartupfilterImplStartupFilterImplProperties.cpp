...
std::string OrgApacheSlingStartupfilterImplStartupFilterImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingStartupfilterImplStartupFilterImplProperties::fromJsonString(std::string const& jsonString)
{
