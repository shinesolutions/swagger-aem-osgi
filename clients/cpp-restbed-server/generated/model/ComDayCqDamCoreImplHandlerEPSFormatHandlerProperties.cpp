...
std::string ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties::fromJsonString(std::string const& jsonString)
{
