...
std::string ComAdobeCqDamCfmImplComponentComponentConfigImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqDamCfmImplComponentComponentConfigImplProperties::fromJsonString(std::string const& jsonString)
{
