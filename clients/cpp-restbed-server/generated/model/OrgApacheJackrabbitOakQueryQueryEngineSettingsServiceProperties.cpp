...
std::string OrgApacheJackrabbitOakQueryQueryEngineSettingsServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakQueryQueryEngineSettingsServiceProperties::fromJsonString(std::string const& jsonString)
{
