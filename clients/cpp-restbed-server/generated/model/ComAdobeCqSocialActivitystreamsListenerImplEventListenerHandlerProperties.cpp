...
std::string ComAdobeCqSocialActivitystreamsListenerImplEventListenerHandlerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialActivitystreamsListenerImplEventListenerHandlerProperties::fromJsonString(std::string const& jsonString)
{
