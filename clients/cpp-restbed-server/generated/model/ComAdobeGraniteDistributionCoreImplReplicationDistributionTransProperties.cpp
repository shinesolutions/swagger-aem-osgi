...
std::string ComAdobeGraniteDistributionCoreImplReplicationDistributionTransProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteDistributionCoreImplReplicationDistributionTransProperties::fromJsonString(std::string const& jsonString)
{
