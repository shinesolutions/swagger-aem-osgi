...
std::string ComAdobeCqSocialCommonsEmailreplyImplUnknownEmailClientProviderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCommonsEmailreplyImplUnknownEmailClientProviderProperties::fromJsonString(std::string const& jsonString)
{
