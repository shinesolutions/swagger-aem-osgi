...
std::string ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties::fromJsonString(std::string const& jsonString)
{
