...
std::string OrgApacheFelixSystemreadySystemReadyMonitorProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheFelixSystemreadySystemReadyMonitorProperties::fromJsonString(std::string const& jsonString)
{
