...
std::string OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties::fromJsonString(std::string const& jsonString)
{
