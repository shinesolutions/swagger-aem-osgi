...
std::string ComAdobeGraniteOffloadingImplOffloadingConfiguratorProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteOffloadingImplOffloadingConfiguratorProperties::fromJsonString(std::string const& jsonString)
{
