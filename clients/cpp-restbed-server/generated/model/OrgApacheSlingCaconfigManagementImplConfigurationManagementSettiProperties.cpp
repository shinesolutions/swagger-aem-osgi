...
std::string OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties::fromJsonString(std::string const& jsonString)
{
