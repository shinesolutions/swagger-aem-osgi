...
std::string ComAdobeGraniteInfocollectorInfoCollectorProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteInfocollectorInfoCollectorProperties::fromJsonString(std::string const& jsonString)
{
