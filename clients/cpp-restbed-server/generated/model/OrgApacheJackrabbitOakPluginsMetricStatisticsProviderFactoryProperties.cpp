...
std::string OrgApacheJackrabbitOakPluginsMetricStatisticsProviderFactoryProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakPluginsMetricStatisticsProviderFactoryProperties::fromJsonString(std::string const& jsonString)
{
