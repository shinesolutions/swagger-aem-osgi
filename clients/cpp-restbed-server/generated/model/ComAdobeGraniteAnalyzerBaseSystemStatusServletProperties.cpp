...
std::string ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties::fromJsonString(std::string const& jsonString)
{
