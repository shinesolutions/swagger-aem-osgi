...
std::string OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiProperties::fromJsonString(std::string const& jsonString)
{
