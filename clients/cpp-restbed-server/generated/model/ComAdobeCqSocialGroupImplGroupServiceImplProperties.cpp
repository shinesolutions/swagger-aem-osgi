...
std::string ComAdobeCqSocialGroupImplGroupServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialGroupImplGroupServiceImplProperties::fromJsonString(std::string const& jsonString)
{
