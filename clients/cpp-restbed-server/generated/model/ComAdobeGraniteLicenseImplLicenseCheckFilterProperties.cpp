...
std::string ComAdobeGraniteLicenseImplLicenseCheckFilterProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteLicenseImplLicenseCheckFilterProperties::fromJsonString(std::string const& jsonString)
{
