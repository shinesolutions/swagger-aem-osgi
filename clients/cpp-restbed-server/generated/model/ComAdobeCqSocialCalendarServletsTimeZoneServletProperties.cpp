...
std::string ComAdobeCqSocialCalendarServletsTimeZoneServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCalendarServletsTimeZoneServletProperties::fromJsonString(std::string const& jsonString)
{
