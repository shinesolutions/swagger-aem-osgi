...
std::string ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::fromJsonString(std::string const& jsonString)
{
