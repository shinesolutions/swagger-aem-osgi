...
std::string ComAdobeGraniteSocialgraphImplSocialGraphFactoryImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteSocialgraphImplSocialGraphFactoryImplProperties::fromJsonString(std::string const& jsonString)
{
