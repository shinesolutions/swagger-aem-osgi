...
std::string ComAdobeCqScreensImplRemoteImplDistributedHttpClientImplInfo::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Pid", m_Pid);
...
void ComAdobeCqScreensImplRemoteImplDistributedHttpClientImplInfo::fromJsonString(std::string const& jsonString)
{
...
void ComAdobeCqScreensImplRemoteImplDistributedHttpClientImplInfo::setPid(std::string value)
{
    m_Pid = value;
}
...
void ComAdobeCqScreensImplRemoteImplDistributedHttpClientImplInfo::setTitle(std::string value)
{
    m_Title = value;
}
...
void ComAdobeCqScreensImplRemoteImplDistributedHttpClientImplInfo::setDescription(std::string value)
{
    m_Description = value;
}
