...
std::string ComDayCqReportingImplCacheCacheImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqReportingImplCacheCacheImplProperties::fromJsonString(std::string const& jsonString)
{
