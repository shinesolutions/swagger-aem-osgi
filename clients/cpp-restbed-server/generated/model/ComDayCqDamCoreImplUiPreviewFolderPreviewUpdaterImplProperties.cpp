...
std::string ComDayCqDamCoreImplUiPreviewFolderPreviewUpdaterImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplUiPreviewFolderPreviewUpdaterImplProperties::fromJsonString(std::string const& jsonString)
{
