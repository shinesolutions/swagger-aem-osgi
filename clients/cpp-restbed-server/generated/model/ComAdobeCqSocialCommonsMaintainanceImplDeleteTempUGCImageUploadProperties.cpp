...
std::string ComAdobeCqSocialCommonsMaintainanceImplDeleteTempUGCImageUploadProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCommonsMaintainanceImplDeleteTempUGCImageUploadProperties::fromJsonString(std::string const& jsonString)
{
