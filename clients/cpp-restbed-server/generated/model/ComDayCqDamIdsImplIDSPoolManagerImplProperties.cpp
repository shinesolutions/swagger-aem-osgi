...
std::string ComDayCqDamIdsImplIDSPoolManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamIdsImplIDSPoolManagerImplProperties::fromJsonString(std::string const& jsonString)
{
