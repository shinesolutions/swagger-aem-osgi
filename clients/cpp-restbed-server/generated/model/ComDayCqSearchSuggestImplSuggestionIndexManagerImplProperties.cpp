...
std::string ComDayCqSearchSuggestImplSuggestionIndexManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqSearchSuggestImplSuggestionIndexManagerImplProperties::fromJsonString(std::string const& jsonString)
{
