...
std::string OrgApacheSlingHcCoreImplServletHealthCheckExecutorServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingHcCoreImplServletHealthCheckExecutorServletProperties::fromJsonString(std::string const& jsonString)
{
