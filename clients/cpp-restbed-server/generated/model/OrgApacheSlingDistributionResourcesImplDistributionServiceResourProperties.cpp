...
std::string OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::fromJsonString(std::string const& jsonString)
{
