...
std::string ComAdobeGraniteDistributionCoreImplCryptoDistributionTransportSeProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteDistributionCoreImplCryptoDistributionTransportSeProperties::fromJsonString(std::string const& jsonString)
{
