...
std::string ComAdobeCqSocialUgcbaseModerationImplAutoModerationImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialUgcbaseModerationImplAutoModerationImplProperties::fromJsonString(std::string const& jsonString)
{
