...
std::string ComAdobeGraniteAuthOauthImplGithubProviderImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteAuthOauthImplGithubProviderImplProperties::fromJsonString(std::string const& jsonString)
{
