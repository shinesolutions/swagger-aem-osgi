...
std::string ComDayCqDamCoreImplProcessTextExtractionProcessProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplProcessTextExtractionProcessProperties::fromJsonString(std::string const& jsonString)
{
