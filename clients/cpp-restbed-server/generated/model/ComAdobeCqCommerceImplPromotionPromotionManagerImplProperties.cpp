...
std::string ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties::fromJsonString(std::string const& jsonString)
{
