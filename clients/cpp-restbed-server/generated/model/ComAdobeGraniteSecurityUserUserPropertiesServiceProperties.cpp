...
std::string ComAdobeGraniteSecurityUserUserPropertiesServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteSecurityUserUserPropertiesServiceProperties::fromJsonString(std::string const& jsonString)
{
