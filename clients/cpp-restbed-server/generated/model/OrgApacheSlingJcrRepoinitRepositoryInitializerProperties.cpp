...
std::string OrgApacheSlingJcrRepoinitRepositoryInitializerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrRepoinitRepositoryInitializerProperties::fromJsonString(std::string const& jsonString)
{
