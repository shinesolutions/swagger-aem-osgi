...
std::string ComAdobeCqProjectsImplServletProjectImageServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqProjectsImplServletProjectImageServletProperties::fromJsonString(std::string const& jsonString)
{
