...
std::string ComAdobeCqSocialSyncImplPublisherSyncServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialSyncImplPublisherSyncServiceImplProperties::fromJsonString(std::string const& jsonString)
{
