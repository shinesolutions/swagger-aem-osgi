...
std::string OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties::fromJsonString(std::string const& jsonString)
{
