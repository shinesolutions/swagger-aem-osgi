...
std::string ComAdobeCqSocialForumDispatcherImplFlushOperationsProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialForumDispatcherImplFlushOperationsProperties::fromJsonString(std::string const& jsonString)
{
