...
std::string OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrServerProviderSeProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrServerProviderSeProperties::fromJsonString(std::string const& jsonString)
{
