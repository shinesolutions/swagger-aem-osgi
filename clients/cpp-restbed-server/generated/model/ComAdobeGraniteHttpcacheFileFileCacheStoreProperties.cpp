...
std::string ComAdobeGraniteHttpcacheFileFileCacheStoreProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteHttpcacheFileFileCacheStoreProperties::fromJsonString(std::string const& jsonString)
{
