...
std::string ComDayCqWcmMsmImplLiveRelationshipManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmMsmImplLiveRelationshipManagerImplProperties::fromJsonString(std::string const& jsonString)
{
