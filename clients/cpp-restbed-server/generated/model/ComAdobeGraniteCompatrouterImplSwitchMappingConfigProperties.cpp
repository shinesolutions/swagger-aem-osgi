...
std::string ComAdobeGraniteCompatrouterImplSwitchMappingConfigProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteCompatrouterImplSwitchMappingConfigProperties::fromJsonString(std::string const& jsonString)
{
