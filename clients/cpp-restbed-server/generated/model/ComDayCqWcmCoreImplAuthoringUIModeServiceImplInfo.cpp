...
std::string ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Pid", m_Pid);
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::fromJsonString(std::string const& jsonString)
{
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setPid(std::string value)
{
    m_Pid = value;
}
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setTitle(std::string value)
{
    m_Title = value;
}
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setDescription(std::string value)
{
    m_Description = value;
}
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setAdditionalProperties(std::string value)
{
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setBundleLocation(std::string value)
{
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setServiceLocation(std::string value)
{
