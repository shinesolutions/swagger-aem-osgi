...
std::string ComDayCqDamCoreImplReportsReportPurgeServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplReportsReportPurgeServiceProperties::fromJsonString(std::string const& jsonString)
{
