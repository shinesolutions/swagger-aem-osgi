...
std::string ComDayCqWcmCoreImplPagePageManagerFactoryImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmCoreImplPagePageManagerFactoryImplProperties::fromJsonString(std::string const& jsonString)
{
