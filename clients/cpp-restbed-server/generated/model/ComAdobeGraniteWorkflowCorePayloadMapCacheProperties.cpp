...
std::string ComAdobeGraniteWorkflowCorePayloadMapCacheProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteWorkflowCorePayloadMapCacheProperties::fromJsonString(std::string const& jsonString)
{
