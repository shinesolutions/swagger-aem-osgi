...
std::string OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties::fromJsonString(std::string const& jsonString)
{
