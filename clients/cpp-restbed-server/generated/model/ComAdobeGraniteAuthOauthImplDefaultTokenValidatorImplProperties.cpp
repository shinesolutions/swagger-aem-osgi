...
std::string ComAdobeGraniteAuthOauthImplDefaultTokenValidatorImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteAuthOauthImplDefaultTokenValidatorImplProperties::fromJsonString(std::string const& jsonString)
{
