...
std::string OrgApacheSlingFeatureflagsFeatureProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingFeatureflagsFeatureProperties::fromJsonString(std::string const& jsonString)
{
