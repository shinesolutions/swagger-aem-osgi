...
std::string ComDayCqWcmFoundationImplPageRedirectServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmFoundationImplPageRedirectServletProperties::fromJsonString(std::string const& jsonString)
{
