...
std::string ComAdobeGraniteAcpPlatformPlatformServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteAcpPlatformPlatformServletProperties::fromJsonString(std::string const& jsonString)
{
