...
std::string ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties::fromJsonString(std::string const& jsonString)
{
