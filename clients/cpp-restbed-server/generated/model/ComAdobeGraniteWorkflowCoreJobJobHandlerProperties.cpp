...
std::string ComAdobeGraniteWorkflowCoreJobJobHandlerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteWorkflowCoreJobJobHandlerProperties::fromJsonString(std::string const& jsonString)
{
