...
std::string ComDayCqDamStockIntegrationImplCacheStockCacheConfigurationSerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamStockIntegrationImplCacheStockCacheConfigurationSerProperties::fromJsonString(std::string const& jsonString)
{
