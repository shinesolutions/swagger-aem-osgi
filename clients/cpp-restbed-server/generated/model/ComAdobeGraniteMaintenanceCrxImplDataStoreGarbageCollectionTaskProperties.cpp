...
std::string ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties::fromJsonString(std::string const& jsonString)
{
