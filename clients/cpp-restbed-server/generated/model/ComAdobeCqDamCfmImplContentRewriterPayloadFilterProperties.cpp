...
std::string ComAdobeCqDamCfmImplContentRewriterPayloadFilterProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqDamCfmImplContentRewriterPayloadFilterProperties::fromJsonString(std::string const& jsonString)
{
