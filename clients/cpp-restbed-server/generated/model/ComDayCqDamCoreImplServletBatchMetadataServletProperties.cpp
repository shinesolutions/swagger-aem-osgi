...
std::string ComDayCqDamCoreImplServletBatchMetadataServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplServletBatchMetadataServletProperties::fromJsonString(std::string const& jsonString)
{
