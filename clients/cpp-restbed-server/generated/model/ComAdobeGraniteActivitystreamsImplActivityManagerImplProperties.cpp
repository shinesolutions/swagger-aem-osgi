...
std::string ComAdobeGraniteActivitystreamsImplActivityManagerImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteActivitystreamsImplActivityManagerImplProperties::fromJsonString(std::string const& jsonString)
{
