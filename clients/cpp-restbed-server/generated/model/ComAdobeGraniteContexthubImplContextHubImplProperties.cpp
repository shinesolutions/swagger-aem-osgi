...
std::string ComAdobeGraniteContexthubImplContextHubImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteContexthubImplContextHubImplProperties::fromJsonString(std::string const& jsonString)
{
