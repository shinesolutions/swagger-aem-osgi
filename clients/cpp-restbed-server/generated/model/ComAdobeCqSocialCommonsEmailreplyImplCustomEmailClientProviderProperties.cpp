...
std::string ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderProperties::fromJsonString(std::string const& jsonString)
{
