...
std::string ComAdobeCqSocialEnablementLearningpathEndpointsImplEnablementLProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialEnablementLearningpathEndpointsImplEnablementLProperties::fromJsonString(std::string const& jsonString)
{
