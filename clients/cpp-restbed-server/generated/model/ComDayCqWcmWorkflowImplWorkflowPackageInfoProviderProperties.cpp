...
std::string ComDayCqWcmWorkflowImplWorkflowPackageInfoProviderProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmWorkflowImplWorkflowPackageInfoProviderProperties::fromJsonString(std::string const& jsonString)
{
