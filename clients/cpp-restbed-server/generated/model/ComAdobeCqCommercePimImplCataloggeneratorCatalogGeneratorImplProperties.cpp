...
std::string ComAdobeCqCommercePimImplCataloggeneratorCatalogGeneratorImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqCommercePimImplCataloggeneratorCatalogGeneratorImplProperties::fromJsonString(std::string const& jsonString)
{
