...
std::string ComDayCqReplicationImplReplicatorImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqReplicationImplReplicatorImplProperties::fromJsonString(std::string const& jsonString)
{
