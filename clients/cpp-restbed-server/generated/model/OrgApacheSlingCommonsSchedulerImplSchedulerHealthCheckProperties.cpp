...
std::string OrgApacheSlingCommonsSchedulerImplSchedulerHealthCheckProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingCommonsSchedulerImplSchedulerHealthCheckProperties::fromJsonString(std::string const& jsonString)
{
