...
std::string ComDayCqWcmDesignimporterImplCanvasPageDeleteHandlerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmDesignimporterImplCanvasPageDeleteHandlerProperties::fromJsonString(std::string const& jsonString)
{
