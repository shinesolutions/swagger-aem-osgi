...
std::string OrgApacheSlingServletsPostImplHelperChunkCleanUpTaskProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingServletsPostImplHelperChunkCleanUpTaskProperties::fromJsonString(std::string const& jsonString)
{
