...
std::string ComAdobeCqSocialScfEndpointsImplDefaultSocialGetServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialScfEndpointsImplDefaultSocialGetServletProperties::fromJsonString(std::string const& jsonString)
{
