...
std::string OrgApacheJackrabbitVaultPackagingRegistryImplFSPackageRegistryProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitVaultPackagingRegistryImplFSPackageRegistryProperties::fromJsonString(std::string const& jsonString)
{
