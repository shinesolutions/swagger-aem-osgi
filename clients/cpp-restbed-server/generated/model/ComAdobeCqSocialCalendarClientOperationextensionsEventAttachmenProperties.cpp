...
std::string ComAdobeCqSocialCalendarClientOperationextensionsEventAttachmenProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCalendarClientOperationextensionsEventAttachmenProperties::fromJsonString(std::string const& jsonString)
{
