...
std::string ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties::fromJsonString(std::string const& jsonString)
{
