...
std::string ComDayCqDamHandlerGibsonFontmanagerImplFontManagerServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamHandlerGibsonFontmanagerImplFontManagerServiceImplProperties::fromJsonString(std::string const& jsonString)
{
