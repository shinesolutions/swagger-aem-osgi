...
std::string OrgApacheSlingDistributionTransportImplUserCredentialsDistributiProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiProperties::fromJsonString(std::string const& jsonString)
{
