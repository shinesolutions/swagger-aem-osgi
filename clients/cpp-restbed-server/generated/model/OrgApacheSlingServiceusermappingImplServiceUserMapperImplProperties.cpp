...
std::string OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties::fromJsonString(std::string const& jsonString)
{
