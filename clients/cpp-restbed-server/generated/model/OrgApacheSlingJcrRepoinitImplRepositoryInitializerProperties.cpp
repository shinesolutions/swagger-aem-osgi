...
std::string OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties::fromJsonString(std::string const& jsonString)
{
