...
std::string ComAdobeGraniteOptoutImplOptOutServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteOptoutImplOptOutServiceImplProperties::fromJsonString(std::string const& jsonString)
{
