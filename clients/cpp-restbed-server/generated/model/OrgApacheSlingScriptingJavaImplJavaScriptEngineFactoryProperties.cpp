...
std::string OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties::fromJsonString(std::string const& jsonString)
{
