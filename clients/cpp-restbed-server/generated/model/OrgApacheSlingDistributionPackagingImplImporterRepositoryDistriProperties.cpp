...
std::string OrgApacheSlingDistributionPackagingImplImporterRepositoryDistriProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingDistributionPackagingImplImporterRepositoryDistriProperties::fromJsonString(std::string const& jsonString)
{
