...
std::string ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties::fromJsonString(std::string const& jsonString)
{
