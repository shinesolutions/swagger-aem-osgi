...
std::string ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletProperties::fromJsonString(std::string const& jsonString)
{
