...
std::string ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenProperties::fromJsonString(std::string const& jsonString)
{
