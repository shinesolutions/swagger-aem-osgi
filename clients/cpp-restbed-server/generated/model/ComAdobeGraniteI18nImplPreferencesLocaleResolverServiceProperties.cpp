...
std::string ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties::fromJsonString(std::string const& jsonString)
{
