...
std::string ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties::fromJsonString(std::string const& jsonString)
{
