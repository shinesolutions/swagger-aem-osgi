...
std::string OrgApacheSlingJcrWebdavImplHandlerDefaultHandlerServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrWebdavImplHandlerDefaultHandlerServiceProperties::fromJsonString(std::string const& jsonString)
{
