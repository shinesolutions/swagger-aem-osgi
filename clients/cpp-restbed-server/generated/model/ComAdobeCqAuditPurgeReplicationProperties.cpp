...
std::string ComAdobeCqAuditPurgeReplicationProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqAuditPurgeReplicationProperties::fromJsonString(std::string const& jsonString)
{
