...
std::string ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties::fromJsonString(std::string const& jsonString)
{
