...
std::string OrgApacheJackrabbitOakSegmentAzureAzureSegmentStoreServiceProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakSegmentAzureAzureSegmentStoreServiceProperties::fromJsonString(std::string const& jsonString)
{
