...
std::string ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportIProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportIProperties::fromJsonString(std::string const& jsonString)
{
