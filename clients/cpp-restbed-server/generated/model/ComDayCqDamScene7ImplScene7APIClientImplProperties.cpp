...
std::string ComDayCqDamScene7ImplScene7APIClientImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamScene7ImplScene7APIClientImplProperties::fromJsonString(std::string const& jsonString)
{
