...
std::string ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperProperties::fromJsonString(std::string const& jsonString)
{
