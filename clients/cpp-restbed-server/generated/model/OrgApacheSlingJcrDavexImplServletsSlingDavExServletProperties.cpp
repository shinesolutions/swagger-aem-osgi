...
std::string OrgApacheSlingJcrDavexImplServletsSlingDavExServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrDavexImplServletsSlingDavExServletProperties::fromJsonString(std::string const& jsonString)
{
