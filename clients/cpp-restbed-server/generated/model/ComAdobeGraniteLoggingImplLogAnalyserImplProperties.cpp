...
std::string ComAdobeGraniteLoggingImplLogAnalyserImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteLoggingImplLogAnalyserImplProperties::fromJsonString(std::string const& jsonString)
{
