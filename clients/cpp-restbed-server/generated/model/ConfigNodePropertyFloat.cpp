...
std::string ConfigNodePropertyFloat::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Name", m_Name);
...
void ConfigNodePropertyFloat::fromJsonString(std::string const& jsonString)
{
...
void ConfigNodePropertyFloat::setName(std::string value)
{
    m_Name = value;
}
...
void ConfigNodePropertyFloat::setDescription(std::string value)
{
    m_Description = value;
}
