...
std::string ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplProperties::fromJsonString(std::string const& jsonString)
{
