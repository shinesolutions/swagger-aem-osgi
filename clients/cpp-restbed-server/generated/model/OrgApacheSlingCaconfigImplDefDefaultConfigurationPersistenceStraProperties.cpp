...
std::string OrgApacheSlingCaconfigImplDefDefaultConfigurationPersistenceStraProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingCaconfigImplDefDefaultConfigurationPersistenceStraProperties::fromJsonString(std::string const& jsonString)
{
