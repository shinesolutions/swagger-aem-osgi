...
std::string ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenInfo::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Pid", m_Pid);
...
void ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenInfo::fromJsonString(std::string const& jsonString)
{
...
void ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenInfo::setPid(std::string value)
{
    m_Pid = value;
}
...
void ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenInfo::setTitle(std::string value)
{
    m_Title = value;
}
...
void ComAdobeGraniteDistributionCoreImplDistributionToReplicationEvenInfo::setDescription(std::string value)
{
    m_Description = value;
}
