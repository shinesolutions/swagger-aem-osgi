...
std::string OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryProperties::fromJsonString(std::string const& jsonString)
{
