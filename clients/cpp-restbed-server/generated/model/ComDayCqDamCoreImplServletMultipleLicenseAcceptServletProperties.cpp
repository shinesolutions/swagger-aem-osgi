...
std::string ComDayCqDamCoreImplServletMultipleLicenseAcceptServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqDamCoreImplServletMultipleLicenseAcceptServletProperties::fromJsonString(std::string const& jsonString)
{
