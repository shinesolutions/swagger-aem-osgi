...
std::string OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties::fromJsonString(std::string const& jsonString)
{
