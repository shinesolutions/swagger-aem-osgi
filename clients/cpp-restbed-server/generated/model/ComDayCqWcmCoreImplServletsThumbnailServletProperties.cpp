...
std::string ComDayCqWcmCoreImplServletsThumbnailServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmCoreImplServletsThumbnailServletProperties::fromJsonString(std::string const& jsonString)
{
