...
std::string OrgApacheJackrabbitOakSpiSecurityAuthorizationCugImplCugConfiProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakSpiSecurityAuthorizationCugImplCugConfiProperties::fromJsonString(std::string const& jsonString)
{
