...
std::string ComAdobeGraniteI18nImplBundlePseudoTranslationsProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteI18nImplBundlePseudoTranslationsProperties::fromJsonString(std::string const& jsonString)
{
