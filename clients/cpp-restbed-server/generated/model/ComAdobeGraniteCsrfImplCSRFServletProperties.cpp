...
std::string ComAdobeGraniteCsrfImplCSRFServletProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteCsrfImplCSRFServletProperties::fromJsonString(std::string const& jsonString)
{
