...
std::string OrgApacheSlingJcrBaseInternalLoginAdminWhitelistFragmentProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrBaseInternalLoginAdminWhitelistFragmentProperties::fromJsonString(std::string const& jsonString)
{
