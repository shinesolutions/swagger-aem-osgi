...
std::string ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportMProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportMProperties::fromJsonString(std::string const& jsonString)
{
