...
std::string ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties::fromJsonString(std::string const& jsonString)
{
