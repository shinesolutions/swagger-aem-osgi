...
std::string ComDayCqWcmScriptingImplBVPManagerProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqWcmScriptingImplBVPManagerProperties::fromJsonString(std::string const& jsonString)
{
