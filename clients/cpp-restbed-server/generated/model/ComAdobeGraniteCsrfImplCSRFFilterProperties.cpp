...
std::string ComAdobeGraniteCsrfImplCSRFFilterProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteCsrfImplCSRFFilterProperties::fromJsonString(std::string const& jsonString)
{
