...
std::string OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties::fromJsonString(std::string const& jsonString)
{
