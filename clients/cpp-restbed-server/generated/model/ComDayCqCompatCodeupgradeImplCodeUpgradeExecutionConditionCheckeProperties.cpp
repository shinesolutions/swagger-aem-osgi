...
std::string ComDayCqCompatCodeupgradeImplCodeUpgradeExecutionConditionCheckeProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqCompatCodeupgradeImplCodeUpgradeExecutionConditionCheckeProperties::fromJsonString(std::string const& jsonString)
{
