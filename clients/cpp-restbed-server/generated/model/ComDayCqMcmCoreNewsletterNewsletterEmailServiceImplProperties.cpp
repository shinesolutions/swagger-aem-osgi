...
std::string ComDayCqMcmCoreNewsletterNewsletterEmailServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComDayCqMcmCoreNewsletterNewsletterEmailServiceImplProperties::fromJsonString(std::string const& jsonString)
{
