...
std::string ComAdobeCqSocialUgcbaseDispatcherImplFlushServiceImplProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeCqSocialUgcbaseDispatcherImplFlushServiceImplProperties::fromJsonString(std::string const& jsonString)
{
