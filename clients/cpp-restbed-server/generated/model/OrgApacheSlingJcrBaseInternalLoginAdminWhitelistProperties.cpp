...
std::string OrgApacheSlingJcrBaseInternalLoginAdminWhitelistProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void OrgApacheSlingJcrBaseInternalLoginAdminWhitelistProperties::fromJsonString(std::string const& jsonString)
{
