...
std::string ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties::fromJsonString(std::string const& jsonString)
{
