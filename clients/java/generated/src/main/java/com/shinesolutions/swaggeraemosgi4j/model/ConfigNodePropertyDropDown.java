...
public class ConfigNodePropertyDropDown {
  ...
  private List<List<Object>> type = new ArrayList<List<Object>>();
  ...
  **/
  ...
  public ConfigNodePropertyDropDown type(List<List<Object>> type) {
    this.type = type;
    return this;
  }

  public ConfigNodePropertyDropDown addTypeItem(List<Object> typeItem) {
    if (this.type == null) {
      this.type = new ArrayList<List<Object>>();
    }
  ...
  **/
  ...
  public List<List<Object>> getType() {
    return type;
  }

  public void setType(List<List<Object>> type) {
    this.type = type;
  }

  public ConfigNodePropertyDropDown value(List<Object> value) {
    this.value = value;
    return this;
  }

  public ConfigNodePropertyDropDown addValueItem(Object valueItem) {
    if (this.value == null) {
