...
public class ComAdobeGraniteWorkflowCoreJobJobHandlerProperties {
  ...
  public static final String SERIALIZED_NAME_ALLOW_SELF_PROCESS_TERMINATION = "allow.self.process.termination";
  @SerializedName(SERIALIZED_NAME_ALLOW_SELF_PROCESS_TERMINATION)
