...
public class ComDayCqDamCoreImplServletCompanionServletProperties {
  ...
  public static final String SERIALIZED_NAME_SLASH_MNT_SLASH_OVERLAY_SLASH_DAM_SLASH_GUI_SLASH_CONTENT_SLASH_ASSETS_SLASH_MOREINFO_HTML_SLASH$_LEFT_CURLY_BRACKET_PATH_RIGHT_CURLY_BRACKET = "/mnt/overlay/dam/gui/content/assets/moreinfo.html/${path}";
  @SerializedName(SERIALIZED_NAME_SLASH_MNT_SLASH_OVERLAY_SLASH_DAM_SLASH_GUI_SLASH_CONTENT_SLASH_ASSETS_SLASH_MOREINFO_HTML_SLASH$_LEFT_CURLY_BRACKET_PATH_RIGHT_CURLY_BRACKET)
