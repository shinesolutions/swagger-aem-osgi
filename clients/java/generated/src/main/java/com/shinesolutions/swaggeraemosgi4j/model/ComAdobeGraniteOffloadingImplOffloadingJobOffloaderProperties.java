...
public class ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties {
  public static final String SERIALIZED_NAME_OFFLOADING_OFFLOADER_ENABLED = "offloading.offloader.enabled";
  @SerializedName(SERIALIZED_NAME_OFFLOADING_OFFLOADER_ENABLED)
