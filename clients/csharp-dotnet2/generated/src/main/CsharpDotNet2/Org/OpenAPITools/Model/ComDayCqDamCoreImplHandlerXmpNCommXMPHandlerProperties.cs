...
namespace Org.OpenAPITools.Model {
  ...
  public class ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties {
    /// <summary>
    /// Gets or Sets XmphandlerCqFormats
    /// </summary>
    [DataMember(Name="xmphandler.cq.formats", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "xmphandler.cq.formats")]
    public ConfigNodePropertyArray XmphandlerCqFormats { get; set; }
