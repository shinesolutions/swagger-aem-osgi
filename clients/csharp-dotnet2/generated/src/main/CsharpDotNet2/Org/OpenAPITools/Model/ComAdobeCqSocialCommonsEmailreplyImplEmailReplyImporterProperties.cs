...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeCqSocialCommonsEmailreplyImplEmailReplyImporterProperties {
    /// <summary>
    /// Gets or Sets ConnectProtocol
    /// </summary>
    [DataMember(Name="connectProtocol", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "connectProtocol")]
    public ConfigNodePropertyDropDown ConnectProtocol { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  ConnectProtocol: ").Append(ConnectProtocol).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
