...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreProperties {
    /// <summary>
    /// Gets or Sets StreamPath
    /// </summary>
    [DataMember(Name="streamPath", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "streamPath")]
    public ConfigNodePropertyString StreamPath { get; set; }
    ...
    public ConfigNodePropertyString StreamName { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  StreamPath: ").Append(StreamPath).Append("\n");
