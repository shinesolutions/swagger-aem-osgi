...
namespace Org.OpenAPITools.Model {
  ...
  public class OrgApacheJackrabbitOakSpiSecurityAuthorizationCugImplCugExcluProperties {
    /// <summary>
    /// Gets or Sets PrincipalNames
    /// </summary>
    [DataMember(Name="principalNames", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "principalNames")]
    public ConfigNodePropertyArray PrincipalNames { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  PrincipalNames: ").Append(PrincipalNames).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
