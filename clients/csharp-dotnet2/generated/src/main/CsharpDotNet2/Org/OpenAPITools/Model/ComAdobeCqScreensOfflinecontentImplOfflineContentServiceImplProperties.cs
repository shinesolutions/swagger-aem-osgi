...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplProperties {
    /// <summary>
    /// Gets or Sets DisableSmartSync
    /// </summary>
    [DataMember(Name="disableSmartSync", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "disableSmartSync")]
    public ConfigNodePropertyBoolean DisableSmartSync { get; set; }
