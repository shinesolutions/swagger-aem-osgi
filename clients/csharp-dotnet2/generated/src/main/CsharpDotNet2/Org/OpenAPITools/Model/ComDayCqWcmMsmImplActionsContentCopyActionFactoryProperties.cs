...
namespace Org.OpenAPITools.Model {
  ...
  public class ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties {
    ...
    /// <summary>
    /// Gets or Sets ContentcopyactionOrderStyle
    /// </summary>
    [DataMember(Name="contentcopyaction.order.style", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "contentcopyaction.order.style")]
    public ConfigNodePropertyDropDown ContentcopyactionOrderStyle { get; set; }
