...
namespace Org.OpenAPITools.Model {
  ...
  public class ComDayCqWcmCoreImplReferencesContentContentReferenceConfigProperties {
    /// <summary>
    /// Gets or Sets ContentReferenceConfigResourceTypes
    /// </summary>
    [DataMember(Name="contentReferenceConfig.resourceTypes", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "contentReferenceConfig.resourceTypes")]
    public ConfigNodePropertyArray ContentReferenceConfigResourceTypes { get; set; }
