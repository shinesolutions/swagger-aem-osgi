...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportIProperties {
    /// <summary>
    /// Gets or Sets CqSocialReportingAnalyticsPollingImporterInterval
    /// </summary>
    [DataMember(Name="cq.social.reporting.analytics.polling.importer.interval", EmitDefaultValue=false)]
    ...
    /// <summary>
    /// Gets or Sets CqSocialReportingAnalyticsPollingImporterPageSize
    /// </summary>
    [DataMember(Name="cq.social.reporting.analytics.polling.importer.pageSize", EmitDefaultValue=false)]
