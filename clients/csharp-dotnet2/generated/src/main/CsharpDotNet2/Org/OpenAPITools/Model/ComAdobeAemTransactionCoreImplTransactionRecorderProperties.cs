...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeAemTransactionCoreImplTransactionRecorderProperties {
    /// <summary>
    /// Gets or Sets IsTransactionRecordingEnabled
    /// </summary>
    [DataMember(Name="isTransactionRecordingEnabled", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "isTransactionRecordingEnabled")]
    public ConfigNodePropertyBoolean IsTransactionRecordingEnabled { get; set; }
