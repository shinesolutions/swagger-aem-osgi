...
namespace Org.OpenAPITools.Model {
  ...
  public class ComAdobeCqContentinsightImplReportingServicesSettingsProviderProperties {
    /// <summary>
    /// Gets or Sets ReportingservicesUrl
    /// </summary>
    [DataMember(Name="reportingservices.url", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "reportingservices.url")]
    public ConfigNodePropertyString ReportingservicesUrl { get; set; }
