...
#ifndef OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H
#define OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H
...
public:
    ...
    ~OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo() override;
    void init();
    ...
    OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties getProperties() const;
    void setProperties(const OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties &properties);
...
#endif // OAIOrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H
