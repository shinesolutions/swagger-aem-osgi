...
#ifndef OAIOrgApacheSlingSecurityImplContentDispositionFilterInfo_H
#define OAIOrgApacheSlingSecurityImplContentDispositionFilterInfo_H
...
public:
    ...
    ~OAIOrgApacheSlingSecurityImplContentDispositionFilterInfo() override;
    void init();
    ...
    OAIOrgApacheSlingSecurityImplContentDispositionFilterProperties getProperties() const;
    void setProperties(const OAIOrgApacheSlingSecurityImplContentDispositionFilterProperties &properties);
...
#endif // OAIOrgApacheSlingSecurityImplContentDispositionFilterInfo_H
