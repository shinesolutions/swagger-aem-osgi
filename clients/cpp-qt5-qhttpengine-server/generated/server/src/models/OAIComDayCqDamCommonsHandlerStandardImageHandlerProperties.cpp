...
void
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::fromJson(QString jsonString) {
...
void
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::fromJsonObject(QJsonObject json) {
...
QString
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::asJson () const {
...
QJsonObject
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::getLargeFileThreshold() const {
    return large_file_threshold;
}
void
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::setLargeFileThreshold(const OAIConfigNodePropertyInteger &large_file_threshold) {
    this->large_file_threshold = large_file_threshold;
    this->m_large_file_threshold_isSet = true;
}

OAIConfigNodePropertyInteger
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::getLargeCommentThreshold() const {
    return large_comment_threshold;
}
void
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::setLargeCommentThreshold(const OAIConfigNodePropertyInteger &large_comment_threshold) {
    this->large_comment_threshold = large_comment_threshold;
    this->m_large_comment_threshold_isSet = true;
}

OAIConfigNodePropertyBoolean
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::getCqDamEnableExtMetaExtraction() const {
    return cq_dam_enable_ext_meta_extraction;
}
void
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::setCqDamEnableExtMetaExtraction(const OAIConfigNodePropertyBoolean &cq_dam_enable_ext_meta_extraction) {
...
bool
OAIComDayCqDamCommonsHandlerStandardImageHandlerProperties::isSet() const {
