...
#ifndef OAIComDayCqDamVideoImplServletVideoTestServletInfo_H
#define OAIComDayCqDamVideoImplServletVideoTestServletInfo_H
...
public:
    ...
    ~OAIComDayCqDamVideoImplServletVideoTestServletInfo() override;
    void init();
    ...
    OAIComDayCqDamVideoImplServletVideoTestServletProperties getProperties() const;
    void setProperties(const OAIComDayCqDamVideoImplServletVideoTestServletProperties &properties);
...
#endif // OAIComDayCqDamVideoImplServletVideoTestServletInfo_H
