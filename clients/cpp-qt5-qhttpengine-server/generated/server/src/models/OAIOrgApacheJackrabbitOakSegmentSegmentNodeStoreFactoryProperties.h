...
#ifndef OAIOrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H
#define OAIOrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H
...
public:
    ...
    ~OAIOrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties() override;
    void init();
    ...
    OAIConfigNodePropertyBoolean getRegisterDescriptors() const;
    void setRegisterDescriptors(const OAIConfigNodePropertyBoolean &register_descriptors);

    OAIConfigNodePropertyBoolean getDispatchChanges() const;
    void setDispatchChanges(const OAIConfigNodePropertyBoolean &dispatch_changes);
...
#endif // OAIOrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H
