...
#ifndef OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo_H
#define OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo_H
...
public:
    ...
    ~OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo() override;
    void init();
    ...
    OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties getProperties() const;
    void setProperties(const OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties &properties);
...
#endif // OAIOrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo_H
