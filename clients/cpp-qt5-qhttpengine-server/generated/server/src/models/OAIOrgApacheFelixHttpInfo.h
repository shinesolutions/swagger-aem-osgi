...
#ifndef OAIOrgApacheFelixHttpInfo_H
#define OAIOrgApacheFelixHttpInfo_H
...
public:
    ...
    ~OAIOrgApacheFelixHttpInfo() override;
    void init();
    ...
    OAIOrgApacheFelixHttpProperties getProperties() const;
    void setProperties(const OAIOrgApacheFelixHttpProperties &properties);
...
#endif // OAIOrgApacheFelixHttpInfo_H
