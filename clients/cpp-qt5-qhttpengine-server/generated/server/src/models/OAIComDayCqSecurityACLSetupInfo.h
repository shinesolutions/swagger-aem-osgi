...
#ifndef OAIComDayCqSecurityACLSetupInfo_H
#define OAIComDayCqSecurityACLSetupInfo_H
...
public:
    ...
    ~OAIComDayCqSecurityACLSetupInfo() override;
    void init();
    ...
    OAIComDayCqSecurityACLSetupProperties getProperties() const;
    void setProperties(const OAIComDayCqSecurityACLSetupProperties &properties);
...
#endif // OAIComDayCqSecurityACLSetupInfo_H
