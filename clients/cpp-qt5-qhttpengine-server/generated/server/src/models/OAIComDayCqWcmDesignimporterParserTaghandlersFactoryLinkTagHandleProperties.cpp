...
void
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::fromJson(QString jsonString) {
...
void
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::fromJsonObject(QJsonObject json) {
...
QString
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::asJson () const {
...
QJsonObject
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::getServiceRanking() const {
    return service_ranking;
}
void
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::setServiceRanking(const OAIConfigNodePropertyInteger &service_ranking) {
    this->service_ranking = service_ranking;
    this->m_service_ranking_isSet = true;
}

OAIConfigNodePropertyString
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::getTagpattern() const {
    return tagpattern;
}
void
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::setTagpattern(const OAIConfigNodePropertyString &tagpattern) {
...
bool
OAIComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::isSet() const {
