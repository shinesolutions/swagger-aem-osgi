...
void
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::fromJson(QString jsonString) {
...
void
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::fromJsonObject(QJsonObject json) {
...
QString
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::asJson () const {
...
QJsonObject
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::getPriorityOrder() const {
    return priority_order;
}
void
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::setPriorityOrder(const OAIConfigNodePropertyInteger &priority_order) {
    this->priority_order = priority_order;
    this->m_priority_order_isSet = true;
}

OAIConfigNodePropertyArray
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::getReplyEmailPatterns() const {
    return reply_email_patterns;
}
void
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::setReplyEmailPatterns(const OAIConfigNodePropertyArray &reply_email_patterns) {
...
bool
OAIComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::isSet() const {
