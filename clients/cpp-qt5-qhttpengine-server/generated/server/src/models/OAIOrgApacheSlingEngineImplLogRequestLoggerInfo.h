...
#ifndef OAIOrgApacheSlingEngineImplLogRequestLoggerInfo_H
#define OAIOrgApacheSlingEngineImplLogRequestLoggerInfo_H
...
public:
    ...
    ~OAIOrgApacheSlingEngineImplLogRequestLoggerInfo() override;
    void init();
    ...
    OAIOrgApacheSlingEngineImplLogRequestLoggerProperties getProperties() const;
    void setProperties(const OAIOrgApacheSlingEngineImplLogRequestLoggerProperties &properties);
...
#endif // OAIOrgApacheSlingEngineImplLogRequestLoggerInfo_H
