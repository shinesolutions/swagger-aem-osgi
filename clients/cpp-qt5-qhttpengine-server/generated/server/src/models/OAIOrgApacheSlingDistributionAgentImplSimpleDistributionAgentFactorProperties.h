...
#ifndef OAIOrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorProperties_H
#define OAIOrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorProperties_H
...
public:
    ...
    ~OAIOrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorProperties() override;
    void init();
    ...
    OAIConfigNodePropertyString getPackageExporterTarget() const;
    void setPackageExporterTarget(const OAIConfigNodePropertyString &package_exporter_target);

    OAIConfigNodePropertyString getPackageImporterTarget() const;
    void setPackageImporterTarget(const OAIConfigNodePropertyString &package_importer_target);
...
#endif // OAIOrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorProperties_H
