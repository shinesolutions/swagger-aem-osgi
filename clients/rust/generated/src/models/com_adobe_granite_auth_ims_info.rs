...
pub struct ComAdobeGraniteAuthImsInfo {
  ...
  properties: Option<::models::ComAdobeGraniteAuthImsProperties>,
...
impl ComAdobeGraniteAuthImsInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteAuthImsInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteAuthImsInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteAuthImsInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteAuthImsProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteAuthImsProperties) -> ComAdobeGraniteAuthImsInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteAuthImsProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteAuthImsInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteAuthImsInfo {
    self.service_location = Some(service_location);
    self
  }
