...
impl ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileProperties {
  ...
  pub fn with_field_whitelist(mut self, field_whitelist: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileProperties {
    self.field_whitelist = Some(field_whitelist);
    self
  }
