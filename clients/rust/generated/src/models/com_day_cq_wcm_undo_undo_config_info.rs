...
pub struct ComDayCqWcmUndoUndoConfigInfo {
  ...
  properties: Option<::models::ComDayCqWcmUndoUndoConfigProperties>,
...
impl ComDayCqWcmUndoUndoConfigInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmUndoUndoConfigInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmUndoUndoConfigInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmUndoUndoConfigInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmUndoUndoConfigProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmUndoUndoConfigProperties) -> ComDayCqWcmUndoUndoConfigInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmUndoUndoConfigProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmUndoUndoConfigInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmUndoUndoConfigInfo {
    self.service_location = Some(service_location);
    self
  }
