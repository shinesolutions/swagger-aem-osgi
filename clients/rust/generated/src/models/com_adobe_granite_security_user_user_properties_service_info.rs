...
pub struct ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
  ...
  properties: Option<::models::ComAdobeGraniteSecurityUserUserPropertiesServiceProperties>,
...
impl ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteSecurityUserUserPropertiesServiceProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteSecurityUserUserPropertiesServiceProperties) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteSecurityUserUserPropertiesServiceProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteSecurityUserUserPropertiesServiceInfo {
    self.service_location = Some(service_location);
    self
  }
