...
impl ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties {
  ...
  pub fn with_service_ranking(mut self, service_ranking: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties {
    self.service_ranking = Some(service_ranking);
    self
  }
