...
pub struct ComDayCqDamVideoImplServletVideoTestServletInfo {
  ...
  properties: Option<::models::ComDayCqDamVideoImplServletVideoTestServletProperties>,
...
impl ComDayCqDamVideoImplServletVideoTestServletInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqDamVideoImplServletVideoTestServletProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqDamVideoImplServletVideoTestServletProperties) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqDamVideoImplServletVideoTestServletProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqDamVideoImplServletVideoTestServletInfo {
    self.service_location = Some(service_location);
    self
  }
