...
pub struct OrgApacheSlingDiscoveryOakConfigInfo {
  ...
  properties: Option<::models::OrgApacheSlingDiscoveryOakConfigProperties>,
...
impl OrgApacheSlingDiscoveryOakConfigInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingDiscoveryOakConfigProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingDiscoveryOakConfigProperties) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingDiscoveryOakConfigProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingDiscoveryOakConfigInfo {
    self.service_location = Some(service_location);
    self
  }
