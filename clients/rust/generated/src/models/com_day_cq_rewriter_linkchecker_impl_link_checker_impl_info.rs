...
pub struct ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
  ...
  properties: Option<::models::ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties>,
...
impl ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo {
    self.service_location = Some(service_location);
    self
  }
