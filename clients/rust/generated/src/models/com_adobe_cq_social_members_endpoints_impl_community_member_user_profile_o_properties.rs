...
impl ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOProperties {
  ...
  pub fn with_field_whitelist(mut self, field_whitelist: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOProperties {
    self.field_whitelist = Some(field_whitelist);
    self
  }
