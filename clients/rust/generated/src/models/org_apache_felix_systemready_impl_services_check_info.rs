...
pub struct OrgApacheFelixSystemreadyImplServicesCheckInfo {
  ...
  properties: Option<::models::OrgApacheFelixSystemreadyImplServicesCheckProperties>,
...
impl OrgApacheFelixSystemreadyImplServicesCheckInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheFelixSystemreadyImplServicesCheckProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheFelixSystemreadyImplServicesCheckProperties) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheFelixSystemreadyImplServicesCheckProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheFelixSystemreadyImplServicesCheckInfo {
    self.service_location = Some(service_location);
    self
  }
