...
impl ComAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderServiceProperties {
  ...
  pub fn with_threshold(mut self, threshold: ::models::ConfigNodePropertyInteger) -> ComAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderServiceProperties {
    self.threshold = Some(threshold);
    self
  }
  ...
  pub fn with_job_topic_name(mut self, job_topic_name: ::models::ConfigNodePropertyString) -> ComAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderServiceProperties {
    self.job_topic_name = Some(job_topic_name);
    self
  }
  ...
  pub fn with_email_enabled(mut self, email_enabled: ::models::ConfigNodePropertyBoolean) -> ComAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderServiceProperties {
    self.email_enabled = Some(email_enabled);
    self
  }
