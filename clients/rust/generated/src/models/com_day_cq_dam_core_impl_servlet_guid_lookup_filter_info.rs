...
pub struct ComDayCqDamCoreImplServletGuidLookupFilterInfo {
  ...
  properties: Option<::models::ComDayCqDamCoreImplServletGuidLookupFilterProperties>,
...
impl ComDayCqDamCoreImplServletGuidLookupFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqDamCoreImplServletGuidLookupFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqDamCoreImplServletGuidLookupFilterProperties) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqDamCoreImplServletGuidLookupFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqDamCoreImplServletGuidLookupFilterInfo {
    self.service_location = Some(service_location);
    self
  }
