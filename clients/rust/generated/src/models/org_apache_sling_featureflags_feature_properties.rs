...
impl OrgApacheSlingFeatureflagsFeatureProperties {
  ...
  pub fn with_name(mut self, name: ::models::ConfigNodePropertyString) -> OrgApacheSlingFeatureflagsFeatureProperties {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_description(mut self, description: ::models::ConfigNodePropertyString) -> OrgApacheSlingFeatureflagsFeatureProperties {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: ::models::ConfigNodePropertyBoolean) -> OrgApacheSlingFeatureflagsFeatureProperties {
    self.enabled = Some(enabled);
    self
  }
