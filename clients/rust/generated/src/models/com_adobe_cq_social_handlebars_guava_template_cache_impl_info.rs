...
pub struct ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
  ...
  properties: Option<::models::ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties>,
...
impl ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo {
    self.service_location = Some(service_location);
    self
  }
