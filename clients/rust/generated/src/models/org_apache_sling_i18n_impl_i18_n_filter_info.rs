...
pub struct OrgApacheSlingI18nImplI18NFilterInfo {
  ...
  properties: Option<::models::OrgApacheSlingI18nImplI18NFilterProperties>,
...
impl OrgApacheSlingI18nImplI18NFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingI18nImplI18NFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingI18nImplI18NFilterProperties) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingI18nImplI18NFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingI18nImplI18NFilterInfo {
    self.service_location = Some(service_location);
    self
  }
