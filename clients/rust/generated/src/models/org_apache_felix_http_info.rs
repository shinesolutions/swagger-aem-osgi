...
pub struct OrgApacheFelixHttpInfo {
  ...
  properties: Option<::models::OrgApacheFelixHttpProperties>,
...
impl OrgApacheFelixHttpInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheFelixHttpInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheFelixHttpInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheFelixHttpInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheFelixHttpProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheFelixHttpProperties) -> OrgApacheFelixHttpInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheFelixHttpProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheFelixHttpInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheFelixHttpInfo {
    self.service_location = Some(service_location);
    self
  }
