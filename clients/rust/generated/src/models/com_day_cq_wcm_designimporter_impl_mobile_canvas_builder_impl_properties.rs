...
pub struct ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
  ...
  device_groups: Option<::models::ConfigNodePropertyArray>,
...
impl ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
  ...
  pub fn with_filepattern(mut self, filepattern: ::models::ConfigNodePropertyString) -> ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
    self.filepattern = Some(filepattern);
    self
  }
  ...
  pub fn set_device_groups(&mut self, device_groups: ::models::ConfigNodePropertyArray) {
    self.device_groups = Some(device_groups);
  }

  pub fn with_device_groups(mut self, device_groups: ::models::ConfigNodePropertyArray) -> ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
    self.device_groups = Some(device_groups);
    self
  }

  pub fn device_groups(&self) -> Option<&::models::ConfigNodePropertyArray> {
    self.device_groups.as_ref()
  }

  pub fn reset_device_groups(&mut self) {
  ...
  pub fn with_build_page_nodes(mut self, build_page_nodes: ::models::ConfigNodePropertyBoolean) -> ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
    self.build_page_nodes = Some(build_page_nodes);
    self
  }
  ...
  pub fn with_build_client_libs(mut self, build_client_libs: ::models::ConfigNodePropertyBoolean) -> ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
    self.build_client_libs = Some(build_client_libs);
    self
  }
  ...
  pub fn with_build_canvas_component(mut self, build_canvas_component: ::models::ConfigNodePropertyBoolean) -> ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties {
    self.build_canvas_component = Some(build_canvas_component);
    self
  }
