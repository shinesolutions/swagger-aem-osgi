...
impl ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenProperties {
  ...
  pub fn with_resource_type_filters(mut self, resource_type_filters: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenProperties {
    self.resource_type_filters = Some(resource_type_filters);
    self
  }
  ...
  pub fn with_priority(mut self, priority: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenProperties {
    self.priority = Some(priority);
    self
  }
