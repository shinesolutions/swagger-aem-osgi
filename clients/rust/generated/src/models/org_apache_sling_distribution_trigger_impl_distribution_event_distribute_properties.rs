...
impl OrgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties {
  ...
  pub fn with_name(mut self, name: ::models::ConfigNodePropertyString) -> OrgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_path(mut self, path: ::models::ConfigNodePropertyString) -> OrgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties {
    self.path = Some(path);
    self
  }
