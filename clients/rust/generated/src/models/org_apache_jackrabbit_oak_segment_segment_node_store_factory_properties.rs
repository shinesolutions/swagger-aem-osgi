...
pub struct OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
  ...
  register_descriptors: Option<::models::ConfigNodePropertyBoolean>,
  #[serde(rename = "dispatchChanges")]
  dispatch_changes: Option<::models::ConfigNodePropertyBoolean>
}
...
impl OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
  ...
  pub fn with_repository_home(mut self, repository_home: ::models::ConfigNodePropertyString) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.repository_home = Some(repository_home);
    self
  }
  ...
  pub fn with_tarmk_mode(mut self, tarmk_mode: ::models::ConfigNodePropertyString) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.tarmk_mode = Some(tarmk_mode);
    self
  }
  ...
  pub fn with_tarmk_size(mut self, tarmk_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.tarmk_size = Some(tarmk_size);
    self
  }
  ...
  pub fn with_segment_cache_size(mut self, segment_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.segment_cache_size = Some(segment_cache_size);
    self
  }
  ...
  pub fn with_string_cache_size(mut self, string_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.string_cache_size = Some(string_cache_size);
    self
  }
  ...
  pub fn with_template_cache_size(mut self, template_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.template_cache_size = Some(template_cache_size);
    self
  }
  ...
  pub fn with_string_deduplication_cache_size(mut self, string_deduplication_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.string_deduplication_cache_size = Some(string_deduplication_cache_size);
    self
  }
  ...
  pub fn with_template_deduplication_cache_size(mut self, template_deduplication_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.template_deduplication_cache_size = Some(template_deduplication_cache_size);
    self
  }
  ...
  pub fn with_node_deduplication_cache_size(mut self, node_deduplication_cache_size: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.node_deduplication_cache_size = Some(node_deduplication_cache_size);
    self
  }
  ...
  pub fn with_pause_compaction(mut self, pause_compaction: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.pause_compaction = Some(pause_compaction);
    self
  }
  ...
  pub fn with_compaction_retry_count(mut self, compaction_retry_count: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_retry_count = Some(compaction_retry_count);
    self
  }
  ...
  pub fn with_compaction_force_timeout(mut self, compaction_force_timeout: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_force_timeout = Some(compaction_force_timeout);
    self
  }
  ...
  pub fn with_compaction_size_delta_estimation(mut self, compaction_size_delta_estimation: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_size_delta_estimation = Some(compaction_size_delta_estimation);
    self
  }
  ...
  pub fn with_compaction_disable_estimation(mut self, compaction_disable_estimation: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_disable_estimation = Some(compaction_disable_estimation);
    self
  }
  ...
  pub fn with_compaction_retained_generations(mut self, compaction_retained_generations: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_retained_generations = Some(compaction_retained_generations);
    self
  }
  ...
  pub fn with_compaction_memory_threshold(mut self, compaction_memory_threshold: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_memory_threshold = Some(compaction_memory_threshold);
    self
  }
  ...
  pub fn with_compaction_progress_log(mut self, compaction_progress_log: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.compaction_progress_log = Some(compaction_progress_log);
    self
  }
  ...
  pub fn with_standby(mut self, standby: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.standby = Some(standby);
    self
  }
  ...
  pub fn with_custom_blob_store(mut self, custom_blob_store: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.custom_blob_store = Some(custom_blob_store);
    self
  }
  ...
  pub fn with_custom_segment_store(mut self, custom_segment_store: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.custom_segment_store = Some(custom_segment_store);
    self
  }
  ...
  pub fn with_split_persistence(mut self, split_persistence: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.split_persistence = Some(split_persistence);
    self
  }
  ...
  pub fn with_repository_backup_dir(mut self, repository_backup_dir: ::models::ConfigNodePropertyString) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.repository_backup_dir = Some(repository_backup_dir);
    self
  }
  ...
  pub fn with_blob_gc_max_age_in_secs(mut self, blob_gc_max_age_in_secs: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.blob_gc_max_age_in_secs = Some(blob_gc_max_age_in_secs);
    self
  }
  ...
  pub fn with_blob_track_snapshot_interval_in_secs(mut self, blob_track_snapshot_interval_in_secs: ::models::ConfigNodePropertyInteger) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.blob_track_snapshot_interval_in_secs = Some(blob_track_snapshot_interval_in_secs);
    self
  }
  ...
  pub fn with_role(mut self, role: ::models::ConfigNodePropertyString) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.role = Some(role);
    self
  }
  ...
  pub fn set_register_descriptors(&mut self, register_descriptors: ::models::ConfigNodePropertyBoolean) {
    self.register_descriptors = Some(register_descriptors);
  }

  pub fn with_register_descriptors(mut self, register_descriptors: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.register_descriptors = Some(register_descriptors);
    self
  }

  pub fn register_descriptors(&self) -> Option<&::models::ConfigNodePropertyBoolean> {
    self.register_descriptors.as_ref()
  }

  pub fn reset_register_descriptors(&mut self) {
    self.register_descriptors = None;
  }

  pub fn set_dispatch_changes(&mut self, dispatch_changes: ::models::ConfigNodePropertyBoolean) {
    self.dispatch_changes = Some(dispatch_changes);
  }

  pub fn with_dispatch_changes(mut self, dispatch_changes: ::models::ConfigNodePropertyBoolean) -> OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    self.dispatch_changes = Some(dispatch_changes);
    self
  }

  pub fn dispatch_changes(&self) -> Option<&::models::ConfigNodePropertyBoolean> {
    self.dispatch_changes.as_ref()
  }

  pub fn reset_dispatch_changes(&mut self) {
    self.dispatch_changes = None;
  }
