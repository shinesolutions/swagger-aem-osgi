...
impl ComAdobeCqSocialNotificationsImplMentionsRouterProperties {
  ...
  pub fn with_event_topics(mut self, event_topics: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialNotificationsImplMentionsRouterProperties {
    self.event_topics = Some(event_topics);
    self
  }
  ...
  pub fn with_event_filter(mut self, event_filter: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialNotificationsImplMentionsRouterProperties {
    self.event_filter = Some(event_filter);
    self
  }
