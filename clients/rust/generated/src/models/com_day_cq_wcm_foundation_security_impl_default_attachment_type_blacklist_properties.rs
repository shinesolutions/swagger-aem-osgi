...
impl ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties {
  ...
  pub fn with_default_attachment_type_blacklist(mut self, default_attachment_type_blacklist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties {
    self.default_attachment_type_blacklist = Some(default_attachment_type_blacklist);
    self
  }
  ...
  pub fn with_baseline_attachment_type_blacklist(mut self, baseline_attachment_type_blacklist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties {
    self.baseline_attachment_type_blacklist = Some(baseline_attachment_type_blacklist);
    self
  }
