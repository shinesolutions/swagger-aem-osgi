...
impl ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
  ...
  pub fn with_parameter_whitelist(mut self, parameter_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.parameter_whitelist = Some(parameter_whitelist);
    self
  }
  ...
  pub fn with_parameter_whitelist_prefixes(mut self, parameter_whitelist_prefixes: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.parameter_whitelist_prefixes = Some(parameter_whitelist_prefixes);
    self
  }
  ...
  pub fn with_binary_parameter_whitelist(mut self, binary_parameter_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.binary_parameter_whitelist = Some(binary_parameter_whitelist);
    self
  }
  ...
  pub fn with_modifier_whitelist(mut self, modifier_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.modifier_whitelist = Some(modifier_whitelist);
    self
  }
  ...
  pub fn with_operation_whitelist(mut self, operation_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.operation_whitelist = Some(operation_whitelist);
    self
  }
  ...
  pub fn with_operation_whitelist_prefixes(mut self, operation_whitelist_prefixes: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.operation_whitelist_prefixes = Some(operation_whitelist_prefixes);
    self
  }
  ...
  pub fn with_typehint_whitelist(mut self, typehint_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.typehint_whitelist = Some(typehint_whitelist);
    self
  }
  ...
  pub fn with_resourcetype_whitelist(mut self, resourcetype_whitelist: ::models::ConfigNodePropertyArray) -> ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties {
    self.resourcetype_whitelist = Some(resourcetype_whitelist);
    self
  }
