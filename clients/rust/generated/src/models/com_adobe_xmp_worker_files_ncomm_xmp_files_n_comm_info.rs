...
pub struct ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
  ...
  properties: Option<::models::ComAdobeXmpWorkerFilesNcommXmpFilesNCommProperties>,
...
impl ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeXmpWorkerFilesNcommXmpFilesNCommProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeXmpWorkerFilesNcommXmpFilesNCommProperties) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeXmpWorkerFilesNcommXmpFilesNCommProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeXmpWorkerFilesNcommXmpFilesNCommInfo {
    self.service_location = Some(service_location);
    self
  }
