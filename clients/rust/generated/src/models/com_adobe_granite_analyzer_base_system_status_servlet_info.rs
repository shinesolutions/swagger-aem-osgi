...
pub struct ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
  ...
  properties: Option<::models::ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties>,
...
impl ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo {
    self.service_location = Some(service_location);
    self
  }
