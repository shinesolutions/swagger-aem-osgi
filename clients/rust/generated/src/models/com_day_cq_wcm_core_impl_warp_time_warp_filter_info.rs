...
pub struct ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreImplWarpTimeWarpFilterProperties>,
...
impl ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreImplWarpTimeWarpFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreImplWarpTimeWarpFilterProperties) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreImplWarpTimeWarpFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreImplWarpTimeWarpFilterInfo {
    self.service_location = Some(service_location);
    self
  }
