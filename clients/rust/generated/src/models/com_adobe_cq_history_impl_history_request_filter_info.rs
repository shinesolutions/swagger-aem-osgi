...
pub struct ComAdobeCqHistoryImplHistoryRequestFilterInfo {
  ...
  properties: Option<::models::ComAdobeCqHistoryImplHistoryRequestFilterProperties>,
...
impl ComAdobeCqHistoryImplHistoryRequestFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeCqHistoryImplHistoryRequestFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeCqHistoryImplHistoryRequestFilterProperties) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeCqHistoryImplHistoryRequestFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeCqHistoryImplHistoryRequestFilterInfo {
    self.service_location = Some(service_location);
    self
  }
