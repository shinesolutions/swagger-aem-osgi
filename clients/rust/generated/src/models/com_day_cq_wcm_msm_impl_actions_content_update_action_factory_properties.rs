...
pub struct ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
  ...
  cq_wcm_msm_action_ignored_mixin: Option<::models::ConfigNodePropertyArray>
}
...
impl ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
  ...
  pub fn with_cq_wcm_msm_action_excludednodetypes(mut self, cq_wcm_msm_action_excludednodetypes: ::models::ConfigNodePropertyArray) -> ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
    self.cq_wcm_msm_action_excludednodetypes = Some(cq_wcm_msm_action_excludednodetypes);
    self
  }
  ...
  pub fn with_cq_wcm_msm_action_excludedparagraphitems(mut self, cq_wcm_msm_action_excludedparagraphitems: ::models::ConfigNodePropertyArray) -> ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
    self.cq_wcm_msm_action_excludedparagraphitems = Some(cq_wcm_msm_action_excludedparagraphitems);
    self
  }
  ...
  pub fn with_cq_wcm_msm_action_excludedprops(mut self, cq_wcm_msm_action_excludedprops: ::models::ConfigNodePropertyArray) -> ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
    self.cq_wcm_msm_action_excludedprops = Some(cq_wcm_msm_action_excludedprops);
    self
  }
  ...
  pub fn set_cq_wcm_msm_action_ignored_mixin(&mut self, cq_wcm_msm_action_ignored_mixin: ::models::ConfigNodePropertyArray) {
    self.cq_wcm_msm_action_ignored_mixin = Some(cq_wcm_msm_action_ignored_mixin);
  }

  pub fn with_cq_wcm_msm_action_ignored_mixin(mut self, cq_wcm_msm_action_ignored_mixin: ::models::ConfigNodePropertyArray) -> ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties {
    self.cq_wcm_msm_action_ignored_mixin = Some(cq_wcm_msm_action_ignored_mixin);
    self
  }

  pub fn cq_wcm_msm_action_ignored_mixin(&self) -> Option<&::models::ConfigNodePropertyArray> {
    self.cq_wcm_msm_action_ignored_mixin.as_ref()
  }

  pub fn reset_cq_wcm_msm_action_ignored_mixin(&mut self) {
    self.cq_wcm_msm_action_ignored_mixin = None;
  }
