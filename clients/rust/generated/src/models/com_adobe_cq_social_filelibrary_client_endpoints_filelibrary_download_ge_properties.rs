...
impl ComAdobeCqSocialFilelibraryClientEndpointsFilelibraryDownloadGeProperties {
  ...
  pub fn with_sling_servlet_selectors(mut self, sling_servlet_selectors: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialFilelibraryClientEndpointsFilelibraryDownloadGeProperties {
    self.sling_servlet_selectors = Some(sling_servlet_selectors);
    self
  }
  ...
  pub fn with_sling_servlet_extensions(mut self, sling_servlet_extensions: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialFilelibraryClientEndpointsFilelibraryDownloadGeProperties {
    self.sling_servlet_extensions = Some(sling_servlet_extensions);
    self
  }
