...
impl ComAdobeCqSocialCommonsEmailreplyImplUnknownEmailClientProviderProperties {
  ...
  pub fn with_reply_email_patterns(mut self, reply_email_patterns: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialCommonsEmailreplyImplUnknownEmailClientProviderProperties {
    self.reply_email_patterns = Some(reply_email_patterns);
    self
  }
  ...
  pub fn with_priority_order(mut self, priority_order: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialCommonsEmailreplyImplUnknownEmailClientProviderProperties {
    self.priority_order = Some(priority_order);
    self
  }
