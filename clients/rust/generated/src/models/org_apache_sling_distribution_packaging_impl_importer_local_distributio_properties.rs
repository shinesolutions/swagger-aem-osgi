...
impl OrgApacheSlingDistributionPackagingImplImporterLocalDistributioProperties {
  ...
  pub fn with_name(mut self, name: ::models::ConfigNodePropertyString) -> OrgApacheSlingDistributionPackagingImplImporterLocalDistributioProperties {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_package_builder_target(mut self, package_builder_target: ::models::ConfigNodePropertyString) -> OrgApacheSlingDistributionPackagingImplImporterLocalDistributioProperties {
    self.package_builder_target = Some(package_builder_target);
    self
  }
