...
impl ComDayCqDamCoreImplHandlerJpegHandlerProperties {
  ...
  pub fn with_cq_dam_enable_ext_meta_extraction(mut self, cq_dam_enable_ext_meta_extraction: ::models::ConfigNodePropertyBoolean) -> ComDayCqDamCoreImplHandlerJpegHandlerProperties {
    self.cq_dam_enable_ext_meta_extraction = Some(cq_dam_enable_ext_meta_extraction);
    self
  }
  ...
  pub fn with_large_file_threshold(mut self, large_file_threshold: ::models::ConfigNodePropertyInteger) -> ComDayCqDamCoreImplHandlerJpegHandlerProperties {
    self.large_file_threshold = Some(large_file_threshold);
    self
  }
  ...
  pub fn with_large_comment_threshold(mut self, large_comment_threshold: ::models::ConfigNodePropertyInteger) -> ComDayCqDamCoreImplHandlerJpegHandlerProperties {
    self.large_comment_threshold = Some(large_comment_threshold);
    self
  }
