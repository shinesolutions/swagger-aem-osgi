...
pub struct ComDayCqAuthImplLoginSelectorHandlerInfo {
  ...
  properties: Option<::models::ComDayCqAuthImplLoginSelectorHandlerProperties>,
...
impl ComDayCqAuthImplLoginSelectorHandlerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqAuthImplLoginSelectorHandlerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqAuthImplLoginSelectorHandlerProperties) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqAuthImplLoginSelectorHandlerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqAuthImplLoginSelectorHandlerInfo {
    self.service_location = Some(service_location);
    self
  }
