...
pub struct ComDayCqWcmMsmImplRolloutManagerImplInfo {
  ...
  properties: Option<::models::ComDayCqWcmMsmImplRolloutManagerImplProperties>,
...
impl ComDayCqWcmMsmImplRolloutManagerImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmMsmImplRolloutManagerImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmMsmImplRolloutManagerImplProperties) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmMsmImplRolloutManagerImplProperties> {
  ...
  pub fn with_additional_properties(mut self, additional_properties: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.additional_properties = Some(additional_properties);
    self
  }
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmMsmImplRolloutManagerImplInfo {
    self.service_location = Some(service_location);
    self
  }
