...
pub struct ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreMvtMvtStatisticsImplProperties>,
...
impl ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreMvtMvtStatisticsImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreMvtMvtStatisticsImplProperties) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreMvtMvtStatisticsImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreMvtMvtStatisticsImplInfo {
    self.service_location = Some(service_location);
    self
  }
