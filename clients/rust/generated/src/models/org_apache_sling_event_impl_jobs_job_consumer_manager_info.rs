...
pub struct OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
  ...
  properties: Option<::models::OrgApacheSlingEventImplJobsJobConsumerManagerProperties>,
...
impl OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingEventImplJobsJobConsumerManagerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingEventImplJobsJobConsumerManagerProperties) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingEventImplJobsJobConsumerManagerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingEventImplJobsJobConsumerManagerInfo {
    self.service_location = Some(service_location);
    self
  }
