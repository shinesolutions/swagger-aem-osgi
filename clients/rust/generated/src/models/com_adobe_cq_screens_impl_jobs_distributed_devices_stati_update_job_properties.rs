...
impl ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties {
  ...
  pub fn with_scheduler_expression(mut self, scheduler_expression: ::models::ConfigNodePropertyString) -> ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties {
    self.scheduler_expression = Some(scheduler_expression);
    self
  }
