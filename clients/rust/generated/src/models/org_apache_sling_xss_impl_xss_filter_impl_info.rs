...
pub struct OrgApacheSlingXssImplXssFilterImplInfo {
  ...
  properties: Option<::models::OrgApacheSlingXssImplXssFilterImplProperties>,
...
impl OrgApacheSlingXssImplXssFilterImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingXssImplXssFilterImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingXssImplXssFilterImplProperties) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingXssImplXssFilterImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingXssImplXssFilterImplInfo {
    self.service_location = Some(service_location);
    self
  }
