...
impl ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportMProperties {
  ...
  pub fn with_report_fetch_delay(mut self, report_fetch_delay: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportMProperties {
    self.report_fetch_delay = Some(report_fetch_delay);
    self
  }
