...
pub struct ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
  ...
  properties: Option<::models::ComAdobeGraniteOptoutImplOptOutServiceImplProperties>,
...
impl ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteOptoutImplOptOutServiceImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteOptoutImplOptOutServiceImplProperties) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteOptoutImplOptOutServiceImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteOptoutImplOptOutServiceImplInfo {
    self.service_location = Some(service_location);
    self
  }
