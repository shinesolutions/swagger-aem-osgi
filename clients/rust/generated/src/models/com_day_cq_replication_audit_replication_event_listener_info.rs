...
pub struct ComDayCqReplicationAuditReplicationEventListenerInfo {
  ...
  properties: Option<::models::ComDayCqReplicationAuditReplicationEventListenerProperties>,
...
impl ComDayCqReplicationAuditReplicationEventListenerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqReplicationAuditReplicationEventListenerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqReplicationAuditReplicationEventListenerProperties) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqReplicationAuditReplicationEventListenerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqReplicationAuditReplicationEventListenerInfo {
    self.service_location = Some(service_location);
    self
  }
