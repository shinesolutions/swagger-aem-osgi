...
pub struct OrgApacheFelixEventadminImplEventAdminInfo {
  ...
  properties: Option<::models::OrgApacheFelixEventadminImplEventAdminProperties>,
...
impl OrgApacheFelixEventadminImplEventAdminInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheFelixEventadminImplEventAdminProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheFelixEventadminImplEventAdminProperties) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheFelixEventadminImplEventAdminProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheFelixEventadminImplEventAdminInfo {
    self.service_location = Some(service_location);
    self
  }
