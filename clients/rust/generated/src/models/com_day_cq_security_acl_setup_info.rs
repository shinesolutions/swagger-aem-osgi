...
pub struct ComDayCqSecurityAclSetupInfo {
  ...
  properties: Option<::models::ComDayCqSecurityAclSetupProperties>,
...
impl ComDayCqSecurityAclSetupInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqSecurityAclSetupInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqSecurityAclSetupInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqSecurityAclSetupInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqSecurityAclSetupProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqSecurityAclSetupProperties) -> ComDayCqSecurityAclSetupInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqSecurityAclSetupProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqSecurityAclSetupInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqSecurityAclSetupInfo {
    self.service_location = Some(service_location);
    self
  }
