...
pub struct ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreStatsPageViewStatisticsImplProperties>,
...
impl ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreStatsPageViewStatisticsImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreStatsPageViewStatisticsImplProperties) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreStatsPageViewStatisticsImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreStatsPageViewStatisticsImplInfo {
    self.service_location = Some(service_location);
    self
  }
