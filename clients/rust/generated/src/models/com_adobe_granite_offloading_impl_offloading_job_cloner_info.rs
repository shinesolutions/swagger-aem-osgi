...
pub struct ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
  ...
  properties: Option<::models::ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties>,
...
impl ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo {
    self.service_location = Some(service_location);
    self
  }
