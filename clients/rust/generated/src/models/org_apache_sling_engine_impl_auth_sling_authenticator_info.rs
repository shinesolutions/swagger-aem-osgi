...
pub struct OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
  ...
  properties: Option<::models::OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties>,
...
impl OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo {
    self.service_location = Some(service_location);
    self
  }
