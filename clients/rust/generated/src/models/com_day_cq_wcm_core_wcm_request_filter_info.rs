...
pub struct ComDayCqWcmCoreWcmRequestFilterInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreWcmRequestFilterProperties>,
...
impl ComDayCqWcmCoreWcmRequestFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreWcmRequestFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreWcmRequestFilterProperties) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreWcmRequestFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreWcmRequestFilterInfo {
    self.service_location = Some(service_location);
    self
  }
