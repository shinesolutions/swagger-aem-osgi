...
impl ComDayCqDamCoreProcessExtractMetadataProcessProperties {
  ...
  pub fn with_process_label(mut self, process_label: ::models::ConfigNodePropertyString) -> ComDayCqDamCoreProcessExtractMetadataProcessProperties {
    self.process_label = Some(process_label);
    self
  }
  ...
  pub fn with_cq_dam_enable_sha1(mut self, cq_dam_enable_sha1: ::models::ConfigNodePropertyBoolean) -> ComDayCqDamCoreProcessExtractMetadataProcessProperties {
    self.cq_dam_enable_sha1 = Some(cq_dam_enable_sha1);
    self
  }
