...
pub struct ComAdobeGraniteCsrfImplCsrfFilterInfo {
  ...
  properties: Option<::models::ComAdobeGraniteCsrfImplCsrfFilterProperties>,
...
impl ComAdobeGraniteCsrfImplCsrfFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteCsrfImplCsrfFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteCsrfImplCsrfFilterProperties) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteCsrfImplCsrfFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteCsrfImplCsrfFilterInfo {
    self.service_location = Some(service_location);
    self
  }
