...
pub struct OrgApacheSlingSecurityImplReferrerFilterInfo {
  ...
  properties: Option<::models::OrgApacheSlingSecurityImplReferrerFilterProperties>,
...
impl OrgApacheSlingSecurityImplReferrerFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingSecurityImplReferrerFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingSecurityImplReferrerFilterProperties) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingSecurityImplReferrerFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingSecurityImplReferrerFilterInfo {
    self.service_location = Some(service_location);
    self
  }
