...
pub struct OrgApacheSlingCommonsLogLogManagerInfo {
  ...
  properties: Option<::models::OrgApacheSlingCommonsLogLogManagerProperties>,
...
impl OrgApacheSlingCommonsLogLogManagerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingCommonsLogLogManagerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingCommonsLogLogManagerProperties) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingCommonsLogLogManagerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingCommonsLogLogManagerInfo {
    self.service_location = Some(service_location);
    self
  }
