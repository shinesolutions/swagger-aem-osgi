...
pub struct ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
  ...
  properties: Option<::models::ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties>,
...
impl ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo {
    self.service_location = Some(service_location);
    self
  }
