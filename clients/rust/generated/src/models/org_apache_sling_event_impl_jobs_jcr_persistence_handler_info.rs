...
pub struct OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
  ...
  properties: Option<::models::OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties>,
...
impl OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo {
    self.service_location = Some(service_location);
    self
  }
