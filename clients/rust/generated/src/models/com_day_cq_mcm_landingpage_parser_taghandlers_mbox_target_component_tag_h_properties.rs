...
impl ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHProperties {
  ...
  pub fn with_service_ranking(mut self, service_ranking: ::models::ConfigNodePropertyInteger) -> ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHProperties {
    self.service_ranking = Some(service_ranking);
    self
  }
  ...
  pub fn with_tagpattern(mut self, tagpattern: ::models::ConfigNodePropertyString) -> ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHProperties {
    self.tagpattern = Some(tagpattern);
    self
  }
  ...
  pub fn with_component_resource_type(mut self, component_resource_type: ::models::ConfigNodePropertyString) -> ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHProperties {
    self.component_resource_type = Some(component_resource_type);
    self
  }
