...
pub struct ComDayCqCommonsServletsRootMappingServletInfo {
  ...
  properties: Option<::models::ComDayCqCommonsServletsRootMappingServletProperties>,
...
impl ComDayCqCommonsServletsRootMappingServletInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqCommonsServletsRootMappingServletProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqCommonsServletsRootMappingServletProperties) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqCommonsServletsRootMappingServletProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqCommonsServletsRootMappingServletInfo {
    self.service_location = Some(service_location);
    self
  }
