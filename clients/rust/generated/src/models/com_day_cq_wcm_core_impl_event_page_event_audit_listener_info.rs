...
pub struct ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreImplEventPageEventAuditListenerProperties>,
...
impl ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreImplEventPageEventAuditListenerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreImplEventPageEventAuditListenerProperties) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreImplEventPageEventAuditListenerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreImplEventPageEventAuditListenerInfo {
    self.service_location = Some(service_location);
    self
  }
