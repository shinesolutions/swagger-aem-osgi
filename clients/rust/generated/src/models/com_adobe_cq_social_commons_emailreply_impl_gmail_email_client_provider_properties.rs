...
impl ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties {
  ...
  pub fn with_priority_order(mut self, priority_order: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties {
    self.priority_order = Some(priority_order);
    self
  }
  ...
  pub fn with_reply_email_patterns(mut self, reply_email_patterns: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties {
    self.reply_email_patterns = Some(reply_email_patterns);
    self
  }
