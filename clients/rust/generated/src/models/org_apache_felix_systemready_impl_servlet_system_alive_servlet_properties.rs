...
impl OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties {
  ...
  pub fn with_osgi_http_whiteboard_servlet_pattern(mut self, osgi_http_whiteboard_servlet_pattern: ::models::ConfigNodePropertyString) -> OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties {
    self.osgi_http_whiteboard_servlet_pattern = Some(osgi_http_whiteboard_servlet_pattern);
    self
  }
  ...
  pub fn with_osgi_http_whiteboard_context_select(mut self, osgi_http_whiteboard_context_select: ::models::ConfigNodePropertyString) -> OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties {
    self.osgi_http_whiteboard_context_select = Some(osgi_http_whiteboard_context_select);
    self
  }
