...
impl ComAdobeGraniteOauthServerImplAccessTokenCleanupTaskProperties {
  ...
  pub fn with_scheduler_expression(mut self, scheduler_expression: ::models::ConfigNodePropertyString) -> ComAdobeGraniteOauthServerImplAccessTokenCleanupTaskProperties {
    self.scheduler_expression = Some(scheduler_expression);
    self
  }
