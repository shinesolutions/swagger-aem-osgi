...
impl ComAdobeCqAuditPurgeReplicationProperties {
  ...
  pub fn with_auditlog_rule_name(mut self, auditlog_rule_name: ::models::ConfigNodePropertyString) -> ComAdobeCqAuditPurgeReplicationProperties {
    self.auditlog_rule_name = Some(auditlog_rule_name);
    self
  }
  ...
  pub fn with_auditlog_rule_contentpath(mut self, auditlog_rule_contentpath: ::models::ConfigNodePropertyString) -> ComAdobeCqAuditPurgeReplicationProperties {
    self.auditlog_rule_contentpath = Some(auditlog_rule_contentpath);
    self
  }
  ...
  pub fn with_auditlog_rule_minimumage(mut self, auditlog_rule_minimumage: ::models::ConfigNodePropertyInteger) -> ComAdobeCqAuditPurgeReplicationProperties {
    self.auditlog_rule_minimumage = Some(auditlog_rule_minimumage);
    self
  }
  ...
  pub fn with_auditlog_rule_types(mut self, auditlog_rule_types: ::models::ConfigNodePropertyDropDown) -> ComAdobeCqAuditPurgeReplicationProperties {
    self.auditlog_rule_types = Some(auditlog_rule_types);
    self
  }
