...
pub struct OrgApacheSlingEngineParametersInfo {
  ...
  properties: Option<::models::OrgApacheSlingEngineParametersProperties>,
...
impl OrgApacheSlingEngineParametersInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingEngineParametersInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingEngineParametersInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingEngineParametersInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingEngineParametersProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingEngineParametersProperties) -> OrgApacheSlingEngineParametersInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingEngineParametersProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingEngineParametersInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingEngineParametersInfo {
    self.service_location = Some(service_location);
    self
  }
