...
pub struct OrgApacheSlingServletsGetDefaultGetServletInfo {
  ...
  properties: Option<::models::OrgApacheSlingServletsGetDefaultGetServletProperties>,
...
impl OrgApacheSlingServletsGetDefaultGetServletInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingServletsGetDefaultGetServletProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingServletsGetDefaultGetServletProperties) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingServletsGetDefaultGetServletProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingServletsGetDefaultGetServletInfo {
    self.service_location = Some(service_location);
    self
  }
