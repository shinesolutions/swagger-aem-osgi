...
pub struct ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
  ...
  properties: Option<::models::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties>,
...
impl ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo {
    self.service_location = Some(service_location);
    self
  }
