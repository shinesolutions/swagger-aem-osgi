...
pub struct OrgApacheSlingEngineImplLogRequestLoggerInfo {
  ...
  properties: Option<::models::OrgApacheSlingEngineImplLogRequestLoggerProperties>,
...
impl OrgApacheSlingEngineImplLogRequestLoggerInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheSlingEngineImplLogRequestLoggerProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheSlingEngineImplLogRequestLoggerProperties) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheSlingEngineImplLogRequestLoggerProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheSlingEngineImplLogRequestLoggerInfo {
    self.service_location = Some(service_location);
    self
  }
