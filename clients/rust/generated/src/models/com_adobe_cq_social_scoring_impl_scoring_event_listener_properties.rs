...
impl ComAdobeCqSocialScoringImplScoringEventListenerProperties {
  ...
  pub fn with_event_topics(mut self, event_topics: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialScoringImplScoringEventListenerProperties {
    self.event_topics = Some(event_topics);
    self
  }
  ...
  pub fn with_event_filter(mut self, event_filter: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialScoringImplScoringEventListenerProperties {
    self.event_filter = Some(event_filter);
    self
  }
