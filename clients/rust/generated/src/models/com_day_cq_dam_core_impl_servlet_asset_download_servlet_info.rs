...
pub struct ComDayCqDamCoreImplServletAssetDownloadServletInfo {
  ...
  properties: Option<::models::ComDayCqDamCoreImplServletAssetDownloadServletProperties>,
...
impl ComDayCqDamCoreImplServletAssetDownloadServletInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqDamCoreImplServletAssetDownloadServletProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqDamCoreImplServletAssetDownloadServletProperties) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqDamCoreImplServletAssetDownloadServletProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqDamCoreImplServletAssetDownloadServletInfo {
    self.service_location = Some(service_location);
    self
  }
