...
impl ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCtaComponentProperties {
  ...
  pub fn with_service_ranking(mut self, service_ranking: ::models::ConfigNodePropertyInteger) -> ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCtaComponentProperties {
    self.service_ranking = Some(service_ranking);
    self
  }
  ...
  pub fn with_tagpattern(mut self, tagpattern: ::models::ConfigNodePropertyString) -> ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCtaComponentProperties {
    self.tagpattern = Some(tagpattern);
    self
  }
