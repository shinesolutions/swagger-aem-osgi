...
pub struct ComDayCqCommonsImplExternalizerImplInfo {
  ...
  properties: Option<::models::ComDayCqCommonsImplExternalizerImplProperties>,
...
impl ComDayCqCommonsImplExternalizerImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqCommonsImplExternalizerImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqCommonsImplExternalizerImplProperties) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqCommonsImplExternalizerImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqCommonsImplExternalizerImplInfo {
    self.service_location = Some(service_location);
    self
  }
