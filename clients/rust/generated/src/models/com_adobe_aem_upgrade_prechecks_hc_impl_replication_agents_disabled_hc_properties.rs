...
impl ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHcProperties {
  ...
  pub fn with_hc_name(mut self, hc_name: ::models::ConfigNodePropertyString) -> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHcProperties {
    self.hc_name = Some(hc_name);
    self
  }
  ...
  pub fn with_hc_tags(mut self, hc_tags: ::models::ConfigNodePropertyArray) -> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHcProperties {
    self.hc_tags = Some(hc_tags);
    self
  }
  ...
  pub fn with_hc_mbean_name(mut self, hc_mbean_name: ::models::ConfigNodePropertyString) -> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHcProperties {
    self.hc_mbean_name = Some(hc_mbean_name);
    self
  }
