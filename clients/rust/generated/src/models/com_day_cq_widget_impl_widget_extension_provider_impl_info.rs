...
pub struct ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
  ...
  properties: Option<::models::ComDayCqWidgetImplWidgetExtensionProviderImplProperties>,
...
impl ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWidgetImplWidgetExtensionProviderImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWidgetImplWidgetExtensionProviderImplProperties) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWidgetImplWidgetExtensionProviderImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWidgetImplWidgetExtensionProviderImplInfo {
    self.service_location = Some(service_location);
    self
  }
