...
pub struct ComDayCqWcmCoreImplWcmDebugFilterInfo {
  ...
  properties: Option<::models::ComDayCqWcmCoreImplWcmDebugFilterProperties>,
...
impl ComDayCqWcmCoreImplWcmDebugFilterInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWcmCoreImplWcmDebugFilterProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWcmCoreImplWcmDebugFilterProperties) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWcmCoreImplWcmDebugFilterProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWcmCoreImplWcmDebugFilterInfo {
    self.service_location = Some(service_location);
    self
  }
