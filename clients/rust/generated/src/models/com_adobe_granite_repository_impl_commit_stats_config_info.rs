...
pub struct ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
  ...
  properties: Option<::models::ComAdobeGraniteRepositoryImplCommitStatsConfigProperties>,
...
impl ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComAdobeGraniteRepositoryImplCommitStatsConfigProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComAdobeGraniteRepositoryImplCommitStatsConfigProperties) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComAdobeGraniteRepositoryImplCommitStatsConfigProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComAdobeGraniteRepositoryImplCommitStatsConfigInfo {
    self.service_location = Some(service_location);
    self
  }
