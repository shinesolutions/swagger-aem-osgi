...
pub struct ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
  ...
  properties: Option<::models::ComDayCqWidgetImplHtmlLibraryManagerImplProperties>,
...
impl ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::ComDayCqWidgetImplHtmlLibraryManagerImplProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::ComDayCqWidgetImplHtmlLibraryManagerImplProperties) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::ComDayCqWidgetImplHtmlLibraryManagerImplProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> ComDayCqWidgetImplHtmlLibraryManagerImplInfo {
    self.service_location = Some(service_location);
    self
  }
