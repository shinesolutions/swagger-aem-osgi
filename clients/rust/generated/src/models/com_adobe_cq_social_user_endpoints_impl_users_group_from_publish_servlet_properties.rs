...
impl ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletProperties {
  ...
  pub fn with_sling_servlet_extensions(mut self, sling_servlet_extensions: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletProperties {
    self.sling_servlet_extensions = Some(sling_servlet_extensions);
    self
  }
  ...
  pub fn with_sling_servlet_paths(mut self, sling_servlet_paths: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletProperties {
    self.sling_servlet_paths = Some(sling_servlet_paths);
    self
  }
  ...
  pub fn with_sling_servlet_methods(mut self, sling_servlet_methods: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletProperties {
    self.sling_servlet_methods = Some(sling_servlet_methods);
    self
  }
