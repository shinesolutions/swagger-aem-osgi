...
pub struct OrgApacheAriesJmxFrameworkStateConfigInfo {
  ...
  properties: Option<::models::OrgApacheAriesJmxFrameworkStateConfigProperties>,
...
impl OrgApacheAriesJmxFrameworkStateConfigInfo {
  ...
  pub fn with_pid(mut self, pid: String) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.pid = Some(pid);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_properties(&mut self, properties: ::models::OrgApacheAriesJmxFrameworkStateConfigProperties) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::models::OrgApacheAriesJmxFrameworkStateConfigProperties) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::models::OrgApacheAriesJmxFrameworkStateConfigProperties> {
  ...
  pub fn with_bundle_location(mut self, bundle_location: String) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.bundle_location = Some(bundle_location);
    self
  }
  ...
  pub fn with_service_location(mut self, service_location: String) -> OrgApacheAriesJmxFrameworkStateConfigInfo {
    self.service_location = Some(service_location);
    self
  }
