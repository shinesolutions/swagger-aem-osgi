...
impl ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties {
  ...
  pub fn with_field_whitelist(mut self, field_whitelist: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties {
    self.field_whitelist = Some(field_whitelist);
    self
  }
  ...
  pub fn with_attachment_type_blacklist(mut self, attachment_type_blacklist: ::models::ConfigNodePropertyArray) -> ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties {
    self.attachment_type_blacklist = Some(attachment_type_blacklist);
    self
  }
