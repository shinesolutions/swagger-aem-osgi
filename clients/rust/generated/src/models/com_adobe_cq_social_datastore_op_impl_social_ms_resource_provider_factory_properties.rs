...
impl ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
  ...
  pub fn with_solr_zk_timeout(mut self, solr_zk_timeout: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.solr_zk_timeout = Some(solr_zk_timeout);
    self
  }
  ...
  pub fn with_solr_commit(mut self, solr_commit: ::models::ConfigNodePropertyString) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.solr_commit = Some(solr_commit);
    self
  }
  ...
  pub fn with_cache_on(mut self, cache_on: ::models::ConfigNodePropertyBoolean) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.cache_on = Some(cache_on);
    self
  }
  ...
  pub fn with_concurrency_level(mut self, concurrency_level: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.concurrency_level = Some(concurrency_level);
    self
  }
  ...
  pub fn with_cache_start_size(mut self, cache_start_size: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.cache_start_size = Some(cache_start_size);
    self
  }
  ...
  pub fn with_cache_ttl(mut self, cache_ttl: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.cache_ttl = Some(cache_ttl);
    self
  }
  ...
  pub fn with_cache_size(mut self, cache_size: ::models::ConfigNodePropertyInteger) -> ComAdobeCqSocialDatastoreOpImplSocialMsResourceProviderFactoryProperties {
    self.cache_size = Some(cache_size);
    self
  }
