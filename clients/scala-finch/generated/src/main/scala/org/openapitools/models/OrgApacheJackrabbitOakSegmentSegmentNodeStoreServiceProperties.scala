 ...
 */
case class OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties(repositoryPeriodhome: Option[ConfigNodePropertyString],
...
object OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties {
    /**
     * Creates the codec for converting OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties from and to JSON.
     */
    implicit val decoder: Decoder[OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties] = deriveDecoder
    implicit val encoder: ObjectEncoder[OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties] = deriveEncoder
}
