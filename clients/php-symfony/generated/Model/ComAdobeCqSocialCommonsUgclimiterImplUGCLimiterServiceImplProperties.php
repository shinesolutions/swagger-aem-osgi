...
/**
 * Class representing the ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplProperties model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplProperties 
{
     ...
     * Sets verbs.
     *
     * @param OpenAPI\Server\Model\ConfigNodePropertyArray|null $verbs
     *
     * @return $this
     */
    public function setVerbs(ConfigNodePropertyArray $verbs = null)
    {
        $this->verbs = $verbs;
