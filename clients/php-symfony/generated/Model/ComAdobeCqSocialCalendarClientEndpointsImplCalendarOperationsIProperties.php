...
/**
 * Class representing the ComAdobeCqSocialCalendarClientEndpointsImplCalendarOperationsIProperties model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class ComAdobeCqSocialCalendarClientEndpointsImplCalendarOperationsIProperties 
{
    ...
    {
        $this->maxRetry = isset($data['maxRetry']) ? $data['maxRetry'] : null;
     ...
     * Sets maxRetry.
     *
     * @param OpenAPI\Server\Model\ConfigNodePropertyInteger|null $maxRetry
     *
     * @return $this
     */
    public function setMaxRetry(ConfigNodePropertyInteger $maxRetry = null)
    {
