...
/**
 * Class representing the OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties 
{
     ...
     * Sets length.
     *
     * @param OpenAPI\Server\Model\ConfigNodePropertyInteger|null $length
     *
     * @return $this
     */
    public function setLength(ConfigNodePropertyInteger $length = null)
    {
        $this->length = $length;
