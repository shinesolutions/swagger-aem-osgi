...
/**
 * Query parameters for comAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSe
 */
class ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeQueryData
{
    /**
