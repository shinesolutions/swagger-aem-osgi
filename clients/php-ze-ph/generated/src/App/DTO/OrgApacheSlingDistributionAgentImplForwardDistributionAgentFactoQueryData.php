...
/**
 * Query parameters for orgApacheSlingDistributionAgentImplForwardDistributionAgentFacto
 */
class OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoQueryData
{
    /**
     * @DTA\Data(field="queue.processing.enabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $queue_processing_enabled;
    /**
     * @DTA\Data(field="triggers.target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $triggers_target;
    /**
    ...
    public $enabled;
    /**
     * @DTA\Data(field="async.delivery", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $async_delivery;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="log.level", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    /**
     * @DTA\Data(field="packageImporter.endpoints", nullable=true)
     ...
     * @var string[]
     */
    public $package_importer_endpoints;
    /**
     * @DTA\Data(field="queue.provider", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $queue_provider;
    /**
     * @DTA\Data(field="retry.strategy", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $apply;
    /**
     * @DTA\Data(field="priorityQueues", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
    ...
    /**
     * @DTA\Data(field="retry.attempts", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    ...
    public $service_name;
    /**
     * @DTA\Data(field="passiveQueues", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $passive_queues;
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="allowed.roots", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $allowed_roots;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="requestAuthorizationStrategy.target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $request_authorization_strategy_target;
    /**
