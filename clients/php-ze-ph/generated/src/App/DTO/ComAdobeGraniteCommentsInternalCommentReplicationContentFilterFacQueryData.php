...
/**
 * Query parameters for comAdobeGraniteCommentsInternalCommentReplicationContentFilterFac
 */
class ComAdobeGraniteCommentsInternalCommentReplicationContentFilterFacQueryData
{
    /**
