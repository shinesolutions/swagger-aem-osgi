...
/**
 * Query parameters for comAdobeGraniteAuthOauthImplBearerAuthenticationHandler
 */
class ComAdobeGraniteAuthOauthImplBearerAuthenticationHandlerQueryData
{
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="auth.bearer.sync.ims", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $auth_bearer_sync_ims;
    /**
     * @DTA\Data(field="auth.tokenRequestParameter", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $auth_token_request_parameter;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="oauth.clientIds.allowed", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $oauth_client_ids_allowed;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="oauth.jwt.support", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $oauth_jwt_support;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="oauth.bearer.configid", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $oauth_bearer_configid;
}
