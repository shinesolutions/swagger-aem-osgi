...
/**
 * Query parameters for comAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheck
 */
class ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckQueryData
{
    /**
