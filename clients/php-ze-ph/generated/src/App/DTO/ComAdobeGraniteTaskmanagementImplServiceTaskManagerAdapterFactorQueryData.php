...
/**
 * Query parameters for comAdobeGraniteTaskmanagementImplServiceTaskManagerAdapterFactor
 */
class ComAdobeGraniteTaskmanagementImplServiceTaskManagerAdapterFactorQueryData
{
    /**
