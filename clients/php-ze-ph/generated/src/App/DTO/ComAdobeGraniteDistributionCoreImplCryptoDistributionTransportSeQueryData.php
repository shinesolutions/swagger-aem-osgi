...
/**
 * Query parameters for comAdobeGraniteDistributionCoreImplCryptoDistributionTransportSe
 */
class ComAdobeGraniteDistributionCoreImplCryptoDistributionTransportSeQueryData
{
    /**
