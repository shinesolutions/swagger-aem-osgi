...
class ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo
{
     ...
     * @DTA\Validator(name="Dictionary", options={"type":\App\DTO\ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties::class})
     * @var \App\DTO\ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties
     */
    public $properties;
    /**
