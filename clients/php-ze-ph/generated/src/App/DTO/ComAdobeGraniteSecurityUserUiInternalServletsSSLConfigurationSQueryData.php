...
/**
 * Query parameters for comAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationS
 */
class ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSQueryData
{
    /**
