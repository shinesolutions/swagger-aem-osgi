...
/**
 * Query parameters for orgApacheSlingCaconfigImplDefDefaultConfigurationPersistenceStra
 */
class OrgApacheSlingCaconfigImplDefDefaultConfigurationPersistenceStraQueryData
{
    /**
