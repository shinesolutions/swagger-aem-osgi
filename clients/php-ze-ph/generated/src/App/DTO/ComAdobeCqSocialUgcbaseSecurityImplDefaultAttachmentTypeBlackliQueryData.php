...
/**
 * Query parameters for comAdobeCqSocialUgcbaseSecurityImplDefaultAttachmentTypeBlackli
 */
class ComAdobeCqSocialUgcbaseSecurityImplDefaultAttachmentTypeBlackliQueryData
{
    /**
