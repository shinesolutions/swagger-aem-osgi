...
/**
 * Query parameters for comAdobeCqSocialActivitystreamsListenerImplModerationEventExten
 */
class ComAdobeCqSocialActivitystreamsListenerImplModerationEventExtenQueryData
{
    /**
