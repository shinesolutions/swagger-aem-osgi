...
/**
 * Query parameters for comDayCqDamCoreImplServletResourceCollectionServlet
 */
class ComDayCqDamCoreImplServletResourceCollectionServletQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="view.selector", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $send_email;
    /**
     * @DTA\Data(field="download.config", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $download_config;
    /**
