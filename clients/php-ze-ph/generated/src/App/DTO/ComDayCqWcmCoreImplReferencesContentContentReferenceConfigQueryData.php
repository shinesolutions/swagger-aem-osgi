...
/**
 * Query parameters for comDayCqWcmCoreImplReferencesContentContentReferenceConfig
 */
class ComDayCqWcmCoreImplReferencesContentContentReferenceConfigQueryData
{
    /**
