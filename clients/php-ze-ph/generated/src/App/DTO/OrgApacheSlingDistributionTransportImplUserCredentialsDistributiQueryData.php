...
/**
 * Query parameters for orgApacheSlingDistributionTransportImplUserCredentialsDistributi
 */
class OrgApacheSlingDistributionTransportImplUserCredentialsDistributiQueryData
{
    /**
