...
/**
 * Query parameters for orgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeName
 */
class OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameQueryData
{
    /**
