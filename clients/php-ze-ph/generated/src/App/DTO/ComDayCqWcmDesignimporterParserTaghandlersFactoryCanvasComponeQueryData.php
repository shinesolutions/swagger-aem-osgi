...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryCanvasCompone
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeQueryData
{
    /**
