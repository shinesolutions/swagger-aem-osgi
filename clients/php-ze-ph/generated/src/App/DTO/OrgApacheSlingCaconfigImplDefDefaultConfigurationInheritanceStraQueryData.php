...
/**
 * Query parameters for orgApacheSlingCaconfigImplDefDefaultConfigurationInheritanceStra
 */
class OrgApacheSlingCaconfigImplDefDefaultConfigurationInheritanceStraQueryData
{
    /**
