...
/**
 * Query parameters for orgApacheSlingModelsJacksonexporterImplResourceModuleProvider
 */
class OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderQueryData
{
    /**
