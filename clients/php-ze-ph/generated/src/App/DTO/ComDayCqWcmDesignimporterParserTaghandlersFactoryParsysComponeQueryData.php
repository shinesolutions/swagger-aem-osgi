...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryParsysCompone
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryParsysComponeQueryData
{
    /**
