...
/**
 * Query parameters for comAdobeCqSocialUgcbaseImplAysncReverseReplicatorImpl
 */
class ComAdobeCqSocialUgcbaseImplAysncReverseReplicatorImplQueryData
{
    /**
