...
/**
 * Query parameters for orgApacheJackrabbitOakSpiSecurityAuthorizationCugImplCugConfi
 */
class OrgApacheJackrabbitOakSpiSecurityAuthorizationCugImplCugConfiQueryData
{
    /**
