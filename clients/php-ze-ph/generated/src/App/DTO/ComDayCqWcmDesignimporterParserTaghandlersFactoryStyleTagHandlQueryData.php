...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandl
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlQueryData
{
    /**
