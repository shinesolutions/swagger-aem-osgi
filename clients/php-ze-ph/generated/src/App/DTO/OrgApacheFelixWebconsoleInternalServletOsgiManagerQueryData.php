...
/**
 * Query parameters for orgApacheFelixWebconsoleInternalServletOsgiManager
 */
class OrgApacheFelixWebconsoleInternalServletOsgiManagerQueryData
{
    /**
     * @DTA\Data(field="http.service.filter", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $http_service_filter;
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="default.render", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $default_render;
    /**
     * @DTA\Data(field="plugins", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $location;
    /**
     * @DTA\Data(field="loglevel", nullable=true)
    ...
    public $action;
    /**
     * @DTA\Data(field="realm", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $category;
    /**
     * @DTA\Data(field="manager.root", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
