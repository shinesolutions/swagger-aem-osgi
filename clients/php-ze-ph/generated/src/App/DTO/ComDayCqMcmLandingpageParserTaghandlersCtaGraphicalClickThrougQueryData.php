...
/**
 * Query parameters for comDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThroug
 */
class ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougQueryData
{
    /**
