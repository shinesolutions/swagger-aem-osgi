...
/**
 * Query parameters for comDayCqWcmMobileCoreImplDeviceDeviceInfoTransformerFactory
 */
class ComDayCqWcmMobileCoreImplDeviceDeviceInfoTransformerFactoryQueryData
{
    /**
