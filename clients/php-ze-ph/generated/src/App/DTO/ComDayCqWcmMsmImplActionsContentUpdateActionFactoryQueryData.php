...
/**
 * Query parameters for comDayCqWcmMsmImplActionsContentUpdateActionFactory
 */
class ComDayCqWcmMsmImplActionsContentUpdateActionFactoryQueryData
{
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="cq.wcm.msm.action.ignoredMixin", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $cq_wcm_msm_action_ignored_mixin;
}
