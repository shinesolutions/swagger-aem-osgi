...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagH
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHQueryData
{
    /**
