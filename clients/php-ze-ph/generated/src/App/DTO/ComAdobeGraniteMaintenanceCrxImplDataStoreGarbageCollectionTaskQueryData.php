...
/**
 * Query parameters for comAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTask
 */
class ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskQueryData
{
    /**
