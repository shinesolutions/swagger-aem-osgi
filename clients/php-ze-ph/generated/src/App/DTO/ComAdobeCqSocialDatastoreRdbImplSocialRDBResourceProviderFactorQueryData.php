...
/**
 * Query parameters for comAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactor
 */
class ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorQueryData
{
    /**
