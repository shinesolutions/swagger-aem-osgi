...
/**
 * Query parameters for comAdobeCqHcContentPackagesHealthCheck
 */
class ComAdobeCqHcContentPackagesHealthCheckQueryData
{
    /**
    ...
    public $hc_name;
    /**
     * @DTA\Data(field="package.names", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
