...
/**
 * Query parameters for orgApacheJackrabbitOakSegmentAzureAzureSegmentStoreService
 */
class OrgApacheJackrabbitOakSegmentAzureAzureSegmentStoreServiceQueryData
{
    /**
    ...
    public $account_name;
    /**
     * @DTA\Data(field="accessKey", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $location;
    /**
     * @DTA\Data(field="containerName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="connectionURL", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    /**
     * @DTA\Data(field="rootPath", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
