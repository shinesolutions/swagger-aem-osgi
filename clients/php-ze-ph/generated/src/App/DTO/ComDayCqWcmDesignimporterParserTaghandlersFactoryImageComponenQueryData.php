...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryImageComponen
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenQueryData
{
    /**
