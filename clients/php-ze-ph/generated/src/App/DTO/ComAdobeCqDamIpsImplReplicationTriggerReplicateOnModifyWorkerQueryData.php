...
/**
 * Query parameters for comAdobeCqDamIpsImplReplicationTriggerReplicateOnModifyWorker
 */
class ComAdobeCqDamIpsImplReplicationTriggerReplicateOnModifyWorkerQueryData
{
    /**
