...
/**
 * Query parameters for orgApacheSlingDistributionPackagingImplImporterRepositoryDistri
 */
class OrgApacheSlingDistributionPackagingImplImporterRepositoryDistriQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="privilege.name", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
