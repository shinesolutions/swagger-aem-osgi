...
/**
 * Query parameters for orgApacheSlingDistributionPackagingImplExporterAgentDistributio
 */
class OrgApacheSlingDistributionPackagingImplExporterAgentDistributioQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="agent.target", nullable=true)
    ...
    public $action;
    /**
     * @DTA\Data(field="drop.invalid.items", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $drop_invalid_items;
    /**
