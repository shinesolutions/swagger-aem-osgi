...
/**
 * Query parameters for orgApacheSlingDistributionTriggerImplPersistedJcrEventDistributi
 */
class OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="nuggetsPath", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
