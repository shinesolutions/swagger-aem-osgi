...
/**
 * Query parameters for orgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorService
 */
class OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceQueryData
{
    /**
