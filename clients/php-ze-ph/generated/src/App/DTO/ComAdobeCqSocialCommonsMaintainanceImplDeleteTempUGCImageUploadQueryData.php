...
/**
 * Query parameters for comAdobeCqSocialCommonsMaintainanceImplDeleteTempUGCImageUpload
 */
class ComAdobeCqSocialCommonsMaintainanceImplDeleteTempUGCImageUploadQueryData
{
    /**
