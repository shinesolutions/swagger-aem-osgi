...
/**
 * Query parameters for comAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImpl
 */
class ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplQueryData
{
    /**
