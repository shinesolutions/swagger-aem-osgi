...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServers
 */
class OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersQueryData
{
    /**
