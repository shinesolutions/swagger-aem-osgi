...
/**
 * Query parameters for comAdobeCqSocialActivitystreamsClientImplSocialActivityComponen
 */
class ComAdobeCqSocialActivitystreamsClientImplSocialActivityComponenQueryData
{
    /**
