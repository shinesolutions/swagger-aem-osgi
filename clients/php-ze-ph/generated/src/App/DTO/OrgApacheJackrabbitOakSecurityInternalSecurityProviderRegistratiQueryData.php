...
/**
 * Query parameters for orgApacheJackrabbitOakSecurityInternalSecurityProviderRegistrati
 */
class OrgApacheJackrabbitOakSecurityInternalSecurityProviderRegistratiQueryData
{
    /**
