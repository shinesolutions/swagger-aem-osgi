...
/**
 * Query parameters for comAdobeCqSocialServiceusersInternalImplServiceUserWrapperImpl
 */
class ComAdobeCqSocialServiceusersInternalImplServiceUserWrapperImplQueryData
{
    /**
