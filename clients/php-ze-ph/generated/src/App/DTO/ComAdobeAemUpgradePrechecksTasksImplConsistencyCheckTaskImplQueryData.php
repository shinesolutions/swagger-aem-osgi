...
/**
 * Query parameters for comAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImpl
 */
class ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplQueryData
{
    /**
