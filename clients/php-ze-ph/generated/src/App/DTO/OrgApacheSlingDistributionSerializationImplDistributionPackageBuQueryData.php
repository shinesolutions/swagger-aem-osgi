...
/**
 * Query parameters for orgApacheSlingDistributionSerializationImplDistributionPackageBu
 */
class OrgApacheSlingDistributionSerializationImplDistributionPackageBuQueryData
{
    /**
     * @DTA\Data(field="format.target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $format_target;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="memoryUnit", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
