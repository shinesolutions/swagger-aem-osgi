...
/**
 * Query parameters for comAdobeCqSecurityHcWebserverImplClickjackingHealthCheck
 */
class ComAdobeCqSecurityHcWebserverImplClickjackingHealthCheckQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="webserver.address", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $webserver_address;
    /**
