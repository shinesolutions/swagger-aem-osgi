...
/**
 * Query parameters for comAdobeCqWcmJobsAsyncImplAsyncDeleteConfigProviderService
 */
class ComAdobeCqWcmJobsAsyncImplAsyncDeleteConfigProviderServiceQueryData
{
    /**
