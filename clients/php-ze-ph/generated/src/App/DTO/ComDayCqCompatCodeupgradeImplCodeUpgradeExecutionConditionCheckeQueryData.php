...
/**
 * Query parameters for comDayCqCompatCodeupgradeImplCodeUpgradeExecutionConditionChecke
 */
class ComDayCqCompatCodeupgradeImplCodeUpgradeExecutionConditionCheckeQueryData
{
    /**
