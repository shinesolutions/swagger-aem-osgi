...
/**
 * Query parameters for comDayCqWcmFoundationImplHTTPAuthHandler
 */
class ComDayCqWcmFoundationImplHTTPAuthHandlerQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="auth.cred.utf8", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $location;
    /**
     * @DTA\Data(field="auth.http.nologin", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $auth_http_nologin;
    /**
     * @DTA\Data(field="auth.default.loginpage", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $auth_default_loginpage;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="auth.cred.form", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $auth_cred_form;
    /**
