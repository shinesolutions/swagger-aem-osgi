...
/**
 * Query parameters for orgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServic
 */
class OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicQueryData
{
    /**
