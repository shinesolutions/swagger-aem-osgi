...
/**
 * Query parameters for comAdobeCqSocialActivitystreamsListenerImplRatingEventActivityS
 */
class ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySQueryData
{
    /**
