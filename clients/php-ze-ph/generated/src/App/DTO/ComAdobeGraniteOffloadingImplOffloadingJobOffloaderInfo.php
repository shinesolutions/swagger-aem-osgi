...
class ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo
{
     ...
     * @DTA\Validator(name="Dictionary", options={"type":\App\DTO\ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties::class})
     * @var \App\DTO\ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties
     */
    public $properties;
    /**
