...
/**
 * Query parameters for comDayCqDamCoreImplProcessSendTransientWorkflowCompletedEmailPr
 */
class ComDayCqDamCoreImplProcessSendTransientWorkflowCompletedEmailPrQueryData
{
    /**
