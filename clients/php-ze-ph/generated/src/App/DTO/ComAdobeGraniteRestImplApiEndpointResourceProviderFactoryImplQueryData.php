...
/**
 * Query parameters for comAdobeGraniteRestImplApiEndpointResourceProviderFactoryImpl
 */
class ComAdobeGraniteRestImplApiEndpointResourceProviderFactoryImplQueryData
{
    /**
