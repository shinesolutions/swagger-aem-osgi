...
/**
 * Query parameters for comAdobeGraniteAuthSsoImplSsoAuthenticationHandler
 */
class ComAdobeGraniteAuthSsoImplSsoAuthenticationHandlerQueryData
{
    /**
     * @DTA\Data(field="headers", nullable=true)
    ...
    public $format;
    /**
     * @DTA\Data(field="usermap", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
    ...
    public $usermap;
    /**
     * @DTA\Data(field="trustedCredentialsAttribute", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $trusted_credentials_attribute;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="cookies", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
