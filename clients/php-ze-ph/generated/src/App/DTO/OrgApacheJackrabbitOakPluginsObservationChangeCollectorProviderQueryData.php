...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsObservationChangeCollectorProvider
 */
class OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="maxItems", nullable=true)
    ...
    public $enabled;
    /**
     * @DTA\Data(field="maxPathDepth", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $max_path_depth;
}
