...
/**
 * Query parameters for comDayCqDamCoreImplAssetlinkshareAdhocAssetShareProxyServlet
 */
class ComDayCqDamCoreImplAssetlinkshareAdhocAssetShareProxyServletQueryData
{
    /**
