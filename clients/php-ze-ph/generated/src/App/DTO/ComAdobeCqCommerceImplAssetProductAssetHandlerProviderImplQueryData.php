...
/**
 * Query parameters for comAdobeCqCommerceImplAssetProductAssetHandlerProviderImpl
 */
class ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplQueryData
{
    /**
