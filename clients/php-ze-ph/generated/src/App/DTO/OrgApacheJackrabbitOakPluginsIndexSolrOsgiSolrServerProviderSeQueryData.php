...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsIndexSolrOsgiSolrServerProviderSe
 */
class OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrServerProviderSeQueryData
{
    /**
