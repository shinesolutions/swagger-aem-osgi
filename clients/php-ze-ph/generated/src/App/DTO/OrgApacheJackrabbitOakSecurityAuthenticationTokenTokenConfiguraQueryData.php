...
/**
 * Query parameters for orgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfigura
 */
class OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraQueryData
{
    /**
    ...
    /**
     * @DTA\Data(field="tokenRefresh", nullable=true)
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="tokenCleanupThreshold", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $token_cleanup_threshold;
    /**
    ...
    public $post;
    /**
     * @DTA\Data(field="tokenExpiration", nullable=true)
    ...
    /**
     * @DTA\Data(field="tokenLength", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
