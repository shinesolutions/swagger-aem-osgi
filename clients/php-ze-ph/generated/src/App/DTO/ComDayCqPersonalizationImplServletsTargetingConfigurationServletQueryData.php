...
/**
 * Query parameters for comDayCqPersonalizationImplServletsTargetingConfigurationServlet
 */
class ComDayCqPersonalizationImplServletsTargetingConfigurationServletQueryData
{
    /**
