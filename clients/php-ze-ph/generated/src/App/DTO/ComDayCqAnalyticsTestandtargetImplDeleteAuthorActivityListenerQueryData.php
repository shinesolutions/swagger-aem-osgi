...
/**
 * Query parameters for comDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListener
 */
class ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerQueryData
{
    /**
