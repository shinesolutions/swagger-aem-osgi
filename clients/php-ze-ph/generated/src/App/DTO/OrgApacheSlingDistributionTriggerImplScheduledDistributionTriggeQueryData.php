...
/**
 * Query parameters for orgApacheSlingDistributionTriggerImplScheduledDistributionTrigge
 */
class OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeQueryData
{
    /**
    ...
    public $path;
    /**
     * @DTA\Data(field="seconds", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
