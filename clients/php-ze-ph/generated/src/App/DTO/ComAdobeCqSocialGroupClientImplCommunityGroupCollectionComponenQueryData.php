...
/**
 * Query parameters for comAdobeCqSocialGroupClientImplCommunityGroupCollectionComponen
 */
class ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenQueryData
{
    /**
