...
/**
 * Query parameters for comAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileO
 */
class ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOQueryData
{
    /**
