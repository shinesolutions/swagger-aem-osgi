...
/**
 * Query parameters for comAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImpl
 */
class ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplQueryData
{
    /**
