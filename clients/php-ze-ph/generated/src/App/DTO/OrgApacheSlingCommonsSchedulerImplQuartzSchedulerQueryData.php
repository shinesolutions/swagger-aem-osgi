...
/**
 * Query parameters for orgApacheSlingCommonsSchedulerImplQuartzScheduler
 */
class OrgApacheSlingCommonsSchedulerImplQuartzSchedulerQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="metrics.filters", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $location;
    /**
     * @DTA\Data(field="allowedPoolNames", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $allowed_pool_names;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="scheduler.useleaderforsingle", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $scheduler_useleaderforsingle;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="slowThresholdMillis", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $slow_threshold_millis;
    /**
     * @DTA\Data(field="poolName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
