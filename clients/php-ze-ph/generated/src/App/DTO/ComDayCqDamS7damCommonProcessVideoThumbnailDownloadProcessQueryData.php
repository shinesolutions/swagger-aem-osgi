...
/**
 * Query parameters for comDayCqDamS7damCommonProcessVideoThumbnailDownloadProcess
 */
class ComDayCqDamS7damCommonProcessVideoThumbnailDownloadProcessQueryData
{
    /**
