...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryDefaultCompon
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultComponQueryData
{
    /**
