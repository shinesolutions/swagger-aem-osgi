...
/**
 * Query parameters for comAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheck
 */
class ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckQueryData
{
    /**
