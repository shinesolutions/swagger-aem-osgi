...
/**
 * Query parameters for comAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckIm
 */
class ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImQueryData
{
    /**
