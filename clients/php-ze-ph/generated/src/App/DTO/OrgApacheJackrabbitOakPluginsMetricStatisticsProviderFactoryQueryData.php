...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsMetricStatisticsProviderFactory
 */
class OrgApacheJackrabbitOakPluginsMetricStatisticsProviderFactoryQueryData
{
    /**
