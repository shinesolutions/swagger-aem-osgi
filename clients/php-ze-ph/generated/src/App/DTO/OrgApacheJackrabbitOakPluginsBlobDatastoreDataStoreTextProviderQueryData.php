...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsBlobDatastoreDataStoreTextProvider
 */
class OrgApacheJackrabbitOakPluginsBlobDatastoreDataStoreTextProviderQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="dir", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
