...
/**
 * Query parameters for orgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategy
 */
class OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="configRefPropertyNames", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $config_ref_property_names;
    /**
    ...
    public $enabled;
    /**
     * @DTA\Data(field="configRefResourceNames", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $config_ref_resource_names;
    /**
