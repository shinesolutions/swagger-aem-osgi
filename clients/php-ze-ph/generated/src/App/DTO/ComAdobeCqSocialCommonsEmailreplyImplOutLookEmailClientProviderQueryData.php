...
/**
 * Query parameters for comAdobeCqSocialCommonsEmailreplyImplOutLookEmailClientProvider
 */
class ComAdobeCqSocialCommonsEmailreplyImplOutLookEmailClientProviderQueryData
{
    /**
