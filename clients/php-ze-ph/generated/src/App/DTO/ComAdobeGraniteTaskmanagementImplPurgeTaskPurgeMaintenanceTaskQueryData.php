...
/**
 * Query parameters for comAdobeGraniteTaskmanagementImplPurgeTaskPurgeMaintenanceTask
 */
class ComAdobeGraniteTaskmanagementImplPurgeTaskPurgeMaintenanceTaskQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="purgeCompleted", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $purge_completed;
    /**
     * @DTA\Data(field="activeAge", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="purgeActive", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    ...
    public $delete;
    /**
     * @DTA\Data(field="saveThreshold", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $save_threshold;
}
