...
/**
 * Query parameters for comDayCqWcmCoreImplServletsContentfinderConnectorConnectorVie
 */
class ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieQueryData
{
    /**
