...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHan
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanQueryData
{
    /**
