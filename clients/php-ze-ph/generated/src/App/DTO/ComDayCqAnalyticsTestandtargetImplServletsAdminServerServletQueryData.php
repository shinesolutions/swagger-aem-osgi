...
/**
 * Query parameters for comDayCqAnalyticsTestandtargetImplServletsAdminServerServlet
 */
class ComDayCqAnalyticsTestandtargetImplServletsAdminServerServletQueryData
{
    /**
