...
/**
 * Query parameters for comAdobeOctopusNcommBootstrap
 */
class ComAdobeOctopusNcommBootstrapQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="maxRequests", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    ...
    public $delete;
    /**
     * @DTA\Data(field="launchTimeout", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $launch_timeout;
    /**
     * @DTA\Data(field="requestTimeout", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    ...
    /**
     * @DTA\Data(field="maxConnections", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
