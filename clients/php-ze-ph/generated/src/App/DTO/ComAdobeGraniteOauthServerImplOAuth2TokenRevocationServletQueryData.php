...
/**
 * Query parameters for comAdobeGraniteOauthServerImplOAuth2TokenRevocationServlet
 */
class ComAdobeGraniteOauthServerImplOAuth2TokenRevocationServletQueryData
{
    /**
