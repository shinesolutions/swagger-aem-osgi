...
/**
 * Query parameters for comAdobeGraniteAuthRequirementImplDefaultRequirementHandler
 */
class ComAdobeGraniteAuthRequirementImplDefaultRequirementHandlerQueryData
{
    /**
