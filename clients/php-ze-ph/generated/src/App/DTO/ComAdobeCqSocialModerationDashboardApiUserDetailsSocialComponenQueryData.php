...
/**
 * Query parameters for comAdobeCqSocialModerationDashboardApiUserDetailsSocialComponen
 */
class ComAdobeCqSocialModerationDashboardApiUserDetailsSocialComponenQueryData
{
    /**
