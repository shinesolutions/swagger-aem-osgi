...
/**
 * Query parameters for comAdobeCqContentinsightImplServletsBrightEdgeProxyServlet
 */
class ComAdobeCqContentinsightImplServletsBrightEdgeProxyServletQueryData
{
    /**
