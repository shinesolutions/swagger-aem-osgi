...
/**
 * Query parameters for orgApacheSlingCaconfigImplConfigurationBindingsValueProvider
 */
class OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderQueryData
{
    /**
