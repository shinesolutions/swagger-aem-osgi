...
/**
 * Query parameters for orgApacheSlingEngineImplAuthSlingAuthenticator
 */
class OrgApacheSlingEngineImplAuthSlingAuthenticatorQueryData
{
    /**
     * @DTA\Data(field="auth.sudo.cookie", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $auth_sudo_cookie;
    /**
    ...
    /**
     * @DTA\Data(field="auth.sudo.parameter", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $auth_sudo_parameter;
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="sling.auth.anonymous.user", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $sling_auth_anonymous_user;
    /**
    ...
    public $post;
    /**
     * @DTA\Data(field="sling.auth.anonymous.password", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $sling_auth_anonymous_password;
    /**
     * @DTA\Data(field="auth.http", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    /**
     * @DTA\Data(field="auth.annonymous", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $auth_annonymous;
    /**
     * @DTA\Data(field="auth.uri.suffix", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $auth_uri_suffix;
    /**
     * @DTA\Data(field="auth.http.realm", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
