...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandl
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlQueryData
{
    /**
