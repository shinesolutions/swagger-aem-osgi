...
/**
 * Query parameters for orgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPr
 */
class OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="protectExternalId", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $protect_external_id;
    /**
