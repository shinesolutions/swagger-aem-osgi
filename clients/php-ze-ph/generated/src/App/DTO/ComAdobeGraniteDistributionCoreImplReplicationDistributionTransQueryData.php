...
/**
 * Query parameters for comAdobeGraniteDistributionCoreImplReplicationDistributionTrans
 */
class ComAdobeGraniteDistributionCoreImplReplicationDistributionTransQueryData
{
    /**
