...
/**
 * Query parameters for comAdobeCqCloudconfigCoreImplConfigurationReplicationEventHandle
 */
class ComAdobeCqCloudconfigCoreImplConfigurationReplicationEventHandleQueryData
{
    /**
