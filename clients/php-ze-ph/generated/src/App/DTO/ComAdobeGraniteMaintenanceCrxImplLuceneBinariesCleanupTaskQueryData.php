...
/**
 * Query parameters for comAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTask
 */
class ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskQueryData
{
    /**
