...
/**
 * Query parameters for comAdobeCqSecurityHcDispatcherImplDispatcherAccessHealthCheck
 */
class ComAdobeCqSecurityHcDispatcherImplDispatcherAccessHealthCheckQueryData
{
    /**
