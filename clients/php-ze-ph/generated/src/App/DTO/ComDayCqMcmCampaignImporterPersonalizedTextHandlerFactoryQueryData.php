...
/**
 * Query parameters for comDayCqMcmCampaignImporterPersonalizedTextHandlerFactory
 */
class ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryQueryData
{
    /**
