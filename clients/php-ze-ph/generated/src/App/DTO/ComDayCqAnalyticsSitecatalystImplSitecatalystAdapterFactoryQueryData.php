...
/**
 * Query parameters for comDayCqAnalyticsSitecatalystImplSitecatalystAdapterFactory
 */
class ComDayCqAnalyticsSitecatalystImplSitecatalystAdapterFactoryQueryData
{
    /**
