...
/**
 * Query parameters for comAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJob
 */
class ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobQueryData
{
    /**
