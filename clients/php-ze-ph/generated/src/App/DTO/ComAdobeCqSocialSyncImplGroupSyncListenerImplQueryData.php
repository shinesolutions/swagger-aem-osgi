...
/**
 * Query parameters for comAdobeCqSocialSyncImplGroupSyncListenerImpl
 */
class ComAdobeCqSocialSyncImplGroupSyncListenerImplQueryData
{
    /**
    ...
    public $post;
    /**
     * @DTA\Data(field="ignorablenodes", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $ignorablenodes;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="nodetypes", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $delete;
    /**
     * @DTA\Data(field="ignorableprops", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $ignorableprops;
    /**
    ...
    public $enabled;
    /**
     * @DTA\Data(field="distfolders", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
