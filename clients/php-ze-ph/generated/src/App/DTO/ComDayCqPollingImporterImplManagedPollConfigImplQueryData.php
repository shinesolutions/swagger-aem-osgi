...
/**
 * Query parameters for comDayCqPollingImporterImplManagedPollConfigImpl
 */
class ComDayCqPollingImporterImplManagedPollConfigImplQueryData
{
    /**
    ...
    public $enabled;
    /**
     * @DTA\Data(field="target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="reference", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
