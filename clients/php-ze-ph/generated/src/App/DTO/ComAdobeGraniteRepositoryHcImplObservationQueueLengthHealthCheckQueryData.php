...
/**
 * Query parameters for comAdobeGraniteRepositoryHcImplObservationQueueLengthHealthCheck
 */
class ComAdobeGraniteRepositoryHcImplObservationQueueLengthHealthCheckQueryData
{
    /**
