...
/**
 * Query parameters for orgApacheSlingCaconfigResourceImplDefDefaultConfigurationResour
 */
class OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="configCollectionInheritancePropertyNames", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $config_collection_inheritance_property_names;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="fallbackPaths", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $fallback_paths;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="configPath", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
