...
/**
 * Query parameters for comDayCqWorkflowImplEmailEMailNotificationService
 */
class ComDayCqWorkflowImplEmailEMailNotificationServiceQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="host.prefix", nullable=true)
    ...
    public $post;
    /**
     * @DTA\Data(field="notify.onabort", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $notify_onabort;
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="notify.useronly", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $notify_useronly;
    /**
    ...
    public $from_address;
    /**
     * @DTA\Data(field="notify.oncontainercomplete", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $notify_oncontainercomplete;
    /**
