...
/**
 * Query parameters for comAdobeCqContentinsightImplServletsReportingServicesProxyServle
 */
class ComAdobeCqContentinsightImplServletsReportingServicesProxyServleQueryData
{
    /**
