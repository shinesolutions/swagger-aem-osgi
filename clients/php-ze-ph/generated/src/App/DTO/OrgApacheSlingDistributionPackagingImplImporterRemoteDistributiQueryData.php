...
/**
 * Query parameters for orgApacheSlingDistributionPackagingImplImporterRemoteDistributi
 */
class OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiQueryData
{
    /**
