...
/**
 * Query parameters for orgApacheSlingEngineImplSlingMainServlet
 */
class OrgApacheSlingEngineImplSlingMainServletQueryData
{
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="sling.max.inclusions", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $sling_max_inclusions;
    /**
     * @DTA\Data(field="sling.trace.allow", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $sling_trace_allow;
    /**
     * @DTA\Data(field="sling.store.pattern.requests", nullable=true)
     ...
     * @var string[]
     */
    public $sling_store_pattern_requests;
    /**
     * @DTA\Data(field="sling.max.record.requests", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $sling_max_record_requests;
    /**
     * @DTA\Data(field="sling.additional.response.headers", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $sling_additional_response_headers;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="sling.max.calls", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $sling_max_calls;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="sling.serverinfo", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $sling_serverinfo;
    /**
