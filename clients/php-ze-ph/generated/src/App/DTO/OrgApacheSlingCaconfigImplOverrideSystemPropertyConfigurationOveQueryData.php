...
/**
 * Query parameters for orgApacheSlingCaconfigImplOverrideSystemPropertyConfigurationOve
 */
class OrgApacheSlingCaconfigImplOverrideSystemPropertyConfigurationOveQueryData
{
    /**
