...
/**
 * Query parameters for orgApacheJackrabbitVaultPackagingRegistryImplFSPackageRegistry
 */
class OrgApacheJackrabbitVaultPackagingRegistryImplFSPackageRegistryQueryData
{
    /**
