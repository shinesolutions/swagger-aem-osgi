...
/**
 * Query parameters for comAdobeCqSocialModerationDashboardApiFilterGroupSocialComponen
 */
class ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenQueryData
{
    /**
