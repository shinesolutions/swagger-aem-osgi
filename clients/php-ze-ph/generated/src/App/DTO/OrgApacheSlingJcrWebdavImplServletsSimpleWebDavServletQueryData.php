...
/**
 * Query parameters for orgApacheSlingJcrWebdavImplServletsSimpleWebDavServlet
 */
class OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletQueryData
{
    /**
     * @DTA\Data(field="filter.prefixes", nullable=true)
    ...
    public $apply;
    /**
     * @DTA\Data(field="collection.types", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
    ...
    /**
     * @DTA\Data(field="filter.types", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="dav.realm", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $dav_realm;
    /**
     * @DTA\Data(field="dav.root", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    /**
     * @DTA\Data(field="filter.uris", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
