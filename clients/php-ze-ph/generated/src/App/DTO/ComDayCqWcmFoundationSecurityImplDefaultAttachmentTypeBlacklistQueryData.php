...
/**
 * Query parameters for comDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklist
 */
class ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistQueryData
{
    /**
