...
/**
 * Query parameters for comAdobeCqSocialCalendarClientEndpointsImplCalendarOperationsI
 */
class ComAdobeCqSocialCalendarClientEndpointsImplCalendarOperationsIQueryData
{
    /**
