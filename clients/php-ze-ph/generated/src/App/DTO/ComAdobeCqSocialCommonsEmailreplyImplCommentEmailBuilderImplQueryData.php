...
/**
 * Query parameters for comAdobeCqSocialCommonsEmailreplyImplCommentEmailBuilderImpl
 */
class ComAdobeCqSocialCommonsEmailreplyImplCommentEmailBuilderImplQueryData
{
    /**
