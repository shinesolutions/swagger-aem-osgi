...
/**
 * Query parameters for orgApacheSlingDistributionAgentImplPrivilegeDistributionRequestA
 */
class OrgApacheSlingDistributionAgentImplPrivilegeDistributionRequestAQueryData
{
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="jcrPrivilege", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $jcr_privilege;
    /**
