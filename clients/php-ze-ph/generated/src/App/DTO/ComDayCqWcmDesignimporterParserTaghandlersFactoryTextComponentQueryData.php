...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryTextComponent
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryTextComponentQueryData
{
    /**
