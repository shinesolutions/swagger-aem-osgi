...
/**
 * Query parameters for comAdobeCqSocialActivitystreamsListenerImplEventListenerHandler
 */
class ComAdobeCqSocialActivitystreamsListenerImplEventListenerHandlerQueryData
{
    /**
