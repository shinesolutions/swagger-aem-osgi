...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsDocumentSecondarySecondaryStoreCac
 */
class OrgApacheJackrabbitOakPluginsDocumentSecondarySecondaryStoreCacQueryData
{
    /**
