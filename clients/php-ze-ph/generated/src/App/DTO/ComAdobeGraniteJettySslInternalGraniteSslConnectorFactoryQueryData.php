...
/**
 * Query parameters for comAdobeGraniteJettySslInternalGraniteSslConnectorFactory
 */
class ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryQueryData
{
    /**
