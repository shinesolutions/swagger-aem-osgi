...
/**
 * Query parameters for orgApacheSlingTracerInternalLogTracer
 */
class OrgApacheSlingTracerInternalLogTracerQueryData
{
    /**
     * @DTA\Data(field="gzipResponse", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $gzip_response;
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="recordingCompressionEnabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $recording_compression_enabled;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="servletEnabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $servlet_enabled;
    /**
     * @DTA\Data(field="recordingCacheSizeInMB", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $recording_cache_size_in_mb;
    /**
     * @DTA\Data(field="tracerSets", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $tracer_sets;
    /**
     * @DTA\Data(field="recordingCacheDurationInSecs", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $recording_cache_duration_in_secs;
}
