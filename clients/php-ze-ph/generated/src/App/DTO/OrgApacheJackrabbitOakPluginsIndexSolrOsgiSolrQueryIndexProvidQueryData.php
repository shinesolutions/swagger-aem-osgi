...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvid
 */
class OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidQueryData
{
    /**
