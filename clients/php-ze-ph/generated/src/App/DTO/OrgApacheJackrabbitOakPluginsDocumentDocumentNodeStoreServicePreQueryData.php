...
/**
 * Query parameters for orgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePre
 */
class OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreQueryData
{
    /**
