...
/**
 * Query parameters for comDayCqDamStockIntegrationImplCacheStockCacheConfigurationSer
 */
class ComDayCqDamStockIntegrationImplCacheStockCacheConfigurationSerQueryData
{
    /**
