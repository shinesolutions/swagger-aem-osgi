...
/**
 * Query parameters for comAdobeCqSocialTranslationImplUGCLanguageDetector
 */
class ComAdobeCqSocialTranslationImplUGCLanguageDetectorQueryData
{
    /**
    ...
    public $post;
    /**
     * @DTA\Data(field="translate.listener.type", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $translate_listener_type;
    /**
     * @DTA\Data(field="translate.property.list", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $translate_property_list;
    /**
