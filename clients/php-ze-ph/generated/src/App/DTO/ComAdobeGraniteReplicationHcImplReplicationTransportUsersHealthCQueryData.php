...
/**
 * Query parameters for comAdobeGraniteReplicationHcImplReplicationTransportUsersHealthC
 */
class ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCQueryData
{
    /**
