...
/**
 * Query parameters for orgApacheFelixWebconsolePluginsEventInternalPluginServlet
 */
class OrgApacheFelixWebconsolePluginsEventInternalPluginServletQueryData
{
    /**
