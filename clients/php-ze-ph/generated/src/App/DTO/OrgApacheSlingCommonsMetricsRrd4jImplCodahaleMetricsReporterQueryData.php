...
/**
 * Query parameters for orgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporter
 */
class OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterQueryData
{
    /**
    ...
    public $path;
    /**
     * @DTA\Data(field="archives", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $post;
    /**
     * @DTA\Data(field="datasources", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
