...
/**
 * Query parameters for comAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperati
 */
class ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiQueryData
{
    /**
