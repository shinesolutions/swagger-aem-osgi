...
/**
 * Query parameters for comDayCqReplicationImplTransportBinaryLessTransportHandler
 */
class ComDayCqReplicationImplTransportBinaryLessTransportHandlerQueryData
{
    /**
