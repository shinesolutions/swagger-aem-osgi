...
/**
 * Query parameters for comDayCqReplicationImplReplicationContentFactoryProviderImpl
 */
class ComDayCqReplicationImplReplicationContentFactoryProviderImplQueryData
{
    /**
