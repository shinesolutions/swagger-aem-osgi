...
/**
 * Query parameters for comAdobeGraniteFragsImplCheckHttpHeaderFlag
 */
class ComAdobeGraniteFragsImplCheckHttpHeaderFlagQueryData
{
    /**
     ...
     * @var string
     */
    public $http_header_valuepattern;
    /**
