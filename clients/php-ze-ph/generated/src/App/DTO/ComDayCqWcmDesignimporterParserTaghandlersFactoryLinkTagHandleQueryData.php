...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandle
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleQueryData
{
    /**
