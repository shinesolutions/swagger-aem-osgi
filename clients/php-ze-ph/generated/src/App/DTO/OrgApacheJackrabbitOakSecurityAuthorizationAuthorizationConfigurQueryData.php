...
/**
 * Query parameters for orgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigur
 */
class OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="permissionsJr2", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $permissions_jr2;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="administrativePrincipals", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $administrative_principals;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="readPaths", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
