...
/**
 * Query parameters for comDayCqDamCoreImplJobsMetadataimportAsyncMetadataImportConfig
 */
class ComDayCqDamCoreImplJobsMetadataimportAsyncMetadataImportConfigQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="operationIcon", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $operation_icon;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="topicName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
