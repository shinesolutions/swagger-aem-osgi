...
/**
 * Query parameters for comAdobeGraniteReplicationHcImplReplicationQueueHealthCheck
 */
class ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckQueryData
{
    /**
