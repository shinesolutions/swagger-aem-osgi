...
/**
 * Query parameters for orgApacheSlingDistributionAgentImplSyncDistributionAgentFactory
 */
class OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryQueryData
{
    /**
    ...
    /**
     * @DTA\Data(field="packageExporter.endpoints", nullable=true)
     ...
     * @var string[]
     */
    public $package_exporter_endpoints;
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="pull.items", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
