...
class OrgApacheSlingXssImplXSSFilterImplInfo
{
     ...
     * @DTA\Validator(name="Dictionary", options={"type":\App\DTO\OrgApacheSlingXssImplXSSFilterImplProperties::class})
     * @var \App\DTO\OrgApacheSlingXssImplXSSFilterImplProperties
     */
    public $properties;
    /**
