...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandle
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleQueryData
{
    /**
