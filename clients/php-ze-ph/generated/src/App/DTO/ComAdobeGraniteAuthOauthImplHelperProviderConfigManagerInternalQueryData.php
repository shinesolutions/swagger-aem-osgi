...
/**
 * Query parameters for comAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternal
 */
class ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalQueryData
{
    /**
