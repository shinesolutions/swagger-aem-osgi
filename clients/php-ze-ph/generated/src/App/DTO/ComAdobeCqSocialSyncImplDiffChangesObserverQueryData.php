...
/**
 * Query parameters for comAdobeCqSocialSyncImplDiffChangesObserver
 */
class ComAdobeCqSocialSyncImplDiffChangesObserverQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="propertyNames", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="agentName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
