...
/**
 * Query parameters for comDayCqAnalyticsSitecatalystImplExporterClassificationsExporte
 */
class ComDayCqAnalyticsSitecatalystImplExporterClassificationsExporteQueryData
{
    /**
