...
/**
 * Query parameters for comDayCqDamS7damCommonAnalyticsImplSiteCatalystReportRunner
 */
class ComDayCqDamS7damCommonAnalyticsImplSiteCatalystReportRunnerQueryData
{
    /**
