...
/**
 * Query parameters for comAdobeGraniteConfImplRuntimeAwareConfigurationResourceResolving
 */
class ComAdobeGraniteConfImplRuntimeAwareConfigurationResourceResolvingQueryData
{
    /**
