...
/**
 * Query parameters for orgApacheSlingDistributionPackagingImplExporterRemoteDistributi
 */
class OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="endpoints", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
