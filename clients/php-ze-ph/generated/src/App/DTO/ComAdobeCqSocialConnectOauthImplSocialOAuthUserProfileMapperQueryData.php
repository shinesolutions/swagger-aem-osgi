...
/**
 * Query parameters for comAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapper
 */
class ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperQueryData
{
    /**
