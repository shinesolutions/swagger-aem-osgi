...
/**
 * Query parameters for orgApacheSlingDistributionPackagingImplExporterLocalDistributio
 */
class OrgApacheSlingDistributionPackagingImplExporterLocalDistributioQueryData
{
    /**
