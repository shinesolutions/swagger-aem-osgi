...
/**
 * Query parameters for comAdobeCqSocialCommonsEmailreplyImplCommentEmailEventListener
 */
class ComAdobeCqSocialCommonsEmailreplyImplCommentEmailEventListenerQueryData
{
    /**
