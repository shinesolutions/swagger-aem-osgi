...
/**
 * Query parameters for orgApacheSlingDistributionTriggerImplJcrEventDistributionTrigger
 */
class OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerQueryData
{
    /**
    ...
    public $path;
    /**
     * @DTA\Data(field="deep", nullable=true)
    ...
    public $delete;
    /**
     * @DTA\Data(field="ignoredPathsPatterns", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
