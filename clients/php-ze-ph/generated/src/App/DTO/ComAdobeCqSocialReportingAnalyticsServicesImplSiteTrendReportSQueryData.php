...
/**
 * Query parameters for comAdobeCqSocialReportingAnalyticsServicesImplSiteTrendReportS
 */
class ComAdobeCqSocialReportingAnalyticsServicesImplSiteTrendReportSQueryData
{
    /**
