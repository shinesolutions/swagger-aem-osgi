...
/**
 * Query parameters for orgApacheSlingCaconfigManagementImplConfigurationManagementSetti
 */
class OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiQueryData
{
    /**
