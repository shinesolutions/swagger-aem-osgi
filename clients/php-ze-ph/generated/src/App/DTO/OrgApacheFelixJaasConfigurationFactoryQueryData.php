...
/**
 * Query parameters for orgApacheFelixJaasConfigurationFactory
 */
class OrgApacheFelixJaasConfigurationFactoryQueryData
{
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="jaas.options", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $jaas_options;
    /**
     * @DTA\Data(field="jaas.classname", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $jaas_classname;
}
