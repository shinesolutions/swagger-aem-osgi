...
/**
 * Query parameters for comDayCommonsHttpclient
 */
class ComDayCommonsHttpclientQueryData
{
    /**
    ...
    /**
     * @DTA\Data(field="proxy.ntlm.host", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $proxy_ntlm_host;
    /**
    ...
    /**
     * @DTA\Data(field="proxy.ntlm.domain", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $proxy_ntlm_domain;
}
