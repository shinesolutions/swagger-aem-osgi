...
/**
 * Query parameters for comAdobeGraniteOauthServerImplOAuth2RevocationEndpointServlet
 */
class ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletQueryData
{
    /**
