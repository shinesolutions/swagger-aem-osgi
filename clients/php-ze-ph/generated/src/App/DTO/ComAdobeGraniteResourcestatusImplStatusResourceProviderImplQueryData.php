...
/**
 * Query parameters for comAdobeGraniteResourcestatusImplStatusResourceProviderImpl
 */
class ComAdobeGraniteResourcestatusImplStatusResourceProviderImplQueryData
{
    /**
