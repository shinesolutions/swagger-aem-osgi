...
/**
 * Query parameters for orgApacheSlingHcCoreImplCompositeHealthCheck
 */
class OrgApacheSlingHcCoreImplCompositeHealthCheckQueryData
{
    /**
    ...
    public $hc_tags;
    /**
     * @DTA\Data(field="filter.combineTagsWithOr", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $filter_combine_tags_with_or;
    /**
    ...
    public $hc_name;
    /**
     * @DTA\Data(field="filter.tags", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
