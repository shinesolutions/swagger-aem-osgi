...
/**
 * Query parameters for comAdobeGraniteFragsImplRandomFeature
 */
class ComAdobeGraniteFragsImplRandomFeatureQueryData
{
    /**
    ...
    /**
     * @DTA\Data(field="cookie.name", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="active.percentage", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $active_percentage;
    /**
