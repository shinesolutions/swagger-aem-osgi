...
/**
 * Query parameters for comAdobeGraniteMonitoringImplScriptConfigImpl
 */
class ComAdobeGraniteMonitoringImplScriptConfigImplQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="script.path", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $interval;
    /**
     * @DTA\Data(field="script.filename", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    /**
     * @DTA\Data(field="script.display", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $script_display;
    /**
     * @DTA\Data(field="script.platform", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $script_platform;
    /**
     * @DTA\Data(field="jmxdomain", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
