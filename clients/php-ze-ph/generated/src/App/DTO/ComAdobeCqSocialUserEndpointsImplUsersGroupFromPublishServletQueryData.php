...
/**
 * Query parameters for comAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServlet
 */
class ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletQueryData
{
    /**
