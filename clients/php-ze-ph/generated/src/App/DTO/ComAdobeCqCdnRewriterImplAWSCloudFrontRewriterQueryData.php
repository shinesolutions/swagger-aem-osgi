...
/**
 * Query parameters for comAdobeCqCdnRewriterImplAWSCloudFrontRewriter
 */
class ComAdobeCqCdnRewriterImplAWSCloudFrontRewriterQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="keypair.alias", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $keypair_alias;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="keypair.id", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
