...
/**
 * Query parameters for orgApacheSlingHcCoreImplJmxAttributeHealthCheck
 */
class OrgApacheSlingHcCoreImplJmxAttributeHealthCheckQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="mbean.name", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="attribute.value.constraint", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $attribute_value_constraint;
    /**
    ...
    /**
     * @DTA\Data(field="attribute.name", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
