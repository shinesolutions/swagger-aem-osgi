...
/**
 * Query parameters for comAdobeGraniteCompatrouterImplCompatSwitchingServiceImpl
 */
class ComAdobeGraniteCompatrouterImplCompatSwitchingServiceImplQueryData
{
    /**
