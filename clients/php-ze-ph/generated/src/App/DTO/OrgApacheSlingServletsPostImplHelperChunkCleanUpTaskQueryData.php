...
/**
 * Query parameters for orgApacheSlingServletsPostImplHelperChunkCleanUpTask
 */
class OrgApacheSlingServletsPostImplHelperChunkCleanUpTaskQueryData
{
    /**
