...
/**
 * Query parameters for orgApacheSlingHcCoreImplScriptableHealthCheck
 */
class OrgApacheSlingHcCoreImplScriptableHealthCheckQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="expression", nullable=true)
    ...
    public $hc_tags;
    /**
     * @DTA\Data(field="language.extension", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $language_extension;
    /**
