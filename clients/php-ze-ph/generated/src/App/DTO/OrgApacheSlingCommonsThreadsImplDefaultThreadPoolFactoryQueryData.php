...
/**
 * Query parameters for orgApacheSlingCommonsThreadsImplDefaultThreadPoolFactory
 */
class OrgApacheSlingCommonsThreadsImplDefaultThreadPoolFactoryQueryData
{
    /**
     * @DTA\Data(field="shutdownWaitTime", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $shutdown_wait_time;
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="blockPolicy", nullable=true)
    ...
    public $delete;
    /**
     * @DTA\Data(field="daemon", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="shutdownGraceful", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $shutdown_graceful;
    /**
    ...
    /**
     * @DTA\Data(field="maxThreadAge", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $max_thread_age;
}
