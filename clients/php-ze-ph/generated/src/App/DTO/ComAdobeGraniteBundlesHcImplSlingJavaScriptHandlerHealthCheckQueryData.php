...
/**
 * Query parameters for comAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheck
 */
class ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckQueryData
{
    /**
