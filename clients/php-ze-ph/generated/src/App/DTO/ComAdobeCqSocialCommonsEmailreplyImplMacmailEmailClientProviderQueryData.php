...
/**
 * Query parameters for comAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProvider
 */
class ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderQueryData
{
    /**
