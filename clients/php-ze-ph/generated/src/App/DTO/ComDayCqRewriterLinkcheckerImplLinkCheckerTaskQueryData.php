...
/**
 * Query parameters for comDayCqRewriterLinkcheckerImplLinkCheckerTask
 */
class ComDayCqRewriterLinkcheckerImplLinkCheckerTaskQueryData
{
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="good_link_test_interval", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $good_link_test_interval;
    /**
     * @DTA\Data(field="link_unused_interval", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $link_unused_interval;
    /**
    ...
    public $action;
    /**
     * @DTA\Data(field="bad_link_test_interval", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"int"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"int"})
     * @var int
     */
    public $bad_link_test_interval;
    /**
