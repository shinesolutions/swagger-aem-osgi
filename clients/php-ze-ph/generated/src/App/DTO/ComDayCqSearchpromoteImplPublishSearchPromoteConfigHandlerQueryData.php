...
/**
 * Query parameters for comDayCqSearchpromoteImplPublishSearchPromoteConfigHandler
 */
class ComDayCqSearchpromoteImplPublishSearchPromoteConfigHandlerQueryData
{
    /**
