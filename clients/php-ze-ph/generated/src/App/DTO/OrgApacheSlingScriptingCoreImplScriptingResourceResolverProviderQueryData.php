...
/**
 * Query parameters for orgApacheSlingScriptingCoreImplScriptingResourceResolverProvider
 */
class OrgApacheSlingScriptingCoreImplScriptingResourceResolverProviderQueryData
{
    /**
