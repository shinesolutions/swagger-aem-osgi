...
/**
 * Query parameters for comAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtension
 */
class ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionQueryData
{
    /**
