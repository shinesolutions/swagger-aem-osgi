...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponen
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenQueryData
{
    /**
