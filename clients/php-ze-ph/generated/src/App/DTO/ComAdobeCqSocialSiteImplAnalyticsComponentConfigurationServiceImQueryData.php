...
/**
 * Query parameters for comAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceIm
 */
class ComAdobeCqSocialSiteImplAnalyticsComponentConfigurationServiceImQueryData
{
    /**
