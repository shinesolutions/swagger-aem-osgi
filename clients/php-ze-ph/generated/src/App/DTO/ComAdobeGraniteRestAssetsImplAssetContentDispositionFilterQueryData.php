...
/**
 * Query parameters for comAdobeGraniteRestAssetsImplAssetContentDispositionFilter
 */
class ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterQueryData
{
    /**
