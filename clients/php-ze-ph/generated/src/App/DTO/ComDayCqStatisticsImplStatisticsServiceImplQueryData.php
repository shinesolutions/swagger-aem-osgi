...
/**
 * Query parameters for comDayCqStatisticsImplStatisticsServiceImpl
 */
class ComDayCqStatisticsImplStatisticsServiceImplQueryData
{
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="keywordsPath", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $keywords_path;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="asyncEntries", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $async_entries;
    /**
