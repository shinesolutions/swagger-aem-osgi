...
/**
 * Query parameters for comDayCqReplicationImplContentDurboBinaryLessContentBuilder
 */
class ComDayCqReplicationImplContentDurboBinaryLessContentBuilderQueryData
{
    /**
