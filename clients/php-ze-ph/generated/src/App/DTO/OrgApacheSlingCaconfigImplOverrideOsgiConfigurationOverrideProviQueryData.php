...
/**
 * Query parameters for orgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProvi
 */
class OrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviQueryData
{
    /**
    ...
    public $description;
    /**
     * @DTA\Data(field="overrides", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
