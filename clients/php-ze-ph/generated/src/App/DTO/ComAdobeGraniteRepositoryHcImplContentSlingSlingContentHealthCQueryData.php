...
/**
 * Query parameters for comAdobeGraniteRepositoryHcImplContentSlingSlingContentHealthC
 */
class ComAdobeGraniteRepositoryHcImplContentSlingSlingContentHealthCQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="exclude.search.path", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
