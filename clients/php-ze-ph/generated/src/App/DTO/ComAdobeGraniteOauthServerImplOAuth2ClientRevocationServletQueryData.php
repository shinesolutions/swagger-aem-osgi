...
/**
 * Query parameters for comAdobeGraniteOauthServerImplOAuth2ClientRevocationServlet
 */
class ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletQueryData
{
    /**
