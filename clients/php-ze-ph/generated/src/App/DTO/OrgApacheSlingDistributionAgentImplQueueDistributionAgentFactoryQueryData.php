...
/**
 * Query parameters for orgApacheSlingDistributionAgentImplQueueDistributionAgentFactory
 */
class OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryQueryData
{
    /**
    ...
    public $service_name;
    /**
     * @DTA\Data(field="queueProviderFactory.target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $queue_provider_factory_target;
    /**
