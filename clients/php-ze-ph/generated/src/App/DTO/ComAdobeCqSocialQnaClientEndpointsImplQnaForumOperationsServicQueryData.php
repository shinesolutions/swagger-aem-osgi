...
/**
 * Query parameters for comAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServic
 */
class ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicQueryData
{
    /**
