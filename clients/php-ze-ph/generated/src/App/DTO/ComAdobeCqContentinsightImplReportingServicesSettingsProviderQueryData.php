...
/**
 * Query parameters for comAdobeCqContentinsightImplReportingServicesSettingsProvider
 */
class ComAdobeCqContentinsightImplReportingServicesSettingsProviderQueryData
{
    /**
