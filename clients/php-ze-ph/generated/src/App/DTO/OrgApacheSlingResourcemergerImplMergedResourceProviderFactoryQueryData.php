...
/**
 * Query parameters for orgApacheSlingResourcemergerImplMergedResourceProviderFactory
 */
class OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryQueryData
{
    /**
