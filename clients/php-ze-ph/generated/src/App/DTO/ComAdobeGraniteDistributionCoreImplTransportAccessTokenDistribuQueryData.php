...
/**
 * Query parameters for comAdobeGraniteDistributionCoreImplTransportAccessTokenDistribu
 */
class ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="accessTokenProvider.target", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $access_token_provider_target;
    /**
