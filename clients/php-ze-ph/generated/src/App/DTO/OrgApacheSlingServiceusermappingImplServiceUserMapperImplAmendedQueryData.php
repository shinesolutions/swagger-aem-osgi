...
/**
 * Query parameters for orgApacheSlingServiceusermappingImplServiceUserMapperImplAmended
 */
class OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedQueryData
{
    /**
