...
/**
 * Query parameters for comDayCqDamPerformanceInternalAssetPerformanceReportSyncJob
 */
class ComDayCqDamPerformanceInternalAssetPerformanceReportSyncJobQueryData
{
    /**
