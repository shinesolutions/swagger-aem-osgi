...
/**
 * Query parameters for comAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportI
 */
class ComAdobeCqSocialReportingAnalyticsServicesImplAnalyticsReportIQueryData
{
    /**
