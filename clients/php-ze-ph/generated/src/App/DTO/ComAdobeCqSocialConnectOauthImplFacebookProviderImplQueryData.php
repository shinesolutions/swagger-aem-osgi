...
/**
 * Query parameters for comAdobeCqSocialConnectOauthImplFacebookProviderImpl
 */
class ComAdobeCqSocialConnectOauthImplFacebookProviderImplQueryData
{
    /**
    ...
    /**
     * @DTA\Data(field="provider.config.facebook.fetch.fields", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $provider_config_facebook_fetch_fields;
    /**
    ...
    /**
     * @DTA\Data(field="provider.config.facebook.fields", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     ...
     * @var string[]
     */
    public $provider_config_facebook_fields;
    /**
     * @DTA\Data(field="provider.config.create.tags.enabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $provider_config_create_tags_enabled;
}
