...
/**
 * Query parameters for comDayCqWcmMobileCoreImplRedirectRedirectFilter
 */
class ComDayCqWcmMobileCoreImplRedirectRedirectFilterQueryData
{
    /**
    ...
    public $apply;
    /**
     * @DTA\Data(field="redirect.enabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $redirect_enabled;
    /**
     * @DTA\Data(field="redirect.paths", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
    ...
    public $location;
    /**
     * @DTA\Data(field="redirect.stats.enabled", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    public $redirect_stats_enabled;
    /**
    ...
    public $delete;
    /**
     * @DTA\Data(field="redirect.extensions", nullable=true)
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="QueryParameterArray", options={"type":"string", "format":"multi"})
     * @DTA\Validator(name="QueryParameterArrayType", options={"type":"string", "format":"multi"})
     * @var string[]
     */
    public $redirect_extensions;
}
