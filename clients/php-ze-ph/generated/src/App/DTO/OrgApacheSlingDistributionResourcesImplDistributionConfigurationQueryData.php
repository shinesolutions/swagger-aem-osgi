...
/**
 * Query parameters for orgApacheSlingDistributionResourcesImplDistributionConfiguration
 */
class OrgApacheSlingDistributionResourcesImplDistributionConfigurationQueryData
{
    /**
