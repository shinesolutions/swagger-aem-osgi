...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandler
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerQueryData
{
    /**
