...
/**
 * Query parameters for comAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthChe
 */
class ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheQueryData
{
    /**
