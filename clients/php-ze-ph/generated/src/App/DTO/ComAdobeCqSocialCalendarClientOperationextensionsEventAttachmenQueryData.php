...
/**
 * Query parameters for comAdobeCqSocialCalendarClientOperationextensionsEventAttachmen
 */
class ComAdobeCqSocialCalendarClientOperationextensionsEventAttachmenQueryData
{
    /**
