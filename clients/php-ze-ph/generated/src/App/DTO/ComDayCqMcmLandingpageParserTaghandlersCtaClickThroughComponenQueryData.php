...
/**
 * Query parameters for comDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponen
 */
class ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenQueryData
{
    /**
