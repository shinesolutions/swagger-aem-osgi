...
/**
 * Query parameters for comAdobeCqSocialModerationDashboardInternalImplFilterGroupSoci
 */
class ComAdobeCqSocialModerationDashboardInternalImplFilterGroupSociQueryData
{
    /**
