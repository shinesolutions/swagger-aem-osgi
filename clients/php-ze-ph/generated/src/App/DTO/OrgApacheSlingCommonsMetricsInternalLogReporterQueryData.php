...
/**
 * Query parameters for orgApacheSlingCommonsMetricsInternalLogReporter
 */
class OrgApacheSlingCommonsMetricsInternalLogReporterQueryData
{
    /**
    ...
    public $level;
    /**
     * @DTA\Data(field="prefix", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $pattern;
    /**
     * @DTA\Data(field="registryName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="loggerName", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $logger_name;
    /**
     * @DTA\Data(field="timeUnit", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
