...
/**
 * Query parameters for comAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheck
 */
class ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckQueryData
{
    /**
