...
/**
 * Query parameters for comAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthCh
 */
class ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChQueryData
{
    /**
