...
/**
 * Query parameters for comAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheck
 */
class ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckQueryData
{
    /**
