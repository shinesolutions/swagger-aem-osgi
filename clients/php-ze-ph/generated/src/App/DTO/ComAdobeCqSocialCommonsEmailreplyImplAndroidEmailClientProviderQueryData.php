...
/**
 * Query parameters for comAdobeCqSocialCommonsEmailreplyImplAndroidEmailClientProvider
 */
class ComAdobeCqSocialCommonsEmailreplyImplAndroidEmailClientProviderQueryData
{
    /**
