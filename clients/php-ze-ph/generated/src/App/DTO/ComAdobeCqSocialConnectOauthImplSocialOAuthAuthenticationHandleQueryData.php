...
/**
 * Query parameters for comAdobeCqSocialConnectOauthImplSocialOAuthAuthenticationHandle
 */
class ComAdobeCqSocialConnectOauthImplSocialOAuthAuthenticationHandleQueryData
{
    /**
