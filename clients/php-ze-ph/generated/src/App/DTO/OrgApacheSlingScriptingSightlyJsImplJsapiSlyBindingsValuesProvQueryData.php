...
/**
 * Query parameters for orgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProv
 */
class OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvQueryData
{
    /**
