...
/**
 * Query parameters for comAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderService
 */
class ComAdobeCqWcmJobsAsyncImplAsyncPageMoveConfigProviderServiceQueryData
{
    /**
