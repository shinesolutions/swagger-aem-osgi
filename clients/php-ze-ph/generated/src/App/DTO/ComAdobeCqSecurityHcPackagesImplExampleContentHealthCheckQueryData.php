...
/**
 * Query parameters for comAdobeCqSecurityHcPackagesImplExampleContentHealthCheck
 */
class ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckQueryData
{
    /**
