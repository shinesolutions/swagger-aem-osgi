...
/**
 * Query parameters for comAdobeGraniteTranslationConnectorMsftCoreImplMicrosoftTransl
 */
class ComAdobeGraniteTranslationConnectorMsftCoreImplMicrosoftTranslQueryData
{
    /**
