...
/**
 * Query parameters for comDayCqMailerDefaultMailService
 */
class ComDayCqMailerDefaultMailServiceQueryData
{
    /**
     * @DTA\Data(field="smtp.password", nullable=true)
    ...
    public $apply;
    /**
     * @DTA\Data(field="smtp.host", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    ...
    public $delete;
    /**
     * @DTA\Data(field="smtp.user", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $smtp_user;
    /**
     * @DTA\Data(field="debug.email", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    ...
    public $post;
    /**
     * @DTA\Data(field="smtp.port", nullable=true)
    ...
    public $smtp_port;
    /**
     * @DTA\Data(field="smtp.ssl", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
    ...
    public $action;
    /**
     * @DTA\Data(field="smtp.starttls", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"bool"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"bool"})
     * @var bool
     */
