...
/**
 * Query parameters for comAdobeCqUiWcmCommonsInternalServletsRteRTEFilterServletFact
 */
class ComAdobeCqUiWcmCommonsInternalServletsRteRTEFilterServletFactQueryData
{
    /**
