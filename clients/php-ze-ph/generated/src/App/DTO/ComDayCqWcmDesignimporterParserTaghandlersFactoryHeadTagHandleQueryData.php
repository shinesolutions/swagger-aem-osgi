...
/**
 * Query parameters for comDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandle
 */
class ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleQueryData
{
    /**
