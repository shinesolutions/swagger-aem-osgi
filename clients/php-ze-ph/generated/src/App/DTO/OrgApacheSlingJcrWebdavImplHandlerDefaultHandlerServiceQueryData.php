...
/**
 * Query parameters for orgApacheSlingJcrWebdavImplHandlerDefaultHandlerService
 */
class OrgApacheSlingJcrWebdavImplHandlerDefaultHandlerServiceQueryData
{
    /**
    ...
    public $propertylist;
    /**
     * @DTA\Data(field="type.content", nullable=true)
    ...
    public $type_content;
    /**
     * @DTA\Data(field="type.collections", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $type_collections;
    /**
    ...
    public $location;
    /**
     * @DTA\Data(field="type.noncollections", nullable=true)
     * @DTA\Strategy(name="QueryParameter", options={"type":"string"})
     * @DTA\Validator(name="QueryParameterType", options={"type":"string"})
     * @var string
     */
    public $type_noncollections;
    /**
