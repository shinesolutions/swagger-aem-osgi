...
/**
 * Query parameters for comAdobeCqSocialAccountverificationImplAccountManagementConfigIm
 */
class ComAdobeCqSocialAccountverificationImplAccountManagementConfigImQueryData
{
    /**
