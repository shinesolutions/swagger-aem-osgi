...
class ComDayCqWidgetImplWidgetExtensionProviderImplInfo
{
     ...
     * @DTA\Validator(name="Dictionary", options={"type":\App\DTO\ComDayCqWidgetImplWidgetExtensionProviderImplProperties::class})
     * @var \App\DTO\ComDayCqWidgetImplWidgetExtensionProviderImplProperties
     */
    public $properties;
    /**
