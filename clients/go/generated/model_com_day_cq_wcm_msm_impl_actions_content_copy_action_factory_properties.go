...
type ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties struct {
	...
	ContentcopyactionOrderStyle ConfigNodePropertyDropDown `json:"contentcopyaction.order.style,omitempty"`
}
