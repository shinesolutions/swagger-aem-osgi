...
type ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties struct {
	...
	CqWcmMsmActionIgnoredMixin ConfigNodePropertyArray `json:"cq.wcm.msm.action.ignoredMixin,omitempty"`
}
