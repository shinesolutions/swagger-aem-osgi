...
void
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::cleanup() {
...
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::fromJson(QString json) {
...
void
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::fromJsonObject(QJsonObject pJson) {
...
QString
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::asJson ()
{
...
QJsonObject
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::asJsonObject() {
    QJsonObject obj;
...
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::getFieldWhitelist() {
    return field_whitelist;
}
void
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::setFieldWhitelist(OAIConfigNodePropertyArray* field_whitelist) {
    this->field_whitelist = field_whitelist;
    this->m_field_whitelist_isSet = true;
}

OAIConfigNodePropertyArray*
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::getAttachmentTypeBlacklist() {
    return attachment_type_blacklist;
}
void
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::setAttachmentTypeBlacklist(OAIConfigNodePropertyArray* attachment_type_blacklist) {
...
bool
OAIComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::isSet(){
