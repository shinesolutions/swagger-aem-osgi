...
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::cleanup() {
...
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::fromJson(QString json) {
...
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::fromJsonObject(QJsonObject pJson) {
...
QString
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::asJson ()
{
...
QJsonObject
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::asJsonObject() {
    QJsonObject obj;
...
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getSolrZkTimeout() {
    return solr_zk_timeout;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setSolrZkTimeout(OAIConfigNodePropertyString* solr_zk_timeout) {
    this->solr_zk_timeout = solr_zk_timeout;
    this->m_solr_zk_timeout_isSet = true;
}

OAIConfigNodePropertyString*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getSolrCommit() {
    return solr_commit;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setSolrCommit(OAIConfigNodePropertyString* solr_commit) {
    this->solr_commit = solr_commit;
    this->m_solr_commit_isSet = true;
}

OAIConfigNodePropertyBoolean*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getCacheOn() {
    return cache_on;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setCacheOn(OAIConfigNodePropertyBoolean* cache_on) {
    this->cache_on = cache_on;
    this->m_cache_on_isSet = true;
}

OAIConfigNodePropertyInteger*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getConcurrencyLevel() {
    return concurrency_level;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setConcurrencyLevel(OAIConfigNodePropertyInteger* concurrency_level) {
    this->concurrency_level = concurrency_level;
    this->m_concurrency_level_isSet = true;
}

OAIConfigNodePropertyInteger*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getCacheStartSize() {
    return cache_start_size;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setCacheStartSize(OAIConfigNodePropertyInteger* cache_start_size) {
    this->cache_start_size = cache_start_size;
    this->m_cache_start_size_isSet = true;
}

OAIConfigNodePropertyInteger*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getCacheTtl() {
    return cache_ttl;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setCacheTtl(OAIConfigNodePropertyInteger* cache_ttl) {
    this->cache_ttl = cache_ttl;
    this->m_cache_ttl_isSet = true;
}

OAIConfigNodePropertyInteger*
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::getCacheSize() {
    return cache_size;
}
void
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::setCacheSize(OAIConfigNodePropertyInteger* cache_size) {
...
bool
OAIComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties::isSet(){
