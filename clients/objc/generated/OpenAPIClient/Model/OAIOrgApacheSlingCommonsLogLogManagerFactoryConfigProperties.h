...
@interface OAIOrgApacheSlingCommonsLogLogManagerFactoryConfigProperties : OAIObject
...
@property(nonatomic) OAIConfigNodePropertyArray* orgApacheSlingCommonsLogNames;

@property(nonatomic) OAIConfigNodePropertyBoolean* orgApacheSlingCommonsLogAdditiv;
