...
@interface OAIComDayCqDamCommonsUtilImplAssetCacheImplProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyInteger* largeFileMin;

@property(nonatomic) OAIConfigNodePropertyBoolean* cacheApply;

@property(nonatomic) OAIConfigNodePropertyArray* mimeTypes;
