...
@interface OAIComAdobeGraniteRepositoryServiceUserConfigurationProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyInteger* serviceRanking;

@property(nonatomic) OAIConfigNodePropertyBoolean* serviceusersSimpleSubjectPopulation;

@property(nonatomic) OAIConfigNodePropertyArray* serviceusersList;
