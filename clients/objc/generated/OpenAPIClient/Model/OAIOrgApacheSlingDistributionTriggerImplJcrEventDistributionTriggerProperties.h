...
@interface OAIOrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerProperties : OAIObject
...
@property(nonatomic) OAIConfigNodePropertyArray* ignoredPathsPatterns;

@property(nonatomic) OAIConfigNodePropertyString* serviceName;

@property(nonatomic) OAIConfigNodePropertyBoolean* deep;
