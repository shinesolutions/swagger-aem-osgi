...
@interface OAIOrgApacheSlingCaconfigImplOverrideOsgiConfigurationOverrideProviProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyString* _description;

@property(nonatomic) OAIConfigNodePropertyArray* overrides;
