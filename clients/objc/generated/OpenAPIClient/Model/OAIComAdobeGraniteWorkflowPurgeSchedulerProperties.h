...
@protocol OAIComAdobeGraniteWorkflowPurgeSchedulerProperties
@end

@interface OAIComAdobeGraniteWorkflowPurgeSchedulerProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyString* scheduledpurgeName;

@property(nonatomic) OAIConfigNodePropertyDropDown* scheduledpurgeWorkflowStatus;

@property(nonatomic) OAIConfigNodePropertyArray* scheduledpurgeModelIds;
