...
@class OAIOrgApacheFelixHttpProperties;



@protocol OAIOrgApacheFelixHttpInfo
@end

@interface OAIOrgApacheFelixHttpInfo : OAIObject
...
@property(nonatomic) OAIOrgApacheFelixHttpProperties* properties;
