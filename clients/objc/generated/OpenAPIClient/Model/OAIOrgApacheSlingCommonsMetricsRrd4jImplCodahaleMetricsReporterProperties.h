...
@interface OAIOrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyArray* datasources;

@property(nonatomic) OAIConfigNodePropertyInteger* step;

@property(nonatomic) OAIConfigNodePropertyArray* archives;
