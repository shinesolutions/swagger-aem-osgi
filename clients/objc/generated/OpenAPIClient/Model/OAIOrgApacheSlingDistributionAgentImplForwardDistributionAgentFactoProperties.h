...
@protocol OAIOrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoProperties
@end

@interface OAIOrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoProperties : OAIObject
...
@property(nonatomic) OAIConfigNodePropertyArray* packageImporterEndpoints;

@property(nonatomic) OAIConfigNodePropertyArray* passiveQueues;

@property(nonatomic) OAIConfigNodePropertyArray* priorityQueues;

@property(nonatomic) OAIConfigNodePropertyDropDown* retryStrategy;
...
@property(nonatomic) OAIConfigNodePropertyDropDown* queueProvider;

@property(nonatomic) OAIConfigNodePropertyBoolean* asyncDelivery;
