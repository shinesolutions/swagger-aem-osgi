...
@interface OAIComDayCrxSecurityTokenImplImplTokenAuthenticationHandlerProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyString* path;

@property(nonatomic) OAIConfigNodePropertyDropDown* tokenRequiredAttr;

@property(nonatomic) OAIConfigNodePropertyString* tokenAlternateUrl;

@property(nonatomic) OAIConfigNodePropertyBoolean* tokenEncapsulated;

@property(nonatomic) OAIConfigNodePropertyArray* skipTokenRefresh;
