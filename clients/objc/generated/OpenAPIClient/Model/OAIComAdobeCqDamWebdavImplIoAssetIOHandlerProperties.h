...
@interface OAIComAdobeCqDamWebdavImplIoAssetIOHandlerProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyInteger* serviceRanking;

@property(nonatomic) OAIConfigNodePropertyString* pathPrefix;

@property(nonatomic) OAIConfigNodePropertyBoolean* createVersion;
