...
@interface OAIComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyInteger* ranking;
