...
@interface OAIOrgApacheSlingDatasourceJNDIDataSourceFactoryProperties : OAIObject
...
@property(nonatomic) OAIConfigNodePropertyString* datasourceJndiName;

@property(nonatomic) OAIConfigNodePropertyArray* jndiProperties;
