...
@interface OAIOrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyBoolean* enabled;

@property(nonatomic) OAIConfigNodePropertyArray* configRefResourceNames;

@property(nonatomic) OAIConfigNodePropertyArray* configRefPropertyNames;
