...
@protocol OAIComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties
@end

@interface OAIComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties : OAIObject


@property(nonatomic) OAIConfigNodePropertyBoolean* parameterGuavaCacheEnabled;

@property(nonatomic) OAIConfigNodePropertyString* parameterGuavaCacheParams;

@property(nonatomic) OAIConfigNodePropertyBoolean* parameterGuavaCacheReload;
