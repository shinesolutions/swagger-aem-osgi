...
data class OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties (
    val jobPeriodconsumermanagerPerioddisableDistribution: ConfigNodePropertyBoolean? = null,
    val startupPerioddelay: ConfigNodePropertyInteger? = null,
    val cleanupPeriodperiod: ConfigNodePropertyInteger? = null
) {
