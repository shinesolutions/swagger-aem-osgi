...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheFelixSystemreadyImplServicesCheckInfo :  IEquatable<OrgApacheFelixSystemreadyImplServicesCheckInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheFelixSystemreadyImplServicesCheckInfo" /> class.
        /// </summary>
        ...
        public OrgApacheFelixSystemreadyImplServicesCheckInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheFelixSystemreadyImplServicesCheckProperties properties = default(OrgApacheFelixSystemreadyImplServicesCheckProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheFelixSystemreadyImplServicesCheckInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheFelixSystemreadyImplServicesCheckInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheFelixSystemreadyImplServicesCheckInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheFelixSystemreadyImplServicesCheckInfo input)
        {
            if (input == null)
                return false;
