...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties :  IEquatable<ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties input)
        {
            if (input == null)
                return false;
