...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo :  IEquatable<OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo" /> class.
        /// </summary>
        ...
        public OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties properties = default(OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties), string additionalProperties = default(string), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceInfo input)
        {
            if (input == null)
                return false;
