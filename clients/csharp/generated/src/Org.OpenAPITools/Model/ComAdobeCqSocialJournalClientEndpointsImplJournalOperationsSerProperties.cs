...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties :  IEquatable<ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties" /> class.
        /// </summary>
        /// <param name="fieldWhitelist">fieldWhitelist.</param>
        /// <param name="attachmentTypeBlacklist">attachmentTypeBlacklist.</param>
        public ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties(ConfigNodePropertyArray fieldWhitelist = default(ConfigNodePropertyArray), ConfigNodePropertyArray attachmentTypeBlacklist = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialJournalClientEndpointsImplJournalOperationsSerProperties input)
        {
            if (input == null)
                return false;
