...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDiscoveryOakConfigInfo :  IEquatable<OrgApacheSlingDiscoveryOakConfigInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingDiscoveryOakConfigInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingDiscoveryOakConfigInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingDiscoveryOakConfigProperties properties = default(OrgApacheSlingDiscoveryOakConfigProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingDiscoveryOakConfigInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDiscoveryOakConfigInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDiscoveryOakConfigInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDiscoveryOakConfigInfo input)
        {
            if (input == null)
                return false;
