...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingResourcemergerPickerOverridingInfo :  IEquatable<OrgApacheSlingResourcemergerPickerOverridingInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingResourcemergerPickerOverridingInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingResourcemergerPickerOverridingInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingResourcemergerPickerOverridingProperties properties = default(OrgApacheSlingResourcemergerPickerOverridingProperties), string additionalProperties = default(string), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingResourcemergerPickerOverridingInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingResourcemergerPickerOverridingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingResourcemergerPickerOverridingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingResourcemergerPickerOverridingInfo input)
        {
            if (input == null)
                return false;
