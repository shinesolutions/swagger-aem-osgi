...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo :  IEquatable<OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties properties = default(OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo input)
        {
            if (input == null)
                return false;
