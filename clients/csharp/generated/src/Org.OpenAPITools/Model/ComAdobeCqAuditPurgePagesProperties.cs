...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqAuditPurgePagesProperties :  IEquatable<ComAdobeCqAuditPurgePagesProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqAuditPurgePagesProperties" /> class.
        /// </summary>
        ...
        public ComAdobeCqAuditPurgePagesProperties(ConfigNodePropertyString auditlogRuleName = default(ConfigNodePropertyString), ConfigNodePropertyString auditlogRuleContentpath = default(ConfigNodePropertyString), ConfigNodePropertyInteger auditlogRuleMinimumage = default(ConfigNodePropertyInteger), ConfigNodePropertyDropDown auditlogRuleTypes = default(ConfigNodePropertyDropDown))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqAuditPurgePagesProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqAuditPurgePagesProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqAuditPurgePagesProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqAuditPurgePagesProperties input)
        {
            if (input == null)
                return false;
