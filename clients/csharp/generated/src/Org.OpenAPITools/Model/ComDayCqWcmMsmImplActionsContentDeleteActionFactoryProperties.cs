...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties :  IEquatable<ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties" /> class.
        /// </summary>
        ...
        public ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties(ConfigNodePropertyArray cqWcmMsmActionExcludednodetypes = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedparagraphitems = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedprops = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties input)
        {
            if (input == null)
                return false;
