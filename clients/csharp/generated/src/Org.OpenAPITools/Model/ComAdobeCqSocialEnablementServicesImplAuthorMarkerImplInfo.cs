...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo :  IEquatable<ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo" /> class.
        /// </summary>
        ...
        public ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties properties = default(ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo input)
        {
            if (input == null)
                return false;
