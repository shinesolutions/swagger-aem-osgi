...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqAccountApiAccountManagementServiceInfo :  IEquatable<ComAdobeCqAccountApiAccountManagementServiceInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqAccountApiAccountManagementServiceInfo" /> class.
        /// </summary>
        ...
        public ComAdobeCqAccountApiAccountManagementServiceInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeCqAccountApiAccountManagementServiceProperties properties = default(ComAdobeCqAccountApiAccountManagementServiceProperties), string additionalProperties = default(string), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeCqAccountApiAccountManagementServiceInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeCqAccountApiAccountManagementServiceInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqAccountApiAccountManagementServiceInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqAccountApiAccountManagementServiceInfo input)
        {
            if (input == null)
                return false;
