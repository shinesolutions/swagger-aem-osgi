...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties :  IEquatable<ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties" /> class.
        /// </summary>
        ...
        /// <param name="contentcopyactionOrderStyle">contentcopyactionOrderStyle.</param>
        public ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties(ConfigNodePropertyArray cqWcmMsmActionExcludednodetypes = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedparagraphitems = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedprops = default(ConfigNodePropertyArray), ConfigNodePropertyDropDown contentcopyactionOrderStyle = default(ConfigNodePropertyDropDown))
        {
        ...
        {
            return this.Equals(input as ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsContentCopyActionFactoryProperties input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ContentcopyactionOrderStyle == input.ContentcopyactionOrderStyle ||
                    (this.ContentcopyactionOrderStyle != null &&
                    this.ContentcopyactionOrderStyle.Equals(input.ContentcopyactionOrderStyle))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ContentcopyactionOrderStyle != null)
                    hashCode = hashCode * 59 + this.ContentcopyactionOrderStyle.GetHashCode();
                return hashCode;
            }
        }
