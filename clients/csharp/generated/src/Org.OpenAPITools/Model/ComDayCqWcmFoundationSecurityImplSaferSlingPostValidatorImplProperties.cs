...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties :  IEquatable<ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties input)
        {
            if (input == null)
                return false;
