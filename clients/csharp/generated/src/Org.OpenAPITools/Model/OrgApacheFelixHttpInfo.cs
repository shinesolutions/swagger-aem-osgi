...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheFelixHttpInfo :  IEquatable<OrgApacheFelixHttpInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheFelixHttpInfo" /> class.
        /// </summary>
        ...
        public OrgApacheFelixHttpInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheFelixHttpProperties properties = default(OrgApacheFelixHttpProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheFelixHttpInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheFelixHttpInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheFelixHttpInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheFelixHttpInfo input)
        {
            if (input == null)
                return false;
