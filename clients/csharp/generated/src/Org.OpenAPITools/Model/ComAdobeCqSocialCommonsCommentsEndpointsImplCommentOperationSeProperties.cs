...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties :  IEquatable<ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties input)
        {
            if (input == null)
                return false;
