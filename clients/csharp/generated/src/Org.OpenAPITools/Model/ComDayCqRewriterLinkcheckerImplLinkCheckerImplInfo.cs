...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo :  IEquatable<ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo" /> class.
        /// </summary>
        ...
        public ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo(string pid = default(string), string title = default(string), string description = default(string), ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties properties = default(ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo);
        }

        /// <summary>
        /// Returns true if ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqRewriterLinkcheckerImplLinkCheckerImplInfo input)
        {
            if (input == null)
                return false;
