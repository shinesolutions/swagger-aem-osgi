...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties :  IEquatable<OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties" /> class.
        /// </summary>
        ...
        public OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties(ConfigNodePropertyString name = default(ConfigNodePropertyString), ConfigNodePropertyString title = default(ConfigNodePropertyString), ConfigNodePropertyString details = default(ConfigNodePropertyString), ConfigNodePropertyBoolean enabled = default(ConfigNodePropertyBoolean), ConfigNodePropertyString serviceName = default(ConfigNodePropertyString), ConfigNodePropertyDropDown logLevel = default(ConfigNodePropertyDropDown), ConfigNodePropertyBoolean queueProcessingEnabled = default(ConfigNodePropertyBoolean), ConfigNodePropertyArray packageExporterEndpoints = default(ConfigNodePropertyArray), ConfigNodePropertyInteger pullItems = default(ConfigNodePropertyInteger), ConfigNodePropertyInteger httpConnTimeout = default(ConfigNodePropertyInteger), ConfigNodePropertyString requestAuthorizationStrategyTarget = default(ConfigNodePropertyString), ConfigNodePropertyString transportSecretProviderTarget = default(ConfigNodePropertyString), ConfigNodePropertyString packageBuilderTarget = default(ConfigNodePropertyString), ConfigNodePropertyString triggersTarget = default(ConfigNodePropertyString))
        {
            this.Name = name;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties input)
        {
            if (input == null)
                return false;
