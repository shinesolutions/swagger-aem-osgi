...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqAuditPurgeReplicationProperties :  IEquatable<ComAdobeCqAuditPurgeReplicationProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqAuditPurgeReplicationProperties" /> class.
        /// </summary>
        ...
        public ComAdobeCqAuditPurgeReplicationProperties(ConfigNodePropertyString auditlogRuleName = default(ConfigNodePropertyString), ConfigNodePropertyString auditlogRuleContentpath = default(ConfigNodePropertyString), ConfigNodePropertyInteger auditlogRuleMinimumage = default(ConfigNodePropertyInteger), ConfigNodePropertyDropDown auditlogRuleTypes = default(ConfigNodePropertyDropDown))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqAuditPurgeReplicationProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqAuditPurgeReplicationProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqAuditPurgeReplicationProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqAuditPurgeReplicationProperties input)
        {
            if (input == null)
                return false;
