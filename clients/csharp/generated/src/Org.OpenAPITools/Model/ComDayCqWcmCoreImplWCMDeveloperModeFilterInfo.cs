...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo :  IEquatable<ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo" /> class.
        /// </summary>
        ...
        public ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo(string pid = default(string), string title = default(string), string description = default(string), ComDayCqWcmCoreImplWCMDeveloperModeFilterProperties properties = default(ComDayCqWcmCoreImplWCMDeveloperModeFilterProperties), string additionalProperties = default(string), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmCoreImplWCMDeveloperModeFilterInfo input)
        {
            if (input == null)
                return false;
