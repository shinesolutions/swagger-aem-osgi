...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqDamCommonsHandlerStandardImageHandlerProperties :  IEquatable<ComDayCqDamCommonsHandlerStandardImageHandlerProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqDamCommonsHandlerStandardImageHandlerProperties" /> class.
        /// </summary>
        ...
        public ComDayCqDamCommonsHandlerStandardImageHandlerProperties(ConfigNodePropertyInteger largeFileThreshold = default(ConfigNodePropertyInteger), ConfigNodePropertyInteger largeCommentThreshold = default(ConfigNodePropertyInteger), ConfigNodePropertyBoolean cqDamEnableExtMetaExtraction = default(ConfigNodePropertyBoolean))
        {
        ...
        {
            return this.Equals(input as ComDayCqDamCommonsHandlerStandardImageHandlerProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqDamCommonsHandlerStandardImageHandlerProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqDamCommonsHandlerStandardImageHandlerProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqDamCommonsHandlerStandardImageHandlerProperties input)
        {
            if (input == null)
                return false;
