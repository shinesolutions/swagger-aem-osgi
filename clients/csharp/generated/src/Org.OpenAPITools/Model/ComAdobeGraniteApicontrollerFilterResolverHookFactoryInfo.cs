...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo :  IEquatable<ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo" /> class.
        /// </summary>
        ...
        public ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeGraniteApicontrollerFilterResolverHookFactoryProperties properties = default(ComAdobeGraniteApicontrollerFilterResolverHookFactoryProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteApicontrollerFilterResolverHookFactoryInfo input)
        {
            if (input == null)
                return false;
