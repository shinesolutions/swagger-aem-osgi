...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo :  IEquatable<ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo" /> class.
        /// </summary>
        ...
        public ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo(string pid = default(string), string title = default(string), string description = default(string), ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties properties = default(ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo input)
        {
            if (input == null)
                return false;
