...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo :  IEquatable<OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties properties = default(OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo input)
        {
            if (input == null)
                return false;
