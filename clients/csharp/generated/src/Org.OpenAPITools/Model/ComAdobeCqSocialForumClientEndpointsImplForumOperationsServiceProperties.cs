...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties :  IEquatable<ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties" /> class.
        /// </summary>
        /// <param name="fieldWhitelist">fieldWhitelist.</param>
        /// <param name="attachmentTypeBlacklist">attachmentTypeBlacklist.</param>
        public ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties(ConfigNodePropertyArray fieldWhitelist = default(ConfigNodePropertyArray), ConfigNodePropertyArray attachmentTypeBlacklist = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties input)
        {
            if (input == null)
                return false;
