...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties :  IEquatable<ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties" /> class.
        /// </summary>
        /// <param name="fieldWhitelist">fieldWhitelist.</param>
        /// <param name="attachmentTypeBlacklist">attachmentTypeBlacklist.</param>
        public ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties(ConfigNodePropertyArray fieldWhitelist = default(ConfigNodePropertyArray), ConfigNodePropertyArray attachmentTypeBlacklist = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties input)
        {
            if (input == null)
                return false;
