...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteRepositoryImplCommitStatsConfigInfo :  IEquatable<ComAdobeGraniteRepositoryImplCommitStatsConfigInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeGraniteRepositoryImplCommitStatsConfigInfo" /> class.
        /// </summary>
        ...
        public ComAdobeGraniteRepositoryImplCommitStatsConfigInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeGraniteRepositoryImplCommitStatsConfigProperties properties = default(ComAdobeGraniteRepositoryImplCommitStatsConfigProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeGraniteRepositoryImplCommitStatsConfigInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteRepositoryImplCommitStatsConfigInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteRepositoryImplCommitStatsConfigInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteRepositoryImplCommitStatsConfigInfo input)
        {
            if (input == null)
                return false;
