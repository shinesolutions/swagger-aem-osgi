...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmCoreImplWarpTimeWarpFilterInfo :  IEquatable<ComDayCqWcmCoreImplWarpTimeWarpFilterInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmCoreImplWarpTimeWarpFilterInfo" /> class.
        /// </summary>
        ...
        public ComDayCqWcmCoreImplWarpTimeWarpFilterInfo(string pid = default(string), string title = default(string), string description = default(string), ComDayCqWcmCoreImplWarpTimeWarpFilterProperties properties = default(ComDayCqWcmCoreImplWarpTimeWarpFilterProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComDayCqWcmCoreImplWarpTimeWarpFilterInfo);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmCoreImplWarpTimeWarpFilterInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmCoreImplWarpTimeWarpFilterInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmCoreImplWarpTimeWarpFilterInfo input)
        {
            if (input == null)
                return false;
