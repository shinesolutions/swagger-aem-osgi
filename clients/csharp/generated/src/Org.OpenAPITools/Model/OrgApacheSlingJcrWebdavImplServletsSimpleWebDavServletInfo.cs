...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo :  IEquatable<OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties properties = default(OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo input)
        {
            if (input == null)
                return false;
