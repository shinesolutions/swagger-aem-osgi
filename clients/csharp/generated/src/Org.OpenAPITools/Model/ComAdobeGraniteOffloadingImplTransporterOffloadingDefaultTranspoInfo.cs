...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo :  IEquatable<ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo" /> class.
        /// </summary>
        ...
        public ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoProperties properties = default(ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo input)
        {
            if (input == null)
                return false;
