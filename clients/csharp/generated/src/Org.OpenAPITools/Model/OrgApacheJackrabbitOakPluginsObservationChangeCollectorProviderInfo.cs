...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo :  IEquatable<OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo" /> class.
        /// </summary>
        ...
        public OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties properties = default(OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo input)
        {
            if (input == null)
                return false;
