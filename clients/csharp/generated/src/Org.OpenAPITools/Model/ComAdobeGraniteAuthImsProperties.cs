...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteAuthImsProperties :  IEquatable<ComAdobeGraniteAuthImsProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComAdobeGraniteAuthImsProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteAuthImsProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteAuthImsProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteAuthImsProperties input)
        {
            if (input == null)
                return false;
