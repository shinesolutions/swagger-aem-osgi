...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties :  IEquatable<ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties input)
        {
            if (input == null)
                return false;
