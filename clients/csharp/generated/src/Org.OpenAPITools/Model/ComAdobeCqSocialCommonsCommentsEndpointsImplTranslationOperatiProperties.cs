...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties :  IEquatable<ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties" /> class.
        /// </summary>
        /// <param name="fieldWhitelist">fieldWhitelist.</param>
        /// <param name="attachmentTypeBlacklist">attachmentTypeBlacklist.</param>
        public ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties(ConfigNodePropertyArray fieldWhitelist = default(ConfigNodePropertyArray), ConfigNodePropertyArray attachmentTypeBlacklist = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties input)
        {
            if (input == null)
                return false;
