...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties :  IEquatable<ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties" /> class.
        /// </summary>
        /// <param name="hcName">hcName.</param>
        /// <param name="hcTags">hcTags.</param>
        /// <param name="hcMbeanName">hcMbeanName.</param>
        public ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties(ConfigNodePropertyString hcName = default(ConfigNodePropertyString), ConfigNodePropertyArray hcTags = default(ConfigNodePropertyArray), ConfigNodePropertyString hcMbeanName = default(ConfigNodePropertyString))
        {
            this.HcName = hcName;
            this.HcTags = hcTags;
        ...
        {
            return this.Equals(input as ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties input)
        {
            if (input == null)
                return false;
