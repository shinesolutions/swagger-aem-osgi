...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties :  IEquatable<ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties" /> class.
        /// </summary>
        ...
        public ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties(ConfigNodePropertyArray nodetypes = default(ConfigNodePropertyArray), ConfigNodePropertyArray ignorableprops = default(ConfigNodePropertyArray), ConfigNodePropertyString ignorablenodes = default(ConfigNodePropertyString), ConfigNodePropertyBoolean enabled = default(ConfigNodePropertyBoolean), ConfigNodePropertyString distfolders = default(ConfigNodePropertyString))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialSyncImplGroupSyncListenerImplProperties input)
        {
            if (input == null)
                return false;
