...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties :  IEquatable<OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties input)
        {
            if (input == null)
                return false;
