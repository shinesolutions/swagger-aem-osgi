...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties :  IEquatable<ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialCommonsEmailreplyImplMacmailEmailClientProviderProperties input)
        {
            if (input == null)
                return false;
