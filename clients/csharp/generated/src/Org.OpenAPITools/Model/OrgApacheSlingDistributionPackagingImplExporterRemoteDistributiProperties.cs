...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties :  IEquatable<OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties input)
        {
            if (input == null)
                return false;
