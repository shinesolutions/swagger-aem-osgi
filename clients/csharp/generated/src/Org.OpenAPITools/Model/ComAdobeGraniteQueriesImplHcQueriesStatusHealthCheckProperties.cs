...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties :  IEquatable<ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties input)
        {
            if (input == null)
                return false;
