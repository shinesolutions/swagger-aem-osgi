...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingCommonsLogLogManagerInfo :  IEquatable<OrgApacheSlingCommonsLogLogManagerInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingCommonsLogLogManagerInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingCommonsLogLogManagerInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingCommonsLogLogManagerProperties properties = default(OrgApacheSlingCommonsLogLogManagerProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingCommonsLogLogManagerInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingCommonsLogLogManagerInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingCommonsLogLogManagerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingCommonsLogLogManagerInfo input)
        {
            if (input == null)
                return false;
