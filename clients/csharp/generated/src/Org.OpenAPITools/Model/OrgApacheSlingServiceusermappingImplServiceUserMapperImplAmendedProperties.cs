...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties :  IEquatable<OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties" /> class.
        /// </summary>
        /// <param name="serviceRanking">serviceRanking.</param>
        /// <param name="userMapping">userMapping.</param>
        public OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties(ConfigNodePropertyInteger serviceRanking = default(ConfigNodePropertyInteger), ConfigNodePropertyArray userMapping = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedProperties input)
        {
            if (input == null)
                return false;
