...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo :  IEquatable<ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo" /> class.
        /// </summary>
        ...
        public ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo(string pid = default(string), string title = default(string), string description = default(string), ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties properties = default(ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo input)
        {
            if (input == null)
                return false;
