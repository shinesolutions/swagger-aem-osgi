...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo :  IEquatable<OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo" /> class.
        /// </summary>
        ...
        public OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo(string pid = default(string), string title = default(string), string description = default(string), OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvProperties properties = default(OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo input)
        {
            if (input == null)
                return false;
