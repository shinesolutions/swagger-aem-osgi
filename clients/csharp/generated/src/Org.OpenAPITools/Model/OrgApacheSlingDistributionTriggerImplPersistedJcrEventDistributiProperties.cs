...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties :  IEquatable<OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NuggetsPath == input.NuggetsPath ||
                    (this.NuggetsPath != null &&
                    this.NuggetsPath.Equals(input.NuggetsPath))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NuggetsPath != null)
                    hashCode = hashCode * 59 + this.NuggetsPath.GetHashCode();
                return hashCode;
            }
        }
