...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties :  IEquatable<ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties" /> class.
        /// </summary>
        /// <param name="disabledCipherSuites">disabledCipherSuites.</param>
        /// <param name="enabledCipherSuites">enabledCipherSuites.</param>
        public ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties(ConfigNodePropertyArray disabledCipherSuites = default(ConfigNodePropertyArray), ConfigNodePropertyArray enabledCipherSuites = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqReplicationImplTransportBinaryLessTransportHandlerProperties input)
        {
            if (input == null)
                return false;
