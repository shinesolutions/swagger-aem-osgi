...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties :  IEquatable<ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties" /> class.
        /// </summary>
        /// <param name="fieldWhitelist">fieldWhitelist.</param>
        /// <param name="attachmentTypeBlacklist">attachmentTypeBlacklist.</param>
        public ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties(ConfigNodePropertyArray fieldWhitelist = default(ConfigNodePropertyArray), ConfigNodePropertyArray attachmentTypeBlacklist = default(ConfigNodePropertyArray))
        {
        ...
        {
            return this.Equals(input as ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties input)
        {
            if (input == null)
                return false;
