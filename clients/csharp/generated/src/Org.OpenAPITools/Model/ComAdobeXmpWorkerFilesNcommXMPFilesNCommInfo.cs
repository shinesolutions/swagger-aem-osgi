...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo :  IEquatable<ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo" /> class.
        /// </summary>
        ...
        public ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo(string pid = default(string), string title = default(string), string description = default(string), ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties properties = default(ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties), string bundleLocation = default(string), string serviceLocation = default(string))
        {
            this.Pid = pid;
            this.Title = title;
        ...
        {
            return this.Equals(input as ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo);
        }

        /// <summary>
        /// Returns true if ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo input)
        {
            if (input == null)
                return false;
