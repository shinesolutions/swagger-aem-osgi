...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties :  IEquatable<ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties" /> class.
        /// </summary>
        /// <param name="hcName">hcName.</param>
        /// <param name="hcTags">hcTags.</param>
        /// <param name="hcMbeanName">hcMbeanName.</param>
        public ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties(ConfigNodePropertyString hcName = default(ConfigNodePropertyString), ConfigNodePropertyArray hcTags = default(ConfigNodePropertyArray), ConfigNodePropertyString hcMbeanName = default(ConfigNodePropertyString))
        {
            this.HcName = hcName;
            this.HcTags = hcTags;
        ...
        {
            return this.Equals(input as ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties input)
        {
            if (input == null)
                return false;
