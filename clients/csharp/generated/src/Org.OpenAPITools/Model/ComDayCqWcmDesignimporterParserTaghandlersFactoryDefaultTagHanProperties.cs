...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties :  IEquatable<ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties input)
        {
            if (input == null)
                return false;
