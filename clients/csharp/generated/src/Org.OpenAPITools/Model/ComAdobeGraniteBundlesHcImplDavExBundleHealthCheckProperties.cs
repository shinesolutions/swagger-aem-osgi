...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties :  IEquatable<ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties);
        }

        /// <summary>
        /// Returns true if ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties input)
        {
            if (input == null)
                return false;
