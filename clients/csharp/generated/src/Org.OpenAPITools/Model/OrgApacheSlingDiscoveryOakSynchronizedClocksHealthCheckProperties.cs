...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties :  IEquatable<OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties" /> class.
        /// </summary>
        /// <param name="hcName">hcName.</param>
        /// <param name="hcTags">hcTags.</param>
        /// <param name="hcMbeanName">hcMbeanName.</param>
        public OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties(ConfigNodePropertyString hcName = default(ConfigNodePropertyString), ConfigNodePropertyArray hcTags = default(ConfigNodePropertyArray), ConfigNodePropertyString hcMbeanName = default(ConfigNodePropertyString))
        {
            this.HcName = hcName;
            this.HcTags = hcTags;
        ...
        {
            return this.Equals(input as OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties input)
        {
            if (input == null)
                return false;
