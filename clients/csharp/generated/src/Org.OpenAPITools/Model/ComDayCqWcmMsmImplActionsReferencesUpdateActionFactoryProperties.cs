...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties :  IEquatable<ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties" /> class.
        /// </summary>
        ...
        /// <param name="cqWcmMsmImplActionReferencesupdatePropUpdateNested">cqWcmMsmImplActionReferencesupdatePropUpdateNested.</param>
        public ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties(ConfigNodePropertyArray cqWcmMsmActionExcludednodetypes = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedparagraphitems = default(ConfigNodePropertyArray), ConfigNodePropertyArray cqWcmMsmActionExcludedprops = default(ConfigNodePropertyArray), ConfigNodePropertyBoolean cqWcmMsmImplActionReferencesupdatePropUpdateNested = default(ConfigNodePropertyBoolean))
        {
        ...
        {
            return this.Equals(input as ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties);
        }

        /// <summary>
        /// Returns true if ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CqWcmMsmImplActionReferencesupdatePropUpdateNested == input.CqWcmMsmImplActionReferencesupdatePropUpdateNested ||
                    (this.CqWcmMsmImplActionReferencesupdatePropUpdateNested != null &&
                    this.CqWcmMsmImplActionReferencesupdatePropUpdateNested.Equals(input.CqWcmMsmImplActionReferencesupdatePropUpdateNested))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CqWcmMsmImplActionReferencesupdatePropUpdateNested != null)
                    hashCode = hashCode * 59 + this.CqWcmMsmImplActionReferencesupdatePropUpdateNested.GetHashCode();
                return hashCode;
            }
        }
