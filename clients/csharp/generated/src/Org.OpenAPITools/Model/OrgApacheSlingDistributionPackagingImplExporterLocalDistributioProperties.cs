...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties :  IEquatable<OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties);
        }

        /// <summary>
        /// Returns true if OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties input)
        {
            if (input == null)
                return false;
