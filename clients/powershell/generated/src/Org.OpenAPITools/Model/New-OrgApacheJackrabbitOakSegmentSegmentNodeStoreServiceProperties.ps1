function New-OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties -ArgumentList @(
            ${repositoryPeriodhome},
            ${tarmkPeriodmode},
            ${tarmkPeriodsize},
            ${segmentCachePeriodsize},
