...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Adobe Experience Manager OSGI config (AEM) API'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{1B637B04-C591-4D54-B815-FADCCFC5B274}' # Has to be static, otherwise each new build will be considered different module
