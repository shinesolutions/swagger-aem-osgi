...
class COM_ADOBE_CQ_HC_CONTENT_PACKAGES_HEALTH_CHECK_PROPERTIES 
...
feature --Access
    ...
    package_names: detachable CONFIG_NODE_PROPERTY_ARRAY 
...
feature -- Change Element  
    ...
    set_package_names (a_name: like package_names)
        -- Set 'package_names' with 'a_name'.
      do
        package_names := a_name
      ensure
        package_names_set: package_names = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass COM_ADOBE_CQ_HC_CONTENT_PACKAGES_HEALTH_CHECK_PROPERTIES%N")
        ...
        if attached package_names as l_package_names then
          Result.append ("%Npackage_names:")
          Result.append (l_package_names.out)
          Result.append ("%N")    
        end  
      end
end
