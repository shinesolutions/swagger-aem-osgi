...
class ORG_APACHE_JACKRABBIT_OAK_SEGMENT_SEGMENT_NODE_STORE_FACTORY_PROPERTIES 
...
feature --Access
    ...
    register_descriptors: detachable CONFIG_NODE_PROPERTY_BOOLEAN 
      
    dispatch_changes: detachable CONFIG_NODE_PROPERTY_BOOLEAN 
...
feature -- Change Element  
    ...
    set_register_descriptors (a_name: like register_descriptors)
        -- Set 'register_descriptors' with 'a_name'.
      do
        register_descriptors := a_name
      ensure
        register_descriptors_set: register_descriptors = a_name		
      end

    set_dispatch_changes (a_name: like dispatch_changes)
        -- Set 'dispatch_changes' with 'a_name'.
      do
        dispatch_changes := a_name
      ensure
        dispatch_changes_set: dispatch_changes = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass ORG_APACHE_JACKRABBIT_OAK_SEGMENT_SEGMENT_NODE_STORE_FACTORY_PROPERTIES%N")
        ...
        if attached register_descriptors as l_register_descriptors then
          Result.append ("%Nregister_descriptors:")
          Result.append (l_register_descriptors.out)
          Result.append ("%N")    
        end  
        if attached dispatch_changes as l_dispatch_changes then
          Result.append ("%Ndispatch_changes:")
          Result.append (l_dispatch_changes.out)
          Result.append ("%N")    
        end  
      end
end
