...
class ORG_APACHE_SLING_DISTRIBUTION_TRIGGER_IMPL_PERSISTED_JCR_EVENT_DISTRIBUTI_PROPERTIES 
...
feature --Access
    ...
    nuggets_path: detachable CONFIG_NODE_PROPERTY_STRING 
...
feature -- Change Element  
    ...
    set_nuggets_path (a_name: like nuggets_path)
        -- Set 'nuggets_path' with 'a_name'.
      do
        nuggets_path := a_name
      ensure
        nuggets_path_set: nuggets_path = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass ORG_APACHE_SLING_DISTRIBUTION_TRIGGER_IMPL_PERSISTED_JCR_EVENT_DISTRIBUTI_PROPERTIES%N")
        ...
        if attached nuggets_path as l_nuggets_path then
          Result.append ("%Nnuggets_path:")
          Result.append (l_nuggets_path.out)
          Result.append ("%N")    
        end  
      end
end
