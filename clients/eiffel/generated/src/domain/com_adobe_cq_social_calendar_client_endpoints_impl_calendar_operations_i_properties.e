...
class COM_ADOBE_CQ_SOCIAL_CALENDAR_CLIENT_ENDPOINTS_IMPL_CALENDAR_OPERATIONS_I_PROPERTIES 
...
feature --Access
    ...
    max_retry: detachable CONFIG_NODE_PROPERTY_INTEGER 
...
feature -- Change Element  
    ...
    set_max_retry (a_name: like max_retry)
        -- Set 'max_retry' with 'a_name'.
      do
        max_retry := a_name
      ensure
        max_retry_set: max_retry = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass COM_ADOBE_CQ_SOCIAL_CALENDAR_CLIENT_ENDPOINTS_IMPL_CALENDAR_OPERATIONS_I_PROPERTIES%N")
        if attached max_retry as l_max_retry then
          Result.append ("%Nmax_retry:")
          Result.append (l_max_retry.out)
          Result.append ("%N")    
        end  
