...
public:
    ...
    /// 
    /// </summary>
    ComDayCqReplicationImplReplicatorImplProperties getProperties() const;
    void setProperties(ComDayCqReplicationImplReplicatorImplProperties const& value);
...
protected:
    ...
    ComDayCqReplicationImplReplicatorImplProperties m_Properties;
