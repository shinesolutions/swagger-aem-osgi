...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqSocialTranslationImplUGCLanguageDetectorProperties getProperties() const;
    void setProperties(ComAdobeCqSocialTranslationImplUGCLanguageDetectorProperties const& value);
...
protected:
    ...
    ComAdobeCqSocialTranslationImplUGCLanguageDetectorProperties m_Properties;
