...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamInddImplServletSnippetCreationServletProperties getProperties() const;
    void setProperties(ComDayCqDamInddImplServletSnippetCreationServletProperties const& value);
...
protected:
    ...
    ComDayCqDamInddImplServletSnippetCreationServletProperties m_Properties;
