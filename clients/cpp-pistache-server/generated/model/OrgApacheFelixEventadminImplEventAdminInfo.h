...
public:
    ...
    /// 
    /// </summary>
    OrgApacheFelixEventadminImplEventAdminProperties getProperties() const;
    void setProperties(OrgApacheFelixEventadminImplEventAdminProperties const& value);
...
protected:
    ...
    OrgApacheFelixEventadminImplEventAdminProperties m_Properties;
