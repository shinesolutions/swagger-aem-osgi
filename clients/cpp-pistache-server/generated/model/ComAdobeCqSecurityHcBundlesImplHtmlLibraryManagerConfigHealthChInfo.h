...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChProperties getProperties() const;
    void setProperties(ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChProperties const& value);
...
protected:
    ...
    ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChProperties m_Properties;
