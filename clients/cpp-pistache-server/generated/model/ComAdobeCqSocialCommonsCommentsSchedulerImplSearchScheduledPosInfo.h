...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties getProperties() const;
    void setProperties(ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties const& value);
...
protected:
    ...
    ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties m_Properties;
