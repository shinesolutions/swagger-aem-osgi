...
public:
    ...
    /// 
    /// </summary>
    ComDayCqReplicationImplReverseReplicatorProperties getProperties() const;
    void setProperties(ComDayCqReplicationImplReverseReplicatorProperties const& value);
...
protected:
    ...
    ComDayCqReplicationImplReverseReplicatorProperties m_Properties;
