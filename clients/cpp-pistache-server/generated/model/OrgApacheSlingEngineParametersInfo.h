...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingEngineParametersProperties getProperties() const;
    void setProperties(OrgApacheSlingEngineParametersProperties const& value);
...
protected:
    ...
    OrgApacheSlingEngineParametersProperties m_Properties;
