...
nlohmann::json ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::toJson() const
{
...
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::fromJson(nlohmann::json& val)
{
    ...
    if(val.find("properties") != val.end())
    {
        ...
        {
            ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplProperties newItem;
...
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::setPid(std::string const& value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::setTitle(std::string const& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::setDescription(std::string const& value)
{
    m_Description = value;
...
ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplProperties ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::getProperties() const
{
    return m_Properties;
}
void ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplInfo::setProperties(ComDayCqDamCoreImplMimeTypeDamMimeTypeServiceImplProperties const& value)
{
    m_Properties = value;
