...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingEngineImplLogRequestLoggerProperties getProperties() const;
    void setProperties(OrgApacheSlingEngineImplLogRequestLoggerProperties const& value);
...
protected:
    ...
    OrgApacheSlingEngineImplLogRequestLoggerProperties m_Properties;
