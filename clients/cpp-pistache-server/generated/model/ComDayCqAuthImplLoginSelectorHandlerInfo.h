...
public:
    ...
    /// 
    /// </summary>
    ComDayCqAuthImplLoginSelectorHandlerProperties getProperties() const;
    void setProperties(ComDayCqAuthImplLoginSelectorHandlerProperties const& value);
...
protected:
    ...
    ComDayCqAuthImplLoginSelectorHandlerProperties m_Properties;
