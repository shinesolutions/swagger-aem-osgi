...
public:
    ...
    /// 
    /// </summary>
    OrgApacheAriesJmxFrameworkStateConfigProperties getProperties() const;
    void setProperties(OrgApacheAriesJmxFrameworkStateConfigProperties const& value);
...
protected:
    ...
    OrgApacheAriesJmxFrameworkStateConfigProperties m_Properties;
