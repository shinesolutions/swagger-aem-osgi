...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties getProperties() const;
    void setProperties(ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties const& value);
...
protected:
    ...
    ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties m_Properties;
