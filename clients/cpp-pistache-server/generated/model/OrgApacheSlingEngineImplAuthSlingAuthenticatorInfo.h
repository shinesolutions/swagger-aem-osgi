...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties getProperties() const;
    void setProperties(OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties const& value);
...
protected:
    ...
    OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties m_Properties;
