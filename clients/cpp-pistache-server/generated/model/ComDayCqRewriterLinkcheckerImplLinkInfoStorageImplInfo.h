...
public:
    ...
    /// 
    /// </summary>
    ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties getProperties() const;
    void setProperties(ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties const& value);
...
protected:
    ...
    ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties m_Properties;
