...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteAuthImsImplIMSInstanceCredentialsValidatorProperties getProperties() const;
    void setProperties(ComAdobeGraniteAuthImsImplIMSInstanceCredentialsValidatorProperties const& value);
...
protected:
    ...
    ComAdobeGraniteAuthImsImplIMSInstanceCredentialsValidatorProperties m_Properties;
