...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties getProperties() const;
    void setProperties(ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties const& value);
...
protected:
    ...
    ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties m_Properties;
