...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreMvtMVTStatisticsImplProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreMvtMVTStatisticsImplProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreMvtMVTStatisticsImplProperties m_Properties;
