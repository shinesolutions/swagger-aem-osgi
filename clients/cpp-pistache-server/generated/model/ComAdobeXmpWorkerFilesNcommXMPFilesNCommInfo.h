...
public:
    ...
    /// 
    /// </summary>
    ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties getProperties() const;
    void setProperties(ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties const& value);
...
protected:
    ...
    ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties m_Properties;
