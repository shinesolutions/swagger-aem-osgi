...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqHistoryImplHistoryServiceImplProperties getProperties() const;
    void setProperties(ComAdobeCqHistoryImplHistoryServiceImplProperties const& value);
...
protected:
    ...
    ComAdobeCqHistoryImplHistoryServiceImplProperties m_Properties;
