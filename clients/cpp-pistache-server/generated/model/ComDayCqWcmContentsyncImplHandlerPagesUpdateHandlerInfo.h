...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmContentsyncImplHandlerPagesUpdateHandlerProperties getProperties() const;
    void setProperties(ComDayCqWcmContentsyncImplHandlerPagesUpdateHandlerProperties const& value);
...
protected:
    ...
    ComDayCqWcmContentsyncImplHandlerPagesUpdateHandlerProperties m_Properties;
