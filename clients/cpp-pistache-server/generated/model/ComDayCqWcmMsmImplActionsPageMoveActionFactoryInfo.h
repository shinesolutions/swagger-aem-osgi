...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties getProperties() const;
    void setProperties(ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties const& value);
...
protected:
    ...
    ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties m_Properties;
