...
public:
    ...
    /// 
    /// </summary>
    OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties getProperties() const;
    void setProperties(OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties const& value);
...
protected:
    ...
    OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties m_Properties;
