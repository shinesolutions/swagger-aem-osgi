...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties getProperties() const;
    void setProperties(ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties const& value);
...
protected:
    ...
    ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties m_Properties;
