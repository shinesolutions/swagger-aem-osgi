...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties getProperties() const;
    void setProperties(OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties const& value);
...
protected:
    ...
    OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties m_Properties;
