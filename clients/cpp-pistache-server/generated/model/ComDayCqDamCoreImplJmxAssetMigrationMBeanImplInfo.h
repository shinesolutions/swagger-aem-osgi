...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamCoreImplJmxAssetMigrationMBeanImplProperties getProperties() const;
    void setProperties(ComDayCqDamCoreImplJmxAssetMigrationMBeanImplProperties const& value);
...
protected:
    ...
    ComDayCqDamCoreImplJmxAssetMigrationMBeanImplProperties m_Properties;
