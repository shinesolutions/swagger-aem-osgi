...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamCoreImplServletDamContentDispositionFilterProperties getProperties() const;
    void setProperties(ComDayCqDamCoreImplServletDamContentDispositionFilterProperties const& value);
...
protected:
    ...
    ComDayCqDamCoreImplServletDamContentDispositionFilterProperties m_Properties;
