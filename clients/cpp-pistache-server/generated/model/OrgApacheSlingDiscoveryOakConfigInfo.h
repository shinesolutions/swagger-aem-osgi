...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingDiscoveryOakConfigProperties getProperties() const;
    void setProperties(OrgApacheSlingDiscoveryOakConfigProperties const& value);
...
protected:
    ...
    OrgApacheSlingDiscoveryOakConfigProperties m_Properties;
