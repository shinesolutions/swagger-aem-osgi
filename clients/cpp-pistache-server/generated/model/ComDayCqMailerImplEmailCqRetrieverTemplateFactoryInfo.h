...
public:
    ...
    /// 
    /// </summary>
    ComDayCqMailerImplEmailCqRetrieverTemplateFactoryProperties getProperties() const;
    void setProperties(ComDayCqMailerImplEmailCqRetrieverTemplateFactoryProperties const& value);
...
protected:
    ...
    ComDayCqMailerImplEmailCqRetrieverTemplateFactoryProperties m_Properties;
