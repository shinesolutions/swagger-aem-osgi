...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties getProperties() const;
    void setProperties(OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties const& value);
...
protected:
    ...
    OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties m_Properties;
