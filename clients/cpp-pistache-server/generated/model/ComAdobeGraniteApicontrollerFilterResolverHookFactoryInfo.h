...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteApicontrollerFilterResolverHookFactoryProperties getProperties() const;
    void setProperties(ComAdobeGraniteApicontrollerFilterResolverHookFactoryProperties const& value);
...
protected:
    ...
    ComAdobeGraniteApicontrollerFilterResolverHookFactoryProperties m_Properties;
