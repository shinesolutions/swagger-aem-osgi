...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties getProperties() const;
    void setProperties(ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties const& value);
...
protected:
    ...
    ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties m_Properties;
