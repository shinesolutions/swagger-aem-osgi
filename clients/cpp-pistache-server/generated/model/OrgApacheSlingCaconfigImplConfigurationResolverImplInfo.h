...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingCaconfigImplConfigurationResolverImplProperties getProperties() const;
    void setProperties(OrgApacheSlingCaconfigImplConfigurationResolverImplProperties const& value);
...
protected:
    ...
    OrgApacheSlingCaconfigImplConfigurationResolverImplProperties m_Properties;
