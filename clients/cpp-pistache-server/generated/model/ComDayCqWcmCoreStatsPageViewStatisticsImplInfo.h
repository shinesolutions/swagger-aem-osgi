...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreStatsPageViewStatisticsImplProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreStatsPageViewStatisticsImplProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreStatsPageViewStatisticsImplProperties m_Properties;
