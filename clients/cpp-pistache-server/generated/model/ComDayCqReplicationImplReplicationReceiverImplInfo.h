...
public:
    ...
    /// 
    /// </summary>
    ComDayCqReplicationImplReplicationReceiverImplProperties getProperties() const;
    void setProperties(ComDayCqReplicationImplReplicationReceiverImplProperties const& value);
...
protected:
    ...
    ComDayCqReplicationImplReplicationReceiverImplProperties m_Properties;
