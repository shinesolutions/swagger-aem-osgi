...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamCoreImplMimeTypeAssetUploadRestrictionHelperProperties getProperties() const;
    void setProperties(ComDayCqDamCoreImplMimeTypeAssetUploadRestrictionHelperProperties const& value);
...
protected:
    ...
    ComDayCqDamCoreImplMimeTypeAssetUploadRestrictionHelperProperties m_Properties;
