...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingServletsGetDefaultGetServletProperties getProperties() const;
    void setProperties(OrgApacheSlingServletsGetDefaultGetServletProperties const& value);
...
protected:
    ...
    OrgApacheSlingServletsGetDefaultGetServletProperties m_Properties;
