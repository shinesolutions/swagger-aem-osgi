...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqDamMacSyncImplDAMSyncServiceImplProperties getProperties() const;
    void setProperties(ComAdobeCqDamMacSyncImplDAMSyncServiceImplProperties const& value);
...
protected:
    ...
    ComAdobeCqDamMacSyncImplDAMSyncServiceImplProperties m_Properties;
