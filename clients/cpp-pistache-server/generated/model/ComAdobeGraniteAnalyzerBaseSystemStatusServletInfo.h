...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties getProperties() const;
    void setProperties(ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties const& value);
...
protected:
    ...
    ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties m_Properties;
