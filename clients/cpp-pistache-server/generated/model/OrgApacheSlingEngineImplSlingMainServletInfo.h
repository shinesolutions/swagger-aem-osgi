...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingEngineImplSlingMainServletProperties getProperties() const;
    void setProperties(OrgApacheSlingEngineImplSlingMainServletProperties const& value);
...
protected:
    ...
    OrgApacheSlingEngineImplSlingMainServletProperties m_Properties;
