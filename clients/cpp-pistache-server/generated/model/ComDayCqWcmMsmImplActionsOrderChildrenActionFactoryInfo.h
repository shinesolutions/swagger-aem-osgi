...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties getProperties() const;
    void setProperties(ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties const& value);
...
protected:
    ...
    ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties m_Properties;
