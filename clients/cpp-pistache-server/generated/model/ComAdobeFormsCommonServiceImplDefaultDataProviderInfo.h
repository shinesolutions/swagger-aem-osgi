...
public:
    ...
    /// 
    /// </summary>
    ComAdobeFormsCommonServiceImplDefaultDataProviderProperties getProperties() const;
    void setProperties(ComAdobeFormsCommonServiceImplDefaultDataProviderProperties const& value);
...
protected:
    ...
    ComAdobeFormsCommonServiceImplDefaultDataProviderProperties m_Properties;
