...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteCsrfImplCSRFFilterProperties getProperties() const;
    void setProperties(ComAdobeGraniteCsrfImplCSRFFilterProperties const& value);
...
protected:
    ...
    ComAdobeGraniteCsrfImplCSRFFilterProperties m_Properties;
