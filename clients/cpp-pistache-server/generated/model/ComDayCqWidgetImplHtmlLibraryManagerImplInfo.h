...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWidgetImplHtmlLibraryManagerImplProperties getProperties() const;
    void setProperties(ComDayCqWidgetImplHtmlLibraryManagerImplProperties const& value);
...
protected:
    ...
    ComDayCqWidgetImplHtmlLibraryManagerImplProperties m_Properties;
