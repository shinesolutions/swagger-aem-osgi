...
public:
    ...
    /// 
    /// </summary>
    ComDayCrxSecurityTokenImplImplTokenAuthenticationHandlerProperties getProperties() const;
    void setProperties(ComDayCrxSecurityTokenImplImplTokenAuthenticationHandlerProperties const& value);
...
protected:
    ...
    ComDayCrxSecurityTokenImplImplTokenAuthenticationHandlerProperties m_Properties;
