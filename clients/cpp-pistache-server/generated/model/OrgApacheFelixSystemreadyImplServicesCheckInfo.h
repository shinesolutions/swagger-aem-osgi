...
public:
    ...
    /// 
    /// </summary>
    OrgApacheFelixSystemreadyImplServicesCheckProperties getProperties() const;
    void setProperties(OrgApacheFelixSystemreadyImplServicesCheckProperties const& value);
...
protected:
    ...
    OrgApacheFelixSystemreadyImplServicesCheckProperties m_Properties;
