...
public:
    ...
    /// 
    /// </summary>
    OrgApacheFelixJaasConfigurationSpiProperties getProperties() const;
    void setProperties(OrgApacheFelixJaasConfigurationSpiProperties const& value);
...
protected:
    ...
    OrgApacheFelixJaasConfigurationSpiProperties m_Properties;
