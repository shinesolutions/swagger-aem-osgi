...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties getProperties() const;
    void setProperties(OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties const& value);
...
protected:
    ...
    OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties m_Properties;
