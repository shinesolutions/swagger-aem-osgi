...
public:
    ...
    /// 
    /// </summary>
    ComDayCqCommonsServletsRootMappingServletProperties getProperties() const;
    void setProperties(ComDayCqCommonsServletsRootMappingServletProperties const& value);
...
protected:
    ...
    ComDayCqCommonsServletsRootMappingServletProperties m_Properties;
