...
public:
    ...
    /// 
    /// </summary>
    ComAdobeAemTransactionCoreImplTransactionRecorderProperties getProperties() const;
    void setProperties(ComAdobeAemTransactionCoreImplTransactionRecorderProperties const& value);
...
protected:
    ...
    ComAdobeAemTransactionCoreImplTransactionRecorderProperties m_Properties;
