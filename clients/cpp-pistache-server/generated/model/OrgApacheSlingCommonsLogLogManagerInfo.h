...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingCommonsLogLogManagerProperties getProperties() const;
    void setProperties(OrgApacheSlingCommonsLogLogManagerProperties const& value);
...
protected:
    ...
    OrgApacheSlingCommonsLogLogManagerProperties m_Properties;
