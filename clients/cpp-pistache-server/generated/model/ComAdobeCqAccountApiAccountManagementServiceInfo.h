...
public:
    ...
    /// 
    /// </summary>
    ComAdobeCqAccountApiAccountManagementServiceProperties getProperties() const;
    void setProperties(ComAdobeCqAccountApiAccountManagementServiceProperties const& value);
...
protected:
    ...
    ComAdobeCqAccountApiAccountManagementServiceProperties m_Properties;
