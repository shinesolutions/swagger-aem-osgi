...
nlohmann::json ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::toJson() const
{
...
void ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::fromJson(nlohmann::json& val)
{
...
ConfigNodePropertyArray ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::getCqWcmMsmActionExcludednodetypes() const
{
    return m_Cq_wcm_msm_action_excludednodetypes;
}
void ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::setCqWcmMsmActionExcludednodetypes(ConfigNodePropertyArray const& value)
{
...
ConfigNodePropertyArray ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::getCqWcmMsmActionExcludedparagraphitems() const
{
    return m_Cq_wcm_msm_action_excludedparagraphitems;
}
void ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::setCqWcmMsmActionExcludedparagraphitems(ConfigNodePropertyArray const& value)
{
...
ConfigNodePropertyArray ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::getCqWcmMsmActionExcludedprops() const
{
    return m_Cq_wcm_msm_action_excludedprops;
}
void ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties::setCqWcmMsmActionExcludedprops(ConfigNodePropertyArray const& value)
{
