...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamVideoImplServletVideoTestServletProperties getProperties() const;
    void setProperties(ComDayCqDamVideoImplServletVideoTestServletProperties const& value);
...
protected:
    ...
    ComDayCqDamVideoImplServletVideoTestServletProperties m_Properties;
