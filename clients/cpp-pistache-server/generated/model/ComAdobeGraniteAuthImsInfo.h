...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteAuthImsProperties getProperties() const;
    void setProperties(ComAdobeGraniteAuthImsProperties const& value);
...
protected:
    ...
    ComAdobeGraniteAuthImsProperties m_Properties;
