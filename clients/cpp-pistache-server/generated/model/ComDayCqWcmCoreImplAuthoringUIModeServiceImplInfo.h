...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties m_Properties;
