...
public:
    ...
    /// 
    /// </summary>
    ComDayCqReplicationAuditReplicationEventListenerProperties getProperties() const;
    void setProperties(ComDayCqReplicationAuditReplicationEventListenerProperties const& value);
...
protected:
    ...
    ComDayCqReplicationAuditReplicationEventListenerProperties m_Properties;
