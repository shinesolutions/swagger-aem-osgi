...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmMsmImplRolloutManagerImplProperties getProperties() const;
    void setProperties(ComDayCqWcmMsmImplRolloutManagerImplProperties const& value);
...
protected:
    ...
    ComDayCqWcmMsmImplRolloutManagerImplProperties m_Properties;
