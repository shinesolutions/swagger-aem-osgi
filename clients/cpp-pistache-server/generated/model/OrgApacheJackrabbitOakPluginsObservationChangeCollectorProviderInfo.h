...
public:
    ...
    /// 
    /// </summary>
    OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties getProperties() const;
    void setProperties(OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties const& value);
...
protected:
    ...
    OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties m_Properties;
