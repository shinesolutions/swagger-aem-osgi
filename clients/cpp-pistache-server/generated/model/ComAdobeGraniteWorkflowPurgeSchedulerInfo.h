...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteWorkflowPurgeSchedulerProperties getProperties() const;
    void setProperties(ComAdobeGraniteWorkflowPurgeSchedulerProperties const& value);
...
protected:
    ...
    ComAdobeGraniteWorkflowPurgeSchedulerProperties m_Properties;
