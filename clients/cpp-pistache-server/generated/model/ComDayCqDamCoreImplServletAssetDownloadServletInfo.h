...
public:
    ...
    /// 
    /// </summary>
    ComDayCqDamCoreImplServletAssetDownloadServletProperties getProperties() const;
    void setProperties(ComDayCqDamCoreImplServletAssetDownloadServletProperties const& value);
...
protected:
    ...
    ComDayCqDamCoreImplServletAssetDownloadServletProperties m_Properties;
