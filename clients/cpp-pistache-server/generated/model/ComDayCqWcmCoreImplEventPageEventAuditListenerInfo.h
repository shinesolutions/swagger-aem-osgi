...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreImplEventPageEventAuditListenerProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreImplEventPageEventAuditListenerProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreImplEventPageEventAuditListenerProperties m_Properties;
