...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingSecurityImplReferrerFilterProperties getProperties() const;
    void setProperties(OrgApacheSlingSecurityImplReferrerFilterProperties const& value);
...
protected:
    ...
    OrgApacheSlingSecurityImplReferrerFilterProperties m_Properties;
