...
public:
    ...
    /// 
    /// </summary>
    ComAdobeGraniteRepositoryImplCommitStatsConfigProperties getProperties() const;
    void setProperties(ComAdobeGraniteRepositoryImplCommitStatsConfigProperties const& value);
...
protected:
    ...
    ComAdobeGraniteRepositoryImplCommitStatsConfigProperties m_Properties;
