...
public:
    ...
    /// 
    /// </summary>
    OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties getProperties() const;
    void setProperties(OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties const& value);
...
protected:
    ...
    OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties m_Properties;
