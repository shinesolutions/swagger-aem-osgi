...
public:
    ...
    /// 
    /// </summary>
    ComDayCqSecurityACLSetupProperties getProperties() const;
    void setProperties(ComDayCqSecurityACLSetupProperties const& value);
...
protected:
    ...
    ComDayCqSecurityACLSetupProperties m_Properties;
