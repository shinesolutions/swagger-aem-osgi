...
public:
    ...
    /// 
    /// </summary>
    OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties getProperties() const;
    void setProperties(OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties const& value);
...
protected:
    ...
    OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties m_Properties;
