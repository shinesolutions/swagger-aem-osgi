...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreImplWCMDebugFilterProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreImplWCMDebugFilterProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreImplWCMDebugFilterProperties m_Properties;
