...
public:
    ...
    /// 
    /// </summary>
    OrgApacheSlingXssImplXSSFilterImplProperties getProperties() const;
    void setProperties(OrgApacheSlingXssImplXSSFilterImplProperties const& value);
...
protected:
    ...
    OrgApacheSlingXssImplXSSFilterImplProperties m_Properties;
