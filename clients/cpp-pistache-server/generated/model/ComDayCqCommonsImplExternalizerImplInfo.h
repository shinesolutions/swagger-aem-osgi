...
public:
    ...
    /// 
    /// </summary>
    ComDayCqCommonsImplExternalizerImplProperties getProperties() const;
    void setProperties(ComDayCqCommonsImplExternalizerImplProperties const& value);
...
protected:
    ...
    ComDayCqCommonsImplExternalizerImplProperties m_Properties;
