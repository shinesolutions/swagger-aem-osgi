...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmUndoUndoConfigProperties getProperties() const;
    void setProperties(ComDayCqWcmUndoUndoConfigProperties const& value);
...
protected:
    ...
    ComDayCqWcmUndoUndoConfigProperties m_Properties;
