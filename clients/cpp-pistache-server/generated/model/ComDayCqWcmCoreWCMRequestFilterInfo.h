...
public:
    ...
    /// 
    /// </summary>
    ComDayCqWcmCoreWCMRequestFilterProperties getProperties() const;
    void setProperties(ComDayCqWcmCoreWCMRequestFilterProperties const& value);
...
protected:
    ...
    ComDayCqWcmCoreWCMRequestFilterProperties m_Properties;
