...
#
package WWW::OpenAPIClient::Object::ComAdobeCqAuditPurgeReplicationProperties;
...
__PACKAGE__->method_documentation({
    ...
    'auditlog/rule/contentpath' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'auditlog.rule.contentpath',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auditlog/rule/minimumage' => {
    	...
    	base_name => 'auditlog.rule.minimumage',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'auditlog/rule/name' => 'auditlog.rule.name',
    'auditlog/rule/contentpath' => 'auditlog.rule.contentpath',
    'auditlog/rule/minimumage' => 'auditlog.rule.minimumage',
