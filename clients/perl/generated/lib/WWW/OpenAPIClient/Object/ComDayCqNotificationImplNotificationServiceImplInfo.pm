...
#
package WWW::OpenAPIClient::Object::ComDayCqNotificationImplNotificationServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqNotificationImplNotificationServiceImplProperties',
