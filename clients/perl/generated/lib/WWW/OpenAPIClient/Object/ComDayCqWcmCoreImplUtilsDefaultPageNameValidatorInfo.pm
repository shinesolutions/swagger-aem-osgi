...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorProperties',
