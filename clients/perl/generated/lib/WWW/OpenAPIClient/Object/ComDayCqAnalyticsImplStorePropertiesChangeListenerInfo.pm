...
#
package WWW::OpenAPIClient::Object::ComDayCqAnalyticsImplStorePropertiesChangeListenerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqAnalyticsImplStorePropertiesChangeListenerProperties',
