...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitOakPluginsIndexSolrOsgiRemoteSolrServerConfProperties;
...
__PACKAGE__->method_documentation({
    ...
    'solr/connection/timeout' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'solr.connection.timeout',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'solr/replication/factor' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'solr.replication.factor',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'solr/http/url' => 'solr.http.url',
    'solr/zk/host' => 'solr.zk.host',
    'solr/collection' => 'solr.collection',
    'solr/socket/timeout' => 'solr.socket.timeout',
    'solr/connection/timeout' => 'solr.connection.timeout',
    'solr/shards/no' => 'solr.shards.no',
    'solr/replication/factor' => 'solr.replication.factor',
    'solr/conf/dir' => 'solr.conf.dir'
} );
