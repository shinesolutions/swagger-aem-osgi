...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmNotificationImplNotificationManagerImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmNotificationImplNotificationManagerImplProperties',
