...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmDesignimporterImplEntryPreprocessorImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmDesignimporterImplEntryPreprocessorImplProperties',
