...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletProperties;
...
__PACKAGE__->method_documentation({
    ...
    'oauth/revocation/active' => {
    	...
    	base_name => 'oauth.revocation.active',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'oauth/revocation/active' => 'oauth.revocation.active'
} );
