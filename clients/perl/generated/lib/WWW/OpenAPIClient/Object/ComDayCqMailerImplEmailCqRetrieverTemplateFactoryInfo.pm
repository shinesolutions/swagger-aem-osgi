...
#
package WWW::OpenAPIClient::Object::ComDayCqMailerImplEmailCqRetrieverTemplateFactoryInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqMailerImplEmailCqRetrieverTemplateFactoryProperties',
