...
#
package WWW::OpenAPIClient::Object::ComDayCqDamIdsImplIDSPoolManagerImplProperties;
...
__PACKAGE__->method_documentation({
    'max/errors/to/blacklist' => {
    	...
    	base_name => 'max.errors.to.blacklist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'retry/interval/to/whitelist' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'retry.interval.to.whitelist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'max/errors/to/blacklist' => 'max.errors.to.blacklist',
    'retry/interval/to/whitelist' => 'retry.interval.to.whitelist',
    'connect/timeout' => 'connect.timeout',
    'socket/timeout' => 'socket.timeout',
    'process/label' => 'process.label',
    'connection/use/max' => 'connection.use.max'
} );
