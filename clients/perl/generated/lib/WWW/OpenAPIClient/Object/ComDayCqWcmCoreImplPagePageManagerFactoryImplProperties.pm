...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmCoreImplPagePageManagerFactoryImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'page_sub_tree_activation_check' => {
    	...
    	base_name => 'pageSubTreeActivationCheck',
    	description => '',
    	format => '',
    	read_only => '',
    		},
