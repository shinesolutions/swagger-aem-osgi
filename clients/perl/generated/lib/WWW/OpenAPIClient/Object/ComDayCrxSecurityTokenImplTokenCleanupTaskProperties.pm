...
#
package WWW::OpenAPIClient::Object::ComDayCrxSecurityTokenImplTokenCleanupTaskProperties;
...
__PACKAGE__->method_documentation({
    'enable/token/cleanup/task' => {
    	...
    	base_name => 'enable.token.cleanup.task',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'enable/token/cleanup/task' => 'enable.token.cleanup.task',
