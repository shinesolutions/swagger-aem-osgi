...
#
package WWW::OpenAPIClient::Object::ComAdobeCqCdnRewriterImplCDNConfigServiceImplProperties;
...
__PACKAGE__->method_documentation({
    'cdn/config/distribution/domain' => {
    	...
    	base_name => 'cdn.config.distribution.domain',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cdn/config/enable/rewriting' => {
    	...
    	base_name => 'cdn.config.enable.rewriting',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cdn/config/path/prefixes' => {
    	...
    	base_name => 'cdn.config.path.prefixes',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'cdn/config/application/protocol' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cdn.config.application.protocol',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cdn/config/distribution/domain' => 'cdn.config.distribution.domain',
    'cdn/config/enable/rewriting' => 'cdn.config.enable.rewriting',
    'cdn/config/path/prefixes' => 'cdn.config.path.prefixes',
    'cdn/config/cdnttl' => 'cdn.config.cdnttl',
    'cdn/config/application/protocol' => 'cdn.config.application.protocol'
} );
