...
#
package WWW::OpenAPIClient::Object::OrgApacheFelixWebconsoleInternalServletOsgiManagerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheFelixWebconsoleInternalServletOsgiManagerProperties',
