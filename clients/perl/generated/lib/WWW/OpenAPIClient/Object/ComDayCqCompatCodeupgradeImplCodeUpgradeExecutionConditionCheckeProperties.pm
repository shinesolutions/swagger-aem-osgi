...
#
package WWW::OpenAPIClient::Object::ComDayCqCompatCodeupgradeImplCodeUpgradeExecutionConditionCheckeProperties;
...
__PACKAGE__->method_documentation({
    ...
    'codeupgradetaskfilters' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'codeupgradetaskfilters',
    	description => '',
    	format => '',
    	read_only => '',
    		},
