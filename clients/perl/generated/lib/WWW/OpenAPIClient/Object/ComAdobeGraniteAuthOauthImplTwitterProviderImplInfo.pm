...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteAuthOauthImplTwitterProviderImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteAuthOauthImplTwitterProviderImplProperties',
