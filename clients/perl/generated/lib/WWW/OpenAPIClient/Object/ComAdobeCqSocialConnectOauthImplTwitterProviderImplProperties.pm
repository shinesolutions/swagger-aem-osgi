...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialConnectOauthImplTwitterProviderImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'provider/config/twitter/enable/params' => {
    	...
    	base_name => 'provider.config.twitter.enable.params',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/twitter/params' => {
    	...
    	base_name => 'provider.config.twitter.params',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'provider/config/twitter/enable/params' => 'provider.config.twitter.enable.params',
    'provider/config/twitter/params' => 'provider.config.twitter.params',
