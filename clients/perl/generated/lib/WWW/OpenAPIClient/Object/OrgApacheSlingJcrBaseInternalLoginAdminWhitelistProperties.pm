...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingJcrBaseInternalLoginAdminWhitelistProperties;
...
__PACKAGE__->method_documentation({
    ...
    'whitelist/bundles/regexp' => {
    	...
    	base_name => 'whitelist.bundles.regexp',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'whitelist/bundles/regexp' => 'whitelist.bundles.regexp'
} );
