...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteCsrfImplCSRFFilterProperties;
...
__PACKAGE__->method_documentation({
    ...
    'filter/enable/safe/user/agents' => {
    	...
    	base_name => 'filter.enable.safe.user.agents',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'filter/safe/user/agents' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'filter.safe.user.agents',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'filter/excluded/paths' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'filter.excluded.paths',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'filter/enable/safe/user/agents' => 'filter.enable.safe.user.agents',
    'filter/safe/user/agents' => 'filter.safe.user.agents',
    'filter/excluded/paths' => 'filter.excluded.paths'
} );
