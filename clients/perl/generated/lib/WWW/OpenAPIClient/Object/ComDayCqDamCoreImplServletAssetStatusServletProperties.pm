...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplServletAssetStatusServletProperties;
...
__PACKAGE__->method_documentation({
    'cq/dam/batch/status/maxassets' => {
    	...
    	base_name => 'cq.dam.batch.status.maxassets',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/dam/batch/status/maxassets' => 'cq.dam.batch.status.maxassets'
} );
