...
#
package WWW::OpenAPIClient::Object::ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplProperties;
...
__PACKAGE__->method_documentation({
    'cq/commerce/asset/handler/fallback' => {
    	...
    	base_name => 'cq.commerce.asset.handler.fallback',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/commerce/asset/handler/fallback' => 'cq.commerce.asset.handler.fallback'
} );
