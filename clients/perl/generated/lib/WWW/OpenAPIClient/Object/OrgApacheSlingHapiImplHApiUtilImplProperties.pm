...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHapiImplHApiUtilImplProperties;
...
__PACKAGE__->method_documentation({
    'org/apache/sling/hapi/tools/resourcetype' => {
    	...
    	base_name => 'org.apache.sling.hapi.tools.resourcetype',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'org/apache/sling/hapi/tools/collectionresourcetype' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'org.apache.sling.hapi.tools.collectionresourcetype',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'org/apache/sling/hapi/tools/searchpaths' => {
    	...
    	base_name => 'org.apache.sling.hapi.tools.searchpaths',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'org/apache/sling/hapi/tools/externalurl' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'org.apache.sling.hapi.tools.externalurl',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'org/apache/sling/hapi/tools/enabled' => {
    	...
    	base_name => 'org.apache.sling.hapi.tools.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'org/apache/sling/hapi/tools/resourcetype' => 'org.apache.sling.hapi.tools.resourcetype',
    'org/apache/sling/hapi/tools/collectionresourcetype' => 'org.apache.sling.hapi.tools.collectionresourcetype',
    'org/apache/sling/hapi/tools/searchpaths' => 'org.apache.sling.hapi.tools.searchpaths',
    'org/apache/sling/hapi/tools/externalurl' => 'org.apache.sling.hapi.tools.externalurl',
    'org/apache/sling/hapi/tools/enabled' => 'org.apache.sling.hapi.tools.enabled'
} );
