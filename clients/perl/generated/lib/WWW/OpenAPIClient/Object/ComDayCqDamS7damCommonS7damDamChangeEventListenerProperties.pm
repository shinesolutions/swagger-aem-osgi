...
#
package WWW::OpenAPIClient::Object::ComDayCqDamS7damCommonS7damDamChangeEventListenerProperties;
...
__PACKAGE__->method_documentation({
    'cq/dam/s7dam/damchangeeventlistener/enabled' => {
    	...
    	base_name => 'cq.dam.s7dam.damchangeeventlistener.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/dam/s7dam/damchangeeventlistener/enabled' => 'cq.dam.s7dam.damchangeeventlistener.enabled'
} );
