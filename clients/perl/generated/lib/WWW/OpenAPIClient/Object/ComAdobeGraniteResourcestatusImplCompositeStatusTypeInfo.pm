...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteResourcestatusImplCompositeStatusTypeInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteResourcestatusImplCompositeStatusTypeProperties',
