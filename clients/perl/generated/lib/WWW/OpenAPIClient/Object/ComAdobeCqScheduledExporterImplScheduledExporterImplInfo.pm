...
#
package WWW::OpenAPIClient::Object::ComAdobeCqScheduledExporterImplScheduledExporterImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqScheduledExporterImplScheduledExporterImplProperties',
