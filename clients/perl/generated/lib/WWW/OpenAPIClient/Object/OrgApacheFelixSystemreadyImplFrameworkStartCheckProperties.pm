...
#
package WWW::OpenAPIClient::Object::OrgApacheFelixSystemreadyImplFrameworkStartCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'target/start/level/prop/name' => {
    	...
    	base_name => 'target.start.level.prop.name',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'timeout' => 'timeout',
    'target/start/level' => 'target.start.level',
    'target/start/level/prop/name' => 'target.start.level.prop.name',
    'type' => 'type'
} );
