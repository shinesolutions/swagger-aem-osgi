...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCommonsHandlerStandardImageHandlerProperties;
...
__PACKAGE__->method_documentation({
    'large_file_threshold' => {
    	...
    	base_name => 'large_file_threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'large_comment_threshold' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'large_comment_threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/dam/enable/ext/meta/extraction' => {
    	...
    	base_name => 'cq.dam.enable.ext.meta.extraction',
    	description => '',
    	format => '',
    	read_only => '',
    		},
