...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingJcrResourcesecurityImplResourceAccessGateFactoryProperties;
...
__PACKAGE__->attribute_map( {
    'path' => 'path',
    'checkpath/prefix' => 'checkpath.prefix',
    'jcr_path' => 'jcrPath'
} );
