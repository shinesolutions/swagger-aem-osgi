...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingEventImplJobsJobConsumerManagerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'job/consumermanager/whitelist' => {
    	...
    	base_name => 'job.consumermanager.whitelist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'job/consumermanager/blacklist' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'job.consumermanager.blacklist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'job/consumermanager/whitelist' => 'job.consumermanager.whitelist',
    'job/consumermanager/blacklist' => 'job.consumermanager.blacklist'
} );
