...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    'number/of/retries/allowed' => {
    	...
    	base_name => 'number.of.retries.allowed',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'number/of/retries/allowed' => 'number.of.retries.allowed',
    'hc/tags' => 'hc.tags'
} );
