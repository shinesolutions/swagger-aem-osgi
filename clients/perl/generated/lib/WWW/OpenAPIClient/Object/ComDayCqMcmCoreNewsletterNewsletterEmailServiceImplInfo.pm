...
#
package WWW::OpenAPIClient::Object::ComDayCqMcmCoreNewsletterNewsletterEmailServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqMcmCoreNewsletterNewsletterEmailServiceImplProperties',
