...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingSecurityImplReferrerFilterProperties;
...
__PACKAGE__->method_documentation({
    ...
    'exclude/agents/regexp' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'exclude.agents.regexp',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'allow/hosts/regexp' => 'allow.hosts.regexp',
    'filter/methods' => 'filter.methods',
    'exclude/agents/regexp' => 'exclude.agents.regexp'
} );
