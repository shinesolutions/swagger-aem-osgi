...
#
package WWW::OpenAPIClient::Object::ComDayCqSearchpromoteImplSearchPromoteServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqSearchpromoteImplSearchPromoteServiceImplProperties',
