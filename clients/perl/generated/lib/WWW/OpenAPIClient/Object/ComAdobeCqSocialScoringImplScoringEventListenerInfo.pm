...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialScoringImplScoringEventListenerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialScoringImplScoringEventListenerProperties',
