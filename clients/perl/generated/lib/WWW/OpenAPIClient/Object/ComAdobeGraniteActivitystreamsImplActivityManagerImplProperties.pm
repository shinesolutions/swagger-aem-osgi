...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteActivitystreamsImplActivityManagerImplProperties;
...
__PACKAGE__->method_documentation({
    'aggregate/relationships' => {
    	...
    	base_name => 'aggregate.relationships',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'aggregate/descend/virtual' => {
    	...
    	base_name => 'aggregate.descend.virtual',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'aggregate/descend/virtual' => 'aggregate.descend.virtual'
} );
