...
#
package WWW::OpenAPIClient::Object::AdaptiveFormAndInteractiveCommunicationWebChannelConfigurationProperties;
...
__PACKAGE__->method_documentation({
    ...
    'af/scripting/compatversion' => {
    	...
    	base_name => 'af.scripting.compatversion',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'generating_compliant_data' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'generatingCompliantData',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'af/scripting/compatversion' => 'af.scripting.compatversion',
