...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsLogLogManagerFactoryConfigInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties',
