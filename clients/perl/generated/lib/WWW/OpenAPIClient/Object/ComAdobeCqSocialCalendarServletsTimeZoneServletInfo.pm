...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialCalendarServletsTimeZoneServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialCalendarServletsTimeZoneServletProperties',
