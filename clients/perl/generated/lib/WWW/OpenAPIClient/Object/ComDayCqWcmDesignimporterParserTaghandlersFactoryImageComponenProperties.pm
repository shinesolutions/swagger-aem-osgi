...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenProperties;
...
__PACKAGE__->method_documentation({
    ...
    'component/resource_type' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'component.resourceType',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'component/resource_type' => 'ConfigNodePropertyString'
} );

__PACKAGE__->attribute_map( {
    'service/ranking' => 'service.ranking',
    'tagpattern' => 'tagpattern',
    'component/resource_type' => 'component.resourceType'
} );
