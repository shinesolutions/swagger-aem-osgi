...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingEngineImplSlingMainServletProperties;
...
__PACKAGE__->method_documentation({
    ...
    'sling/max/inclusions' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'sling.max.inclusions',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'sling/max/record/requests' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'sling.max.record.requests',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'sling/store/pattern/requests' => {
    	...
    	base_name => 'sling.store.pattern.requests',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'sling/additional/response/headers' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'sling.additional.response.headers',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'sling/max/calls' => 'sling.max.calls',
    'sling/max/inclusions' => 'sling.max.inclusions',
    'sling/trace/allow' => 'sling.trace.allow',
    'sling/max/record/requests' => 'sling.max.record.requests',
    'sling/store/pattern/requests' => 'sling.store.pattern.requests',
    'sling/serverinfo' => 'sling.serverinfo',
    'sling/additional/response/headers' => 'sling.additional.response.headers'
} );
