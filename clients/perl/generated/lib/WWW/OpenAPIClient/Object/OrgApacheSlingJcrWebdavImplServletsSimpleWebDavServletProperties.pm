...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties;
...
__PACKAGE__->method_documentation({
    ...
    'dav/create_absolute_uri' => {
    	...
    	base_name => 'dav.create-absolute-uri',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'dav/create_absolute_uri' => 'ConfigNodePropertyBoolean',
...
__PACKAGE__->attribute_map( {
    'dav/root' => 'dav.root',
    'dav/create_absolute_uri' => 'dav.create-absolute-uri',
    'dav/realm' => 'dav.realm',
    'collection/types' => 'collection.types',
    'filter/prefixes' => 'filter.prefixes',
    'filter/types' => 'filter.types',
    'filter/uris' => 'filter.uris',
    'type/collections' => 'type.collections',
    'type/noncollections' => 'type.noncollections',
