...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplServletResourceCollectionServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreImplServletResourceCollectionServletProperties',
