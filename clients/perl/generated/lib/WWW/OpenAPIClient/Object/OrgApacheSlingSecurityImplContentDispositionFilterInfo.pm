...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingSecurityImplContentDispositionFilterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingSecurityImplContentDispositionFilterProperties',
