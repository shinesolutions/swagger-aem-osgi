...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplUiPreviewFolderPreviewUpdaterImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreImplUiPreviewFolderPreviewUpdaterImplProperties',
