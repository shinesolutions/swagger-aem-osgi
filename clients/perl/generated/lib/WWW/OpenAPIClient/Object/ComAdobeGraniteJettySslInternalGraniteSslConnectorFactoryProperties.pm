...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryProperties;
...
__PACKAGE__->method_documentation({
    'com/adobe/granite/jetty/ssl/port' => {
    	...
    	base_name => 'com.adobe.granite.jetty.ssl.port',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/granite/jetty/ssl/keystore/user' => {
    	...
    	base_name => 'com.adobe.granite.jetty.ssl.keystore.user',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/granite/jetty/ssl/keystore/password' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'com.adobe.granite.jetty.ssl.keystore.password',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/granite/jetty/ssl/ciphersuites/excluded' => {
    	...
    	base_name => 'com.adobe.granite.jetty.ssl.ciphersuites.excluded',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/granite/jetty/ssl/ciphersuites/included' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'com.adobe.granite.jetty.ssl.ciphersuites.included',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/granite/jetty/ssl/client/certificate' => {
    	...
    	base_name => 'com.adobe.granite.jetty.ssl.client.certificate',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'com/adobe/granite/jetty/ssl/port' => 'com.adobe.granite.jetty.ssl.port',
    'com/adobe/granite/jetty/ssl/keystore/user' => 'com.adobe.granite.jetty.ssl.keystore.user',
    'com/adobe/granite/jetty/ssl/keystore/password' => 'com.adobe.granite.jetty.ssl.keystore.password',
    'com/adobe/granite/jetty/ssl/ciphersuites/excluded' => 'com.adobe.granite.jetty.ssl.ciphersuites.excluded',
    'com/adobe/granite/jetty/ssl/ciphersuites/included' => 'com.adobe.granite.jetty.ssl.ciphersuites.included',
    'com/adobe/granite/jetty/ssl/client/certificate' => 'com.adobe.granite.jetty.ssl.client.certificate'
} );
