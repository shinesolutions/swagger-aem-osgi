...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties;
...
__PACKAGE__->method_documentation({
    ...
    'config_collection_inheritance_property_names' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'configCollectionInheritancePropertyNames',
    	description => '',
    	format => '',
    	read_only => '',
    		},
