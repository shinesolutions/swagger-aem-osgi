...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDeserfwImplDeserializationFirewallImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqDeserfwImplDeserializationFirewallImplProperties',
