...
#
package WWW::OpenAPIClient::Object::ComDayCqDamStockIntegrationImplCacheStockCacheConfigurationSerProperties;
...
__PACKAGE__->method_documentation({
    'get_cache_expiration_unit' => {
    	...
    	base_name => 'getCacheExpirationUnit',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'get_cache_expiration_value' => {
    	...
    	base_name => 'getCacheExpirationValue',
    	description => '',
    	format => '',
    	read_only => '',
    		},
