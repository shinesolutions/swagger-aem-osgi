...
#
package WWW::OpenAPIClient::Object::ComAdobeCqCdnRewriterImplAWSCloudFrontRewriterProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cdnrewriter/attributes' => {
    	...
    	base_name => 'cdnrewriter.attributes',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cdn/rewriter/distribution/domain' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cdn.rewriter.distribution.domain',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'cdnrewriter/attributes' => 'cdnrewriter.attributes',
    'cdn/rewriter/distribution/domain' => 'cdn.rewriter.distribution.domain'
} );
