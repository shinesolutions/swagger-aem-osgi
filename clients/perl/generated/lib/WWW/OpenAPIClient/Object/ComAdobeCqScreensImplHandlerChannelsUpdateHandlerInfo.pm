...
#
package WWW::OpenAPIClient::Object::ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqScreensImplHandlerChannelsUpdateHandlerProperties',
