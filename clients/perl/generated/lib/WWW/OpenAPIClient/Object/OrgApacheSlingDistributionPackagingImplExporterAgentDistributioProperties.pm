...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingDistributionPackagingImplExporterAgentDistributioProperties;
...
__PACKAGE__->attribute_map( {
    'name' => 'name',
    'queue' => 'queue',
    'drop/invalid/items' => 'drop.invalid.items',
