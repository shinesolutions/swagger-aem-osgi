...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialConnectOauthImplFacebookProviderImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialConnectOauthImplFacebookProviderImplProperties',
