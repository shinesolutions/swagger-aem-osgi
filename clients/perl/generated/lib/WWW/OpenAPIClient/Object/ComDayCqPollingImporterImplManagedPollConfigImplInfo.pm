...
#
package WWW::OpenAPIClient::Object::ComDayCqPollingImporterImplManagedPollConfigImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqPollingImporterImplManagedPollConfigImplProperties',
