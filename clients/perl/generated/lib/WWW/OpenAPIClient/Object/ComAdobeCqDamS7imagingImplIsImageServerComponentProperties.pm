...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDamS7imagingImplIsImageServerComponentProperties;
...
__PACKAGE__->method_documentation({
    ...
    'random_access_url_timeout' => {
    	...
    	base_name => 'RandomAccessUrlTimeout',
    	description => '',
    	format => '',
    	read_only => '',
    		},
