...
#
package WWW::OpenAPIClient::Object::ComAdobeCqInboxImplTypeproviderItemTypeProviderInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqInboxImplTypeproviderItemTypeProviderProperties',
