...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteCompatrouterImplSwitchMappingConfigInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteCompatrouterImplSwitchMappingConfigProperties',
