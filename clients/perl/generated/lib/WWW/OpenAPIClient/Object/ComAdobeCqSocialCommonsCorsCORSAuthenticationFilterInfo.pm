...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialCommonsCorsCORSAuthenticationFilterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialCommonsCorsCORSAuthenticationFilterProperties',
