...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingJcrJackrabbitServerJndiRegistrationSupportProperties;
...
__PACKAGE__->method_documentation({
    'java/naming/factory/initial' => {
    	...
    	base_name => 'java.naming.factory.initial',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'java/naming/provider/url' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'java.naming.provider.url',
    	description => '',
    	format => '',
    	read_only => '',
    		},
