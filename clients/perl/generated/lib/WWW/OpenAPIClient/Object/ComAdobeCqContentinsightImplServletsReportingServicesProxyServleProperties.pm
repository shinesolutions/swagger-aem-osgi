...
#
package WWW::OpenAPIClient::Object::ComAdobeCqContentinsightImplServletsReportingServicesProxyServleProperties;
...
__PACKAGE__->method_documentation({
    'reportingservices/proxy/whitelist' => {
    	...
    	base_name => 'reportingservices.proxy.whitelist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'reportingservices/proxy/whitelist' => 'reportingservices.proxy.whitelist'
} );
