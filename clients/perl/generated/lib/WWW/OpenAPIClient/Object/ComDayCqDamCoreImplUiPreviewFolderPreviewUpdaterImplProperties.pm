...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplUiPreviewFolderPreviewUpdaterImplProperties;
...
__PACKAGE__->method_documentation({
    'create_preview_enabled' => {
    	...
    	base_name => 'createPreviewEnabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'update_preview_enabled' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'updatePreviewEnabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'folder_preview_rendition_regex' => {
    	...
    	base_name => 'folderPreviewRenditionRegex',
    	description => '',
    	format => '',
    	read_only => '',
    		},
