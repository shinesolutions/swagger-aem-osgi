...
#
package WWW::OpenAPIClient::Object::ComDayCqDamS7damCommonPostServletsSetModifyHandlerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamS7damCommonPostServletsSetModifyHandlerProperties',
