...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmMsmImplRolloutManagerImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'rolloutmgr/excludedprops/default' => {
    	...
    	base_name => 'rolloutmgr.excludedprops.default',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/excludedparagraphprops/default' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'rolloutmgr.excludedparagraphprops.default',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/excludednodetypes/default' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'rolloutmgr.excludednodetypes.default',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/threadpool/maxsize' => {
    	...
    	base_name => 'rolloutmgr.threadpool.maxsize',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/threadpool/maxshutdowntime' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'rolloutmgr.threadpool.maxshutdowntime',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/threadpool/priority' => {
    	...
    	base_name => 'rolloutmgr.threadpool.priority',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/commit/size' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'rolloutmgr.commit.size',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'rolloutmgr/conflicthandling/enabled' => {
    	...
    	base_name => 'rolloutmgr.conflicthandling.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'rolloutmgr/excludedprops/default' => 'rolloutmgr.excludedprops.default',
    'rolloutmgr/excludedparagraphprops/default' => 'rolloutmgr.excludedparagraphprops.default',
    'rolloutmgr/excludednodetypes/default' => 'rolloutmgr.excludednodetypes.default',
    'rolloutmgr/threadpool/maxsize' => 'rolloutmgr.threadpool.maxsize',
    'rolloutmgr/threadpool/maxshutdowntime' => 'rolloutmgr.threadpool.maxshutdowntime',
    'rolloutmgr/threadpool/priority' => 'rolloutmgr.threadpool.priority',
    'rolloutmgr/commit/size' => 'rolloutmgr.commit.size',
    'rolloutmgr/conflicthandling/enabled' => 'rolloutmgr.conflicthandling.enabled'
} );
