...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraProperties;
...
__PACKAGE__->method_documentation({
    ...
    'token_cleanup_threshold' => {
    	...
    	base_name => 'tokenCleanupThreshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
