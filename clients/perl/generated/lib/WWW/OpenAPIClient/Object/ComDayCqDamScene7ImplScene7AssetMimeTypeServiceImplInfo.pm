...
#
package WWW::OpenAPIClient::Object::ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamScene7ImplScene7AssetMimeTypeServiceImplProperties',
