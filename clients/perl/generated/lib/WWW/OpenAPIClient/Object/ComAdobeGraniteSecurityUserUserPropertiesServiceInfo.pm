...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteSecurityUserUserPropertiesServiceInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteSecurityUserUserPropertiesServiceProperties',
