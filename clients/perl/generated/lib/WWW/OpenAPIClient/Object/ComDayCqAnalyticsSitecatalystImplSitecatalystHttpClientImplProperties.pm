...
#
package WWW::OpenAPIClient::Object::ComDayCqAnalyticsSitecatalystImplSitecatalystHttpClientImplProperties;
...
__PACKAGE__->method_documentation({
    'cq/analytics/sitecatalyst/service/datacenter/url' => {
    	...
    	base_name => 'cq.analytics.sitecatalyst.service.datacenter.url',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/analytics/sitecatalyst/service/datacenter/url' => 'cq.analytics.sitecatalyst.service.datacenter.url',
