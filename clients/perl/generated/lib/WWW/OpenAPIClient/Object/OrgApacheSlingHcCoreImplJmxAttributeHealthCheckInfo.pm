...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHcCoreImplJmxAttributeHealthCheckInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingHcCoreImplJmxAttributeHealthCheckProperties',
