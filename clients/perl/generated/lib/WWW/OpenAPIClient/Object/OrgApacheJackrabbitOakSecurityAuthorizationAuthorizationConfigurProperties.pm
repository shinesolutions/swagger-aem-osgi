...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties;
...
__PACKAGE__->method_documentation({
    ...
    'administrative_principals' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'administrativePrincipals',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'configuration_ranking' => {
    	...
    	base_name => 'configurationRanking',
    	description => '',
    	format => '',
    	read_only => '',
    		},
