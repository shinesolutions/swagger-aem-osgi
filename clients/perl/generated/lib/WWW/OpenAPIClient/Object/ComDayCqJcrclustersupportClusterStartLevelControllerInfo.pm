...
#
package WWW::OpenAPIClient::Object::ComDayCqJcrclustersupportClusterStartLevelControllerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqJcrclustersupportClusterStartLevelControllerProperties',
