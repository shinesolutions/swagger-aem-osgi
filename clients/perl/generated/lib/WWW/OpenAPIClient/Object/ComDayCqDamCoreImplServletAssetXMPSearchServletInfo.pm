...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplServletAssetXMPSearchServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreImplServletAssetXMPSearchServletProperties',
