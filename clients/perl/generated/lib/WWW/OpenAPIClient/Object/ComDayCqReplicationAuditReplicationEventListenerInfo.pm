...
#
package WWW::OpenAPIClient::Object::ComDayCqReplicationAuditReplicationEventListenerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqReplicationAuditReplicationEventListenerProperties',
