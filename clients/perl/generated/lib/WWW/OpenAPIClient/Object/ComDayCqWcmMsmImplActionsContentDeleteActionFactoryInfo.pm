...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmMsmImplActionsContentDeleteActionFactoryInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties',
