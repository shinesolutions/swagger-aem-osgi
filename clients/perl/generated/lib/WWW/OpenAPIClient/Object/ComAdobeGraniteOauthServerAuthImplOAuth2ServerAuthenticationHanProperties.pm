...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteOauthServerAuthImplOAuth2ServerAuthenticationHanProperties;
...
__PACKAGE__->method_documentation({
    ...
    'oauth/offline/validation' => {
    	...
    	base_name => 'oauth.offline.validation',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'oauth/offline/validation' => 'oauth.offline.validation'
} );
