...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingSettingsImplSlingSettingsServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingSettingsImplSlingSettingsServiceImplProperties',
