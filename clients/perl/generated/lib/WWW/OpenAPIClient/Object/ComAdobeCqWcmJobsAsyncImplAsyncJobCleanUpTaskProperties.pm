...
#
package WWW::OpenAPIClient::Object::ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties;
...
__PACKAGE__->attribute_map( {
    ...
    'job/purge/threshold' => 'job.purge.threshold',
    'job/purge/max/jobs' => 'job.purge.max.jobs'
} );
