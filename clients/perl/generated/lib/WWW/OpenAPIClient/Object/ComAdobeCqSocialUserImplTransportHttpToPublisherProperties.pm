...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialUserImplTransportHttpToPublisherProperties;
...
__PACKAGE__->method_documentation({
    ...
    'disabled/cipher/suites' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'disabled.cipher.suites',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'enabled/cipher/suites' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'enabled.cipher.suites',
    	description => '',
    	format => '',
    	read_only => '',
    		},
