...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties',
