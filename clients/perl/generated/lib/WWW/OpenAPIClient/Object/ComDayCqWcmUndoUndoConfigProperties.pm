...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmUndoUndoConfigProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cq/wcm/undo/validity' => {
    	...
    	base_name => 'cq.wcm.undo.validity',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'cq/wcm/undo/persistence' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cq.wcm.undo.persistence',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/wcm/undo/persistence/mode' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'cq.wcm.undo.persistence.mode',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/wcm/undo/markermode' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cq.wcm.undo.markermode',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/wcm/undo/whitelist' => {
    	...
    	base_name => 'cq.wcm.undo.whitelist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/wcm/undo/blacklist' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'cq.wcm.undo.blacklist',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/wcm/undo/enabled' => 'cq.wcm.undo.enabled',
    'cq/wcm/undo/path' => 'cq.wcm.undo.path',
    'cq/wcm/undo/validity' => 'cq.wcm.undo.validity',
    'cq/wcm/undo/steps' => 'cq.wcm.undo.steps',
    'cq/wcm/undo/persistence' => 'cq.wcm.undo.persistence',
    'cq/wcm/undo/persistence/mode' => 'cq.wcm.undo.persistence.mode',
    'cq/wcm/undo/markermode' => 'cq.wcm.undo.markermode',
    'cq/wcm/undo/whitelist' => 'cq.wcm.undo.whitelist',
    'cq/wcm/undo/blacklist' => 'cq.wcm.undo.blacklist'
} );
