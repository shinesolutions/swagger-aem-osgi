...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'user/enable/default/mapping' => {
    	...
    	base_name => 'user.enable.default.mapping',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'user/enable/default/mapping' => 'user.enable.default.mapping',
