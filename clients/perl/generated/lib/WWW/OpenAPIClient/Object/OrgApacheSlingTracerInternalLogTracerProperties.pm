...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingTracerInternalLogTracerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'recording_cache_size_in_mb' => {
    	...
    	base_name => 'recordingCacheSizeInMB',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'recording_cache_duration_in_secs' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'recordingCacheDurationInSecs',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'recording_compression_enabled' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'recordingCompressionEnabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
