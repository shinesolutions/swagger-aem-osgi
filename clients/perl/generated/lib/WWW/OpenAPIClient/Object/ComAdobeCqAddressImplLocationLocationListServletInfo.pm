...
#
package WWW::OpenAPIClient::Object::ComAdobeCqAddressImplLocationLocationListServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqAddressImplLocationLocationListServletProperties',
