...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHcCoreImplServletHealthCheckExecutorServletProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cors/access_control_allow_origin' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cors.accessControlAllowOrigin',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'cors/access_control_allow_origin' => 'ConfigNodePropertyString'
} );

__PACKAGE__->attribute_map( {
    'servlet_path' => 'servletPath',
    'disabled' => 'disabled',
    'cors/access_control_allow_origin' => 'cors.accessControlAllowOrigin'
} );
