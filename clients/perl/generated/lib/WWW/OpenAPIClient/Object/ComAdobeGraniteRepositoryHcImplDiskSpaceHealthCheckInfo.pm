...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteRepositoryHcImplDiskSpaceHealthCheckInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteRepositoryHcImplDiskSpaceHealthCheckProperties',
