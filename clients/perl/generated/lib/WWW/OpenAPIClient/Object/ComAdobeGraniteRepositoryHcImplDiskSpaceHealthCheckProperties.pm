...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteRepositoryHcImplDiskSpaceHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'disk/space/warn/threshold' => {
    	...
    	base_name => 'disk.space.warn.threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'disk/space/error/threshold' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'disk.space.error.threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'hc/tags' => 'hc.tags',
    'disk/space/warn/threshold' => 'disk.space.warn.threshold',
    'disk/space/error/threshold' => 'disk.space.error.threshold'
} );
