...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteTaskmanagementImplJcrTaskArchiveServiceProperties;
...
__PACKAGE__->method_documentation({
    ...
    'archive/since/days/completed' => {
    	...
    	base_name => 'archive.since.days.completed',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'archiving/enabled' => 'archiving.enabled',
    'scheduler/expression' => 'scheduler.expression',
    'archive/since/days/completed' => 'archive.since.days.completed'
} );
