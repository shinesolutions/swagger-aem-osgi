...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialConnectOauthImplFacebookProviderImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'oauth/cloud/config/root' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'oauth.cloud.config.root',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/root' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'provider.config.root',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/create/tags/enabled' => {
    	...
    	base_name => 'provider.config.create.tags.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/user/folder' => {
    	...
    	base_name => 'provider.config.user.folder',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/facebook/fetch/fields' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'provider.config.facebook.fetch.fields',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/facebook/fields' => {
    	...
    	base_name => 'provider.config.facebook.fields',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'provider/config/refresh/userdata/enabled' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'provider.config.refresh.userdata.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'oauth/cloud/config/root' => 'oauth.cloud.config.root',
    'provider/config/root' => 'provider.config.root',
    'provider/config/create/tags/enabled' => 'provider.config.create.tags.enabled',
    'provider/config/user/folder' => 'provider.config.user.folder',
    'provider/config/facebook/fetch/fields' => 'provider.config.facebook.fetch.fields',
    'provider/config/facebook/fields' => 'provider.config.facebook.fields',
    'provider/config/refresh/userdata/enabled' => 'provider.config.refresh.userdata.enabled'
} );
