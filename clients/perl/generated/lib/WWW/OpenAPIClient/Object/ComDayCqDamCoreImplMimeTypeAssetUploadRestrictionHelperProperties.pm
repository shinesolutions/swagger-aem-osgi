...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplMimeTypeAssetUploadRestrictionHelperProperties;
...
__PACKAGE__->method_documentation({
    'cq/dam/allow/all/mime' => {
    	...
    	base_name => 'cq.dam.allow.all.mime',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/dam/allowed/asset/mimes' => {
    	...
    	base_name => 'cq.dam.allowed.asset.mimes',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/dam/allow/all/mime' => 'cq.dam.allow.all.mime',
    'cq/dam/allowed/asset/mimes' => 'cq.dam.allowed.asset.mimes'
} );
