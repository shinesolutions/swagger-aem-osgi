...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties;
...
__PACKAGE__->method_documentation({
    'ignore_property_name_regex' => {
    	...
    	base_name => 'ignorePropertyNameRegex',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'config_collection_properties_resource_names' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'configCollectionPropertiesResourceNames',
    	description => '',
    	format => '',
    	read_only => '',
    		},
