...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqDamMacSyncHelperImplMACSyncClientImplProperties',
