...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHcCoreImplCompositeHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'filter/combine_tags_with_or' => {
    	...
    	base_name => 'filter.combineTagsWithOr',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'filter/combine_tags_with_or' => 'ConfigNodePropertyBoolean'
} );

__PACKAGE__->attribute_map( {
    'hc/name' => 'hc.name',
    'hc/tags' => 'hc.tags',
    'hc/mbean/name' => 'hc.mbean.name',
    'filter/tags' => 'filter.tags',
    'filter/combine_tags_with_or' => 'filter.combineTagsWithOr'
} );
