...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitOakPluginsIndexAsyncIndexerServiceProperties;
...
__PACKAGE__->method_documentation({
    ...
    'failing_index_timeout_seconds' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'failingIndexTimeoutSeconds',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'error_warn_interval_seconds' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'errorWarnIntervalSeconds',
    	description => '',
    	format => '',
    	read_only => '',
    		},
