...
#
package WWW::OpenAPIClient::Object::ComDayCqPollingImporterImplPollingImporterImplProperties;
...
__PACKAGE__->method_documentation({
    'importer/min/interval' => {
    	...
    	base_name => 'importer.min.interval',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'importer/min/interval' => 'importer.min.interval',
    'importer/user' => 'importer.user',
