...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCaconfigImplDefDefaultConfigurationInheritanceStraProperties;
...
__PACKAGE__->method_documentation({
    ...
    'config_property_inheritance_property_names' => {
    	...
    	base_name => 'configPropertyInheritancePropertyNames',
    	description => '',
    	format => '',
    	read_only => '',
    		},
