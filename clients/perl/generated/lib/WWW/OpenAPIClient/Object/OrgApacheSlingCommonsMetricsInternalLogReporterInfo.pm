...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsMetricsInternalLogReporterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCommonsMetricsInternalLogReporterProperties',
