...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialConnectOauthImplTwitterProviderImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialConnectOauthImplTwitterProviderImplProperties',
