...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplProcessTextExtractionProcessInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreImplProcessTextExtractionProcessProperties',
