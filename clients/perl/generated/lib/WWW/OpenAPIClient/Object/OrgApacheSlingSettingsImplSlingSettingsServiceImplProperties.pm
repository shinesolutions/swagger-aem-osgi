...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingSettingsImplSlingSettingsServiceImplProperties;
...
__PACKAGE__->attribute_map( {
    'sling/name' => 'sling.name',
    'sling/description' => 'sling.description'
} );
