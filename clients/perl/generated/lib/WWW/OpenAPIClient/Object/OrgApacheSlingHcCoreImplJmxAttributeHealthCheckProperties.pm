...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHcCoreImplJmxAttributeHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'attribute/value/constraint' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'attribute.value.constraint',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'attribute/value/constraint' => 'attribute.value.constraint'
} );
