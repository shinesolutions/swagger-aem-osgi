...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplMissingMetadataNotificationJobProperties;
...
__PACKAGE__->method_documentation({
    'cq/dam/missingmetadata/notification/scheduler/istimebased' => {
    	...
    	base_name => 'cq.dam.missingmetadata.notification.scheduler.istimebased',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/dam/missingmetadata/notification/scheduler/timebased/rule' => {
    	...
    	base_name => 'cq.dam.missingmetadata.notification.scheduler.timebased.rule',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/dam/missingmetadata/notification/scheduler/period/rule' => {
    	...
    	base_name => 'cq.dam.missingmetadata.notification.scheduler.period.rule',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/dam/missingmetadata/notification/recipient' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cq.dam.missingmetadata.notification.recipient',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/dam/missingmetadata/notification/scheduler/istimebased' => 'cq.dam.missingmetadata.notification.scheduler.istimebased',
    'cq/dam/missingmetadata/notification/scheduler/timebased/rule' => 'cq.dam.missingmetadata.notification.scheduler.timebased.rule',
    'cq/dam/missingmetadata/notification/scheduler/period/rule' => 'cq.dam.missingmetadata.notification.scheduler.period.rule',
    'cq/dam/missingmetadata/notification/recipient' => 'cq.dam.missingmetadata.notification.recipient'
} );
