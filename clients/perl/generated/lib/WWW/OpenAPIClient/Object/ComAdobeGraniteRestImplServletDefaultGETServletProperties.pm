...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteRestImplServletDefaultGETServletProperties;
...
__PACKAGE__->attribute_map( {
    ...
    'use/absolute/uri' => 'use.absolute.uri'
} );
