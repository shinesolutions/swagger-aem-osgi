...
#
package WWW::OpenAPIClient::Object::ComAdobeFormsCommonServiceImplDefaultDataProviderInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeFormsCommonServiceImplDefaultDataProviderProperties',
