...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties;
...
__PACKAGE__->method_documentation({
    'enable_scheduled_posts_search' => {
    	...
    	base_name => 'enableScheduledPostsSearch',
    	description => '',
    	format => '',
    	read_only => '',
    		},
