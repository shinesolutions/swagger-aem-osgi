...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteWorkflowCoreWorkflowConfigProperties;
...
__PACKAGE__->method_documentation({
    'cq/workflow/config/workflow/packages/root/path' => {
    	...
    	base_name => 'cq.workflow.config.workflow.packages.root.path',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/workflow/config/workflow/process/legacy/mode' => {
    	...
    	base_name => 'cq.workflow.config.workflow.process.legacy.mode',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/workflow/config/allow/locking' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'cq.workflow.config.allow.locking',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/workflow/config/workflow/packages/root/path' => 'cq.workflow.config.workflow.packages.root.path',
    'cq/workflow/config/workflow/process/legacy/mode' => 'cq.workflow.config.workflow.process.legacy.mode',
    'cq/workflow/config/allow/locking' => 'cq.workflow.config.allow.locking'
} );
