...
#
package WWW::OpenAPIClient::Object::ComDayCqDamIdsImplIDSJobProcessorProperties;
...
__PACKAGE__->method_documentation({
    ...
    'enable/retry/scripterror' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'enable.retry.scripterror',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'externalizer/domain/cqhost' => {
    	...
    	base_name => 'externalizer.domain.cqhost',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'externalizer/domain/http' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'externalizer.domain.http',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'enable/multisession' => 'enable.multisession',
    'ids/cc/enable' => 'ids.cc.enable',
    'enable/retry' => 'enable.retry',
    'enable/retry/scripterror' => 'enable.retry.scripterror',
    'externalizer/domain/cqhost' => 'externalizer.domain.cqhost',
    'externalizer/domain/http' => 'externalizer.domain.http'
} );
