...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingEngineImplLogRequestLoggerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'request/log/outputtype' => {
    	...
    	base_name => 'request.log.outputtype',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'access/log/outputtype' => {
    	datatype => 'ConfigNodePropertyDropDown',
    	base_name => 'access.log.outputtype',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'request/log/output' => 'request.log.output',
    'request/log/outputtype' => 'request.log.outputtype',
    'request/log/enabled' => 'request.log.enabled',
    'access/log/output' => 'access.log.output',
    'access/log/outputtype' => 'access.log.outputtype',
    'access/log/enabled' => 'access.log.enabled'
} );
