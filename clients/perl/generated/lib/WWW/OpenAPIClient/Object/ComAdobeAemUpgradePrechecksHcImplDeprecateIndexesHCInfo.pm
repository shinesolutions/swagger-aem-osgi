...
#
package WWW::OpenAPIClient::Object::ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeAemUpgradePrechecksHcImplDeprecateIndexesHCProperties',
