...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteAuthImsImplIMSAccessTokenRequestCustomizerImplProperties;
...
__PACKAGE__->method_documentation({
    'auth/ims/client/secret' => {
    	...
    	base_name => 'auth.ims.client.secret',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'auth/ims/client/secret' => 'auth.ims.client.secret',
    'customizer/type' => 'customizer.type'
} );
