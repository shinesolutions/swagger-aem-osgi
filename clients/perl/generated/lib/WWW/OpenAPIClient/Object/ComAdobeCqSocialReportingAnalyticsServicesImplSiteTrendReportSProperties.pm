...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialReportingAnalyticsServicesImplSiteTrendReportSProperties;
...
__PACKAGE__->method_documentation({
    'cq/social/console/analytics/sites/mapping' => {
    	...
    	base_name => 'cq.social.console.analytics.sites.mapping',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/social/console/analytics/sites/mapping' => 'cq.social.console.analytics.sites.mapping',
    'priority' => 'priority'
} );
