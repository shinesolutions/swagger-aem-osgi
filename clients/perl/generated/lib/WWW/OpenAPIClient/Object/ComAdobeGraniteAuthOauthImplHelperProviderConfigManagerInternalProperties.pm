...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalProperties;
...
__PACKAGE__->method_documentation({
    'oauth/cookie/login/timeout' => {
    	...
    	base_name => 'oauth.cookie.login.timeout',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'oauth/cookie/max/age' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'oauth.cookie.max.age',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'oauth/cookie/login/timeout' => 'oauth.cookie.login.timeout',
    'oauth/cookie/max/age' => 'oauth.cookie.max.age'
} );
