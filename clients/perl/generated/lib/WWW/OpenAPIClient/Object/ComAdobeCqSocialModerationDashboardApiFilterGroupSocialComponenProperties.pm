...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenProperties;
...
__PACKAGE__->method_documentation({
    'resource_type/filters' => {
    	...
    	base_name => 'resourceType.filters',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    'resource_type/filters' => 'ConfigNodePropertyArray',
    'priority' => 'ConfigNodePropertyInteger'
} );

__PACKAGE__->attribute_map( {
    'resource_type/filters' => 'resourceType.filters',
    'priority' => 'priority'
} );
