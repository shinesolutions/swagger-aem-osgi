...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreImplMissingMetadataNotificationJobInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreImplMissingMetadataNotificationJobProperties',
