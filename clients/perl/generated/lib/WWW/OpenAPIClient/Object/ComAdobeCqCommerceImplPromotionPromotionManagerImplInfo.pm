...
#
package WWW::OpenAPIClient::Object::ComAdobeCqCommerceImplPromotionPromotionManagerImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties',
