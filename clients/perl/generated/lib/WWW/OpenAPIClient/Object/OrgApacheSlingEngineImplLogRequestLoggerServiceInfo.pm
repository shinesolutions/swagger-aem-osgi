...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingEngineImplLogRequestLoggerServiceInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingEngineImplLogRequestLoggerServiceProperties',
