...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmCoreImplWCMDeveloperModeFilterProperties;
...
__PACKAGE__->method_documentation({
    'wcmdevmodefilter/enabled' => {
    	...
    	base_name => 'wcmdevmodefilter.enabled',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'wcmdevmodefilter/enabled' => 'wcmdevmodefilter.enabled'
} );
