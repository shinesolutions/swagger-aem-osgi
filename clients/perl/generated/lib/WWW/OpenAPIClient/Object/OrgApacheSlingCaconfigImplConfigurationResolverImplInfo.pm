...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCaconfigImplConfigurationResolverImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCaconfigImplConfigurationResolverImplProperties',
