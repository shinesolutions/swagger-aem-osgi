...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialTranslationImplUGCLanguageDetectorInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialTranslationImplUGCLanguageDetectorProperties',
