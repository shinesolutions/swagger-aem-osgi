...
#
package WWW::OpenAPIClient::Object::ComAdobeCqInboxImplTypeproviderItemTypeProviderProperties;
...
__PACKAGE__->method_documentation({
    'inbox/impl/typeprovider/registrypaths' => {
    	...
    	base_name => 'inbox.impl.typeprovider.registrypaths',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'inbox/impl/typeprovider/legacypaths' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'inbox.impl.typeprovider.legacypaths',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'inbox/impl/typeprovider/defaulturl/failureitem' => {
    	...
    	base_name => 'inbox.impl.typeprovider.defaulturl.failureitem',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'inbox/impl/typeprovider/defaulturl/workitem' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'inbox.impl.typeprovider.defaulturl.workitem',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'inbox/impl/typeprovider/defaulturl/task' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'inbox.impl.typeprovider.defaulturl.task',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'inbox/impl/typeprovider/registrypaths' => 'inbox.impl.typeprovider.registrypaths',
    'inbox/impl/typeprovider/legacypaths' => 'inbox.impl.typeprovider.legacypaths',
    'inbox/impl/typeprovider/defaulturl/failureitem' => 'inbox.impl.typeprovider.defaulturl.failureitem',
    'inbox/impl/typeprovider/defaulturl/workitem' => 'inbox.impl.typeprovider.defaulturl.workitem',
    'inbox/impl/typeprovider/defaulturl/task' => 'inbox.impl.typeprovider.defaulturl.task'
} );
