...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsLogLogManagerFactoryWriterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCommonsLogLogManagerFactoryWriterProperties',
