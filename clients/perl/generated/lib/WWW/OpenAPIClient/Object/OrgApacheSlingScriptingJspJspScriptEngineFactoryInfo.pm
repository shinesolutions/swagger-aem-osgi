...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingScriptingJspJspScriptEngineFactoryInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingScriptingJspJspScriptEngineFactoryProperties',
