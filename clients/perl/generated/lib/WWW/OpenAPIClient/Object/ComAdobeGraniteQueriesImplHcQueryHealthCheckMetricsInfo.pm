...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteQueriesImplHcQueryHealthCheckMetricsInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteQueriesImplHcQueryHealthCheckMetricsProperties',
