...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDamMacSyncImplDAMSyncServiceImplProperties;
...
__PACKAGE__->method_documentation({
    'com/adobe/cq/dam/mac/sync/damsyncservice/registered_paths' => {
    	...
    	base_name => 'com.adobe.cq.dam.mac.sync.damsyncservice.registered_paths',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/cq/dam/mac/sync/damsyncservice/sync/renditions' => {
    	...
    	base_name => 'com.adobe.cq.dam.mac.sync.damsyncservice.sync.renditions',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/cq/dam/mac/sync/damsyncservice/replicate/thread/wait/ms' => {
    	...
    	base_name => 'com.adobe.cq.dam.mac.sync.damsyncservice.replicate.thread.wait.ms',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'com/adobe/cq/dam/mac/sync/damsyncservice/platform' => {
    	...
    	base_name => 'com.adobe.cq.dam.mac.sync.damsyncservice.platform',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'com/adobe/cq/dam/mac/sync/damsyncservice/registered_paths' => 'com.adobe.cq.dam.mac.sync.damsyncservice.registered_paths',
    'com/adobe/cq/dam/mac/sync/damsyncservice/sync/renditions' => 'com.adobe.cq.dam.mac.sync.damsyncservice.sync.renditions',
    'com/adobe/cq/dam/mac/sync/damsyncservice/replicate/thread/wait/ms' => 'com.adobe.cq.dam.mac.sync.damsyncservice.replicate.thread.wait.ms',
    'com/adobe/cq/dam/mac/sync/damsyncservice/platform' => 'com.adobe.cq.dam.mac.sync.damsyncservice.platform'
} );
