...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmCoreImplLinkCheckerConfigurationFactoryImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'link/predated/prefix' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'link.predated.prefix',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'link/predated/remove' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'link.predated.remove',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'link/predated/suffix' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'link.predated.suffix',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'link/expired/prefix' => 'link.expired.prefix',
    'link/expired/remove' => 'link.expired.remove',
    'link/expired/suffix' => 'link.expired.suffix',
    'link/invalid/prefix' => 'link.invalid.prefix',
    'link/invalid/remove' => 'link.invalid.remove',
    'link/invalid/suffix' => 'link.invalid.suffix',
    'link/predated/prefix' => 'link.predated.prefix',
    'link/predated/remove' => 'link.predated.remove',
    'link/predated/suffix' => 'link.predated.suffix',
    'link/wcmmodes' => 'link.wcmmodes'
} );
