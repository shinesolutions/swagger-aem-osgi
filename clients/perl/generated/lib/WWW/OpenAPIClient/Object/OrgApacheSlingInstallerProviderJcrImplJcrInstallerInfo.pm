...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingInstallerProviderJcrImplJcrInstallerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingInstallerProviderJcrImplJcrInstallerProperties',
