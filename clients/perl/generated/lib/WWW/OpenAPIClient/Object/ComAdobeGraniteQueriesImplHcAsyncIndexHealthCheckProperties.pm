...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteQueriesImplHcAsyncIndexHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    'indexing/critical/threshold' => {
    	...
    	base_name => 'indexing.critical.threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'indexing/warn/threshold' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'indexing.warn.threshold',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'indexing/critical/threshold' => 'indexing.critical.threshold',
    'indexing/warn/threshold' => 'indexing.warn.threshold',
    'hc/tags' => 'hc.tags'
} );
