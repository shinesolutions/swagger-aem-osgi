...
#
package WWW::OpenAPIClient::Object::ComDayCrxSecurityTokenImplImplTokenAuthenticationHandlerProperties;
...
__PACKAGE__->attribute_map( {
    'path' => 'path',
    'token/required/attr' => 'token.required.attr',
    'token/alternate/url' => 'token.alternate.url',
    'token/encapsulated' => 'token.encapsulated',
    'skip/token/refresh' => 'skip.token.refresh'
} );
