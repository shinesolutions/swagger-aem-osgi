...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuProperties;
...
__PACKAGE__->method_documentation({
    ...
    'access_token_provider/target' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'accessTokenProvider.target',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'access_token_provider/target' => 'ConfigNodePropertyString'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'user_id' => 'userId',
    'access_token_provider/target' => 'accessTokenProvider.target'
} );
