...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmFoundationFormsImplFormsHandlingServletProperties',
