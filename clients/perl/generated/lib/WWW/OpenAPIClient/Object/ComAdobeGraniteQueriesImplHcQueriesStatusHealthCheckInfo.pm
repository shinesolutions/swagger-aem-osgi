...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteQueriesImplHcQueriesStatusHealthCheckProperties',
