...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties;
...
__PACKAGE__->method_documentation({
    ...
    'queue_provider_factory/target' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'queueProviderFactory.target',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'queue_provider_factory/target' => 'ConfigNodePropertyString',
...
__PACKAGE__->attribute_map( {
    ...
    'queue_provider_factory/target' => 'queueProviderFactory.target',
