...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmFoundationImplPageImpressionsTrackerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmFoundationImplPageImpressionsTrackerProperties',
