...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreProcessMetadataProcessorProcessProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cq/dam/metadata/xssprotected/properties' => {
    	...
    	base_name => 'cq.dam.metadata.xssprotected.properties',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'cq/dam/enable/sha1' => 'cq.dam.enable.sha1',
    'cq/dam/metadata/xssprotected/properties' => 'cq.dam.metadata.xssprotected.properties'
} );
