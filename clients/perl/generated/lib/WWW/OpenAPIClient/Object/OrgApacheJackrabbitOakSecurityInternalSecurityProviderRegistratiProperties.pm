...
#
package WWW::OpenAPIClient::Object::OrgApacheJackrabbitOakSecurityInternalSecurityProviderRegistratiProperties;
...
__PACKAGE__->method_documentation({
    ...
    'authorization_composition_type' => {
    	...
    	base_name => 'authorizationCompositionType',
    	description => '',
    	format => '',
    	read_only => '',
    		},
