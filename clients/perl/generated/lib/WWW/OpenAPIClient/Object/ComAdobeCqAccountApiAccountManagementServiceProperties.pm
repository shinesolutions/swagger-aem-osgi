...
#
package WWW::OpenAPIClient::Object::ComAdobeCqAccountApiAccountManagementServiceProperties;
...
__PACKAGE__->method_documentation({
    'cq/accountmanager/token/validity/period' => {
    	...
    	base_name => 'cq.accountmanager.token.validity.period',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/accountmanager/config/requestnewaccount/mail' => {
    	...
    	base_name => 'cq.accountmanager.config.requestnewaccount.mail',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/accountmanager/config/requestnewpwd/mail' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'cq.accountmanager.config.requestnewpwd.mail',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/accountmanager/token/validity/period' => 'cq.accountmanager.token.validity.period',
    'cq/accountmanager/config/requestnewaccount/mail' => 'cq.accountmanager.config.requestnewaccount.mail',
    'cq/accountmanager/config/requestnewpwd/mail' => 'cq.accountmanager.config.requestnewpwd.mail'
} );
