...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteTranslationCoreImplTranslationManagerImplProperties;
...
__PACKAGE__->method_documentation({
    'default_connector_name' => {
    	...
    	base_name => 'defaultConnectorName',
    	description => '',
    	format => '',
    	read_only => '',
    		},
