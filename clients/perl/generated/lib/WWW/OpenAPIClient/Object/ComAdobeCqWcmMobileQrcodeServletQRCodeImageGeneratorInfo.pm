...
#
package WWW::OpenAPIClient::Object::ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorProperties',
