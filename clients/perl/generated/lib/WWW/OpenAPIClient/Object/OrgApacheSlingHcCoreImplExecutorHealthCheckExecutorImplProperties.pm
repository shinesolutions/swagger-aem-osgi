...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'long_running_future_threshold_for_critical_ms' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'longRunningFutureThresholdForCriticalMs',
    	description => '',
    	format => '',
    	read_only => '',
    		},
