...
#
package WWW::OpenAPIClient::Object::ComDayCqJcrclustersupportClusterStartLevelControllerProperties;
...
__PACKAGE__->method_documentation({
    'cluster/level/enable' => {
    	...
    	base_name => 'cluster.level.enable',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cluster/master/level' => {
    	...
    	base_name => 'cluster.master.level',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cluster/level/enable' => 'cluster.level.enable',
    'cluster/master/level' => 'cluster.master.level',
    'cluster/slave/level' => 'cluster.slave.level'
} );
