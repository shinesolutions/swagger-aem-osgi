...
#
package WWW::OpenAPIClient::Object::ComDayCqWorkflowImplEmailEMailNotificationServiceProperties;
...
__PACKAGE__->method_documentation({
    ...
    'notify/oncontainercomplete' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'notify.oncontainercomplete',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'notify/onabort' => 'notify.onabort',
    'notify/oncomplete' => 'notify.oncomplete',
    'notify/oncontainercomplete' => 'notify.oncontainercomplete',
    'notify/useronly' => 'notify.useronly'
} );
