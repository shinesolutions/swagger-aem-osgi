...
#
package WWW::OpenAPIClient::Object::ComDayCqSearchSuggestImplSuggestionIndexManagerImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqSearchSuggestImplSuggestionIndexManagerImplProperties',
