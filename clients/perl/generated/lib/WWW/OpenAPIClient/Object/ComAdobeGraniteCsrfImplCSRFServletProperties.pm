...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteCsrfImplCSRFServletProperties;
...
__PACKAGE__->method_documentation({
    'csrf/token/expires/in' => {
    	...
    	base_name => 'csrf.token.expires.in',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'csrf/token/expires/in' => 'csrf.token.expires.in',
