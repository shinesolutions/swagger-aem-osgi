...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialSyncImplPublisherSyncServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialSyncImplPublisherSyncServiceImplProperties',
