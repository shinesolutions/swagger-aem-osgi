...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSecurityHcDispatcherImplDispatcherAccessHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'dispatcher/filter/allowed' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'dispatcher.filter.allowed',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'dispatcher/filter/blocked' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'dispatcher.filter.blocked',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'hc/tags' => 'hc.tags',
    'dispatcher/address' => 'dispatcher.address',
    'dispatcher/filter/allowed' => 'dispatcher.filter.allowed',
    'dispatcher/filter/blocked' => 'dispatcher.filter.blocked'
} );
