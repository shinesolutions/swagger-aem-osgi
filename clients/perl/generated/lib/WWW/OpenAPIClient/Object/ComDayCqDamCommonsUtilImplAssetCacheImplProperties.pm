...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCommonsUtilImplAssetCacheImplProperties;
...
__PACKAGE__->attribute_map( {
    'large/file/min' => 'large.file.min',
    'cache/apply' => 'cache.apply',
