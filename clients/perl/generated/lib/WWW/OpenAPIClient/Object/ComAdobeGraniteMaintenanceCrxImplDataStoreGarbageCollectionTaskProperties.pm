...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskProperties;
...
__PACKAGE__->method_documentation({
    'granite/maintenance/mandatory' => {
    	...
    	base_name => 'granite.maintenance.mandatory',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'granite/maintenance/mandatory' => 'granite.maintenance.mandatory',
