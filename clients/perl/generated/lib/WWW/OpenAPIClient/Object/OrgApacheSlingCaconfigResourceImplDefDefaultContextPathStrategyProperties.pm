...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties;
...
__PACKAGE__->method_documentation({
    ...
    'config_ref_resource_names' => {
    	...
    	base_name => 'configRefResourceNames',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'config_ref_property_names' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'configRefPropertyNames',
    	description => '',
    	format => '',
    	read_only => '',
    		},
