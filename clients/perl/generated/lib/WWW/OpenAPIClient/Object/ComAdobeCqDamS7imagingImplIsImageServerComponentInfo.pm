...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDamS7imagingImplIsImageServerComponentInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqDamS7imagingImplIsImageServerComponentProperties',
