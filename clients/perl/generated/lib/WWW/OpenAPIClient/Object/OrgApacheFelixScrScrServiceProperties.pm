...
#
package WWW::OpenAPIClient::Object::OrgApacheFelixScrScrServiceProperties;
...
__PACKAGE__->method_documentation({
    ...
    'ds/delayed/keep_instances' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'ds.delayed.keepInstances',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'ds/lock/timeout/milliseconds' => {
    	...
    	base_name => 'ds.lock.timeout.milliseconds',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'ds/stop/timeout/milliseconds' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'ds.stop.timeout.milliseconds',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'ds/delayed/keep_instances' => 'ConfigNodePropertyBoolean',
...
__PACKAGE__->attribute_map( {
    'ds/loglevel' => 'ds.loglevel',
    'ds/factory/enabled' => 'ds.factory.enabled',
    'ds/delayed/keep_instances' => 'ds.delayed.keepInstances',
    'ds/lock/timeout/milliseconds' => 'ds.lock.timeout.milliseconds',
    'ds/stop/timeout/milliseconds' => 'ds.stop.timeout.milliseconds',
    'ds/global/extender' => 'ds.global.extender'
} );
