...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteRepositoryServiceUserConfigurationProperties;
...
__PACKAGE__->method_documentation({
    ...
    'serviceusers/simple_subject_population' => {
    	...
    	base_name => 'serviceusers.simpleSubjectPopulation',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'serviceusers/simple_subject_population' => 'ConfigNodePropertyBoolean',
    'serviceusers/list' => 'ConfigNodePropertyArray'
} );

__PACKAGE__->attribute_map( {
    'service/ranking' => 'service.ranking',
    'serviceusers/simple_subject_population' => 'serviceusers.simpleSubjectPopulation',
    'serviceusers/list' => 'serviceusers.list'
} );
