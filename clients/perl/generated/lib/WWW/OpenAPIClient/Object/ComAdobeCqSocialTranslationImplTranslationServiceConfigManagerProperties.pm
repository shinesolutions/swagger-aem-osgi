...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialTranslationImplTranslationServiceConfigManagerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'translate/attribution' => {
    	...
    	base_name => 'translate.attribution',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'translate/smart/rendering' => {
    	datatype => 'ConfigNodePropertyDropDown',
    	base_name => 'translate.smart.rendering',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'translate/caching/duration' => {
    	...
    	base_name => 'translate.caching.duration',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'translate/session/save/interval' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'translate.session.save.interval',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'translate/session/save/batch_limit' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'translate.session.save.batchLimit',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->openapi_types( {
    ...
    'translate/session/save/batch_limit' => 'ConfigNodePropertyString'
} );

__PACKAGE__->attribute_map( {
    'translate/language' => 'translate.language',
    'translate/display' => 'translate.display',
    'translate/attribution' => 'translate.attribution',
    'translate/caching' => 'translate.caching',
    'translate/smart/rendering' => 'translate.smart.rendering',
    'translate/caching/duration' => 'translate.caching.duration',
    'translate/session/save/interval' => 'translate.session.save.interval',
    'translate/session/save/batch_limit' => 'translate.session.save.batchLimit'
} );
