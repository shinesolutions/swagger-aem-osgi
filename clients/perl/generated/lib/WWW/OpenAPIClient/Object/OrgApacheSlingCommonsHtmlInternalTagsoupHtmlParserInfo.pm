...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsHtmlInternalTagsoupHtmlParserInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCommonsHtmlInternalTagsoupHtmlParserProperties',
