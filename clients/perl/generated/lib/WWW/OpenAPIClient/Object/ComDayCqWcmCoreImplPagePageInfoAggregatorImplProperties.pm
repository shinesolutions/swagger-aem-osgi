...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmCoreImplPagePageInfoAggregatorImplProperties;
...
__PACKAGE__->method_documentation({
    'page/info/provider/property/regex/default' => {
    	...
    	base_name => 'page.info.provider.property.regex.default',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'page/info/provider/property/name' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'page.info.provider.property.name',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'page/info/provider/property/regex/default' => 'page.info.provider.property.regex.default',
    'page/info/provider/property/name' => 'page.info.provider.property.name'
} );
