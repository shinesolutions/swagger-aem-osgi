...
#
package WWW::OpenAPIClient::Object::ComDayCqAuthImplLoginSelectorHandlerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'auth/loginselector/mappings' => {
    	...
    	base_name => 'auth.loginselector.mappings',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auth/loginselector/changepw/mappings' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'auth.loginselector.changepw.mappings',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auth/loginselector/defaultloginpage' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'auth.loginselector.defaultloginpage',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auth/loginselector/defaultchangepwpage' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'auth.loginselector.defaultchangepwpage',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auth/loginselector/handle' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'auth.loginselector.handle',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'auth/loginselector/handle/all/extensions' => {
    	...
    	base_name => 'auth.loginselector.handle.all.extensions',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'auth/loginselector/mappings' => 'auth.loginselector.mappings',
    'auth/loginselector/changepw/mappings' => 'auth.loginselector.changepw.mappings',
    'auth/loginselector/defaultloginpage' => 'auth.loginselector.defaultloginpage',
    'auth/loginselector/defaultchangepwpage' => 'auth.loginselector.defaultchangepwpage',
    'auth/loginselector/handle' => 'auth.loginselector.handle',
    'auth/loginselector/handle/all/extensions' => 'auth.loginselector.handle.all.extensions'
} );
