...
#
package WWW::OpenAPIClient::Object::ComDayCqRewriterLinkcheckerImplLinkCheckerImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'scheduler/concurrent' => {
    	...
    	base_name => 'scheduler.concurrent',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'service/bad_link_tolerance_interval' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'service.bad_link_tolerance_interval',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'service/check_override_patterns' => {
    	...
    	base_name => 'service.check_override_patterns',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'service/cache_broken_internal_links' => {
    	datatype => 'ConfigNodePropertyBoolean',
    	base_name => 'service.cache_broken_internal_links',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'service/special_link_prefix' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'service.special_link_prefix',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'service/special_link_patterns' => {
    	datatype => 'ConfigNodePropertyArray',
    	base_name => 'service.special_link_patterns',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'scheduler/concurrent' => 'scheduler.concurrent',
    'service/bad_link_tolerance_interval' => 'service.bad_link_tolerance_interval',
    'service/check_override_patterns' => 'service.check_override_patterns',
    'service/cache_broken_internal_links' => 'service.cache_broken_internal_links',
    'service/special_link_prefix' => 'service.special_link_prefix',
    'service/special_link_patterns' => 'service.special_link_patterns'
} );
