...
#
package WWW::OpenAPIClient::Object::ComDayCqDamInddImplServletSnippetCreationServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamInddImplServletSnippetCreationServletProperties',
