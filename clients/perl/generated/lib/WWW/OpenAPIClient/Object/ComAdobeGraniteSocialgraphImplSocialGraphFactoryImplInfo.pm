...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteSocialgraphImplSocialGraphFactoryImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteSocialgraphImplSocialGraphFactoryImplProperties',
