...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmWorkflowImplWcmWorkflowServiceImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cq/wcm/workflow/terminate/on/activate' => {
    	...
    	base_name => 'cq.wcm.workflow.terminate.on.activate',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/wcm/worklfow/terminate/exclusion/list' => {
    	...
    	base_name => 'cq.wcm.worklfow.terminate.exclusion.list',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'cq/wcm/workflow/terminate/on/activate' => 'cq.wcm.workflow.terminate.on.activate',
    'cq/wcm/worklfow/terminate/exclusion/list' => 'cq.wcm.worklfow.terminate.exclusion.list'
} );
