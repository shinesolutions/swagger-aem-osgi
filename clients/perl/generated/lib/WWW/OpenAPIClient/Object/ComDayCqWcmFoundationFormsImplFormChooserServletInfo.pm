...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmFoundationFormsImplFormChooserServletInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqWcmFoundationFormsImplFormChooserServletProperties',
