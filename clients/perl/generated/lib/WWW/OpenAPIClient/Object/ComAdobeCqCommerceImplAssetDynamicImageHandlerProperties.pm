...
#
package WWW::OpenAPIClient::Object::ComAdobeCqCommerceImplAssetDynamicImageHandlerProperties;
...
__PACKAGE__->method_documentation({
    'cq/commerce/asset/handler/active' => {
    	...
    	base_name => 'cq.commerce.asset.handler.active',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'cq/commerce/asset/handler/name' => {
    	...
    	base_name => 'cq.commerce.asset.handler.name',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'cq/commerce/asset/handler/active' => 'cq.commerce.asset.handler.active',
    'cq/commerce/asset/handler/name' => 'cq.commerce.asset.handler.name'
} );
