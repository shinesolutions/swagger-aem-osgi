...
#
package WWW::OpenAPIClient::Object::ComDayCqDamCoreProcessExifToolExtractMetadataProcessInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamCoreProcessExifToolExtractMetadataProcessProperties',
