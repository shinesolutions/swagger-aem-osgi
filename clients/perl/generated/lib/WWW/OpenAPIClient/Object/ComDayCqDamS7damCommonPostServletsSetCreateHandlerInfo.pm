...
#
package WWW::OpenAPIClient::Object::ComDayCqDamS7damCommonPostServletsSetCreateHandlerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties',
