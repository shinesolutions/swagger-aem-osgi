...
#
package WWW::OpenAPIClient::Object::ComDayCqSearchImplBuilderQueryBuilderImplProperties;
...
__PACKAGE__->method_documentation({
    ...
    'cache/entry/lifetime' => {
    	datatype => 'ConfigNodePropertyInteger',
    	base_name => 'cache.entry.lifetime',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'excerpt/properties' => 'excerpt.properties',
    'cache/max/entries' => 'cache.max.entries',
    'cache/entry/lifetime' => 'cache.entry.lifetime',
