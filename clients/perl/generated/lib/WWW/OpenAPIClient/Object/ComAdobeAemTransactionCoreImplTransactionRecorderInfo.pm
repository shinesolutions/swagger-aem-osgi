...
#
package WWW::OpenAPIClient::Object::ComAdobeAemTransactionCoreImplTransactionRecorderInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeAemTransactionCoreImplTransactionRecorderProperties',
