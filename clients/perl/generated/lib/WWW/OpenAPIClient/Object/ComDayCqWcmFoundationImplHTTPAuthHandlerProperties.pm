...
#
package WWW::OpenAPIClient::Object::ComDayCqWcmFoundationImplHTTPAuthHandlerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'auth/default/loginpage' => {
    	datatype => 'ConfigNodePropertyString',
    	base_name => 'auth.default.loginpage',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'path' => 'path',
    'auth/http/nologin' => 'auth.http.nologin',
    'auth/http/realm' => 'auth.http.realm',
    'auth/default/loginpage' => 'auth.default.loginpage',
    'auth/cred/form' => 'auth.cred.form',
    'auth/cred/utf8' => 'auth.cred.utf8'
} );
