...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsMimeInternalMimeTypeServiceImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingCommonsMimeInternalMimeTypeServiceImplProperties',
