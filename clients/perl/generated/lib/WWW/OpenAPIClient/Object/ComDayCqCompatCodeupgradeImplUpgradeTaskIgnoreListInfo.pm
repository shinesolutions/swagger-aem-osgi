...
#
package WWW::OpenAPIClient::Object::ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListProperties',
