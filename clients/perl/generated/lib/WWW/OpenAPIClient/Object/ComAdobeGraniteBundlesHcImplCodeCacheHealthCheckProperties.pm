...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckProperties;
...
__PACKAGE__->method_documentation({
    ...
    'minimum/code/cache/size' => {
    	...
    	base_name => 'minimum.code.cache.size',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    'hc/tags' => 'hc.tags',
    'minimum/code/cache/size' => 'minimum.code.cache.size'
} );
