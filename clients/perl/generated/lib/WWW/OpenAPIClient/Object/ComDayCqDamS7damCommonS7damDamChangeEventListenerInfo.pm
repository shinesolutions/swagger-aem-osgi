...
#
package WWW::OpenAPIClient::Object::ComDayCqDamS7damCommonS7damDamChangeEventListenerInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqDamS7damCommonS7damDamChangeEventListenerProperties',
