...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialNotificationsImplMentionsRouterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialNotificationsImplMentionsRouterProperties',
