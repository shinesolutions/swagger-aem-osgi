...
#
package WWW::OpenAPIClient::Object::ComAdobeGraniteAuthOauthImplFacebookProviderImplInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeGraniteAuthOauthImplFacebookProviderImplProperties',
