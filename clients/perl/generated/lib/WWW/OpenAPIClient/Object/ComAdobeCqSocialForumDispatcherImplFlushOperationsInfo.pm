...
#
package WWW::OpenAPIClient::Object::ComAdobeCqSocialForumDispatcherImplFlushOperationsInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqSocialForumDispatcherImplFlushOperationsProperties',
