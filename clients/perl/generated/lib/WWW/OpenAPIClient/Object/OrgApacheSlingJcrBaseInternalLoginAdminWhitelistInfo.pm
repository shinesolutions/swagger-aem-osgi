...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingJcrBaseInternalLoginAdminWhitelistInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheSlingJcrBaseInternalLoginAdminWhitelistProperties',
