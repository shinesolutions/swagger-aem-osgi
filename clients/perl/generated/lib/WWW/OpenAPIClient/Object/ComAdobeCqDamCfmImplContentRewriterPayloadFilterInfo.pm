...
#
package WWW::OpenAPIClient::Object::ComAdobeCqDamCfmImplContentRewriterPayloadFilterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComAdobeCqDamCfmImplContentRewriterPayloadFilterProperties',
