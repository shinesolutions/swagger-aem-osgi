...
#
package WWW::OpenAPIClient::Object::OrgApacheFelixSystemreadyImplFrameworkStartCheckInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'OrgApacheFelixSystemreadyImplFrameworkStartCheckProperties',
