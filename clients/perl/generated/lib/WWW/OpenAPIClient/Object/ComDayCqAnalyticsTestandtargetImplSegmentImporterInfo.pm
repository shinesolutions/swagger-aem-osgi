...
#
package WWW::OpenAPIClient::Object::ComDayCqAnalyticsTestandtargetImplSegmentImporterInfo;
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
    	datatype => 'ComDayCqAnalyticsTestandtargetImplSegmentImporterProperties',
