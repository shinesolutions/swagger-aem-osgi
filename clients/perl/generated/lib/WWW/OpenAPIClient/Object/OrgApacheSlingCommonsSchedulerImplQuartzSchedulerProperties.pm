...
#
package WWW::OpenAPIClient::Object::OrgApacheSlingCommonsSchedulerImplQuartzSchedulerProperties;
...
__PACKAGE__->method_documentation({
    ...
    'scheduler/useleaderforsingle' => {
    	...
    	base_name => 'scheduler.useleaderforsingle',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->attribute_map( {
    ...
    'scheduler/useleaderforsingle' => 'scheduler.useleaderforsingle',
