...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties) {
  'use strict';
