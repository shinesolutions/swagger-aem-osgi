...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmMsmImplActionsContentUpdateActionFactoryInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties);
  }
}(this, function(ApiClient, ComDayCqWcmMsmImplActionsContentUpdateActionFactoryProperties) {
  'use strict';
