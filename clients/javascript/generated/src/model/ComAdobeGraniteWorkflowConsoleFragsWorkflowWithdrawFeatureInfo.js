...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties) {
  'use strict';
