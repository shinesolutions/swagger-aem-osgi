...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteAuthOauthImplTwitterProviderImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteAuthOauthImplTwitterProviderImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteAuthOauthImplTwitterProviderImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteAuthOauthImplTwitterProviderImplProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteAuthOauthImplTwitterProviderImplProperties) {
  'use strict';
