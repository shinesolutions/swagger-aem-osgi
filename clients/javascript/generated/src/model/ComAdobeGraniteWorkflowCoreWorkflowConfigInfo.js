...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteWorkflowCoreWorkflowConfigProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteWorkflowCoreWorkflowConfigProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowCoreWorkflowConfigInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowCoreWorkflowConfigProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteWorkflowCoreWorkflowConfigProperties) {
  'use strict';
