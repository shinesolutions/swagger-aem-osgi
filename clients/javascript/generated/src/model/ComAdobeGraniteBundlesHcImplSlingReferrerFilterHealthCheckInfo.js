...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties) {
  'use strict';
