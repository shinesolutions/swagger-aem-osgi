...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingCommonsLogLogManagerFactoryConfigInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties);
  }
}(this, function(ApiClient, OrgApacheSlingCommonsLogLogManagerFactoryConfigProperties) {
  'use strict';
