...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplProperties);
  }
}(this, function(ApiClient, OrgApacheSlingHcCoreImplExecutorHealthCheckExecutorImplProperties) {
  'use strict';
