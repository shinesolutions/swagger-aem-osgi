...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties);
  }
}(this, function(ApiClient, OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties) {
  'use strict';
