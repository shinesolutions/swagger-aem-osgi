...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties);
  }
}(this, function(ApiClient, OrgApacheSlingCaconfigResourceImplDefDefaultContextPathStrategyProperties) {
  'use strict';
