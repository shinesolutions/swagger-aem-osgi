...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerProperties) {
  'use strict';
