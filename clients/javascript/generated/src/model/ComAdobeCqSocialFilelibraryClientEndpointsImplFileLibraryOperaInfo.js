...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties);
  }
}(this, function(ApiClient, ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties) {
  'use strict';
