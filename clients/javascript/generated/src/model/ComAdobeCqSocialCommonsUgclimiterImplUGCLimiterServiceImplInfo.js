...
import ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplProperties from './ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplProperties';
...
class ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo {
    ...
    constructor() { 
        ...
        ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo();
 ...
 * @member {String} pid
 */
ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo.prototype['pid'] = undefined;

/**
 * @member {String} title
 */
ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo.prototype['title'] = undefined;

/**
 * @member {String} description
 */
ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo.prototype['description'] = undefined;

/**
 * @member {module:model/ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplProperties} properties
 */
ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo.prototype['properties'] = undefined;
...
export default ComAdobeCqSocialCommonsUgclimiterImplUGCLimiterServiceImplInfo;
