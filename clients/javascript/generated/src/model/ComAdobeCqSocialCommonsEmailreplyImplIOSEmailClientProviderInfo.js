...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties);
  }
}(this, function(ApiClient, ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties) {
  'use strict';
