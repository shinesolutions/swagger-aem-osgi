...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties) {
  'use strict';
