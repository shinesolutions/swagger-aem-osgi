...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqDamCfmImplContentRewriterAssetProcessorProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqDamCfmImplContentRewriterAssetProcessorProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqDamCfmImplContentRewriterAssetProcessorInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqDamCfmImplContentRewriterAssetProcessorProperties);
  }
}(this, function(ApiClient, ComAdobeCqDamCfmImplContentRewriterAssetProcessorProperties) {
  'use strict';
