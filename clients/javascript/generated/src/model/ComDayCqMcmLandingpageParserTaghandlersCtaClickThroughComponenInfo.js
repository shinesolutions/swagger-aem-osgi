...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties);
  }
}(this, function(ApiClient, ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties) {
  'use strict';
