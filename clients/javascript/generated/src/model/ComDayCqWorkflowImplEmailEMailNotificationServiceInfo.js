...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWorkflowImplEmailEMailNotificationServiceProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWorkflowImplEmailEMailNotificationServiceProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWorkflowImplEmailEMailNotificationServiceInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWorkflowImplEmailEMailNotificationServiceProperties);
  }
}(this, function(ApiClient, ComDayCqWorkflowImplEmailEMailNotificationServiceProperties) {
  'use strict';
