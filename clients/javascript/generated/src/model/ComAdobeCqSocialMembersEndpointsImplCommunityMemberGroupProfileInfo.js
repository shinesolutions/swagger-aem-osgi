...
import ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileProperties from './ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileProperties';
...
class ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo {
    ...
    constructor() { 
        ...
        ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo();
 ...
 * @member {String} pid
 */
ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo.prototype['pid'] = undefined;

/**
 * @member {String} title
 */
ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo.prototype['title'] = undefined;

/**
 * @member {String} description
 */
ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo.prototype['description'] = undefined;

/**
 * @member {module:model/ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileProperties} properties
 */
ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo.prototype['properties'] = undefined;
...
export default ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo;
