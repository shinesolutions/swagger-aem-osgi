...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteOmnisearchImplCoreOmniSearchServiceImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteOmnisearchImplCoreOmniSearchServiceImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteOmnisearchImplCoreOmniSearchServiceImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteOmnisearchImplCoreOmniSearchServiceImplProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteOmnisearchImplCoreOmniSearchServiceImplProperties) {
  'use strict';
