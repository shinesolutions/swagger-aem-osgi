...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowCorePayloadmapPayloadMoveListenerProperties = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ConfigNodePropertyArray, root.NodeSwaggerAemOsgi.ConfigNodePropertyBoolean);
  }
   ...
   */
  exports.prototype['payload.move.white.list'] = undefined;
  /**
   * @member {module:model/ConfigNodePropertyBoolean} payload.move.handle.from.workflow.process
   */
  exports.prototype['payload.move.handle.from.workflow.process'] = undefined;
