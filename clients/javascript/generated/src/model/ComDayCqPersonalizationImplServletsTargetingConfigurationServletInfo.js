...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqPersonalizationImplServletsTargetingConfigurationServletInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties);
  }
}(this, function(ApiClient, ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties) {
  'use strict';
