...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties);
  }
}(this, function(ApiClient, OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties) {
  'use strict';
