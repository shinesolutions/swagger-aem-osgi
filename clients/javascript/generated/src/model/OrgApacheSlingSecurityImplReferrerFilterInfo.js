...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingSecurityImplReferrerFilterProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingSecurityImplReferrerFilterProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingSecurityImplReferrerFilterInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingSecurityImplReferrerFilterProperties);
  }
}(this, function(ApiClient, OrgApacheSlingSecurityImplReferrerFilterProperties) {
  'use strict';
