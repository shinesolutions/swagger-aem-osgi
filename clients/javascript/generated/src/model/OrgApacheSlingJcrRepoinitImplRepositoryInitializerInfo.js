...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties);
  }
}(this, function(ApiClient, OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties) {
  'use strict';
