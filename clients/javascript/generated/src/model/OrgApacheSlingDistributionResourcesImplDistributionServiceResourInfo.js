...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties);
  }
}(this, function(ApiClient, OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties) {
  'use strict';
