...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties);
  }
}(this, function(ApiClient, OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties) {
  'use strict';
