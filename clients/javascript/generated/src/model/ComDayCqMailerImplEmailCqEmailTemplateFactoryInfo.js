...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqMailerImplEmailCqEmailTemplateFactoryInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties);
  }
}(this, function(ApiClient, ComDayCqMailerImplEmailCqEmailTemplateFactoryProperties) {
  'use strict';
