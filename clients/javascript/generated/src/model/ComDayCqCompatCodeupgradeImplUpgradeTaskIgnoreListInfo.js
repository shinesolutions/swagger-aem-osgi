...
import ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListProperties from './ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListProperties';
...
class ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo {
    ...
    constructor() { 
        ...
        ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo();
 ...
 * @member {String} pid
 */
ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo.prototype['pid'] = undefined;

/**
 * @member {String} title
 */
ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo.prototype['title'] = undefined;

/**
 * @member {String} description
 */
ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo.prototype['description'] = undefined;

/**
 * @member {module:model/ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListProperties} properties
 */
ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo.prototype['properties'] = undefined;
...
export default ComDayCqCompatCodeupgradeImplUpgradeTaskIgnoreListInfo;
