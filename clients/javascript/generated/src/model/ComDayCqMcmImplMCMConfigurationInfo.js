...
import ComDayCqMcmImplMCMConfigurationProperties from './ComDayCqMcmImplMCMConfigurationProperties';
...
class ComDayCqMcmImplMCMConfigurationInfo {
    ...
    constructor() { 
        ...
        ComDayCqMcmImplMCMConfigurationInfo.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComDayCqMcmImplMCMConfigurationInfo();
 ...
 * @member {String} pid
 */
ComDayCqMcmImplMCMConfigurationInfo.prototype['pid'] = undefined;

/**
 * @member {String} title
 */
ComDayCqMcmImplMCMConfigurationInfo.prototype['title'] = undefined;

/**
 * @member {String} description
 */
ComDayCqMcmImplMCMConfigurationInfo.prototype['description'] = undefined;

/**
 * @member {module:model/ComDayCqMcmImplMCMConfigurationProperties} properties
 */
ComDayCqMcmImplMCMConfigurationInfo.prototype['properties'] = undefined;
...
export default ComDayCqMcmImplMCMConfigurationInfo;
