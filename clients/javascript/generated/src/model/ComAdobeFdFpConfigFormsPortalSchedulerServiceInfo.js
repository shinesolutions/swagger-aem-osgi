...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeFdFpConfigFormsPortalSchedulerServiceProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeFdFpConfigFormsPortalSchedulerServiceProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeFdFpConfigFormsPortalSchedulerServiceInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeFdFpConfigFormsPortalSchedulerServiceProperties);
  }
}(this, function(ApiClient, ComAdobeFdFpConfigFormsPortalSchedulerServiceProperties) {
  'use strict';
