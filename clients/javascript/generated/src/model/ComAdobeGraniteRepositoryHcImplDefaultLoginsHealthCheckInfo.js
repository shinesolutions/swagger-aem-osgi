...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteRepositoryHcImplDefaultLoginsHealthCheckProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteRepositoryHcImplDefaultLoginsHealthCheckProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteRepositoryHcImplDefaultLoginsHealthCheckInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteRepositoryHcImplDefaultLoginsHealthCheckProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteRepositoryHcImplDefaultLoginsHealthCheckProperties) {
  'use strict';
