...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqDamCoreImplJmxAssetUpdateMonitorImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqDamCoreImplJmxAssetUpdateMonitorImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqDamCoreImplJmxAssetUpdateMonitorImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqDamCoreImplJmxAssetUpdateMonitorImplProperties);
  }
}(this, function(ApiClient, ComDayCqDamCoreImplJmxAssetUpdateMonitorImplProperties) {
  'use strict';
