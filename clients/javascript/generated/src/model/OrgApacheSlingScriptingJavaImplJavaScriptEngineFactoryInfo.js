...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties);
  }
}(this, function(ApiClient, OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties) {
  'use strict';
