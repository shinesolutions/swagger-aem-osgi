...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqDamCoreImplCacheCQBufferedImageCacheProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqDamCoreImplCacheCQBufferedImageCacheProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqDamCoreImplCacheCQBufferedImageCacheInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqDamCoreImplCacheCQBufferedImageCacheProperties);
  }
}(this, function(ApiClient, ComDayCqDamCoreImplCacheCQBufferedImageCacheProperties) {
  'use strict';
