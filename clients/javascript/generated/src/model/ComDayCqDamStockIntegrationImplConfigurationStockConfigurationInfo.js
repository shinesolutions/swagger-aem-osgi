...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqDamStockIntegrationImplConfigurationStockConfigurationProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqDamStockIntegrationImplConfigurationStockConfigurationProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqDamStockIntegrationImplConfigurationStockConfigurationInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqDamStockIntegrationImplConfigurationStockConfigurationProperties);
  }
}(this, function(ApiClient, ComDayCqDamStockIntegrationImplConfigurationStockConfigurationProperties) {
  'use strict';
