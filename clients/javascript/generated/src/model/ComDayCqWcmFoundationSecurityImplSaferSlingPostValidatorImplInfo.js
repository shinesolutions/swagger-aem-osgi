...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties);
  }
}(this, function(ApiClient, ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties) {
  'use strict';
