...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties) {
  'use strict';
