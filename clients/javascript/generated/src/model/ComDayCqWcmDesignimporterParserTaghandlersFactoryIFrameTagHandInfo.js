...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmDesignimporterParserTaghandlersFactoryIFrameTagHandProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmDesignimporterParserTaghandlersFactoryIFrameTagHandProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryIFrameTagHandInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryIFrameTagHandProperties);
  }
}(this, function(ApiClient, ComDayCqWcmDesignimporterParserTaghandlersFactoryIFrameTagHandProperties) {
  'use strict';
