...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties) {
  'use strict';
