...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApacheSlingHealthCheckResultHTMLSerializerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApacheSlingHealthCheckResultHTMLSerializerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ApacheSlingHealthCheckResultHTMLSerializerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ApacheSlingHealthCheckResultHTMLSerializerProperties);
  }
}(this, function(ApiClient, ApacheSlingHealthCheckResultHTMLSerializerProperties) {
  'use strict';
