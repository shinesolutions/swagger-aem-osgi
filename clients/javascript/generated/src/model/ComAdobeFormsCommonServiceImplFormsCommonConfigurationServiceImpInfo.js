...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties);
  }
}(this, function(ApiClient, ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties) {
  'use strict';
