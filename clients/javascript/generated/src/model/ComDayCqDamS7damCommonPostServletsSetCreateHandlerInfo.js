...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqDamS7damCommonPostServletsSetCreateHandlerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties);
  }
}(this, function(ApiClient, ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties) {
  'use strict';
