...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties);
  }
}(this, function(ApiClient, OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties) {
  'use strict';
