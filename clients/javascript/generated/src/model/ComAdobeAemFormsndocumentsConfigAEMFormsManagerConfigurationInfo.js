...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeAemFormsndocumentsConfigAEMFormsManagerConfigurationProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeAemFormsndocumentsConfigAEMFormsManagerConfigurationProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeAemFormsndocumentsConfigAEMFormsManagerConfigurationInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeAemFormsndocumentsConfigAEMFormsManagerConfigurationProperties);
  }
}(this, function(ApiClient, ComAdobeAemFormsndocumentsConfigAEMFormsManagerConfigurationProperties) {
  'use strict';
