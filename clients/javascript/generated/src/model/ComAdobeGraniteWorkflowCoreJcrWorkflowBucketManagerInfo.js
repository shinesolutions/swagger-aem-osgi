...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties) {
  'use strict';
