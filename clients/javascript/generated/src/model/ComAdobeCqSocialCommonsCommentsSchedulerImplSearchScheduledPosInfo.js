...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties);
  }
}(this, function(ApiClient, ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosProperties) {
  'use strict';
