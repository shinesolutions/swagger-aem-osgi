...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties);
  }
}(this, function(ApiClient, ComAdobeCqScreensImplJobsDistributedDevicesStatiUpdateJobProperties) {
  'use strict';
