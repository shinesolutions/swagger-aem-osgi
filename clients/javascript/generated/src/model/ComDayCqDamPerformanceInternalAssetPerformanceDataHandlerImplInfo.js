...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqDamPerformanceInternalAssetPerformanceDataHandlerImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqDamPerformanceInternalAssetPerformanceDataHandlerImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqDamPerformanceInternalAssetPerformanceDataHandlerImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqDamPerformanceInternalAssetPerformanceDataHandlerImplProperties);
  }
}(this, function(ApiClient, ComDayCqDamPerformanceInternalAssetPerformanceDataHandlerImplProperties) {
  'use strict';
