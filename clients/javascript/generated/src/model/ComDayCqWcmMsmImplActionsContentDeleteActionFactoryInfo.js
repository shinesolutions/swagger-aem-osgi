...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmMsmImplActionsContentDeleteActionFactoryInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties);
  }
}(this, function(ApiClient, ComDayCqWcmMsmImplActionsContentDeleteActionFactoryProperties) {
  'use strict';
