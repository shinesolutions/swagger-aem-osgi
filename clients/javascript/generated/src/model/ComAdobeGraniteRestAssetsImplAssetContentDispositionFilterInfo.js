...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties);
  }
}(this, function(ApiClient, ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties) {
  'use strict';
