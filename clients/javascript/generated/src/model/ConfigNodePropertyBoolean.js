...
class ConfigNodePropertyBoolean {
    ...
    constructor() { 
        ...
        ConfigNodePropertyBoolean.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigNodePropertyBoolean();
 ...
 * @member {String} name
 */
ConfigNodePropertyBoolean.prototype['name'] = undefined;

/**
 * True if optional
 * @member {Boolean} optional
 */
ConfigNodePropertyBoolean.prototype['optional'] = undefined;

/**
 * True if property is set
 * @member {Boolean} is_set
 */
ConfigNodePropertyBoolean.prototype['is_set'] = undefined;

/**
 * Property type, 1=String, 2=Long, 3=Integer, 7=Float, 11=Boolean, 12=Secrets(String)
 * @member {Number} type
 */
ConfigNodePropertyBoolean.prototype['type'] = undefined;
 ...
 */
ConfigNodePropertyBoolean.prototype['description'] = undefined;
...
export default ConfigNodePropertyBoolean;
