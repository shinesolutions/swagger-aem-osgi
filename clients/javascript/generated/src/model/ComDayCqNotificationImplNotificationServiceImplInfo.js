...
import ComDayCqNotificationImplNotificationServiceImplProperties from './ComDayCqNotificationImplNotificationServiceImplProperties';
...
class ComDayCqNotificationImplNotificationServiceImplInfo {
    ...
    constructor() { 
        ...
        ComDayCqNotificationImplNotificationServiceImplInfo.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComDayCqNotificationImplNotificationServiceImplInfo();
 ...
 * @member {String} pid
 */
ComDayCqNotificationImplNotificationServiceImplInfo.prototype['pid'] = undefined;

/**
 * @member {String} title
 */
ComDayCqNotificationImplNotificationServiceImplInfo.prototype['title'] = undefined;

/**
 * @member {String} description
 */
ComDayCqNotificationImplNotificationServiceImplInfo.prototype['description'] = undefined;

/**
 * @member {module:model/ComDayCqNotificationImplNotificationServiceImplProperties} properties
 */
ComDayCqNotificationImplNotificationServiceImplInfo.prototype['properties'] = undefined;
...
export default ComDayCqNotificationImplNotificationServiceImplInfo;
