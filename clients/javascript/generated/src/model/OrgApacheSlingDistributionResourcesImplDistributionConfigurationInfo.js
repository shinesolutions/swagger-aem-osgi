...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties);
  }
}(this, function(ApiClient, OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties) {
  'use strict';
