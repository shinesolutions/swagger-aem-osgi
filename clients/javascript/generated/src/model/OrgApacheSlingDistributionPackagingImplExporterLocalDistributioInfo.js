...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties);
  }
}(this, function(ApiClient, OrgApacheSlingDistributionPackagingImplExporterLocalDistributioProperties) {
  'use strict';
