...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWorkflowImplEmailTaskEMailNotificationServiceInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties);
  }
}(this, function(ApiClient, ComDayCqWorkflowImplEmailTaskEMailNotificationServiceProperties) {
  'use strict';
