...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties);
  }
}(this, function(ApiClient, ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties) {
  'use strict';
