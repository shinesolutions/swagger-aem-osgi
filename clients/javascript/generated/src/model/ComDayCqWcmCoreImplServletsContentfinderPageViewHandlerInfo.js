...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerProperties);
  }
}(this, function(ApiClient, ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerProperties) {
  'use strict';
