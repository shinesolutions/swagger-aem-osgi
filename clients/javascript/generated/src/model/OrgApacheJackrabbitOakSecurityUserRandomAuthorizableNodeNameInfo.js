...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties);
  }
}(this, function(ApiClient, OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties) {
  'use strict';
