...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerProperties);
  }
}(this, function(ApiClient, OrgApacheSlingDistributionTriggerImplJcrEventDistributionTriggerProperties) {
  'use strict';
