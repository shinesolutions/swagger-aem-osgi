...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenProperties);
  }
}(this, function(ApiClient, ComDayCqWcmDesignimporterParserTaghandlersFactoryImageComponenProperties) {
  'use strict';
