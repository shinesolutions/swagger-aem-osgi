...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCrxSecurityTokenImplTokenCleanupTaskProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCrxSecurityTokenImplTokenCleanupTaskProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCrxSecurityTokenImplTokenCleanupTaskInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCrxSecurityTokenImplTokenCleanupTaskProperties);
  }
}(this, function(ApiClient, ComDayCrxSecurityTokenImplTokenCleanupTaskProperties) {
  'use strict';
