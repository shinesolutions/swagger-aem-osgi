...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties);
  }
}(this, function(ApiClient, ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties) {
  'use strict';
