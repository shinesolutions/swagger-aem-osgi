...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties);
  }
}(this, function(ApiClient, ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties) {
  'use strict';
