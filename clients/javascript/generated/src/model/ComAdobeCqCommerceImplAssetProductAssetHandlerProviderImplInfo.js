...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplProperties);
  }
}(this, function(ApiClient, ComAdobeCqCommerceImplAssetProductAssetHandlerProviderImplProperties) {
  'use strict';
