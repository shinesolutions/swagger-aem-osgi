...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceProperties);
  }
}(this, function(ApiClient, OrgApacheJackrabbitOakSegmentSegmentNodeStoreMonitorServiceProperties) {
  'use strict';
