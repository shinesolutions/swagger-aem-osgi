...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.NodeSwaggerAemOsgi) {
      root.NodeSwaggerAemOsgi = {};
    }
    root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerInfo = factory(root.NodeSwaggerAemOsgi.ApiClient, root.NodeSwaggerAemOsgi.ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerProperties);
  }
}(this, function(ApiClient, ComDayCqWcmDesignimporterParserTaghandlersFactoryImgTagHandlerProperties) {
  'use strict';
