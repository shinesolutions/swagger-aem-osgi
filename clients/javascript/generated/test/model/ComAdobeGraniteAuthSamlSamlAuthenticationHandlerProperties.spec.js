...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties();
  });
  ...
  describe('ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties', function() {
    it('should create an instance of ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties', function() {
      // uncomment below and update the code to test ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties
      //var instane = new NodeSwaggerAemOsgi.ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties);
    });
    ...
    it('should have the property identitySyncType (base name: "identitySyncType")', function() {
      // uncomment below and update the code to test the property identitySyncType
      //var instane = new NodeSwaggerAemOsgi.ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties();
      //expect(instance).to.be();
    });
