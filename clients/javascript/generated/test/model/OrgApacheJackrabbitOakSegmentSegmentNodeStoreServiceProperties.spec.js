...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties();
  });
  ...
  describe('OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties', function() {
    it('should create an instance of OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties', function() {
      // uncomment below and update the code to test OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSegmentSegmentNodeStoreServiceProperties);
    });
