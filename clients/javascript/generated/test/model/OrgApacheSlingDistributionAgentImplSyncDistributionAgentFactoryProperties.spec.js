...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties();
  });
  ...
  describe('OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties', function() {
    it('should create an instance of OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties', function() {
      // uncomment below and update the code to test OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties);
    });
