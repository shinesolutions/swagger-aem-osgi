...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties();
  });
  ...
  describe('OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties', function() {
    it('should create an instance of OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties', function() {
      // uncomment below and update the code to test OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProviderServiceProperties);
    });
