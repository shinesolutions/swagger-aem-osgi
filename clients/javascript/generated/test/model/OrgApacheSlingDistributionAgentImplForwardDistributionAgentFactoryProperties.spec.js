...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties();
  });
  ...
  describe('OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties', function() {
    it('should create an instance of OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties', function() {
      // uncomment below and update the code to test OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoryProperties);
    });
