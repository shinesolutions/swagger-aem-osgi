...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties();
  });
  ...
  describe('ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties', function() {
    it('should create an instance of ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties', function() {
      // uncomment below and update the code to test ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties
      //var instane = new NodeSwaggerAemOsgi.ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties);
    });
