...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties();
  });
  ...
  describe('OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties', function() {
    it('should create an instance of OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties', function() {
      // uncomment below and update the code to test OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties);
    });
