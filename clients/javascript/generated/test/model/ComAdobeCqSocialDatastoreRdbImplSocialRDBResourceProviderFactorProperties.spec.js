...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties();
  });
  ...
  describe('ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties', function() {
    it('should create an instance of ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties', function() {
      // uncomment below and update the code to test ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties
      //var instane = new NodeSwaggerAemOsgi.ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties);
    });
