...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties();
  });
  ...
  describe('OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties', function() {
    it('should create an instance of OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties', function() {
      // uncomment below and update the code to test OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties);
    });
    ...
    it('should have the property queueProviderFactoryTarget (base name: "queueProviderFactory.target")', function() {
      // uncomment below and update the code to test the property queueProviderFactoryTarget
      //var instane = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplQueueDistributionAgentFactoryProperties();
      //expect(instance).to.be();
    });
