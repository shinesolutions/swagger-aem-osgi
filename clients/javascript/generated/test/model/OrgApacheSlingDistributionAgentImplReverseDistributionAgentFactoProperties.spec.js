...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties();
  });
  ...
  describe('OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties', function() {
    it('should create an instance of OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties', function() {
      // uncomment below and update the code to test OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheSlingDistributionAgentImplReverseDistributionAgentFactoProperties);
    });
