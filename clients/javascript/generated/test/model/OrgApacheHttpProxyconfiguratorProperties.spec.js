...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.OrgApacheHttpProxyconfiguratorProperties();
  });
  ...
  describe('OrgApacheHttpProxyconfiguratorProperties', function() {
    it('should create an instance of OrgApacheHttpProxyconfiguratorProperties', function() {
      // uncomment below and update the code to test OrgApacheHttpProxyconfiguratorProperties
      //var instane = new NodeSwaggerAemOsgi.OrgApacheHttpProxyconfiguratorProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.OrgApacheHttpProxyconfiguratorProperties);
    });
    ...
    it('should have the property proxyPort (base name: "proxy.port")', function() {
