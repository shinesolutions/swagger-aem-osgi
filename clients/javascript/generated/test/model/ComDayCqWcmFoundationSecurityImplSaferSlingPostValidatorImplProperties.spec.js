...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties();
  });
  ...
  describe('ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties', function() {
    it('should create an instance of ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties', function() {
      // uncomment below and update the code to test ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties
      //var instane = new NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties();
      //expect(instance).to.be.a(NodeSwaggerAemOsgi.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties);
    });
