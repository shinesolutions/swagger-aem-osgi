...
public struct ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo: Codable {
    ...
    public init(pid: String?, title: String?, _description: String?, properties: ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckProperties?, additionalProperties: String?, bundleLocation: String?, serviceLocation: String?) {
        self.pid = pid
        self.title = title
