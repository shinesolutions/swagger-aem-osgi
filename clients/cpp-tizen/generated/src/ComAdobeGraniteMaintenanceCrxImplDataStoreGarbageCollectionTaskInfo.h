...
#ifndef _ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo_H_
#define _ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo_H_
...
class ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo();
	ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo(char* str);
...
#endif /* _ComAdobeGraniteMaintenanceCrxImplDataStoreGarbageCollectionTaskInfo_H_ */
