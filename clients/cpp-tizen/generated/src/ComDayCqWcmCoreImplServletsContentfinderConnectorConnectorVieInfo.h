...
#ifndef _ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo_H_
#define _ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo_H_
...
class ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo();
	ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo(char* str);
...
#endif /* _ComDayCqWcmCoreImplServletsContentfinderConnectorConnectorVieInfo_H_ */
