...
#ifndef _OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo_H_
#define _OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo_H_
...
class OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo();
	OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionPackagingImplImporterLocalDistributioInfo_H_ */
