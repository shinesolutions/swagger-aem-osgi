...
void
OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties")) {
			jsonToValue(&properties, node, "OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties", "OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties");
		} else {
			
			OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties* obj = static_cast<OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties*> (&properties);
...
OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo::OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo::toJson()
{
	...
	if (isprimitive("OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties")) {
		OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties", "");
	}
	else {
		
		OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties obj = static_cast<OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
