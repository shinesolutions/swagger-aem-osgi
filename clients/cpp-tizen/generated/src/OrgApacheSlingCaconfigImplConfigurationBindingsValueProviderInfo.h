...
#ifndef _OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo_H_
#define _OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo_H_
...
class OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo();
	OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo(char* str);
...
#endif /* _OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderInfo_H_ */
