...
void
ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties", "ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties");
		} else {
			
			ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties* obj = static_cast<ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties*> (&properties);
...
ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties")) {
		ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties", "");
	}
	else {
		
		ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties obj = static_cast<ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
