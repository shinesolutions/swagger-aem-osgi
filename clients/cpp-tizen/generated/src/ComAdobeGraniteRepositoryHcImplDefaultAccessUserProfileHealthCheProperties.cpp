...
void
ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheProperties::ComAdobeGraniteRepositoryHcImplDefaultAccessUserProfileHealthCheProperties(char* json)
{
	this->fromJson(json);
}
