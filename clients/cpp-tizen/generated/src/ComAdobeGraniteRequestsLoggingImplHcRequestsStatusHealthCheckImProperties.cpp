...
void
ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImProperties::ComAdobeGraniteRequestsLoggingImplHcRequestsStatusHealthCheckImProperties(char* json)
{
	this->fromJson(json);
}
