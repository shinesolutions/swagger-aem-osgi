...
void
ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties::__init()
{
	//enabled = new ConfigNodePropertyBoolean();
}

void
ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties::__cleanup()
{
	//if(enabled != NULL) {
	//
	//delete enabled;
...
void
ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties::ComAdobeGraniteWorkflowConsoleFragsWorkflowWithdrawFeatureProperties(char* json)
{
	this->fromJson(json);
}
