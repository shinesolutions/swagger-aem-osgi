...
void
OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties", "OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties");
		} else {
			
			OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties* obj = static_cast<OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties*> (&properties);
...
OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo::OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties")) {
		OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties", "");
	}
	else {
		
		OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties obj = static_cast<OrgApacheSlingCaconfigManagementImplConfigurationManagementSettiProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
