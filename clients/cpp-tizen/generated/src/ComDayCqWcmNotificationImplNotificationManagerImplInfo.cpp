...
void
ComDayCqWcmNotificationImplNotificationManagerImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmNotificationImplNotificationManagerImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmNotificationImplNotificationManagerImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmNotificationImplNotificationManagerImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmNotificationImplNotificationManagerImplProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmNotificationImplNotificationManagerImplProperties", "ComDayCqWcmNotificationImplNotificationManagerImplProperties");
		} else {
			
			ComDayCqWcmNotificationImplNotificationManagerImplProperties* obj = static_cast<ComDayCqWcmNotificationImplNotificationManagerImplProperties*> (&properties);
...
ComDayCqWcmNotificationImplNotificationManagerImplInfo::ComDayCqWcmNotificationImplNotificationManagerImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmNotificationImplNotificationManagerImplInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmNotificationImplNotificationManagerImplProperties")) {
		ComDayCqWcmNotificationImplNotificationManagerImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmNotificationImplNotificationManagerImplProperties", "");
	}
	else {
		
		ComDayCqWcmNotificationImplNotificationManagerImplProperties obj = static_cast<ComDayCqWcmNotificationImplNotificationManagerImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
