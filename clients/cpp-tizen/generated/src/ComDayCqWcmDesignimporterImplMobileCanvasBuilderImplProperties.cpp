...
void
ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties::__init()
{
	//filepattern = new ConfigNodePropertyString();
	//devicegroups = new ConfigNodePropertyArray();
...
void
ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties::__cleanup()
{
	//if(filepattern != NULL) {
	//
	//delete filepattern;
...
void
ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties::fromJson(char* jsonStr)
{
	...
	const gchar *devicegroupsKey = "device.groups";
	node = json_object_get_member(pJsonObject, devicegroupsKey);
	if (node !=NULL) {
	

		if (isprimitive("ConfigNodePropertyArray")) {
			jsonToValue(&devicegroups, node, "ConfigNodePropertyArray", "ConfigNodePropertyArray");
		} else {
			
			ConfigNodePropertyArray* obj = static_cast<ConfigNodePropertyArray*> (&devicegroups);
			obj->fromJson(json_to_string(node, false));
...
ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties::ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmDesignimporterImplMobileCanvasBuilderImplProperties::toJson()
{
	...
	if (isprimitive("ConfigNodePropertyArray")) {
		ConfigNodePropertyArray obj = getDevicegroups();
		node = converttoJson(&obj, "ConfigNodePropertyArray", "");
	}
	else {
		
		ConfigNodePropertyArray obj = static_cast<ConfigNodePropertyArray> (getDevicegroups());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
	...
	const gchar *devicegroupsKey = "device.groups";
	json_object_set_member(pJsonObject, devicegroupsKey, node);
	if (isprimitive("ConfigNodePropertyBoolean")) {
