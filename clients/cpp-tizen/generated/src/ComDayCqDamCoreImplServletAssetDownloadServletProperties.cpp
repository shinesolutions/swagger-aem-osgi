...
void
ComDayCqDamCoreImplServletAssetDownloadServletProperties::__init()
{
	//enabled = new ConfigNodePropertyBoolean();
}

void
ComDayCqDamCoreImplServletAssetDownloadServletProperties::__cleanup()
{
	//if(enabled != NULL) {
	//
	//delete enabled;
...
void
ComDayCqDamCoreImplServletAssetDownloadServletProperties::fromJson(char* jsonStr)
{
...
ComDayCqDamCoreImplServletAssetDownloadServletProperties::ComDayCqDamCoreImplServletAssetDownloadServletProperties(char* json)
{
	this->fromJson(json);
}
