...
#ifndef _OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo_H_
#define _OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo_H_
...
class OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo();
	OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo_H_ */
