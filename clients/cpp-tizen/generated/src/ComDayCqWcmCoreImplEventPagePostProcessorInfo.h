...
#ifndef _ComDayCqWcmCoreImplEventPagePostProcessorInfo_H_
#define _ComDayCqWcmCoreImplEventPagePostProcessorInfo_H_
...
class ComDayCqWcmCoreImplEventPagePostProcessorInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmCoreImplEventPagePostProcessorInfo();
	ComDayCqWcmCoreImplEventPagePostProcessorInfo(char* str);
...
#endif /* _ComDayCqWcmCoreImplEventPagePostProcessorInfo_H_ */
