...
#ifndef _ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo_H_
#define _ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo_H_
...
class ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo();
	ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo(char* str);
...
#endif /* _ComDayCqMcmLandingpageParserTaghandlersCtaGraphicalClickThrougInfo_H_ */
