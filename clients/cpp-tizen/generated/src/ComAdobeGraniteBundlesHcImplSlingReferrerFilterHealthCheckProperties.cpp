...
void
ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties::ComAdobeGraniteBundlesHcImplSlingReferrerFilterHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
