...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryStyleTagHandlProperties(char* json)
{
	this->fromJson(json);
}
