...
void
ComDayCqWcmCoreMvtMVTStatisticsImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmCoreMvtMVTStatisticsImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmCoreMvtMVTStatisticsImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmCoreMvtMVTStatisticsImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmCoreMvtMVTStatisticsImplProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmCoreMvtMVTStatisticsImplProperties", "ComDayCqWcmCoreMvtMVTStatisticsImplProperties");
		} else {
			
			ComDayCqWcmCoreMvtMVTStatisticsImplProperties* obj = static_cast<ComDayCqWcmCoreMvtMVTStatisticsImplProperties*> (&properties);
...
ComDayCqWcmCoreMvtMVTStatisticsImplInfo::ComDayCqWcmCoreMvtMVTStatisticsImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmCoreMvtMVTStatisticsImplInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmCoreMvtMVTStatisticsImplProperties")) {
		ComDayCqWcmCoreMvtMVTStatisticsImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmCoreMvtMVTStatisticsImplProperties", "");
	}
	else {
		
		ComDayCqWcmCoreMvtMVTStatisticsImplProperties obj = static_cast<ComDayCqWcmCoreMvtMVTStatisticsImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
