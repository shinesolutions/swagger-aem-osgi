...
void
OrgApacheFelixEventadminImplEventAdminInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheFelixEventadminImplEventAdminProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheFelixEventadminImplEventAdminInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheFelixEventadminImplEventAdminInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheFelixEventadminImplEventAdminProperties")) {
			jsonToValue(&properties, node, "OrgApacheFelixEventadminImplEventAdminProperties", "OrgApacheFelixEventadminImplEventAdminProperties");
		} else {
			
			OrgApacheFelixEventadminImplEventAdminProperties* obj = static_cast<OrgApacheFelixEventadminImplEventAdminProperties*> (&properties);
...
OrgApacheFelixEventadminImplEventAdminInfo::OrgApacheFelixEventadminImplEventAdminInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheFelixEventadminImplEventAdminInfo::toJson()
{
	...
	if (isprimitive("OrgApacheFelixEventadminImplEventAdminProperties")) {
		OrgApacheFelixEventadminImplEventAdminProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheFelixEventadminImplEventAdminProperties", "");
	}
	else {
		
		OrgApacheFelixEventadminImplEventAdminProperties obj = static_cast<OrgApacheFelixEventadminImplEventAdminProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
