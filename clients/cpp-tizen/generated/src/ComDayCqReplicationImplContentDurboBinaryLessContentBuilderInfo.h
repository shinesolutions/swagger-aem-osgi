...
#ifndef _ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo_H_
#define _ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo_H_
...
class ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo();
	ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo(char* str);
...
#endif /* _ComDayCqReplicationImplContentDurboBinaryLessContentBuilderInfo_H_ */
