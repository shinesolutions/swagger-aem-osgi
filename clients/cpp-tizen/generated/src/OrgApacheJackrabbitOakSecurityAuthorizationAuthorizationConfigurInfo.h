...
#ifndef _OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H_
#define _OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H_
...
class OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo();
	OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo_H_ */
