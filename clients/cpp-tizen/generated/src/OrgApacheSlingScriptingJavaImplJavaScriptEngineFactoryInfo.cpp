...
void
OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties", "OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties");
		} else {
			
			OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties* obj = static_cast<OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties*> (&properties);
...
OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo::OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties")) {
		OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties", "");
	}
	else {
		
		OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties obj = static_cast<OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
