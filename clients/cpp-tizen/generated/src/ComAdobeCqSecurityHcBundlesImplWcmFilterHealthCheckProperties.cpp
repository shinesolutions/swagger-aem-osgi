...
void
ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties::ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
