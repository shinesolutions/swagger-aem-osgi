...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryCanvasComponeProperties(char* json)
{
	this->fromJson(json);
}
