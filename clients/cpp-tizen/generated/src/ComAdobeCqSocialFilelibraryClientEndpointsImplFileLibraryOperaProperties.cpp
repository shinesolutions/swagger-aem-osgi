...
void
ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::__init()
{
...
void
ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::__cleanup()
{
...
void
ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::fromJson(char* jsonStr)
{
...
ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties::ComAdobeCqSocialFilelibraryClientEndpointsImplFileLibraryOperaProperties(char* json)
{
	this->fromJson(json);
}
