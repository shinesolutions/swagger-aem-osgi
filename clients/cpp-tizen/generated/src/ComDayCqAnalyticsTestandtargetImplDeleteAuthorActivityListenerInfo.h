...
#ifndef _ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo_H_
#define _ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo_H_
...
class ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo();
	ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo(char* str);
...
#endif /* _ComDayCqAnalyticsTestandtargetImplDeleteAuthorActivityListenerInfo_H_ */
