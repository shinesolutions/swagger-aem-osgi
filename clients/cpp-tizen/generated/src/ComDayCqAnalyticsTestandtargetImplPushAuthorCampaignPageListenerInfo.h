...
#ifndef _ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo_H_
#define _ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo_H_
...
class ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo();
	ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo(char* str);
...
#endif /* _ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo_H_ */
