...
void
ComDayCqReplicationAuditReplicationEventListenerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqReplicationAuditReplicationEventListenerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqReplicationAuditReplicationEventListenerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqReplicationAuditReplicationEventListenerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqReplicationAuditReplicationEventListenerProperties")) {
			jsonToValue(&properties, node, "ComDayCqReplicationAuditReplicationEventListenerProperties", "ComDayCqReplicationAuditReplicationEventListenerProperties");
		} else {
			
			ComDayCqReplicationAuditReplicationEventListenerProperties* obj = static_cast<ComDayCqReplicationAuditReplicationEventListenerProperties*> (&properties);
...
ComDayCqReplicationAuditReplicationEventListenerInfo::ComDayCqReplicationAuditReplicationEventListenerInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqReplicationAuditReplicationEventListenerInfo::toJson()
{
	...
	if (isprimitive("ComDayCqReplicationAuditReplicationEventListenerProperties")) {
		ComDayCqReplicationAuditReplicationEventListenerProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqReplicationAuditReplicationEventListenerProperties", "");
	}
	else {
		
		ComDayCqReplicationAuditReplicationEventListenerProperties obj = static_cast<ComDayCqReplicationAuditReplicationEventListenerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
