...
#ifndef _ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo_H_
#define _ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo_H_
...
class ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo();
	ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo(char* str);
...
#endif /* _ComAdobeCqSecurityHcBundlesImplHtmlLibraryManagerConfigHealthChInfo_H_ */
