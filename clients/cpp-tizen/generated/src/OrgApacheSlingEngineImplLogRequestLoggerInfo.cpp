...
void
OrgApacheSlingEngineImplLogRequestLoggerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingEngineImplLogRequestLoggerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingEngineImplLogRequestLoggerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingEngineImplLogRequestLoggerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingEngineImplLogRequestLoggerProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingEngineImplLogRequestLoggerProperties", "OrgApacheSlingEngineImplLogRequestLoggerProperties");
		} else {
			
			OrgApacheSlingEngineImplLogRequestLoggerProperties* obj = static_cast<OrgApacheSlingEngineImplLogRequestLoggerProperties*> (&properties);
...
OrgApacheSlingEngineImplLogRequestLoggerInfo::OrgApacheSlingEngineImplLogRequestLoggerInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingEngineImplLogRequestLoggerInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingEngineImplLogRequestLoggerProperties")) {
		OrgApacheSlingEngineImplLogRequestLoggerProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingEngineImplLogRequestLoggerProperties", "");
	}
	else {
		
		OrgApacheSlingEngineImplLogRequestLoggerProperties obj = static_cast<OrgApacheSlingEngineImplLogRequestLoggerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
