...
void
OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties", "OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties");
		} else {
			
			OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties* obj = static_cast<OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties*> (&properties);
...
OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo::OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties")) {
		OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties", "");
	}
	else {
		
		OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties obj = static_cast<OrgApacheSlingCaconfigResourceImplDefDefaultConfigurationResourProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
