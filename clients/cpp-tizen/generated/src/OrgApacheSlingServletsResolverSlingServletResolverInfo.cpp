...
void
OrgApacheSlingServletsResolverSlingServletResolverInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingServletsResolverSlingServletResolverProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingServletsResolverSlingServletResolverInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingServletsResolverSlingServletResolverInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingServletsResolverSlingServletResolverProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingServletsResolverSlingServletResolverProperties", "OrgApacheSlingServletsResolverSlingServletResolverProperties");
		} else {
			
			OrgApacheSlingServletsResolverSlingServletResolverProperties* obj = static_cast<OrgApacheSlingServletsResolverSlingServletResolverProperties*> (&properties);
...
OrgApacheSlingServletsResolverSlingServletResolverInfo::OrgApacheSlingServletsResolverSlingServletResolverInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingServletsResolverSlingServletResolverInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingServletsResolverSlingServletResolverProperties")) {
		OrgApacheSlingServletsResolverSlingServletResolverProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingServletsResolverSlingServletResolverProperties", "");
	}
	else {
		
		OrgApacheSlingServletsResolverSlingServletResolverProperties obj = static_cast<OrgApacheSlingServletsResolverSlingServletResolverProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
