...
#ifndef _OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo_H_
#define _OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo_H_
...
class OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo();
	OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo_H_ */
