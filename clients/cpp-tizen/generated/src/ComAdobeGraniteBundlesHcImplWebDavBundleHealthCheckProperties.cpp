...
void
ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties::ComAdobeGraniteBundlesHcImplWebDavBundleHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
