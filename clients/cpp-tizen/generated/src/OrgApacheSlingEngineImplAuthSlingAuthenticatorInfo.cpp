...
void
OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties", "OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties");
		} else {
			
			OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties* obj = static_cast<OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties*> (&properties);
...
OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties")) {
		OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties", "");
	}
	else {
		
		OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties obj = static_cast<OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
