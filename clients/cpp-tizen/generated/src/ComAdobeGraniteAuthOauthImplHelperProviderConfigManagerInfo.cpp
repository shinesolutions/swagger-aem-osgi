...
void
ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties", "ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties");
		} else {
			
			ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties* obj = static_cast<ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties*> (&properties);
...
ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo::ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties")) {
		ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties", "");
	}
	else {
		
		ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties obj = static_cast<ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
