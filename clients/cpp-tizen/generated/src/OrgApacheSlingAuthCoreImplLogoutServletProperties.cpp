...
void
OrgApacheSlingAuthCoreImplLogoutServletProperties::__init()
{
...
void
OrgApacheSlingAuthCoreImplLogoutServletProperties::__cleanup()
{
...
void
OrgApacheSlingAuthCoreImplLogoutServletProperties::fromJson(char* jsonStr)
{
...
OrgApacheSlingAuthCoreImplLogoutServletProperties::OrgApacheSlingAuthCoreImplLogoutServletProperties(char* json)
{
	this->fromJson(json);
}
