...
void
ComDayCqSecurityACLSetupInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqSecurityACLSetupProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqSecurityACLSetupInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqSecurityACLSetupInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqSecurityACLSetupProperties")) {
			jsonToValue(&properties, node, "ComDayCqSecurityACLSetupProperties", "ComDayCqSecurityACLSetupProperties");
		} else {
			
			ComDayCqSecurityACLSetupProperties* obj = static_cast<ComDayCqSecurityACLSetupProperties*> (&properties);
...
ComDayCqSecurityACLSetupInfo::ComDayCqSecurityACLSetupInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqSecurityACLSetupInfo::toJson()
{
	...
	if (isprimitive("ComDayCqSecurityACLSetupProperties")) {
		ComDayCqSecurityACLSetupProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqSecurityACLSetupProperties", "");
	}
	else {
		
		ComDayCqSecurityACLSetupProperties obj = static_cast<ComDayCqSecurityACLSetupProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
