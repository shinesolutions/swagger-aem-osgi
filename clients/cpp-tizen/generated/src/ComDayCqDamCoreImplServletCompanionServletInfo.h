...
#ifndef _ComDayCqDamCoreImplServletCompanionServletInfo_H_
#define _ComDayCqDamCoreImplServletCompanionServletInfo_H_
...
class ComDayCqDamCoreImplServletCompanionServletInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqDamCoreImplServletCompanionServletInfo();
	ComDayCqDamCoreImplServletCompanionServletInfo(char* str);
...
#endif /* _ComDayCqDamCoreImplServletCompanionServletInfo_H_ */
