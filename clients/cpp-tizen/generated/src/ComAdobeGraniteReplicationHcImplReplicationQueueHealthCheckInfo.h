...
#ifndef _ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo_H_
#define _ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo_H_
...
class ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo();
	ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo(char* str);
...
#endif /* _ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo_H_ */
