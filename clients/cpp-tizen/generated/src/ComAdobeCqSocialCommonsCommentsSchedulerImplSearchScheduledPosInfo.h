...
#ifndef _ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo_H_
#define _ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo_H_
...
class ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo();
	ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsCommentsSchedulerImplSearchScheduledPosInfo_H_ */
