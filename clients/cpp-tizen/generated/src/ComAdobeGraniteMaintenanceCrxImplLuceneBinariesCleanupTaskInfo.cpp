...
void
ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties", "ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties");
		} else {
			
			ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties* obj = static_cast<ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties*> (&properties);
...
ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo::ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties")) {
		ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties", "");
	}
	else {
		
		ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties obj = static_cast<ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
