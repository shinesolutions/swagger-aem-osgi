...
void
ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSProperties::ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSProperties(char* json)
{
	this->fromJson(json);
}
