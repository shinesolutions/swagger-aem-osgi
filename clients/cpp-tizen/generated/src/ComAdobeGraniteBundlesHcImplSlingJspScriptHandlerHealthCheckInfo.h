...
#ifndef _ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo_H_
#define _ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo_H_
...
class ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo();
	ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo(char* str);
...
#endif /* _ComAdobeGraniteBundlesHcImplSlingJspScriptHandlerHealthCheckInfo_H_ */
