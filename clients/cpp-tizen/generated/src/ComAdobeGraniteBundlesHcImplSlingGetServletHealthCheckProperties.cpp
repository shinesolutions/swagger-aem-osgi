...
void
ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties::ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
