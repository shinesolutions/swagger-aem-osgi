...
void
ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties")) {
			jsonToValue(&properties, node, "ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties", "ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties");
		} else {
			
			ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties* obj = static_cast<ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties*> (&properties);
...
ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo::ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo::toJson()
{
	...
	if (isprimitive("ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties")) {
		ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties", "");
	}
	else {
		
		ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties obj = static_cast<ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
