...
void
ComAdobeCqAuditPurgeReplicationProperties::__init()
{
...
void
ComAdobeCqAuditPurgeReplicationProperties::__cleanup()
{
...
void
ComAdobeCqAuditPurgeReplicationProperties::fromJson(char* jsonStr)
{
...
ComAdobeCqAuditPurgeReplicationProperties::ComAdobeCqAuditPurgeReplicationProperties(char* json)
{
	this->fromJson(json);
}
