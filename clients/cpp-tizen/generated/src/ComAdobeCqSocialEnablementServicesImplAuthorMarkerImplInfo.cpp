...
void
ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties")) {
			jsonToValue(&properties, node, "ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties", "ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties");
		} else {
			
			ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties* obj = static_cast<ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties*> (&properties);
...
ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo::ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo::toJson()
{
	...
	if (isprimitive("ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties")) {
		ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties", "");
	}
	else {
		
		ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties obj = static_cast<ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
