...
void
OrgApacheFelixHttpInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheFelixHttpProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheFelixHttpInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheFelixHttpInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheFelixHttpProperties")) {
			jsonToValue(&properties, node, "OrgApacheFelixHttpProperties", "OrgApacheFelixHttpProperties");
		} else {
			
			OrgApacheFelixHttpProperties* obj = static_cast<OrgApacheFelixHttpProperties*> (&properties);
...
OrgApacheFelixHttpInfo::OrgApacheFelixHttpInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheFelixHttpInfo::toJson()
{
	...
	if (isprimitive("OrgApacheFelixHttpProperties")) {
		OrgApacheFelixHttpProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheFelixHttpProperties", "");
	}
	else {
		
		OrgApacheFelixHttpProperties obj = static_cast<OrgApacheFelixHttpProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
