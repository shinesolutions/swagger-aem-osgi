...
void
ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties::__init()
{
...
void
ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties::__cleanup()
{
...
void
ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties::fromJson(char* jsonStr)
{
...
ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties::ComDayCqMcmLandingpageParserTaghandlersCtaClickThroughComponenProperties(char* json)
{
	this->fromJson(json);
}
