...
void
ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
