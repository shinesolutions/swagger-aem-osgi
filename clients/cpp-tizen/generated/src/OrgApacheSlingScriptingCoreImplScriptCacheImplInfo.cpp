...
void
OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingScriptingCoreImplScriptCacheImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingScriptingCoreImplScriptCacheImplProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingScriptingCoreImplScriptCacheImplProperties", "OrgApacheSlingScriptingCoreImplScriptCacheImplProperties");
		} else {
			
			OrgApacheSlingScriptingCoreImplScriptCacheImplProperties* obj = static_cast<OrgApacheSlingScriptingCoreImplScriptCacheImplProperties*> (&properties);
...
OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::OrgApacheSlingScriptingCoreImplScriptCacheImplInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingScriptingCoreImplScriptCacheImplProperties")) {
		OrgApacheSlingScriptingCoreImplScriptCacheImplProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingScriptingCoreImplScriptCacheImplProperties", "");
	}
	else {
		
		OrgApacheSlingScriptingCoreImplScriptCacheImplProperties obj = static_cast<OrgApacheSlingScriptingCoreImplScriptCacheImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
