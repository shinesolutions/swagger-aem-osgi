...
#ifndef _ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo_H_
#define _ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo_H_
...
class ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo();
	ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderInfo_H_ */
