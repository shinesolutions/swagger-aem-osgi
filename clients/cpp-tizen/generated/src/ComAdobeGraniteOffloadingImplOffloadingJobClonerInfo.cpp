...
void
ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties", "ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties");
		} else {
			
			ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties* obj = static_cast<ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties*> (&properties);
...
ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo::ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties")) {
		ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties", "");
	}
	else {
		
		ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties obj = static_cast<ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
