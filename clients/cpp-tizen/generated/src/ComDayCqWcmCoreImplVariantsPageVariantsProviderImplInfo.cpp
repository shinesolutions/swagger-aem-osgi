...
void
ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties", "ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties");
		} else {
			
			ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties* obj = static_cast<ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties*> (&properties);
...
ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo::ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties")) {
		ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties", "");
	}
	else {
		
		ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties obj = static_cast<ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
