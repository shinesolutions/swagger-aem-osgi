...
void
ComDayCqDamCoreImplAssetMoveListenerProperties::__init()
{
	//enabled = new ConfigNodePropertyBoolean();
}

void
ComDayCqDamCoreImplAssetMoveListenerProperties::__cleanup()
{
	//if(enabled != NULL) {
	//
	//delete enabled;
...
void
ComDayCqDamCoreImplAssetMoveListenerProperties::fromJson(char* jsonStr)
{
...
ComDayCqDamCoreImplAssetMoveListenerProperties::ComDayCqDamCoreImplAssetMoveListenerProperties(char* json)
{
	this->fromJson(json);
}
