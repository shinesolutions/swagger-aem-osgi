...
void
ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties")) {
			jsonToValue(&properties, node, "ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties", "ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties");
		} else {
			
			ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties* obj = static_cast<ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties*> (&properties);
...
ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo::ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo::toJson()
{
	...
	if (isprimitive("ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties")) {
		ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties", "");
	}
	else {
		
		ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties obj = static_cast<ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
