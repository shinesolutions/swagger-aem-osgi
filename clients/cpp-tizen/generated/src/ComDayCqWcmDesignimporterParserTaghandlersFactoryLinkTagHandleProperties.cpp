...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryLinkTagHandleProperties(char* json)
{
	this->fromJson(json);
}
