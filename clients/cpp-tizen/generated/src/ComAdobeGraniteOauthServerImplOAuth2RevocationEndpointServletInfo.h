...
#ifndef _ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo_H_
#define _ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo_H_
...
class ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo();
	ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo(char* str);
...
#endif /* _ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo_H_ */
