...
#ifndef _ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo_H_
#define _ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo_H_
...
class ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo();
	ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo(char* str);
...
#endif /* _ComDayCqWcmCoreImplDevicedetectionDeviceIdentificationModeImplInfo_H_ */
