...
#ifndef _ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo_H_
#define _ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo_H_
...
class ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo();
	ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo(char* str);
...
#endif /* _ComAdobeCqSocialUserEndpointsImplUsersGroupFromPublishServletInfo_H_ */
