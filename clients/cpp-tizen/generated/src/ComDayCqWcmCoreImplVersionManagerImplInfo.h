...
#ifndef _ComDayCqWcmCoreImplVersionManagerImplInfo_H_
#define _ComDayCqWcmCoreImplVersionManagerImplInfo_H_
...
class ComDayCqWcmCoreImplVersionManagerImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmCoreImplVersionManagerImplInfo();
	ComDayCqWcmCoreImplVersionManagerImplInfo(char* str);
...
#endif /* _ComDayCqWcmCoreImplVersionManagerImplInfo_H_ */
