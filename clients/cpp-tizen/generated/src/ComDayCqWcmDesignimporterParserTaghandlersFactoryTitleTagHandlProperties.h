...
#ifndef _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties_H_
#define _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties_H_
...
class ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties();
	ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties(char* str);
...
#endif /* _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleTagHandlProperties_H_ */
