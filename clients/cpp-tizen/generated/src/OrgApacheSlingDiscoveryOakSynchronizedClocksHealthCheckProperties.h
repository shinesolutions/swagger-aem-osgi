...
#ifndef _OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties_H_
#define _OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties_H_
...
class OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties();
	OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties(char* str);
...
#endif /* _OrgApacheSlingDiscoveryOakSynchronizedClocksHealthCheckProperties_H_ */
