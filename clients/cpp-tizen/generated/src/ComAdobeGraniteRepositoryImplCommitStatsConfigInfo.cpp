...
void
ComAdobeGraniteRepositoryImplCommitStatsConfigInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteRepositoryImplCommitStatsConfigProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteRepositoryImplCommitStatsConfigInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteRepositoryImplCommitStatsConfigInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteRepositoryImplCommitStatsConfigProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteRepositoryImplCommitStatsConfigProperties", "ComAdobeGraniteRepositoryImplCommitStatsConfigProperties");
		} else {
			
			ComAdobeGraniteRepositoryImplCommitStatsConfigProperties* obj = static_cast<ComAdobeGraniteRepositoryImplCommitStatsConfigProperties*> (&properties);
...
ComAdobeGraniteRepositoryImplCommitStatsConfigInfo::ComAdobeGraniteRepositoryImplCommitStatsConfigInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteRepositoryImplCommitStatsConfigInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteRepositoryImplCommitStatsConfigProperties")) {
		ComAdobeGraniteRepositoryImplCommitStatsConfigProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteRepositoryImplCommitStatsConfigProperties", "");
	}
	else {
		
		ComAdobeGraniteRepositoryImplCommitStatsConfigProperties obj = static_cast<ComAdobeGraniteRepositoryImplCommitStatsConfigProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
