...
#ifndef _OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo_H_
#define _OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo_H_
...
class OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo();
	OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo(char* str);
...
#endif /* _OrgApacheSlingServiceusermappingImplServiceUserMapperImplAmendedInfo_H_ */
