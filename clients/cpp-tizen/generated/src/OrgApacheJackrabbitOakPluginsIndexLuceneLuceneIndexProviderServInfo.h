...
#ifndef _OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo_H_
#define _OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo_H_
...
class OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo();
	OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsIndexLuceneLuceneIndexProviderServInfo_H_ */
