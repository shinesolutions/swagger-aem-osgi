...
void
ComDayCqWcmUndoUndoConfigInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmUndoUndoConfigProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmUndoUndoConfigInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmUndoUndoConfigInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmUndoUndoConfigProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmUndoUndoConfigProperties", "ComDayCqWcmUndoUndoConfigProperties");
		} else {
			
			ComDayCqWcmUndoUndoConfigProperties* obj = static_cast<ComDayCqWcmUndoUndoConfigProperties*> (&properties);
...
ComDayCqWcmUndoUndoConfigInfo::ComDayCqWcmUndoUndoConfigInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmUndoUndoConfigInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmUndoUndoConfigProperties")) {
		ComDayCqWcmUndoUndoConfigProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmUndoUndoConfigProperties", "");
	}
	else {
		
		ComDayCqWcmUndoUndoConfigProperties obj = static_cast<ComDayCqWcmUndoUndoConfigProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
