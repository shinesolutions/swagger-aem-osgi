...
void
OrgApacheSlingI18nImplJcrResourceBundleProviderInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingI18nImplJcrResourceBundleProviderProperties();
...
void
OrgApacheSlingI18nImplJcrResourceBundleProviderInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingI18nImplJcrResourceBundleProviderInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingI18nImplJcrResourceBundleProviderProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingI18nImplJcrResourceBundleProviderProperties", "OrgApacheSlingI18nImplJcrResourceBundleProviderProperties");
		} else {
			
			OrgApacheSlingI18nImplJcrResourceBundleProviderProperties* obj = static_cast<OrgApacheSlingI18nImplJcrResourceBundleProviderProperties*> (&properties);
...
OrgApacheSlingI18nImplJcrResourceBundleProviderInfo::OrgApacheSlingI18nImplJcrResourceBundleProviderInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingI18nImplJcrResourceBundleProviderInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingI18nImplJcrResourceBundleProviderProperties")) {
		OrgApacheSlingI18nImplJcrResourceBundleProviderProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingI18nImplJcrResourceBundleProviderProperties", "");
	}
	else {
		
		OrgApacheSlingI18nImplJcrResourceBundleProviderProperties obj = static_cast<OrgApacheSlingI18nImplJcrResourceBundleProviderProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
