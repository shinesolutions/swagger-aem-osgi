...
void
ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryProperties::__init()
{
...
void
ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryProperties::__cleanup()
{
...
void
ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryProperties::fromJson(char* jsonStr)
{
...
ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryProperties::ComDayCqMcmCampaignImporterPersonalizedTextHandlerFactoryProperties(char* json)
{
	this->fromJson(json);
}
