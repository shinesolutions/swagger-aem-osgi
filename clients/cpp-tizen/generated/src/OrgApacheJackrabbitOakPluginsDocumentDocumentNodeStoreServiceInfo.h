...
#ifndef _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo_H_
#define _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo_H_
...
class OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo();
	OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServiceInfo_H_ */
