...
#ifndef _OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo_H_
#define _OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo_H_
...
class OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo();
	OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo_H_ */
