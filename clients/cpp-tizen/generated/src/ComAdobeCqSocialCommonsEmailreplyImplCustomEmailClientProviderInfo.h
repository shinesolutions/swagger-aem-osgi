...
#ifndef _ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo_H_
#define _ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo_H_
...
class ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo();
	ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsEmailreplyImplCustomEmailClientProviderInfo_H_ */
