...
void
OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties", "OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties");
		} else {
			
			OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties* obj = static_cast<OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties*> (&properties);
...
OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo::OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingServiceusermappingImplServiceUserMapperImplInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties")) {
		OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties", "");
	}
	else {
		
		OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties obj = static_cast<OrgApacheSlingServiceusermappingImplServiceUserMapperImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
