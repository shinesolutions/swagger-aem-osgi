...
#ifndef _OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H_
#define _OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H_
...
class OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties();
	OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties(char* str);
	...
	/*! \brief Get 
	 */
	ConfigNodePropertyBoolean getRegisterDescriptors();

	/*! \brief Set 
	 */
	void setRegisterDescriptors(ConfigNodePropertyBoolean  registerDescriptors);
	/*! \brief Get 
	 */
	ConfigNodePropertyBoolean getDispatchChanges();

	/*! \brief Set 
	 */
	void setDispatchChanges(ConfigNodePropertyBoolean  dispatchChanges);
...
#endif /* _OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties_H_ */
