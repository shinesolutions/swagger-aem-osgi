...
#ifndef _ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties_H_
#define _ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties_H_
...
class ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties();
	ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties(char* str);
...
#endif /* _ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties_H_ */
