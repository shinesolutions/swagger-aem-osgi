...
#ifndef _ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo_H_
#define _ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo_H_
...
class ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo();
	ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo(char* str);
...
#endif /* _ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo_H_ */
