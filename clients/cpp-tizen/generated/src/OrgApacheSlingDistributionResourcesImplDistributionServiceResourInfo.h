...
#ifndef _OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo_H_
#define _OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo_H_
...
class OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo();
	OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionResourcesImplDistributionServiceResourInfo_H_ */
