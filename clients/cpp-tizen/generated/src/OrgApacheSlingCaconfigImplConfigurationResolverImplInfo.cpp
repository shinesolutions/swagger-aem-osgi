...
void
OrgApacheSlingCaconfigImplConfigurationResolverImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingCaconfigImplConfigurationResolverImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingCaconfigImplConfigurationResolverImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingCaconfigImplConfigurationResolverImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingCaconfigImplConfigurationResolverImplProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingCaconfigImplConfigurationResolverImplProperties", "OrgApacheSlingCaconfigImplConfigurationResolverImplProperties");
		} else {
			
			OrgApacheSlingCaconfigImplConfigurationResolverImplProperties* obj = static_cast<OrgApacheSlingCaconfigImplConfigurationResolverImplProperties*> (&properties);
...
OrgApacheSlingCaconfigImplConfigurationResolverImplInfo::OrgApacheSlingCaconfigImplConfigurationResolverImplInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingCaconfigImplConfigurationResolverImplInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingCaconfigImplConfigurationResolverImplProperties")) {
		OrgApacheSlingCaconfigImplConfigurationResolverImplProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingCaconfigImplConfigurationResolverImplProperties", "");
	}
	else {
		
		OrgApacheSlingCaconfigImplConfigurationResolverImplProperties obj = static_cast<OrgApacheSlingCaconfigImplConfigurationResolverImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
