...
#ifndef _ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo_H_
#define _ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo_H_
...
class ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo();
	ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo(char* str);
...
#endif /* _ComAdobeCqSocialMembersEndpointsImplCommunityMemberGroupProfileInfo_H_ */
