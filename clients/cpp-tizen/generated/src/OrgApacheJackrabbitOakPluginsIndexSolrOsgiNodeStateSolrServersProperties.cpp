...
void
OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::__init()
{
	//enabled = new ConfigNodePropertyBoolean();
}

void
OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::__cleanup()
{
	//if(enabled != NULL) {
	//
	//delete enabled;
...
void
OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::fromJson(char* jsonStr)
{
...
OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties(char* json)
{
	this->fromJson(json);
}
