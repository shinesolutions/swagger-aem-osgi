...
#ifndef _OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo_H_
#define _OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo_H_
...
class OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo();
	OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionPackagingImplExporterLocalDistributioInfo_H_ */
