...
#ifndef _ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo_H_
#define _ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo_H_
...
class ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo();
	ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsUgclimitsconfigImplCommunityUserUGCLimitInfo_H_ */
