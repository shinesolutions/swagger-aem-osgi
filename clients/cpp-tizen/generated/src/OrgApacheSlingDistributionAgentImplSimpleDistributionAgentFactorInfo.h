...
#ifndef _OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo_H_
#define _OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo_H_
...
class OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo();
	OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionAgentImplSimpleDistributionAgentFactorInfo_H_ */
