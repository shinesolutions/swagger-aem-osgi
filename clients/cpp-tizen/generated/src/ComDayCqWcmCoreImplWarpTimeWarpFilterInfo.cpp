...
void
ComDayCqWcmCoreImplWarpTimeWarpFilterInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmCoreImplWarpTimeWarpFilterProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmCoreImplWarpTimeWarpFilterInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmCoreImplWarpTimeWarpFilterInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmCoreImplWarpTimeWarpFilterProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmCoreImplWarpTimeWarpFilterProperties", "ComDayCqWcmCoreImplWarpTimeWarpFilterProperties");
		} else {
			
			ComDayCqWcmCoreImplWarpTimeWarpFilterProperties* obj = static_cast<ComDayCqWcmCoreImplWarpTimeWarpFilterProperties*> (&properties);
...
ComDayCqWcmCoreImplWarpTimeWarpFilterInfo::ComDayCqWcmCoreImplWarpTimeWarpFilterInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmCoreImplWarpTimeWarpFilterInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmCoreImplWarpTimeWarpFilterProperties")) {
		ComDayCqWcmCoreImplWarpTimeWarpFilterProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmCoreImplWarpTimeWarpFilterProperties", "");
	}
	else {
		
		ComDayCqWcmCoreImplWarpTimeWarpFilterProperties obj = static_cast<ComDayCqWcmCoreImplWarpTimeWarpFilterProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
