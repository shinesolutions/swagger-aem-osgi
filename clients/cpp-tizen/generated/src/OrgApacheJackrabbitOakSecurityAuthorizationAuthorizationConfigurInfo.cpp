...
void
OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties")) {
			jsonToValue(&properties, node, "OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties", "OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties");
		} else {
			
			OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties* obj = static_cast<OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties*> (&properties);
...
OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::toJson()
{
	...
	if (isprimitive("OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties")) {
		OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties", "");
	}
	else {
		
		OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties obj = static_cast<OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
