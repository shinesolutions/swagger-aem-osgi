...
#ifndef _ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo_H_
#define _ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo_H_
...
class ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo();
	ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo(char* str);
...
#endif /* _ComAdobeGraniteDistributionCoreImplTransportAccessTokenDistribuInfo_H_ */
