...
#ifndef _OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo_H_
#define _OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo_H_
...
class OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo();
	OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo_H_ */
