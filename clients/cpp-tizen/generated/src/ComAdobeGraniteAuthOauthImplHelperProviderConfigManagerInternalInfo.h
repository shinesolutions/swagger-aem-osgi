...
#ifndef _ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo_H_
#define _ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo_H_
...
class ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo();
	ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo(char* str);
...
#endif /* _ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo_H_ */
