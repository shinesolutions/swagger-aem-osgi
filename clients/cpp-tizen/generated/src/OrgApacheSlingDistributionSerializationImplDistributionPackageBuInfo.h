...
#ifndef _OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo_H_
#define _OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo_H_
...
class OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo();
	OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo_H_ */
