...
void
OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::__init()
{
...
void
OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::__cleanup()
{
...
void
OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::fromJson(char* jsonStr)
{
...
OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties::OrgApacheSlingDistributionResourcesImplDistributionServiceResourProperties(char* json)
{
	this->fromJson(json);
}
