...
void
OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties")) {
			jsonToValue(&properties, node, "OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties", "OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties");
		} else {
			
			OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties* obj = static_cast<OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties*> (&properties);
...
OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo::OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo::toJson()
{
	...
	if (isprimitive("OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties")) {
		OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties", "");
	}
	else {
		
		OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties obj = static_cast<OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
