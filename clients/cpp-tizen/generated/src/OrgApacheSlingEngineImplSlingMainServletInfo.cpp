...
void
OrgApacheSlingEngineImplSlingMainServletInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingEngineImplSlingMainServletProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingEngineImplSlingMainServletInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingEngineImplSlingMainServletInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingEngineImplSlingMainServletProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingEngineImplSlingMainServletProperties", "OrgApacheSlingEngineImplSlingMainServletProperties");
		} else {
			
			OrgApacheSlingEngineImplSlingMainServletProperties* obj = static_cast<OrgApacheSlingEngineImplSlingMainServletProperties*> (&properties);
...
OrgApacheSlingEngineImplSlingMainServletInfo::OrgApacheSlingEngineImplSlingMainServletInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingEngineImplSlingMainServletInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingEngineImplSlingMainServletProperties")) {
		OrgApacheSlingEngineImplSlingMainServletProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingEngineImplSlingMainServletProperties", "");
	}
	else {
		
		OrgApacheSlingEngineImplSlingMainServletProperties obj = static_cast<OrgApacheSlingEngineImplSlingMainServletProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
