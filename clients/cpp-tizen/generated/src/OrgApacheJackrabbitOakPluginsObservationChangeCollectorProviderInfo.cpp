...
void
OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties")) {
			jsonToValue(&properties, node, "OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties", "OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties");
		} else {
			
			OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties* obj = static_cast<OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties*> (&properties);
...
OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo::OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo::toJson()
{
	...
	if (isprimitive("OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties")) {
		OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties", "");
	}
	else {
		
		OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties obj = static_cast<OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
