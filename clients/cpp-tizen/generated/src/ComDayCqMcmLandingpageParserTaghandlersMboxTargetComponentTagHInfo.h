...
#ifndef _ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo_H_
#define _ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo_H_
...
class ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo();
	ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo(char* str);
...
#endif /* _ComDayCqMcmLandingpageParserTaghandlersMboxTargetComponentTagHInfo_H_ */
