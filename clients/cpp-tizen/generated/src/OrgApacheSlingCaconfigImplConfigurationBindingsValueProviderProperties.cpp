...
void
OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderProperties::__init()
{
	//enabled = new ConfigNodePropertyBoolean();
}

void
OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderProperties::__cleanup()
{
	//if(enabled != NULL) {
	//
	//delete enabled;
...
void
OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderProperties::fromJson(char* jsonStr)
{
...
OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderProperties::OrgApacheSlingCaconfigImplConfigurationBindingsValueProviderProperties(char* json)
{
	this->fromJson(json);
}
