...
#ifndef _ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo_H_
#define _ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo_H_
...
class ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo();
	ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo(char* str);
...
#endif /* _ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplInfo_H_ */
