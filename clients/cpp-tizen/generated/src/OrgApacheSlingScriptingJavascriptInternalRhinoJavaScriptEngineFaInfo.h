...
#ifndef _OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo_H_
#define _OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo_H_
...
class OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo();
	OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo(char* str);
...
#endif /* _OrgApacheSlingScriptingJavascriptInternalRhinoJavaScriptEngineFaInfo_H_ */
