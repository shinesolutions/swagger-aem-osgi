...
void
ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties")) {
			jsonToValue(&properties, node, "ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties", "ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties");
		} else {
			
			ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties* obj = static_cast<ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties*> (&properties);
...
ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo::ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo::toJson()
{
	...
	if (isprimitive("ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties")) {
		ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties", "");
	}
	else {
		
		ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties obj = static_cast<ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
