...
#ifndef _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo_H_
#define _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo_H_
...
class OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo();
	OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo(char* str);
...
#endif /* _OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo_H_ */
