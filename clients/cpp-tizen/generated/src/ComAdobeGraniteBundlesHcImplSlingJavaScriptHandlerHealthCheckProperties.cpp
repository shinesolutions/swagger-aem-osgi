...
void
ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
