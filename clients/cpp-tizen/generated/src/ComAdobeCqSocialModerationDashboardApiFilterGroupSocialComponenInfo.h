...
#ifndef _ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo_H_
#define _ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo_H_
...
class ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo();
	ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo(char* str);
...
#endif /* _ComAdobeCqSocialModerationDashboardApiFilterGroupSocialComponenInfo_H_ */
