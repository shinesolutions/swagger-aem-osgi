...
#ifndef _OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo_H_
#define _OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo_H_
...
class OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo();
	OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionPackagingImplImporterRemoteDistributiInfo_H_ */
