...
#ifndef _ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo_H_
#define _ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo_H_
...
class ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo();
	ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo(char* str);
...
#endif /* _ComAdobeAemUpgradePrechecksTasksImplConsistencyCheckTaskImplInfo_H_ */
