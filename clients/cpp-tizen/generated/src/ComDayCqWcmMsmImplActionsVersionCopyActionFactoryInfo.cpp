...
void
ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties", "ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties");
		} else {
			
			ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties* obj = static_cast<ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties*> (&properties);
...
ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo::ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties")) {
		ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties", "");
	}
	else {
		
		ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties obj = static_cast<ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
