...
#ifndef _ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo_H_
#define _ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo_H_
...
class ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo();
	ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsEmailreplyImplEmailQuotedTextPatternsImpInfo_H_ */
