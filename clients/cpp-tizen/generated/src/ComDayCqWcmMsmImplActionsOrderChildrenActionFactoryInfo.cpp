...
void
ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties")) {
			jsonToValue(&properties, node, "ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties", "ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties");
		} else {
			
			ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties* obj = static_cast<ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties*> (&properties);
...
ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo::ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryInfo::toJson()
{
	...
	if (isprimitive("ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties")) {
		ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties", "");
	}
	else {
		
		ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties obj = static_cast<ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
