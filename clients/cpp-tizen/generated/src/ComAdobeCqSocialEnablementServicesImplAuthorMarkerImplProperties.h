...
class ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties();
	ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties(char* str);
...
#endif /* _ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties_H_ */
