...
#ifndef _OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo_H_
#define _OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo_H_
...
class OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo();
	OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo(char* str);
...
#endif /* _OrgApacheSlingDistributionAgentImplForwardDistributionAgentFactoInfo_H_ */
