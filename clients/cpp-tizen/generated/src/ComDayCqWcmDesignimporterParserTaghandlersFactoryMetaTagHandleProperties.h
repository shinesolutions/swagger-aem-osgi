...
#ifndef _ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties_H_
#define _ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties_H_
...
class ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties();
	ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties(char* str);
...
#endif /* _ComDayCqWcmDesignimporterParserTaghandlersFactoryMetaTagHandleProperties_H_ */
