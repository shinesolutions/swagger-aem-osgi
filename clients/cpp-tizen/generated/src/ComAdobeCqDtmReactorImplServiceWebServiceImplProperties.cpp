...
void
ComAdobeCqDtmReactorImplServiceWebServiceImplProperties::__init()
{
...
void
ComAdobeCqDtmReactorImplServiceWebServiceImplProperties::__cleanup()
{
	//if(endpointUri != NULL) {
	//
	//delete endpointUri;
...
void
ComAdobeCqDtmReactorImplServiceWebServiceImplProperties::fromJson(char* jsonStr)
{
...
ComAdobeCqDtmReactorImplServiceWebServiceImplProperties::ComAdobeCqDtmReactorImplServiceWebServiceImplProperties(char* json)
{
	this->fromJson(json);
}
