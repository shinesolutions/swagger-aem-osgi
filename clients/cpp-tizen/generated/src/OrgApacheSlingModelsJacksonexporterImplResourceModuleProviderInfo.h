...
#ifndef _OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo_H_
#define _OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo_H_
...
class OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo();
	OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo(char* str);
...
#endif /* _OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo_H_ */
