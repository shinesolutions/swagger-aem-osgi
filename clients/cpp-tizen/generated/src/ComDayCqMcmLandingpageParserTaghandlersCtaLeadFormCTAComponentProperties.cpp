...
void
ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCTAComponentProperties::__init()
{
...
void
ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCTAComponentProperties::__cleanup()
{
...
void
ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCTAComponentProperties::fromJson(char* jsonStr)
{
...
ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCTAComponentProperties::ComDayCqMcmLandingpageParserTaghandlersCtaLeadFormCTAComponentProperties(char* json)
{
	this->fromJson(json);
}
