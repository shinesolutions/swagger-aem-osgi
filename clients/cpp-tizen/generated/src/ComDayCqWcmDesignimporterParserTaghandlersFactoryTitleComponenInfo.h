...
#ifndef _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo_H_
#define _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo_H_
...
class ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo();
	ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo(char* str);
...
#endif /* _ComDayCqWcmDesignimporterParserTaghandlersFactoryTitleComponenInfo_H_ */
