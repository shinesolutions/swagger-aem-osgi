...
#ifndef _MessagingUserComponentFactoryInfo_H_
#define _MessagingUserComponentFactoryInfo_H_
...
class MessagingUserComponentFactoryInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	MessagingUserComponentFactoryInfo();
	MessagingUserComponentFactoryInfo(char* str);
...
#endif /* _MessagingUserComponentFactoryInfo_H_ */
