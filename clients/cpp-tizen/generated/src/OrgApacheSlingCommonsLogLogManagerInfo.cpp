...
void
OrgApacheSlingCommonsLogLogManagerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingCommonsLogLogManagerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingCommonsLogLogManagerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingCommonsLogLogManagerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingCommonsLogLogManagerProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingCommonsLogLogManagerProperties", "OrgApacheSlingCommonsLogLogManagerProperties");
		} else {
			
			OrgApacheSlingCommonsLogLogManagerProperties* obj = static_cast<OrgApacheSlingCommonsLogLogManagerProperties*> (&properties);
...
OrgApacheSlingCommonsLogLogManagerInfo::OrgApacheSlingCommonsLogLogManagerInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingCommonsLogLogManagerInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingCommonsLogLogManagerProperties")) {
		OrgApacheSlingCommonsLogLogManagerProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingCommonsLogLogManagerProperties", "");
	}
	else {
		
		OrgApacheSlingCommonsLogLogManagerProperties obj = static_cast<OrgApacheSlingCommonsLogLogManagerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
