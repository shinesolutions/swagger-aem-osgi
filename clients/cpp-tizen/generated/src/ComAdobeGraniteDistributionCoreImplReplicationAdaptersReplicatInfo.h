...
#ifndef _ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo_H_
#define _ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo_H_
...
class ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo();
	ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo(char* str);
...
#endif /* _ComAdobeGraniteDistributionCoreImplReplicationAdaptersReplicatInfo_H_ */
