...
void
ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties::ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties(char* json)
{
	this->fromJson(json);
}
