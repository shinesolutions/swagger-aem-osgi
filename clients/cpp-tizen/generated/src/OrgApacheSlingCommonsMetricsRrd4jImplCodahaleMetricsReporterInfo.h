...
#ifndef _OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo_H_
#define _OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo_H_
...
class OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo();
	OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo(char* str);
...
#endif /* _OrgApacheSlingCommonsMetricsRrd4jImplCodahaleMetricsReporterInfo_H_ */
