...
void
ComAdobeGraniteLoggingImplLogErrorHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteLoggingImplLogErrorHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteLoggingImplLogErrorHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteLoggingImplLogErrorHealthCheckProperties::ComAdobeGraniteLoggingImplLogErrorHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
