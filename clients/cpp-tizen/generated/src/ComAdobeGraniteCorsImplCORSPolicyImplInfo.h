...
#ifndef _ComAdobeGraniteCorsImplCORSPolicyImplInfo_H_
#define _ComAdobeGraniteCorsImplCORSPolicyImplInfo_H_
...
class ComAdobeGraniteCorsImplCORSPolicyImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteCorsImplCORSPolicyImplInfo();
	ComAdobeGraniteCorsImplCORSPolicyImplInfo(char* str);
...
#endif /* _ComAdobeGraniteCorsImplCORSPolicyImplInfo_H_ */
