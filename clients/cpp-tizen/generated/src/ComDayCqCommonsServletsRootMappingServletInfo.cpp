...
void
ComDayCqCommonsServletsRootMappingServletInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqCommonsServletsRootMappingServletProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqCommonsServletsRootMappingServletInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqCommonsServletsRootMappingServletInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqCommonsServletsRootMappingServletProperties")) {
			jsonToValue(&properties, node, "ComDayCqCommonsServletsRootMappingServletProperties", "ComDayCqCommonsServletsRootMappingServletProperties");
		} else {
			
			ComDayCqCommonsServletsRootMappingServletProperties* obj = static_cast<ComDayCqCommonsServletsRootMappingServletProperties*> (&properties);
...
ComDayCqCommonsServletsRootMappingServletInfo::ComDayCqCommonsServletsRootMappingServletInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqCommonsServletsRootMappingServletInfo::toJson()
{
	...
	if (isprimitive("ComDayCqCommonsServletsRootMappingServletProperties")) {
		ComDayCqCommonsServletsRootMappingServletProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqCommonsServletsRootMappingServletProperties", "");
	}
	else {
		
		ComDayCqCommonsServletsRootMappingServletProperties obj = static_cast<ComDayCqCommonsServletsRootMappingServletProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
