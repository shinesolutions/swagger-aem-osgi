...
void
ComAdobeGraniteSecurityUserUserPropertiesServiceInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteSecurityUserUserPropertiesServiceProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteSecurityUserUserPropertiesServiceInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteSecurityUserUserPropertiesServiceInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteSecurityUserUserPropertiesServiceProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteSecurityUserUserPropertiesServiceProperties", "ComAdobeGraniteSecurityUserUserPropertiesServiceProperties");
		} else {
			
			ComAdobeGraniteSecurityUserUserPropertiesServiceProperties* obj = static_cast<ComAdobeGraniteSecurityUserUserPropertiesServiceProperties*> (&properties);
...
ComAdobeGraniteSecurityUserUserPropertiesServiceInfo::ComAdobeGraniteSecurityUserUserPropertiesServiceInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteSecurityUserUserPropertiesServiceInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteSecurityUserUserPropertiesServiceProperties")) {
		ComAdobeGraniteSecurityUserUserPropertiesServiceProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteSecurityUserUserPropertiesServiceProperties", "");
	}
	else {
		
		ComAdobeGraniteSecurityUserUserPropertiesServiceProperties obj = static_cast<ComAdobeGraniteSecurityUserUserPropertiesServiceProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
