...
void
ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::__init()
{
	//oauthproviderid = new ConfigNodePropertyString();
}

void
ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::__cleanup()
{
...
void
ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties(char* json)
{
	this->fromJson(json);
}
