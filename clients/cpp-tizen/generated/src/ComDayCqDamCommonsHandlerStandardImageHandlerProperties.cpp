...
void
ComDayCqDamCommonsHandlerStandardImageHandlerProperties::__init()
{
...
void
ComDayCqDamCommonsHandlerStandardImageHandlerProperties::__cleanup()
{
...
void
ComDayCqDamCommonsHandlerStandardImageHandlerProperties::fromJson(char* jsonStr)
{
...
ComDayCqDamCommonsHandlerStandardImageHandlerProperties::ComDayCqDamCommonsHandlerStandardImageHandlerProperties(char* json)
{
	this->fromJson(json);
}
