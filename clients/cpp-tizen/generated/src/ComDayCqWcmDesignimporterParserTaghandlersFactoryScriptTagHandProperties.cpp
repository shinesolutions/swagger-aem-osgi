...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryScriptTagHandProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryScriptTagHandProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryScriptTagHandProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryScriptTagHandProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryScriptTagHandProperties(char* json)
{
	this->fromJson(json);
}
