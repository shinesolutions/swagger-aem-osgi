...
#ifndef _ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo_H_
#define _ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo_H_
...
class ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo();
	ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo(char* str);
...
#endif /* _ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo_H_ */
