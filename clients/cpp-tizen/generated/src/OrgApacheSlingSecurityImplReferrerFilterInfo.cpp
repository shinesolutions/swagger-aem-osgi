...
void
OrgApacheSlingSecurityImplReferrerFilterInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingSecurityImplReferrerFilterProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingSecurityImplReferrerFilterInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingSecurityImplReferrerFilterInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingSecurityImplReferrerFilterProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingSecurityImplReferrerFilterProperties", "OrgApacheSlingSecurityImplReferrerFilterProperties");
		} else {
			
			OrgApacheSlingSecurityImplReferrerFilterProperties* obj = static_cast<OrgApacheSlingSecurityImplReferrerFilterProperties*> (&properties);
...
OrgApacheSlingSecurityImplReferrerFilterInfo::OrgApacheSlingSecurityImplReferrerFilterInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingSecurityImplReferrerFilterInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingSecurityImplReferrerFilterProperties")) {
		OrgApacheSlingSecurityImplReferrerFilterProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingSecurityImplReferrerFilterProperties", "");
	}
	else {
		
		OrgApacheSlingSecurityImplReferrerFilterProperties obj = static_cast<OrgApacheSlingSecurityImplReferrerFilterProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
