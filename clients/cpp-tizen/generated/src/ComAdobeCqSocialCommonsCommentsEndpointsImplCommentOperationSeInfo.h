...
#ifndef _ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo_H_
#define _ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo_H_
...
class ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo();
	ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo(char* str);
...
#endif /* _ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeInfo_H_ */
