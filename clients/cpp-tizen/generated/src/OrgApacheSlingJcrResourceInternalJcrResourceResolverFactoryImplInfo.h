...
#ifndef _OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo_H_
#define _OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo_H_
...
class OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo();
	OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo(char* str);
...
#endif /* _OrgApacheSlingJcrResourceInternalJcrResourceResolverFactoryImplInfo_H_ */
