...
void
ComAdobeGraniteOptoutImplOptOutServiceImplInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeGraniteOptoutImplOptOutServiceImplProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComAdobeGraniteOptoutImplOptOutServiceImplInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeGraniteOptoutImplOptOutServiceImplInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeGraniteOptoutImplOptOutServiceImplProperties")) {
			jsonToValue(&properties, node, "ComAdobeGraniteOptoutImplOptOutServiceImplProperties", "ComAdobeGraniteOptoutImplOptOutServiceImplProperties");
		} else {
			
			ComAdobeGraniteOptoutImplOptOutServiceImplProperties* obj = static_cast<ComAdobeGraniteOptoutImplOptOutServiceImplProperties*> (&properties);
...
ComAdobeGraniteOptoutImplOptOutServiceImplInfo::ComAdobeGraniteOptoutImplOptOutServiceImplInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeGraniteOptoutImplOptOutServiceImplInfo::toJson()
{
	...
	if (isprimitive("ComAdobeGraniteOptoutImplOptOutServiceImplProperties")) {
		ComAdobeGraniteOptoutImplOptOutServiceImplProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeGraniteOptoutImplOptOutServiceImplProperties", "");
	}
	else {
		
		ComAdobeGraniteOptoutImplOptOutServiceImplProperties obj = static_cast<ComAdobeGraniteOptoutImplOptOutServiceImplProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
