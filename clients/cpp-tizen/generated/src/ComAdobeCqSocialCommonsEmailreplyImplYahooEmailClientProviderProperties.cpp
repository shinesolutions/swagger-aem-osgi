...
void
ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::__init()
{
...
void
ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::__cleanup()
{
...
void
ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::fromJson(char* jsonStr)
{
...
ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties::ComAdobeCqSocialCommonsEmailreplyImplYahooEmailClientProviderProperties(char* json)
{
	this->fromJson(json);
}
