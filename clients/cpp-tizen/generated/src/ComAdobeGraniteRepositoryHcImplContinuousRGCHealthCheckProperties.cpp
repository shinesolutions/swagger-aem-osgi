...
void
ComAdobeGraniteRepositoryHcImplContinuousRGCHealthCheckProperties::__init()
{
	//hctags = new ConfigNodePropertyArray();
}

void
ComAdobeGraniteRepositoryHcImplContinuousRGCHealthCheckProperties::__cleanup()
{
	//if(hctags != NULL) {
	//
	//delete hctags;
...
void
ComAdobeGraniteRepositoryHcImplContinuousRGCHealthCheckProperties::fromJson(char* jsonStr)
{
...
ComAdobeGraniteRepositoryHcImplContinuousRGCHealthCheckProperties::ComAdobeGraniteRepositoryHcImplContinuousRGCHealthCheckProperties(char* json)
{
	this->fromJson(json);
}
