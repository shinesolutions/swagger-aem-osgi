...
void
OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties")) {
			jsonToValue(&properties, node, "OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties", "OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties");
		} else {
			
			OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties* obj = static_cast<OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties*> (&properties);
...
OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo::OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableInfo::toJson()
{
	...
	if (isprimitive("OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties")) {
		OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties", "");
	}
	else {
		
		OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties obj = static_cast<OrgApacheJackrabbitOakSpiSecurityUserActionDefaultAuthorizableProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
