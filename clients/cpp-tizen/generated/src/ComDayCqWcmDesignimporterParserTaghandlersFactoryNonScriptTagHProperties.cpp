...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryNonScriptTagHProperties(char* json)
{
	this->fromJson(json);
}
