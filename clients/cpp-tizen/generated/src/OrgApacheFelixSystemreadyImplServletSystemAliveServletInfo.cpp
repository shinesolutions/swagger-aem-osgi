...
void
OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties")) {
			jsonToValue(&properties, node, "OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties", "OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties");
		} else {
			
			OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties* obj = static_cast<OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties*> (&properties);
...
OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo::OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheFelixSystemreadyImplServletSystemAliveServletInfo::toJson()
{
	...
	if (isprimitive("OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties")) {
		OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties", "");
	}
	else {
		
		OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties obj = static_cast<OrgApacheFelixSystemreadyImplServletSystemAliveServletProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
