...
void
OrgApacheSlingEventImplJobsJobConsumerManagerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new OrgApacheSlingEventImplJobsJobConsumerManagerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
OrgApacheSlingEventImplJobsJobConsumerManagerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
OrgApacheSlingEventImplJobsJobConsumerManagerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OrgApacheSlingEventImplJobsJobConsumerManagerProperties")) {
			jsonToValue(&properties, node, "OrgApacheSlingEventImplJobsJobConsumerManagerProperties", "OrgApacheSlingEventImplJobsJobConsumerManagerProperties");
		} else {
			
			OrgApacheSlingEventImplJobsJobConsumerManagerProperties* obj = static_cast<OrgApacheSlingEventImplJobsJobConsumerManagerProperties*> (&properties);
...
OrgApacheSlingEventImplJobsJobConsumerManagerInfo::OrgApacheSlingEventImplJobsJobConsumerManagerInfo(char* json)
{
	this->fromJson(json);
}
...
OrgApacheSlingEventImplJobsJobConsumerManagerInfo::toJson()
{
	...
	if (isprimitive("OrgApacheSlingEventImplJobsJobConsumerManagerProperties")) {
		OrgApacheSlingEventImplJobsJobConsumerManagerProperties obj = getProperties();
		node = converttoJson(&obj, "OrgApacheSlingEventImplJobsJobConsumerManagerProperties", "");
	}
	else {
		
		OrgApacheSlingEventImplJobsJobConsumerManagerProperties obj = static_cast<OrgApacheSlingEventImplJobsJobConsumerManagerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
