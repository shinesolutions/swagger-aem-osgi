...
#ifndef _ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo_H_
#define _ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo_H_
...
class ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo();
	ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo(char* str);
...
#endif /* _ComAdobeGraniteSecurityUserUiInternalServletsSSLConfigurationSInfo_H_ */
