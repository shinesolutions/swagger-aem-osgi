...
#ifndef _ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo_H_
#define _ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo_H_
...
class ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo();
	ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo(char* str);
...
#endif /* _ComAdobeCqScreensOfflinecontentImplOfflineContentServiceImplInfo_H_ */
