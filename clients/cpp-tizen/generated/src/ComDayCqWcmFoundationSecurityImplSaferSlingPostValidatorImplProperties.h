...
#ifndef _ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties_H_
#define _ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties_H_
...
class ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties();
	ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties(char* str);
...
#endif /* _ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties_H_ */
