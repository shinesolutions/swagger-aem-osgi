...
#ifndef _OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo_H_
#define _OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo_H_
...
class OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo();
	OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo(char* str);
...
#endif /* _OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo_H_ */
