...
void
ComAdobeCqAccountApiAccountManagementServiceInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComAdobeCqAccountApiAccountManagementServiceProperties();
...
void
ComAdobeCqAccountApiAccountManagementServiceInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComAdobeCqAccountApiAccountManagementServiceInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComAdobeCqAccountApiAccountManagementServiceProperties")) {
			jsonToValue(&properties, node, "ComAdobeCqAccountApiAccountManagementServiceProperties", "ComAdobeCqAccountApiAccountManagementServiceProperties");
		} else {
			
			ComAdobeCqAccountApiAccountManagementServiceProperties* obj = static_cast<ComAdobeCqAccountApiAccountManagementServiceProperties*> (&properties);
...
ComAdobeCqAccountApiAccountManagementServiceInfo::ComAdobeCqAccountApiAccountManagementServiceInfo(char* json)
{
	this->fromJson(json);
}
...
ComAdobeCqAccountApiAccountManagementServiceInfo::toJson()
{
	...
	if (isprimitive("ComAdobeCqAccountApiAccountManagementServiceProperties")) {
		ComAdobeCqAccountApiAccountManagementServiceProperties obj = getProperties();
		node = converttoJson(&obj, "ComAdobeCqAccountApiAccountManagementServiceProperties", "");
	}
	else {
		
		ComAdobeCqAccountApiAccountManagementServiceProperties obj = static_cast<ComAdobeCqAccountApiAccountManagementServiceProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
