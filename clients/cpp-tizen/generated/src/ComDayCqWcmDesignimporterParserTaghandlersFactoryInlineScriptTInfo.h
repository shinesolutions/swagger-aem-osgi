...
#ifndef _ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo_H_
#define _ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo_H_
...
class ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo();
	ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo(char* str);
...
#endif /* _ComDayCqWcmDesignimporterParserTaghandlersFactoryInlineScriptTInfo_H_ */
