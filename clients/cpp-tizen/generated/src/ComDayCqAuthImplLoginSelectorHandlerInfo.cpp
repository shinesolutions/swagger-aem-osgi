...
void
ComDayCqAuthImplLoginSelectorHandlerInfo::__init()
{
	//pid = std::string();
	//title = std::string();
	//description = std::string();
	//properties = new ComDayCqAuthImplLoginSelectorHandlerProperties();
	//bundle_location = std::string();
	//service_location = std::string();
}

void
ComDayCqAuthImplLoginSelectorHandlerInfo::__cleanup()
{
	//if(pid != NULL) {
	//
	//delete pid;
...
void
ComDayCqAuthImplLoginSelectorHandlerInfo::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("ComDayCqAuthImplLoginSelectorHandlerProperties")) {
			jsonToValue(&properties, node, "ComDayCqAuthImplLoginSelectorHandlerProperties", "ComDayCqAuthImplLoginSelectorHandlerProperties");
		} else {
			
			ComDayCqAuthImplLoginSelectorHandlerProperties* obj = static_cast<ComDayCqAuthImplLoginSelectorHandlerProperties*> (&properties);
...
ComDayCqAuthImplLoginSelectorHandlerInfo::ComDayCqAuthImplLoginSelectorHandlerInfo(char* json)
{
	this->fromJson(json);
}
...
ComDayCqAuthImplLoginSelectorHandlerInfo::toJson()
{
	...
	if (isprimitive("ComDayCqAuthImplLoginSelectorHandlerProperties")) {
		ComDayCqAuthImplLoginSelectorHandlerProperties obj = getProperties();
		node = converttoJson(&obj, "ComDayCqAuthImplLoginSelectorHandlerProperties", "");
	}
	else {
		
		ComDayCqAuthImplLoginSelectorHandlerProperties obj = static_cast<ComDayCqAuthImplLoginSelectorHandlerProperties> (getProperties());
		GError *mygerror;
		mygerror = NULL;
