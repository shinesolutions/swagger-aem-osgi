...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties::__init()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties::__cleanup()
{
...
void
ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties::fromJson(char* jsonStr)
{
...
ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties::ComDayCqWcmDesignimporterParserTaghandlersFactoryDefaultTagHanProperties(char* json)
{
	this->fromJson(json);
}
