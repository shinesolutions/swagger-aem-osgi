-module(openapi_com_day_cq_wcm_msm_impl_actions_content_update_action_factory_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_wcm_msm_impl_actions_content_update_action_factory_properties/0]).

-type openapi_com_day_cq_wcm_msm_impl_actions_content_update_action_factory_properties() ::
    #{ 'cq_wcm_msm_action_excludednodetypes' => openapi_config_node_property_array:openapi_config_node_property_array(),
       ...
       'cq_wcm_msm_action_ignoredMixin' => openapi_config_node_property_array:openapi_config_node_property_array()
     }.
...
encode(#{ 'cq_wcm_msm_action_excludednodetypes' := CqWcmMsmActionExcludednodetypes,
          ...
          'cq_wcm_msm_action_ignoredMixin' := CqWcmMsmActionIgnoredMixin
        }) ->
