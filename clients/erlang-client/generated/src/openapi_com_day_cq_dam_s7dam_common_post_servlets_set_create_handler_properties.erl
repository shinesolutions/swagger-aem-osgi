-module(openapi_com_day_cq_dam_s7dam_common_post_servlets_set_create_handler_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_dam_s7dam_common_post_servlets_set_create_handler_properties/0]).

-type openapi_com_day_cq_dam_s7dam_common_post_servlets_set_create_handler_properties() ::
