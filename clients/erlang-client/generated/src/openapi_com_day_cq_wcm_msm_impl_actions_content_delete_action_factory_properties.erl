-module(openapi_com_day_cq_wcm_msm_impl_actions_content_delete_action_factory_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_wcm_msm_impl_actions_content_delete_action_factory_properties/0]).

-type openapi_com_day_cq_wcm_msm_impl_actions_content_delete_action_factory_properties() ::
