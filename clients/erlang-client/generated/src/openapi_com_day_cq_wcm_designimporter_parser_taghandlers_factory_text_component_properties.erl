-module(openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_text_component_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_text_component_properties/0]).

-type openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_text_component_properties() ::
