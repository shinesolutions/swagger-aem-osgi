-module(openapi_com_adobe_aem_upgrade_prechecks_hc_impl_deprecate_indexes_hc_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_aem_upgrade_prechecks_hc_impl_deprecate_indexes_hc_properties/0]).

-type openapi_com_adobe_aem_upgrade_prechecks_hc_impl_deprecate_indexes_hc_properties() ::
