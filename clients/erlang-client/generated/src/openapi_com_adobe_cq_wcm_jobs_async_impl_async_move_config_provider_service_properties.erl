-module(openapi_com_adobe_cq_wcm_jobs_async_impl_async_move_config_provider_service_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_cq_wcm_jobs_async_impl_async_move_config_provider_service_properties/0]).

-type openapi_com_adobe_cq_wcm_jobs_async_impl_async_move_config_provider_service_properties() ::
