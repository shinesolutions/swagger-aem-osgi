-module(openapi_com_adobe_cq_audit_purge_dam_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_cq_audit_purge_dam_properties/0]).

-type openapi_com_adobe_cq_audit_purge_dam_properties() ::
