-module(openapi_com_adobe_cq_commerce_impl_asset_static_image_handler_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_cq_commerce_impl_asset_static_image_handler_properties/0]).

-type openapi_com_adobe_cq_commerce_impl_asset_static_image_handler_properties() ::
