-module(openapi_com_adobe_granite_auth_oauth_impl_helper_provider_config_manager_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_granite_auth_oauth_impl_helper_provider_config_manager_properties/0]).

-type openapi_com_adobe_granite_auth_oauth_impl_helper_provider_config_manager_properties() ::
