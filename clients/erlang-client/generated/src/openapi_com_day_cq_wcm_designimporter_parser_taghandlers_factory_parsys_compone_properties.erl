-module(openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_parsys_compone_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_parsys_compone_properties/0]).

-type openapi_com_day_cq_wcm_designimporter_parser_taghandlers_factory_parsys_compone_properties() ::
