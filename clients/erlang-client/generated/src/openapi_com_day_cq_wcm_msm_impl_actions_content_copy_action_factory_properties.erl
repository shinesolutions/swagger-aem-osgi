-module(openapi_com_day_cq_wcm_msm_impl_actions_content_copy_action_factory_properties).

-export([encode/1]).

-export_type([openapi_com_day_cq_wcm_msm_impl_actions_content_copy_action_factory_properties/0]).

-type openapi_com_day_cq_wcm_msm_impl_actions_content_copy_action_factory_properties() ::
    #{ 'cq_wcm_msm_action_excludednodetypes' => openapi_config_node_property_array:openapi_config_node_property_array(),
       ...
       'contentcopyaction_order_style' => openapi_config_node_property_drop_down:openapi_config_node_property_drop_down()
     }.
...
encode(#{ 'cq_wcm_msm_action_excludednodetypes' := CqWcmMsmActionExcludednodetypes,
          ...
          'contentcopyaction_order_style' := ContentcopyactionOrderStyle
        }) ->
