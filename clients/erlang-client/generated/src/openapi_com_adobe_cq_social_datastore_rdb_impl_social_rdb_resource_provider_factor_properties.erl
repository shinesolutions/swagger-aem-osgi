-module(openapi_com_adobe_cq_social_datastore_rdb_impl_social_rdb_resource_provider_factor_properties).

-export([encode/1]).

-export_type([openapi_com_adobe_cq_social_datastore_rdb_impl_social_rdb_resource_provider_factor_properties/0]).

-type openapi_com_adobe_cq_social_datastore_rdb_impl_social_rdb_resource_provider_factor_properties() ::
