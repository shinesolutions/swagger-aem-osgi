...
web::json::value OrgApacheSlingEngineImplLogRequestLoggerInfo::toJson() const
{
...
void OrgApacheSlingEngineImplLogRequestLoggerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingEngineImplLogRequestLoggerProperties> newItem(new OrgApacheSlingEngineImplLogRequestLoggerProperties());
...
void OrgApacheSlingEngineImplLogRequestLoggerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingEngineImplLogRequestLoggerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingEngineImplLogRequestLoggerInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplLogRequestLoggerInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplLogRequestLoggerInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingEngineImplLogRequestLoggerProperties> OrgApacheSlingEngineImplLogRequestLoggerInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setProperties(std::shared_ptr<OrgApacheSlingEngineImplLogRequestLoggerProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingEngineImplLogRequestLoggerInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingEngineImplLogRequestLoggerInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingEngineImplLogRequestLoggerInfo::setServiceLocation(utility::string_t value)
{
