...
web::json::value ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::toJson() const
{
...
void ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::fromJson(web::json::value& val)
{
...
void ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::getOauthProviderId() const
{
    return m_Oauth_provider_id;
}


void ComAdobeGraniteAuthImsImplExternalUserIdMappingProviderExtensionProperties::setOauthProviderId(std::shared_ptr<ConfigNodePropertyString> value)
{
