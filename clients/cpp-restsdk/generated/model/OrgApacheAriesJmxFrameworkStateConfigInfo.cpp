...
web::json::value OrgApacheAriesJmxFrameworkStateConfigInfo::toJson() const
{
...
void OrgApacheAriesJmxFrameworkStateConfigInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheAriesJmxFrameworkStateConfigProperties> newItem(new OrgApacheAriesJmxFrameworkStateConfigProperties());
...
void OrgApacheAriesJmxFrameworkStateConfigInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheAriesJmxFrameworkStateConfigInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheAriesJmxFrameworkStateConfigInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheAriesJmxFrameworkStateConfigInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheAriesJmxFrameworkStateConfigInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheAriesJmxFrameworkStateConfigProperties> OrgApacheAriesJmxFrameworkStateConfigInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setProperties(std::shared_ptr<OrgApacheAriesJmxFrameworkStateConfigProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheAriesJmxFrameworkStateConfigInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheAriesJmxFrameworkStateConfigInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheAriesJmxFrameworkStateConfigInfo::setServiceLocation(utility::string_t value)
{
