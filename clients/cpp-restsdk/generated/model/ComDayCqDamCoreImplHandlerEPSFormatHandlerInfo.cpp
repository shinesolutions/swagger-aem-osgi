...
web::json::value ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::toJson() const
{
...
void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties> newItem(new ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties());
...
void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties> ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo::setProperties(std::shared_ptr<ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties> value)
{
    m_Properties = value;
