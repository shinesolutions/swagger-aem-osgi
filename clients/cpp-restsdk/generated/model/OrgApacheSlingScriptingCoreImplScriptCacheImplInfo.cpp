...
web::json::value OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::toJson() const
{
...
void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingScriptingCoreImplScriptCacheImplProperties> newItem(new OrgApacheSlingScriptingCoreImplScriptCacheImplProperties());
...
void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingScriptingCoreImplScriptCacheImplInfo::setServiceLocation(utility::string_t value)
{
