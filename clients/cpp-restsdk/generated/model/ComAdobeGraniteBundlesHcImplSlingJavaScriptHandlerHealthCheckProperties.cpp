...
web::json::value ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::toJson() const
{
...
void ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::fromJson(web::json::value& val)
{
...
void ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::getHcTags() const
{
    return m_Hc_tags;
}


void ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties::setHcTags(std::shared_ptr<ConfigNodePropertyArray> value)
{
    m_Hc_tags = value;
    m_Hc_tagsIsSet = true;
}
