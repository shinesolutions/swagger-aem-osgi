...
web::json::value OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::toJson() const
{
...
void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingDistributionTransportImplUserCredentialsDistributiProperties> newItem(new OrgApacheSlingDistributionTransportImplUserCredentialsDistributiProperties());
...
void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo::setDescription(utility::string_t value)
{
    m_Description = value;
