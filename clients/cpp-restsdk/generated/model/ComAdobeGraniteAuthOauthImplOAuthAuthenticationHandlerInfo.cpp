...
web::json::value ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::toJson() const
{
...
void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerProperties> newItem(new ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerProperties());
...
void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteAuthOauthImplOAuthAuthenticationHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
