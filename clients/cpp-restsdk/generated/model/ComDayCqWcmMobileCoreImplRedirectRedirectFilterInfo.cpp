...
web::json::value ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::toJson() const
{
...
void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties> newItem(new ComDayCqWcmMobileCoreImplRedirectRedirectFilterProperties());
...
void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWcmMobileCoreImplRedirectRedirectFilterInfo::setServiceLocation(utility::string_t value)
{
