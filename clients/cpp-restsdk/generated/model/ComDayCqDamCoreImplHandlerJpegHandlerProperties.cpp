...
web::json::value ComDayCqDamCoreImplHandlerJpegHandlerProperties::toJson() const
{
...
void ComDayCqDamCoreImplHandlerJpegHandlerProperties::fromJson(web::json::value& val)
{
...
void ComDayCqDamCoreImplHandlerJpegHandlerProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplHandlerJpegHandlerProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyBoolean> ComDayCqDamCoreImplHandlerJpegHandlerProperties::getCqDamEnableExtMetaExtraction() const
{
    return m_Cq_dam_enable_ext_meta_extraction;
}


void ComDayCqDamCoreImplHandlerJpegHandlerProperties::setCqDamEnableExtMetaExtraction(std::shared_ptr<ConfigNodePropertyBoolean> value)
{
...
std::shared_ptr<ConfigNodePropertyInteger> ComDayCqDamCoreImplHandlerJpegHandlerProperties::getLargeFileThreshold() const
{
    return m_Large_file_threshold;
}


void ComDayCqDamCoreImplHandlerJpegHandlerProperties::setLargeFileThreshold(std::shared_ptr<ConfigNodePropertyInteger> value)
{
...
std::shared_ptr<ConfigNodePropertyInteger> ComDayCqDamCoreImplHandlerJpegHandlerProperties::getLargeCommentThreshold() const
{
    return m_Large_comment_threshold;
}


void ComDayCqDamCoreImplHandlerJpegHandlerProperties::setLargeCommentThreshold(std::shared_ptr<ConfigNodePropertyInteger> value)
{
