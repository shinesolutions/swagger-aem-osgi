...
web::json::value OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::toJson() const
{
...
void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties> newItem(new OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties());
...
void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties> OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheJackrabbitVaultPackagingImplPackagingImplInfo::setProperties(std::shared_ptr<OrgApacheJackrabbitVaultPackagingImplPackagingImplProperties> value)
{
    m_Properties = value;
