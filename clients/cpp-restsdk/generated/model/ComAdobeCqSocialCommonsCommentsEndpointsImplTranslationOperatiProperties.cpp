...
web::json::value ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::toJson() const
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::getFieldWhitelist() const
{
    return m_FieldWhitelist;
}


void ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::setFieldWhitelist(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::getAttachmentTypeBlacklist() const
{
    return m_AttachmentTypeBlacklist;
}


void ComAdobeCqSocialCommonsCommentsEndpointsImplTranslationOperatiProperties::setAttachmentTypeBlacklist(std::shared_ptr<ConfigNodePropertyArray> value)
{
