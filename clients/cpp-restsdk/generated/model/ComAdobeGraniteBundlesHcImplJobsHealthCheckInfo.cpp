...
web::json::value ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::toJson() const
{
...
void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteBundlesHcImplJobsHealthCheckProperties> newItem(new ComAdobeGraniteBundlesHcImplJobsHealthCheckProperties());
...
void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeGraniteBundlesHcImplJobsHealthCheckProperties> ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeGraniteBundlesHcImplJobsHealthCheckInfo::setProperties(std::shared_ptr<ComAdobeGraniteBundlesHcImplJobsHealthCheckProperties> value)
{
    m_Properties = value;
