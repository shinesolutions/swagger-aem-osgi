...
web::json::value ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::toJson() const
{
...
void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties> newItem(new ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties());
...
void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties> ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckInfo::setProperties(std::shared_ptr<ComAdobeCqSecurityHcBundlesImplWcmFilterHealthCheckProperties> value)
{
    m_Properties = value;
