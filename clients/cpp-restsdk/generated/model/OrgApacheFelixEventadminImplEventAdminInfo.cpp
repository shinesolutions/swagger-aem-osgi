...
web::json::value OrgApacheFelixEventadminImplEventAdminInfo::toJson() const
{
...
void OrgApacheFelixEventadminImplEventAdminInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheFelixEventadminImplEventAdminProperties> newItem(new OrgApacheFelixEventadminImplEventAdminProperties());
...
void OrgApacheFelixEventadminImplEventAdminInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixEventadminImplEventAdminInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheFelixEventadminImplEventAdminInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheFelixEventadminImplEventAdminInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheFelixEventadminImplEventAdminInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheFelixEventadminImplEventAdminInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheFelixEventadminImplEventAdminInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheFelixEventadminImplEventAdminInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheFelixEventadminImplEventAdminInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheFelixEventadminImplEventAdminInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheFelixEventadminImplEventAdminInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheFelixEventadminImplEventAdminInfo::setServiceLocation(utility::string_t value)
{
