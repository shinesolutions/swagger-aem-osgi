...
web::json::value ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::toJson() const
{
...
void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqDamMacSyncHelperImplMACSyncClientImplProperties> newItem(new ComAdobeCqDamMacSyncHelperImplMACSyncClientImplProperties());
...
void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqDamMacSyncHelperImplMACSyncClientImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
