...
web::json::value ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::toJson() const
{
...
void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreImplCommandsWCMCommandServletProperties> newItem(new ComDayCqWcmCoreImplCommandsWCMCommandServletProperties());
...
void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmCoreImplCommandsWCMCommandServletProperties> ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmCoreImplCommandsWCMCommandServletInfo::setProperties(std::shared_ptr<ComDayCqWcmCoreImplCommandsWCMCommandServletProperties> value)
{
    m_Properties = value;
