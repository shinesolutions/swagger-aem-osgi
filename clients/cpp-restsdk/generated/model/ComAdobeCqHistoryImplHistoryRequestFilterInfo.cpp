...
web::json::value ComAdobeCqHistoryImplHistoryRequestFilterInfo::toJson() const
{
...
void ComAdobeCqHistoryImplHistoryRequestFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqHistoryImplHistoryRequestFilterProperties> newItem(new ComAdobeCqHistoryImplHistoryRequestFilterProperties());
...
void ComAdobeCqHistoryImplHistoryRequestFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqHistoryImplHistoryRequestFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqHistoryImplHistoryRequestFilterInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqHistoryImplHistoryRequestFilterInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqHistoryImplHistoryRequestFilterInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqHistoryImplHistoryRequestFilterProperties> ComAdobeCqHistoryImplHistoryRequestFilterInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setProperties(std::shared_ptr<ComAdobeCqHistoryImplHistoryRequestFilterProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeCqHistoryImplHistoryRequestFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeCqHistoryImplHistoryRequestFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeCqHistoryImplHistoryRequestFilterInfo::setServiceLocation(utility::string_t value)
{
