...
web::json::value ComDayCqWcmCoreImplWCMDebugFilterInfo::toJson() const
{
...
void ComDayCqWcmCoreImplWCMDebugFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreImplWCMDebugFilterProperties> newItem(new ComDayCqWcmCoreImplWCMDebugFilterProperties());
...
void ComDayCqWcmCoreImplWCMDebugFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreImplWCMDebugFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreImplWCMDebugFilterInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreImplWCMDebugFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplWCMDebugFilterInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreImplWCMDebugFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplWCMDebugFilterInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreImplWCMDebugFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComDayCqWcmCoreImplWCMDebugFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWcmCoreImplWCMDebugFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWcmCoreImplWCMDebugFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWcmCoreImplWCMDebugFilterInfo::setServiceLocation(utility::string_t value)
{
