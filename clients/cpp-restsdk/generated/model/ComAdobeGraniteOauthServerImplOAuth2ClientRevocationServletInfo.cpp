...
web::json::value ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::toJson() const
{
...
void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletProperties> newItem(new ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletProperties());
...
void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
