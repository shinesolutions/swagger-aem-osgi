...
web::json::value ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::toJson() const
{
...
void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties> newItem(new ComAdobeGraniteOffloadingImplOffloadingJobOffloaderProperties());
...
void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeGraniteOffloadingImplOffloadingJobOffloaderInfo::setServiceLocation(utility::string_t value)
{
