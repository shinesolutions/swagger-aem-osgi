...
web::json::value ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::toJson() const
{
...
void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletProperties> newItem(new ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletProperties());
...
void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletProperties> ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setProperties(std::shared_ptr<ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeGraniteAnalyzerScriptsCompileAllScriptsCompilerServletInfo::setServiceLocation(utility::string_t value)
{
