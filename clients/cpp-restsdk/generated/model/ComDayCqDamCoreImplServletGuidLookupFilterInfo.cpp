...
web::json::value ComDayCqDamCoreImplServletGuidLookupFilterInfo::toJson() const
{
...
void ComDayCqDamCoreImplServletGuidLookupFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplServletGuidLookupFilterProperties> newItem(new ComDayCqDamCoreImplServletGuidLookupFilterProperties());
...
void ComDayCqDamCoreImplServletGuidLookupFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplServletGuidLookupFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplServletGuidLookupFilterInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplServletGuidLookupFilterInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplServletGuidLookupFilterInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamCoreImplServletGuidLookupFilterProperties> ComDayCqDamCoreImplServletGuidLookupFilterInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setProperties(std::shared_ptr<ComDayCqDamCoreImplServletGuidLookupFilterProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqDamCoreImplServletGuidLookupFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqDamCoreImplServletGuidLookupFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqDamCoreImplServletGuidLookupFilterInfo::setServiceLocation(utility::string_t value)
{
