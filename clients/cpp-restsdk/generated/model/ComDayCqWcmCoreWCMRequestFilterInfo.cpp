...
web::json::value ComDayCqWcmCoreWCMRequestFilterInfo::toJson() const
{
...
void ComDayCqWcmCoreWCMRequestFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreWCMRequestFilterProperties> newItem(new ComDayCqWcmCoreWCMRequestFilterProperties());
...
void ComDayCqWcmCoreWCMRequestFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreWCMRequestFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreWCMRequestFilterInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreWCMRequestFilterInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreWCMRequestFilterInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmCoreWCMRequestFilterProperties> ComDayCqWcmCoreWCMRequestFilterInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setProperties(std::shared_ptr<ComDayCqWcmCoreWCMRequestFilterProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqWcmCoreWCMRequestFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWcmCoreWCMRequestFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWcmCoreWCMRequestFilterInfo::setServiceLocation(utility::string_t value)
{
