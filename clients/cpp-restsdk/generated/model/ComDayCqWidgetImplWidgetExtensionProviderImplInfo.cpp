...
web::json::value ComDayCqWidgetImplWidgetExtensionProviderImplInfo::toJson() const
{
...
void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWidgetImplWidgetExtensionProviderImplProperties> newItem(new ComDayCqWidgetImplWidgetExtensionProviderImplProperties());
...
void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWidgetImplWidgetExtensionProviderImplProperties> ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setProperties(std::shared_ptr<ComDayCqWidgetImplWidgetExtensionProviderImplProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWidgetImplWidgetExtensionProviderImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWidgetImplWidgetExtensionProviderImplInfo::setServiceLocation(utility::string_t value)
{
