...
web::json::value OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::toJson() const
{
...
void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrProperties> newItem(new OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrProperties());
...
void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheJackrabbitOakSpiSecurityAuthenticationExternalImplPrInfo::setDescription(utility::string_t value)
{
    m_Description = value;
