...
web::json::value ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::toJson() const
{
...
void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorProperties> newItem(new ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorProperties());
...
void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreImplUtilsDefaultPageNameValidatorInfo::setDescription(utility::string_t value)
{
    m_Description = value;
