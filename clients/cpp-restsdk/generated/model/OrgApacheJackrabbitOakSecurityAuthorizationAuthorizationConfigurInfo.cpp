...
web::json::value OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::toJson() const
{
...
void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties> newItem(new OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties());
...
void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties> OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setProperties(std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheJackrabbitOakSecurityAuthorizationAuthorizationConfigurInfo::setServiceLocation(utility::string_t value)
{
