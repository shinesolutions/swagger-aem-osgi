...
web::json::value ComDayCqCommonsServletsRootMappingServletInfo::toJson() const
{
...
void ComDayCqCommonsServletsRootMappingServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqCommonsServletsRootMappingServletProperties> newItem(new ComDayCqCommonsServletsRootMappingServletProperties());
...
void ComDayCqCommonsServletsRootMappingServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqCommonsServletsRootMappingServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqCommonsServletsRootMappingServletInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqCommonsServletsRootMappingServletInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqCommonsServletsRootMappingServletInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqCommonsServletsRootMappingServletProperties> ComDayCqCommonsServletsRootMappingServletInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setProperties(std::shared_ptr<ComDayCqCommonsServletsRootMappingServletProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqCommonsServletsRootMappingServletInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqCommonsServletsRootMappingServletInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqCommonsServletsRootMappingServletInfo::setServiceLocation(utility::string_t value)
{
