...
web::json::value ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::toJson() const
{
...
void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamInddImplHandlerIndesignXMPHandlerProperties> newItem(new ComDayCqDamInddImplHandlerIndesignXMPHandlerProperties());
...
void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamInddImplHandlerIndesignXMPHandlerProperties> ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamInddImplHandlerIndesignXMPHandlerInfo::setProperties(std::shared_ptr<ComDayCqDamInddImplHandlerIndesignXMPHandlerProperties> value)
{
    m_Properties = value;
