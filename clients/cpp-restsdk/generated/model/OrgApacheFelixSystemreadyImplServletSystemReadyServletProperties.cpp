...
web::json::value OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::toJson() const
{
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::fromJson(web::json::value& val)
{
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyString> OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::getOsgiHttpWhiteboardServletPattern() const
{
    return m_Osgi_http_whiteboard_servlet_pattern;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::setOsgiHttpWhiteboardServletPattern(std::shared_ptr<ConfigNodePropertyString> value)
{
...
std::shared_ptr<ConfigNodePropertyString> OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::getOsgiHttpWhiteboardContextSelect() const
{
    return m_Osgi_http_whiteboard_context_select;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties::setOsgiHttpWhiteboardContextSelect(std::shared_ptr<ConfigNodePropertyString> value)
{
