...
web::json::value ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::toJson() const
{
...
void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckProperties> newItem(new ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckProperties());
...
void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteQueriesImplHcLargeIndexHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
