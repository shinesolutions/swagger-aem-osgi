...
web::json::value ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::toJson() const
{
...
void ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::fromJson(web::json::value& val)
{
...
void ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::getDefaultAttachmentTypeBlacklist() const
{
    return m_Default_attachment_type_blacklist;
}


void ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::setDefaultAttachmentTypeBlacklist(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::getBaselineAttachmentTypeBlacklist() const
{
    return m_Baseline_attachment_type_blacklist;
}


void ComDayCqWcmFoundationSecurityImplDefaultAttachmentTypeBlacklistProperties::setBaselineAttachmentTypeBlacklist(std::shared_ptr<ConfigNodePropertyArray> value)
{
