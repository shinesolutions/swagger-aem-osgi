...
web::json::value ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::toJson() const
{
...
void ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::fromJson(web::json::value& val)
{
...
void ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::getHcTags() const
{
    return m_Hc_tags;
}


void ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties::setHcTags(std::shared_ptr<ConfigNodePropertyArray> value)
{
    m_Hc_tags = value;
    m_Hc_tagsIsSet = true;
}
