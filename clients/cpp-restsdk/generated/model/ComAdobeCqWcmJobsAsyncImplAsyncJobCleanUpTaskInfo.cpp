...
web::json::value ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::toJson() const
{
...
void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties> newItem(new ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties());
...
void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties> ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo::setProperties(std::shared_ptr<ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties> value)
{
    m_Properties = value;
