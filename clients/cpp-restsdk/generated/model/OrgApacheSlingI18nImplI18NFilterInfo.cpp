...
void OrgApacheSlingI18nImplI18NFilterInfo::validate()
{
    // TODO: implement validation
}

web::json::value OrgApacheSlingI18nImplI18NFilterInfo::toJson() const
{
...
void OrgApacheSlingI18nImplI18NFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingI18nImplI18NFilterProperties> newItem(new OrgApacheSlingI18nImplI18NFilterProperties());
...
void OrgApacheSlingI18nImplI18NFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingI18nImplI18NFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingI18nImplI18NFilterInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::pidIsSet() const
{
    return m_PidIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetPid()
{
    m_PidIsSet = false;
}

utility::string_t OrgApacheSlingI18nImplI18NFilterInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::titleIsSet() const
{
    return m_TitleIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetTitle()
{
    m_TitleIsSet = false;
}

utility::string_t OrgApacheSlingI18nImplI18NFilterInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetDescription()
{
    m_DescriptionIsSet = false;
}

std::shared_ptr<OrgApacheSlingI18nImplI18NFilterProperties> OrgApacheSlingI18nImplI18NFilterInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setProperties(std::shared_ptr<OrgApacheSlingI18nImplI18NFilterProperties> value)
{
    m_Properties = value;
    m_PropertiesIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetProperties()
{
    m_PropertiesIsSet = false;
}

utility::string_t OrgApacheSlingI18nImplI18NFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setBundleLocation(utility::string_t value)
{
    m_Bundle_location = value;
    m_Bundle_locationIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::bundleLocationIsSet() const
{
    return m_Bundle_locationIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetBundle_location()
{
    m_Bundle_locationIsSet = false;
}

utility::string_t OrgApacheSlingI18nImplI18NFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingI18nImplI18NFilterInfo::setServiceLocation(utility::string_t value)
{
    m_Service_location = value;
    m_Service_locationIsSet = true;
}
bool OrgApacheSlingI18nImplI18NFilterInfo::serviceLocationIsSet() const
{
    return m_Service_locationIsSet;
}

void OrgApacheSlingI18nImplI18NFilterInfo::unsetService_location()
{
    m_Service_locationIsSet = false;
}
