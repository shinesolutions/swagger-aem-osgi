...
web::json::value ComDayCqCommonsImplExternalizerImplInfo::toJson() const
{
...
void ComDayCqCommonsImplExternalizerImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqCommonsImplExternalizerImplProperties> newItem(new ComDayCqCommonsImplExternalizerImplProperties());
...
void ComDayCqCommonsImplExternalizerImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqCommonsImplExternalizerImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqCommonsImplExternalizerImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqCommonsImplExternalizerImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqCommonsImplExternalizerImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqCommonsImplExternalizerImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqCommonsImplExternalizerImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqCommonsImplExternalizerImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqCommonsImplExternalizerImplProperties> ComDayCqCommonsImplExternalizerImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqCommonsImplExternalizerImplInfo::setProperties(std::shared_ptr<ComDayCqCommonsImplExternalizerImplProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqCommonsImplExternalizerImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqCommonsImplExternalizerImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqCommonsImplExternalizerImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqCommonsImplExternalizerImplInfo::setServiceLocation(utility::string_t value)
{
