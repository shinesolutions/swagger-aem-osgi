...
web::json::value OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::toJson() const
{
...
void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties> newItem(new OrgApacheSlingJcrRepoinitImplRepositoryInitializerProperties());
...
void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingJcrRepoinitImplRepositoryInitializerInfo::setServiceLocation(utility::string_t value)
{
