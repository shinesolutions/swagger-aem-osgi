...
web::json::value OrgApacheSlingAuthCoreImplLogoutServletProperties::toJson() const
{
...
void OrgApacheSlingAuthCoreImplLogoutServletProperties::fromJson(web::json::value& val)
{
...
void OrgApacheSlingAuthCoreImplLogoutServletProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingAuthCoreImplLogoutServletProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> OrgApacheSlingAuthCoreImplLogoutServletProperties::getSlingServletMethods() const
{
    return m_Sling_servlet_methods;
}


void OrgApacheSlingAuthCoreImplLogoutServletProperties::setSlingServletMethods(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyString> OrgApacheSlingAuthCoreImplLogoutServletProperties::getSlingServletPaths() const
{
    return m_Sling_servlet_paths;
}


void OrgApacheSlingAuthCoreImplLogoutServletProperties::setSlingServletPaths(std::shared_ptr<ConfigNodePropertyString> value)
{
