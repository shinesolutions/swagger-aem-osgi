...
web::json::value OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::toJson() const
{
...
void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraProperties> newItem(new OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraProperties());
...
void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraProperties> OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setProperties(std::shared_ptr<OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheJackrabbitOakSecurityAuthenticationTokenTokenConfiguraInfo::setServiceLocation(utility::string_t value)
{
