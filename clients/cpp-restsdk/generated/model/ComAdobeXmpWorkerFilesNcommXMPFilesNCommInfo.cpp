...
web::json::value ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::toJson() const
{
...
void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties> newItem(new ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties());
...
void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties> ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setProperties(std::shared_ptr<ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo::setServiceLocation(utility::string_t value)
{
