...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeProperties_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeProperties_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<ConfigNodePropertyString> getSeconds() const;
    bool secondsIsSet() const;
    void unsetSeconds();
    void setSeconds(std::shared_ptr<ConfigNodePropertyString> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_PathIsSet;
    std::shared_ptr<ConfigNodePropertyString> m_Seconds;
    bool m_SecondsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeProperties_H_ */
