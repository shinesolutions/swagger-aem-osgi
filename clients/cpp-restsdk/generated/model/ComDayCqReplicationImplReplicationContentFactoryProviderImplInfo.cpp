...
web::json::value ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::toJson() const
{
...
void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqReplicationImplReplicationContentFactoryProviderImplProperties> newItem(new ComDayCqReplicationImplReplicationContentFactoryProviderImplProperties());
...
void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo::setServiceLocation(utility::string_t value)
{
