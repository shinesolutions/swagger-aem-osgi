...
web::json::value ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::toJson() const
{
...
void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties> newItem(new ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties());
...
void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties> ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceInfo::setProperties(std::shared_ptr<ComAdobeGraniteI18nImplPreferencesLocaleResolverServiceProperties> value)
{
    m_Properties = value;
