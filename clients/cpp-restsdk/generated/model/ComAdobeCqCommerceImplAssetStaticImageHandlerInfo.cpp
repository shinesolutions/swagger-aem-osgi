...
web::json::value ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::toJson() const
{
...
void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqCommerceImplAssetStaticImageHandlerProperties> newItem(new ComAdobeCqCommerceImplAssetStaticImageHandlerProperties());
...
void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqCommerceImplAssetStaticImageHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
