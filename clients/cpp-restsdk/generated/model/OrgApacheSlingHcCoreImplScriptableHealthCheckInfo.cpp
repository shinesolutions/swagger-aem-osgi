...
web::json::value OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::toJson() const
{
...
void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingHcCoreImplScriptableHealthCheckProperties> newItem(new OrgApacheSlingHcCoreImplScriptableHealthCheckProperties());
...
void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingHcCoreImplScriptableHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
