...
web::json::value ComAdobeGraniteCsrfImplCSRFFilterInfo::toJson() const
{
...
void ComAdobeGraniteCsrfImplCSRFFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteCsrfImplCSRFFilterProperties> newItem(new ComAdobeGraniteCsrfImplCSRFFilterProperties());
...
void ComAdobeGraniteCsrfImplCSRFFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteCsrfImplCSRFFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteCsrfImplCSRFFilterInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteCsrfImplCSRFFilterInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteCsrfImplCSRFFilterInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeGraniteCsrfImplCSRFFilterProperties> ComAdobeGraniteCsrfImplCSRFFilterInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setProperties(std::shared_ptr<ComAdobeGraniteCsrfImplCSRFFilterProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeGraniteCsrfImplCSRFFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteCsrfImplCSRFFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeGraniteCsrfImplCSRFFilterInfo::setServiceLocation(utility::string_t value)
{
