...
web::json::value ComDayCommonsHttpclientInfo::toJson() const
{
...
void ComDayCommonsHttpclientInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCommonsHttpclientProperties> newItem(new ComDayCommonsHttpclientProperties());
...
void ComDayCommonsHttpclientInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCommonsHttpclientInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCommonsHttpclientInfo::getPid() const
{
    return m_Pid;
}


void ComDayCommonsHttpclientInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCommonsHttpclientInfo::getTitle() const
{
    return m_Title;
}


void ComDayCommonsHttpclientInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCommonsHttpclientInfo::getDescription() const
{
    return m_Description;
}


void ComDayCommonsHttpclientInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCommonsHttpclientProperties> ComDayCommonsHttpclientInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCommonsHttpclientInfo::setProperties(std::shared_ptr<ComDayCommonsHttpclientProperties> value)
{
    m_Properties = value;
