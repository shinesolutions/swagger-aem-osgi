...
web::json::value ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::toJson() const
{
...
void ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::getEventTopics() const
{
    return m_Event_topics;
}


void ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::setEventTopics(std::shared_ptr<ConfigNodePropertyString> value)
{
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::getEventFilter() const
{
    return m_Event_filter;
}


void ComAdobeCqSocialNotificationsImplNotificationsRouterProperties::setEventFilter(std::shared_ptr<ConfigNodePropertyString> value)
{
