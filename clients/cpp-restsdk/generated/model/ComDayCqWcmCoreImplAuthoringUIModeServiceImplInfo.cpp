...
web::json::value ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::toJson() const
{
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties> newItem(new ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties());
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties> ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setProperties(std::shared_ptr<ComDayCqWcmCoreImplAuthoringUIModeServiceImplProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setAdditionalProperties(utility::string_t value)
{
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWcmCoreImplAuthoringUIModeServiceImplInfo::setServiceLocation(utility::string_t value)
{
