...
web::json::value ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::toJson() const
{
...
void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties> newItem(new ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties());
...
void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties> ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpInfo::setProperties(std::shared_ptr<ComAdobeFormsCommonServiceImplFormsCommonConfigurationServiceImpProperties> value)
{
    m_Properties = value;
