...
web::json::value ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::toJson() const
{
...
void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqSocialSyncImplUserSyncListenerImplProperties> newItem(new ComAdobeCqSocialSyncImplUserSyncListenerImplProperties());
...
void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqSocialSyncImplUserSyncListenerImplProperties> ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqSocialSyncImplUserSyncListenerImplInfo::setProperties(std::shared_ptr<ComAdobeCqSocialSyncImplUserSyncListenerImplProperties> value)
{
    m_Properties = value;
