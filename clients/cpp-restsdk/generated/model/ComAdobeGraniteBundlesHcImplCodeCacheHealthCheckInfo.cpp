...
web::json::value ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::toJson() const
{
...
void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckProperties> newItem(new ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckProperties());
...
void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteBundlesHcImplCodeCacheHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
