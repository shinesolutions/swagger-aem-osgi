...
web::json::value ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::toJson() const
{
...
void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::fromJson(web::json::value& val)
{
...
void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::getHcName() const
{
    return m_Hc_name;
}


void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::setHcName(std::shared_ptr<ConfigNodePropertyString> value)
{
    m_Hc_name = value;
    m_Hc_nameIsSet = true;
}
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::getHcTags() const
{
    return m_Hc_tags;
}


void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::setHcTags(std::shared_ptr<ConfigNodePropertyArray> value)
{
    m_Hc_tags = value;
    m_Hc_tagsIsSet = true;
}
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::getHcMbeanName() const
{
    return m_Hc_mbean_name;
}


void ComAdobeAemUpgradePrechecksHcImplReplicationAgentsDisabledHCProperties::setHcMbeanName(std::shared_ptr<ConfigNodePropertyString> value)
{
