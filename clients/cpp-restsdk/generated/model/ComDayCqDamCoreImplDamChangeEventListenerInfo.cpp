...
web::json::value ComDayCqDamCoreImplDamChangeEventListenerInfo::toJson() const
{
...
void ComDayCqDamCoreImplDamChangeEventListenerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplDamChangeEventListenerProperties> newItem(new ComDayCqDamCoreImplDamChangeEventListenerProperties());
...
void ComDayCqDamCoreImplDamChangeEventListenerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplDamChangeEventListenerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplDamChangeEventListenerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplDamChangeEventListenerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplDamChangeEventListenerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplDamChangeEventListenerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplDamChangeEventListenerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplDamChangeEventListenerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
