...
web::json::value OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::toJson() const
{
...
void OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::fromJson(web::json::value& val)
{
...
void OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyBoolean> OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::getEnabled() const
{
    return m_Enabled;
}


void OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties::setEnabled(std::shared_ptr<ConfigNodePropertyBoolean> value)
{
    m_Enabled = value;
    m_EnabledIsSet = true;
}
