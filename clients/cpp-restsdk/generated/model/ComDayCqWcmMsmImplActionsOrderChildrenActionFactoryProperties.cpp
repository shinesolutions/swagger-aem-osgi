...
web::json::value ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::toJson() const
{
...
void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::fromJson(web::json::value& val)
{
...
void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::getCqWcmMsmActionExcludednodetypes() const
{
    return m_Cq_wcm_msm_action_excludednodetypes;
}


void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::setCqWcmMsmActionExcludednodetypes(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::getCqWcmMsmActionExcludedparagraphitems() const
{
    return m_Cq_wcm_msm_action_excludedparagraphitems;
}


void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::setCqWcmMsmActionExcludedparagraphitems(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::getCqWcmMsmActionExcludedprops() const
{
    return m_Cq_wcm_msm_action_excludedprops;
}


void ComDayCqWcmMsmImplActionsOrderChildrenActionFactoryProperties::setCqWcmMsmActionExcludedprops(std::shared_ptr<ConfigNodePropertyArray> value)
{
