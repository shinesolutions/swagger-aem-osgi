...
web::json::value OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::toJson() const
{
...
void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingDistributionSerializationImplDistributionPackageBuProperties> newItem(new OrgApacheSlingDistributionSerializationImplDistributionPackageBuProperties());
...
void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingDistributionSerializationImplDistributionPackageBuInfo::setDescription(utility::string_t value)
{
    m_Description = value;
