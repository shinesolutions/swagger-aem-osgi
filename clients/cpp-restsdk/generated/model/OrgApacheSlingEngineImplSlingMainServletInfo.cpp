...
web::json::value OrgApacheSlingEngineImplSlingMainServletInfo::toJson() const
{
...
void OrgApacheSlingEngineImplSlingMainServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingEngineImplSlingMainServletProperties> newItem(new OrgApacheSlingEngineImplSlingMainServletProperties());
...
void OrgApacheSlingEngineImplSlingMainServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingEngineImplSlingMainServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingEngineImplSlingMainServletInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplSlingMainServletInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplSlingMainServletInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingEngineImplSlingMainServletProperties> OrgApacheSlingEngineImplSlingMainServletInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setProperties(std::shared_ptr<OrgApacheSlingEngineImplSlingMainServletProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingEngineImplSlingMainServletInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingEngineImplSlingMainServletInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingEngineImplSlingMainServletInfo::setServiceLocation(utility::string_t value)
{
