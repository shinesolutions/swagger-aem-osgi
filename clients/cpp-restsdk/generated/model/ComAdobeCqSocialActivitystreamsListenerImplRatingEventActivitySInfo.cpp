...
web::json::value ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::toJson() const
{
...
void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySProperties> newItem(new ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySProperties());
...
void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqSocialActivitystreamsListenerImplRatingEventActivitySInfo::setDescription(utility::string_t value)
{
    m_Description = value;
