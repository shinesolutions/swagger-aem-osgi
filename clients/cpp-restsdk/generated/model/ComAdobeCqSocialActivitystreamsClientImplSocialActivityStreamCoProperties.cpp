...
web::json::value ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::toJson() const
{
...
void ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyInteger> ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::getPriority() const
{
    return m_Priority;
}


void ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties::setPriority(std::shared_ptr<ConfigNodePropertyInteger> value)
{
    m_Priority = value;
