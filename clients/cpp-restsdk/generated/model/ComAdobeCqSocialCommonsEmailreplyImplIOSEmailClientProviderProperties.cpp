...
web::json::value ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::toJson() const
{
...
void ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyInteger> ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::getPriorityOrder() const
{
    return m_PriorityOrder;
}


void ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::setPriorityOrder(std::shared_ptr<ConfigNodePropertyInteger> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::getReplyEmailPatterns() const
{
    return m_ReplyEmailPatterns;
}


void ComAdobeCqSocialCommonsEmailreplyImplIOSEmailClientProviderProperties::setReplyEmailPatterns(std::shared_ptr<ConfigNodePropertyArray> value)
{
