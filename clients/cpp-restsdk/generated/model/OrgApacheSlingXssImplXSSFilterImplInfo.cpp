...
web::json::value OrgApacheSlingXssImplXSSFilterImplInfo::toJson() const
{
...
void OrgApacheSlingXssImplXSSFilterImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingXssImplXSSFilterImplProperties> newItem(new OrgApacheSlingXssImplXSSFilterImplProperties());
...
void OrgApacheSlingXssImplXSSFilterImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingXssImplXSSFilterImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingXssImplXSSFilterImplInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingXssImplXSSFilterImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingXssImplXSSFilterImplInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingXssImplXSSFilterImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingXssImplXSSFilterImplInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingXssImplXSSFilterImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheSlingXssImplXSSFilterImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingXssImplXSSFilterImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingXssImplXSSFilterImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingXssImplXSSFilterImplInfo::setServiceLocation(utility::string_t value)
{
