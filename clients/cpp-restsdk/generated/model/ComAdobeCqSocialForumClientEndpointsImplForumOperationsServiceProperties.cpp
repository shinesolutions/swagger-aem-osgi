...
web::json::value ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties::toJson() const
{
...
void ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
