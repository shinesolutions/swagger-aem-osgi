...
web::json::value OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::toJson() const
{
...
void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingHcCoreImplCompositeHealthCheckProperties> newItem(new OrgApacheSlingHcCoreImplCompositeHealthCheckProperties());
...
void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingHcCoreImplCompositeHealthCheckProperties> OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingHcCoreImplCompositeHealthCheckInfo::setProperties(std::shared_ptr<OrgApacheSlingHcCoreImplCompositeHealthCheckProperties> value)
{
    m_Properties = value;
