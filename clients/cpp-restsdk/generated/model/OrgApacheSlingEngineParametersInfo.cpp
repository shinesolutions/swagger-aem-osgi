...
web::json::value OrgApacheSlingEngineParametersInfo::toJson() const
{
...
void OrgApacheSlingEngineParametersInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingEngineParametersProperties> newItem(new OrgApacheSlingEngineParametersProperties());
...
void OrgApacheSlingEngineParametersInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingEngineParametersInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingEngineParametersInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingEngineParametersInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineParametersInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingEngineParametersInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineParametersInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingEngineParametersInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingEngineParametersProperties> OrgApacheSlingEngineParametersInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingEngineParametersInfo::setProperties(std::shared_ptr<OrgApacheSlingEngineParametersProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingEngineParametersInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingEngineParametersInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingEngineParametersInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingEngineParametersInfo::setServiceLocation(utility::string_t value)
{
