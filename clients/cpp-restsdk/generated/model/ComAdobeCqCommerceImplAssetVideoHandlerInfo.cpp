...
web::json::value ComAdobeCqCommerceImplAssetVideoHandlerInfo::toJson() const
{
...
void ComAdobeCqCommerceImplAssetVideoHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqCommerceImplAssetVideoHandlerProperties> newItem(new ComAdobeCqCommerceImplAssetVideoHandlerProperties());
...
void ComAdobeCqCommerceImplAssetVideoHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqCommerceImplAssetVideoHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqCommerceImplAssetVideoHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqCommerceImplAssetVideoHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqCommerceImplAssetVideoHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqCommerceImplAssetVideoHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqCommerceImplAssetVideoHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqCommerceImplAssetVideoHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqCommerceImplAssetVideoHandlerProperties> ComAdobeCqCommerceImplAssetVideoHandlerInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqCommerceImplAssetVideoHandlerInfo::setProperties(std::shared_ptr<ComAdobeCqCommerceImplAssetVideoHandlerProperties> value)
{
    m_Properties = value;
