...
web::json::value ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::toJson() const
{
...
void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties> newItem(new ComAdobeGraniteAnalyzerBaseSystemStatusServletProperties());
...
void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeGraniteAnalyzerBaseSystemStatusServletInfo::setServiceLocation(utility::string_t value)
{
