...
web::json::value OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::toJson() const
{
...
void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheFelixWebconsolePluginsEventInternalPluginServletProperties> newItem(new OrgApacheFelixWebconsolePluginsEventInternalPluginServletProperties());
...
void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheFelixWebconsolePluginsEventInternalPluginServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
