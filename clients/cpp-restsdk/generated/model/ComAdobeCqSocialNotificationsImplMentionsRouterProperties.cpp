...
void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::validate()
{
    // TODO: implement validation
}

web::json::value ComAdobeCqSocialNotificationsImplMentionsRouterProperties::toJson() const
{
...
void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyString> ComAdobeCqSocialNotificationsImplMentionsRouterProperties::getEventTopics() const
{
    return m_Event_topics;
}


void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::setEventTopics(std::shared_ptr<ConfigNodePropertyString> value)
{
    m_Event_topics = value;
    m_Event_topicsIsSet = true;
}
bool ComAdobeCqSocialNotificationsImplMentionsRouterProperties::eventTopicsIsSet() const
{
    return m_Event_topicsIsSet;
}

void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::unsetEvent_topics()
{
    m_Event_topicsIsSet = false;
}

std::shared_ptr<ConfigNodePropertyString> ComAdobeCqSocialNotificationsImplMentionsRouterProperties::getEventFilter() const
{
    return m_Event_filter;
}


void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::setEventFilter(std::shared_ptr<ConfigNodePropertyString> value)
{
    m_Event_filter = value;
    m_Event_filterIsSet = true;
}
bool ComAdobeCqSocialNotificationsImplMentionsRouterProperties::eventFilterIsSet() const
{
    return m_Event_filterIsSet;
}

void ComAdobeCqSocialNotificationsImplMentionsRouterProperties::unsetEvent_filter()
{
    m_Event_filterIsSet = false;
}
