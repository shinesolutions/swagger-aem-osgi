...
web::json::value OrgApacheFelixJaasConfigurationSpiInfo::toJson() const
{
...
void OrgApacheFelixJaasConfigurationSpiInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheFelixJaasConfigurationSpiProperties> newItem(new OrgApacheFelixJaasConfigurationSpiProperties());
...
void OrgApacheFelixJaasConfigurationSpiInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixJaasConfigurationSpiInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheFelixJaasConfigurationSpiInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheFelixJaasConfigurationSpiInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheFelixJaasConfigurationSpiInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheFelixJaasConfigurationSpiProperties> OrgApacheFelixJaasConfigurationSpiInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setProperties(std::shared_ptr<OrgApacheFelixJaasConfigurationSpiProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheFelixJaasConfigurationSpiInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheFelixJaasConfigurationSpiInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheFelixJaasConfigurationSpiInfo::setServiceLocation(utility::string_t value)
{
