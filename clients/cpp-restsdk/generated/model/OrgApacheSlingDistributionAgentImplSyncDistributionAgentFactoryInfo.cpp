...
web::json::value OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::toJson() const
{
...
void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties> newItem(new OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryProperties());
...
void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingDistributionAgentImplSyncDistributionAgentFactoryInfo::setDescription(utility::string_t value)
{
    m_Description = value;
