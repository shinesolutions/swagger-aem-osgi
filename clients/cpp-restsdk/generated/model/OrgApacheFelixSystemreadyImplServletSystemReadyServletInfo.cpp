...
web::json::value OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::toJson() const
{
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties> newItem(new OrgApacheFelixSystemreadyImplServletSystemReadyServletProperties());
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheFelixSystemreadyImplServletSystemReadyServletInfo::setServiceLocation(utility::string_t value)
{
