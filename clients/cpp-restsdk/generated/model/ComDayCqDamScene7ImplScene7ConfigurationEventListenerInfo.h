...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<ComDayCqDamScene7ImplScene7ConfigurationEventListenerProperties> getProperties() const;
    bool propertiesIsSet() const;
    void unsetProperties();
    void setProperties(std::shared_ptr<ComDayCqDamScene7ImplScene7ConfigurationEventListenerProperties> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::shared_ptr<ComDayCqDamScene7ImplScene7ConfigurationEventListenerProperties> m_Properties;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo_H_ */
