...
web::json::value ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::toJson() const
{
...
void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties> newItem(new ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties());
...
void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties> ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerInfo::setProperties(std::shared_ptr<ComAdobeGraniteWorkflowCoreJcrWorkflowBucketManagerProperties> value)
{
    m_Properties = value;
