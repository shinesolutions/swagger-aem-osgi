...
web::json::value ComDayCqDamCoreImplServletCompanionServletInfo::toJson() const
{
...
void ComDayCqDamCoreImplServletCompanionServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplServletCompanionServletProperties> newItem(new ComDayCqDamCoreImplServletCompanionServletProperties());
...
void ComDayCqDamCoreImplServletCompanionServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplServletCompanionServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplServletCompanionServletInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplServletCompanionServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplServletCompanionServletInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplServletCompanionServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplServletCompanionServletInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplServletCompanionServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamCoreImplServletCompanionServletProperties> ComDayCqDamCoreImplServletCompanionServletInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamCoreImplServletCompanionServletInfo::setProperties(std::shared_ptr<ComDayCqDamCoreImplServletCompanionServletProperties> value)
{
    m_Properties = value;
