...
web::json::value ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::toJson() const
{
...
void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreImplPagePageInfoAggregatorImplProperties> newItem(new ComDayCqWcmCoreImplPagePageInfoAggregatorImplProperties());
...
void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmCoreImplPagePageInfoAggregatorImplProperties> ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmCoreImplPagePageInfoAggregatorImplInfo::setProperties(std::shared_ptr<ComDayCqWcmCoreImplPagePageInfoAggregatorImplProperties> value)
{
    m_Properties = value;
