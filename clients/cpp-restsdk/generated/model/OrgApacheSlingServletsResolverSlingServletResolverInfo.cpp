...
web::json::value OrgApacheSlingServletsResolverSlingServletResolverInfo::toJson() const
{
...
void OrgApacheSlingServletsResolverSlingServletResolverInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingServletsResolverSlingServletResolverProperties> newItem(new OrgApacheSlingServletsResolverSlingServletResolverProperties());
...
void OrgApacheSlingServletsResolverSlingServletResolverInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingServletsResolverSlingServletResolverInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingServletsResolverSlingServletResolverInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingServletsResolverSlingServletResolverInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingServletsResolverSlingServletResolverInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingServletsResolverSlingServletResolverInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingServletsResolverSlingServletResolverInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingServletsResolverSlingServletResolverInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t OrgApacheSlingServletsResolverSlingServletResolverInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingServletsResolverSlingServletResolverInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingServletsResolverSlingServletResolverInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingServletsResolverSlingServletResolverInfo::setServiceLocation(utility::string_t value)
{
