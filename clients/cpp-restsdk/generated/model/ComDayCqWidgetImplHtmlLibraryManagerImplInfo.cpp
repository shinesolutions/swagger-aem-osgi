...
web::json::value ComDayCqWidgetImplHtmlLibraryManagerImplInfo::toJson() const
{
...
void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWidgetImplHtmlLibraryManagerImplProperties> newItem(new ComDayCqWidgetImplHtmlLibraryManagerImplProperties());
...
void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWidgetImplHtmlLibraryManagerImplProperties> ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setProperties(std::shared_ptr<ComDayCqWidgetImplHtmlLibraryManagerImplProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWidgetImplHtmlLibraryManagerImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWidgetImplHtmlLibraryManagerImplInfo::setServiceLocation(utility::string_t value)
{
