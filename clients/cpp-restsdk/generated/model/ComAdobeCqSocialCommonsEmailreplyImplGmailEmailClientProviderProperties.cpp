...
web::json::value ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::toJson() const
{
...
void ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyInteger> ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::getPriorityOrder() const
{
    return m_PriorityOrder;
}


void ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::setPriorityOrder(std::shared_ptr<ConfigNodePropertyInteger> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::getReplyEmailPatterns() const
{
    return m_ReplyEmailPatterns;
}


void ComAdobeCqSocialCommonsEmailreplyImplGmailEmailClientProviderProperties::setReplyEmailPatterns(std::shared_ptr<ConfigNodePropertyArray> value)
{
