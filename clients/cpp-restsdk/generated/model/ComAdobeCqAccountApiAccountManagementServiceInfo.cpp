...
web::json::value ComAdobeCqAccountApiAccountManagementServiceInfo::toJson() const
{
...
void ComAdobeCqAccountApiAccountManagementServiceInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqAccountApiAccountManagementServiceProperties> newItem(new ComAdobeCqAccountApiAccountManagementServiceProperties());
...
void ComAdobeCqAccountApiAccountManagementServiceInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqAccountApiAccountManagementServiceInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqAccountApiAccountManagementServiceProperties> ComAdobeCqAccountApiAccountManagementServiceInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setProperties(std::shared_ptr<ComAdobeCqAccountApiAccountManagementServiceProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setAdditionalProperties(utility::string_t value)
{
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeCqAccountApiAccountManagementServiceInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeCqAccountApiAccountManagementServiceInfo::setServiceLocation(utility::string_t value)
{
