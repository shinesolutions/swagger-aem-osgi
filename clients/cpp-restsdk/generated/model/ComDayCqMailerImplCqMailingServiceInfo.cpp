...
web::json::value ComDayCqMailerImplCqMailingServiceInfo::toJson() const
{
...
void ComDayCqMailerImplCqMailingServiceInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqMailerImplCqMailingServiceProperties> newItem(new ComDayCqMailerImplCqMailingServiceProperties());
...
void ComDayCqMailerImplCqMailingServiceInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqMailerImplCqMailingServiceInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqMailerImplCqMailingServiceInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqMailerImplCqMailingServiceInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqMailerImplCqMailingServiceInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqMailerImplCqMailingServiceInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqMailerImplCqMailingServiceInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqMailerImplCqMailingServiceInfo::setDescription(utility::string_t value)
{
    m_Description = value;
