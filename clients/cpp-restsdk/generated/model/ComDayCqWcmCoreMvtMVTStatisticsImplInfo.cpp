...
web::json::value ComDayCqWcmCoreMvtMVTStatisticsImplInfo::toJson() const
{
...
void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmCoreMvtMVTStatisticsImplProperties> newItem(new ComDayCqWcmCoreMvtMVTStatisticsImplProperties());
...
void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmCoreMvtMVTStatisticsImplProperties> ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setProperties(std::shared_ptr<ComDayCqWcmCoreMvtMVTStatisticsImplProperties> value)
{
    m_Properties = value;
...
utility::string_t ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqWcmCoreMvtMVTStatisticsImplInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqWcmCoreMvtMVTStatisticsImplInfo::setServiceLocation(utility::string_t value)
{
