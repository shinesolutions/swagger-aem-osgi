...
web::json::value ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::toJson() const
{
...
void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryProperties> newItem(new ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryProperties());
...
void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setAdditionalProperties(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeGraniteJettySslInternalGraniteSslConnectorFactoryInfo::setServiceLocation(utility::string_t value)
{
