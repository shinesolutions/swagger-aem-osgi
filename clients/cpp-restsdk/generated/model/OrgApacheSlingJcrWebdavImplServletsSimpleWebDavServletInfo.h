...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties> getProperties() const;
    bool propertiesIsSet() const;
    void unsetProperties();
    void setProperties(std::shared_ptr<OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::shared_ptr<OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties> m_Properties;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo_H_ */
