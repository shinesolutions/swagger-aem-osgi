...
web::json::value OrgApacheSlingResourcemergerPickerOverridingProperties::toJson() const
{
...
void OrgApacheSlingResourcemergerPickerOverridingProperties::fromJson(web::json::value& val)
{
...
void OrgApacheSlingResourcemergerPickerOverridingProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingResourcemergerPickerOverridingProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
