...
web::json::value ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::toJson() const
{
...
void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties> newItem(new ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckProperties());
...
void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeGraniteBundlesHcImplCrxdeSupportBundleHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
