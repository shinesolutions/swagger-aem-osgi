...
web::json::value ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::toJson() const
{
...
void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqScreensImplHandlerChannelsUpdateHandlerProperties> newItem(new ComAdobeCqScreensImplHandlerChannelsUpdateHandlerProperties());
...
void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqScreensImplHandlerChannelsUpdateHandlerProperties> ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqScreensImplHandlerChannelsUpdateHandlerInfo::setProperties(std::shared_ptr<ComAdobeCqScreensImplHandlerChannelsUpdateHandlerProperties> value)
{
    m_Properties = value;
