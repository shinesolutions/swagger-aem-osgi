...
web::json::value ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::toJson() const
{
...
void ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::getFieldWhitelist() const
{
    return m_FieldWhitelist;
}


void ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::setFieldWhitelist(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::getAttachmentTypeBlacklist() const
{
    return m_AttachmentTypeBlacklist;
}


void ComAdobeCqSocialReviewClientEndpointsImplReviewOperationsServiProperties::setAttachmentTypeBlacklist(std::shared_ptr<ConfigNodePropertyArray> value)
{
