...
web::json::value OrgApacheSlingCommonsLogLogManagerInfo::toJson() const
{
...
void OrgApacheSlingCommonsLogLogManagerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingCommonsLogLogManagerProperties> newItem(new OrgApacheSlingCommonsLogLogManagerProperties());
...
void OrgApacheSlingCommonsLogLogManagerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingCommonsLogLogManagerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingCommonsLogLogManagerInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingCommonsLogLogManagerInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingCommonsLogLogManagerInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingCommonsLogLogManagerProperties> OrgApacheSlingCommonsLogLogManagerInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setProperties(std::shared_ptr<OrgApacheSlingCommonsLogLogManagerProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingCommonsLogLogManagerInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingCommonsLogLogManagerInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingCommonsLogLogManagerInfo::setServiceLocation(utility::string_t value)
{
