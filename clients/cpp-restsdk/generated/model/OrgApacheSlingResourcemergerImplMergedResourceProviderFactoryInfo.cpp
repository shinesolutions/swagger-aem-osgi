...
web::json::value OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::toJson() const
{
...
void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryProperties> newItem(new OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryProperties());
...
void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingResourcemergerImplMergedResourceProviderFactoryInfo::setDescription(utility::string_t value)
{
    m_Description = value;
