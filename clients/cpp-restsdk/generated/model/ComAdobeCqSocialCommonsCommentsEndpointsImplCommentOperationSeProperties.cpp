...
web::json::value ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::toJson() const
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::fromJson(web::json::value& val)
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::getFieldWhitelist() const
{
    return m_FieldWhitelist;
}


void ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::setFieldWhitelist(std::shared_ptr<ConfigNodePropertyArray> value)
{
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::getAttachmentTypeBlacklist() const
{
    return m_AttachmentTypeBlacklist;
}


void ComAdobeCqSocialCommonsCommentsEndpointsImplCommentOperationSeProperties::setAttachmentTypeBlacklist(std::shared_ptr<ConfigNodePropertyArray> value)
{
