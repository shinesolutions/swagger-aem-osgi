...
web::json::value OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::toJson() const
{
...
void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties> newItem(new OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties());
...
void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties> OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setProperties(std::shared_ptr<OrgApacheSlingEngineImplAuthSlingAuthenticatorProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingEngineImplAuthSlingAuthenticatorInfo::setServiceLocation(utility::string_t value)
{
