...
void OrgApacheFelixScrScrServiceInfo::validate()
{
    // TODO: implement validation
}

web::json::value OrgApacheFelixScrScrServiceInfo::toJson() const
{
...
void OrgApacheFelixScrScrServiceInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheFelixScrScrServiceProperties> newItem(new OrgApacheFelixScrScrServiceProperties());
...
void OrgApacheFelixScrScrServiceInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheFelixScrScrServiceInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheFelixScrScrServiceInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheFelixScrScrServiceInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
bool OrgApacheFelixScrScrServiceInfo::pidIsSet() const
{
    return m_PidIsSet;
}

void OrgApacheFelixScrScrServiceInfo::unsetPid()
{
    m_PidIsSet = false;
}

utility::string_t OrgApacheFelixScrScrServiceInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheFelixScrScrServiceInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
bool OrgApacheFelixScrScrServiceInfo::titleIsSet() const
{
    return m_TitleIsSet;
}

void OrgApacheFelixScrScrServiceInfo::unsetTitle()
{
    m_TitleIsSet = false;
}

utility::string_t OrgApacheFelixScrScrServiceInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheFelixScrScrServiceInfo::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool OrgApacheFelixScrScrServiceInfo::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void OrgApacheFelixScrScrServiceInfo::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
bool OrgApacheFelixScrScrServiceInfo::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void OrgApacheFelixScrScrServiceInfo::unsetProperties()
{
    m_PropertiesIsSet = false;
}
