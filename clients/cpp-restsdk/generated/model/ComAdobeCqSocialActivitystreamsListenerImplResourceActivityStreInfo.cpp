...
web::json::value ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::toJson() const
{
...
void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreProperties> newItem(new ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreProperties());
...
void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreProperties> ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getProperties() const
{
    return m_Properties;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setProperties(std::shared_ptr<ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreProperties> value)
{
    m_Properties = value;
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeCqSocialActivitystreamsListenerImplResourceActivityStreInfo::setServiceLocation(utility::string_t value)
{
