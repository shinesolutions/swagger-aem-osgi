...
web::json::value ComDayCqAuthImplLoginSelectorHandlerInfo::toJson() const
{
...
void ComDayCqAuthImplLoginSelectorHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqAuthImplLoginSelectorHandlerProperties> newItem(new ComDayCqAuthImplLoginSelectorHandlerProperties());
...
void ComDayCqAuthImplLoginSelectorHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqAuthImplLoginSelectorHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqAuthImplLoginSelectorHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqAuthImplLoginSelectorHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqAuthImplLoginSelectorHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqAuthImplLoginSelectorHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqAuthImplLoginSelectorHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqAuthImplLoginSelectorHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComDayCqAuthImplLoginSelectorHandlerInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqAuthImplLoginSelectorHandlerInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqAuthImplLoginSelectorHandlerInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqAuthImplLoginSelectorHandlerInfo::setServiceLocation(utility::string_t value)
{
