...
web::json::value ComDayCqDamS7damCommonServletsS7damProductInfoServletProperties::toJson() const
{
...
void ComDayCqDamS7damCommonServletsS7damProductInfoServletProperties::fromJson(web::json::value& val)
{
...
void ComDayCqDamS7damCommonServletsS7damProductInfoServletProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamS7damCommonServletsS7damProductInfoServletProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
