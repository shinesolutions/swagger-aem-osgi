...
web::json::value ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::toJson() const
{
...
void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties> newItem(new ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties());
...
void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties> ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo::setProperties(std::shared_ptr<ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties> value)
{
    m_Properties = value;
