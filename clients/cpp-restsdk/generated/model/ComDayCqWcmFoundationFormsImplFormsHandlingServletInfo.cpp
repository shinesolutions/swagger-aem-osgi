...
web::json::value ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::toJson() const
{
...
void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqWcmFoundationFormsImplFormsHandlingServletProperties> newItem(new ComDayCqWcmFoundationFormsImplFormsHandlingServletProperties());
...
void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqWcmFoundationFormsImplFormsHandlingServletProperties> ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqWcmFoundationFormsImplFormsHandlingServletInfo::setProperties(std::shared_ptr<ComDayCqWcmFoundationFormsImplFormsHandlingServletProperties> value)
{
    m_Properties = value;
