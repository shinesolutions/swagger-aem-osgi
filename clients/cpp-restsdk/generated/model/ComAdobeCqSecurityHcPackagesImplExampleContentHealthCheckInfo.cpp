...
web::json::value ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::toJson() const
{
...
void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckProperties> newItem(new ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckProperties());
...
void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getPid() const
{
    return m_Pid;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getTitle() const
{
    return m_Title;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getDescription() const
{
    return m_Description;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setAdditionalProperties(utility::string_t value)
{
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComAdobeCqSecurityHcPackagesImplExampleContentHealthCheckInfo::setServiceLocation(utility::string_t value)
{
