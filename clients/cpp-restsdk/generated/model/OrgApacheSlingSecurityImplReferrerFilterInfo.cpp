...
web::json::value OrgApacheSlingSecurityImplReferrerFilterInfo::toJson() const
{
...
void OrgApacheSlingSecurityImplReferrerFilterInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<OrgApacheSlingSecurityImplReferrerFilterProperties> newItem(new OrgApacheSlingSecurityImplReferrerFilterProperties());
...
void OrgApacheSlingSecurityImplReferrerFilterInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrgApacheSlingSecurityImplReferrerFilterInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t OrgApacheSlingSecurityImplReferrerFilterInfo::getPid() const
{
    return m_Pid;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t OrgApacheSlingSecurityImplReferrerFilterInfo::getTitle() const
{
    return m_Title;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t OrgApacheSlingSecurityImplReferrerFilterInfo::getDescription() const
{
    return m_Description;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<OrgApacheSlingSecurityImplReferrerFilterProperties> OrgApacheSlingSecurityImplReferrerFilterInfo::getProperties() const
{
    return m_Properties;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setProperties(std::shared_ptr<OrgApacheSlingSecurityImplReferrerFilterProperties> value)
{
    m_Properties = value;
...
utility::string_t OrgApacheSlingSecurityImplReferrerFilterInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t OrgApacheSlingSecurityImplReferrerFilterInfo::getServiceLocation() const
{
    return m_Service_location;
}


void OrgApacheSlingSecurityImplReferrerFilterInfo::setServiceLocation(utility::string_t value)
{
