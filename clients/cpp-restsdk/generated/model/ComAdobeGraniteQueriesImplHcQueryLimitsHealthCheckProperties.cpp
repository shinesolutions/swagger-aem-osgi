...
web::json::value ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::toJson() const
{
...
void ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::fromJson(web::json::value& val)
{
...
void ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<ConfigNodePropertyArray> ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::getHcTags() const
{
    return m_Hc_tags;
}


void ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties::setHcTags(std::shared_ptr<ConfigNodePropertyArray> value)
{
    m_Hc_tags = value;
    m_Hc_tagsIsSet = true;
}
