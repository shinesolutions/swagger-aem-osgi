...
web::json::value ComDayCqDamInddProcessINDDMediaExtractProcessInfo::toJson() const
{
...
void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamInddProcessINDDMediaExtractProcessProperties> newItem(new ComDayCqDamInddProcessINDDMediaExtractProcessProperties());
...
void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamInddProcessINDDMediaExtractProcessInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamInddProcessINDDMediaExtractProcessInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamInddProcessINDDMediaExtractProcessInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
std::shared_ptr<ComDayCqDamInddProcessINDDMediaExtractProcessProperties> ComDayCqDamInddProcessINDDMediaExtractProcessInfo::getProperties() const
{
    return m_Properties;
}


void ComDayCqDamInddProcessINDDMediaExtractProcessInfo::setProperties(std::shared_ptr<ComDayCqDamInddProcessINDDMediaExtractProcessProperties> value)
{
    m_Properties = value;
