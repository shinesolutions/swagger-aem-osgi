...
web::json::value ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::toJson() const
{
...
void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatProperties> newItem(new ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatProperties());
...
void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamCoreImplFoldermetadataschemaFolderMetadataSchemaFeatInfo::setDescription(utility::string_t value)
{
    m_Description = value;
