...
web::json::value ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::toJson() const
{
...
void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("properties")))
    {
        ...
        {
            std::shared_ptr<ComDayCqDamScene7ImplScene7ConfigurationEventListenerProperties> newItem(new ComDayCqDamScene7ImplScene7ConfigurationEventListenerProperties());
...
void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::getPid() const
{
    return m_Pid;
}


void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::setPid(utility::string_t value)
{
    m_Pid = value;
    m_PidIsSet = true;
}
...
utility::string_t ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::getTitle() const
{
    return m_Title;
}


void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
...
utility::string_t ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::getDescription() const
{
    return m_Description;
}


void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::setDescription(utility::string_t value)
{
    m_Description = value;
...
utility::string_t ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::getBundleLocation() const
{
    return m_Bundle_location;
}


void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::setBundleLocation(utility::string_t value)
{
...
utility::string_t ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::getServiceLocation() const
{
    return m_Service_location;
}


void ComDayCqDamScene7ImplScene7ConfigurationEventListenerInfo::setServiceLocation(utility::string_t value)
{
