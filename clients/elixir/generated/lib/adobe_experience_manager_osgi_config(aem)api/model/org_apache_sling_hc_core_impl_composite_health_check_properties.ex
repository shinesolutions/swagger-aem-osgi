...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.OrgApacheSlingHcCoreImplCompositeHealthCheckProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.OrgApacheSlingHcCoreImplCompositeHealthCheckProperties do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"filter.tags", :struct, AdobeExperienceManagerOSGIConfig(AEM)API.Model.ConfigNodePropertyArray, options)
    |> deserialize(:"filter.combineTagsWithOr", :struct, AdobeExperienceManagerOSGIConfig(AEM)API.Model.ConfigNodePropertyBoolean, options)
  end
end
