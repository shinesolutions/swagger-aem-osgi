...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialQnaClientEndpointsImplQnaForumOperationsServicProperties do
