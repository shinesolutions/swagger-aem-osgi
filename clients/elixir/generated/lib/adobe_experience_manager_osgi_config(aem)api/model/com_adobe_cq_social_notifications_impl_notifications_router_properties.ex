...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialNotificationsImplNotificationsRouterProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialNotificationsImplNotificationsRouterProperties do
