...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComDayCqWcmFoundationSecurityImplSaferSlingPostValidatorImplProperties do
