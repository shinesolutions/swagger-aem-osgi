...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqCommerceImplAssetDynamicImageHandlerProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqCommerceImplAssetDynamicImageHandlerProperties do
