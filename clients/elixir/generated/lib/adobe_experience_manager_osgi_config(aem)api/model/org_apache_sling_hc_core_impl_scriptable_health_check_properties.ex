...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.OrgApacheSlingHcCoreImplScriptableHealthCheckProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.OrgApacheSlingHcCoreImplScriptableHealthCheckProperties do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"language.extension", :struct, AdobeExperienceManagerOSGIConfig(AEM)API.Model.ConfigNodePropertyString, options)
  end
end
