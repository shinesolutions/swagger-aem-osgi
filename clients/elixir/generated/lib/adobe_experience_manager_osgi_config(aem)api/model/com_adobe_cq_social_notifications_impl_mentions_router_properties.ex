...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialNotificationsImplMentionsRouterProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialNotificationsImplMentionsRouterProperties do
