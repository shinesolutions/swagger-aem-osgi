...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialScoringImplScoringEventListenerProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqSocialScoringImplScoringEventListenerProperties do
