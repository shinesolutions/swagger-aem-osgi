...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqCommerceImplAssetVideoHandlerProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqCommerceImplAssetVideoHandlerProperties do
