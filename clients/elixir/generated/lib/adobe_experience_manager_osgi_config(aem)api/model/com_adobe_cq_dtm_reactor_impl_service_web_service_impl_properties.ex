...
defmodule AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqDtmReactorImplServiceWebServiceImplProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: AdobeExperienceManagerOSGIConfig(AEM)API.Model.ComAdobeCqDtmReactorImplServiceWebServiceImplProperties do
