...
import org.openapitools.server.api.model.ComDayCqWcmScriptingImplBVPManagerProperties;
...
public class ComDayCqWcmScriptingImplBVPManagerInfo   {
  ...
  public ComDayCqWcmScriptingImplBVPManagerInfo (String pid, String title, String description, ComDayCqWcmScriptingImplBVPManagerProperties properties) {
    this.pid = pid;
    this.title = title;
