...
public class ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo   {
  ...
  public ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletInfo (String pid, String title, String description, ComAdobeGraniteOauthServerImplOAuth2ClientRevocationServletProperties properties) {
    this.pid = pid;
    this.title = title;
