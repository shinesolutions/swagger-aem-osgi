...
public class ComDayCqDamCoreImplRenditionMakerImplInfo   {
  ...
  public ComDayCqDamCoreImplRenditionMakerImplInfo (String pid, String title, String description, ComDayCqDamCoreImplRenditionMakerImplProperties properties) {
    this.pid = pid;
    this.title = title;
