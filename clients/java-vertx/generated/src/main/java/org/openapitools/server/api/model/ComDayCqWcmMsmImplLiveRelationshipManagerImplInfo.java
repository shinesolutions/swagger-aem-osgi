...
public class ComDayCqWcmMsmImplLiveRelationshipManagerImplInfo   {
  ...
  public ComDayCqWcmMsmImplLiveRelationshipManagerImplInfo (String pid, String title, String description, ComDayCqWcmMsmImplLiveRelationshipManagerImplProperties properties) {
    this.pid = pid;
    this.title = title;
