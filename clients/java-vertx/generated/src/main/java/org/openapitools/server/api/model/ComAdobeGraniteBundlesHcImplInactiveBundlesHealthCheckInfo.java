...
public class ComAdobeGraniteBundlesHcImplInactiveBundlesHealthCheckInfo   {
  ...
  public ComAdobeGraniteBundlesHcImplInactiveBundlesHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteBundlesHcImplInactiveBundlesHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
