...
public class ComDayCqWcmCoreStatsPageViewStatisticsImplInfo   {
  ...
  public ComDayCqWcmCoreStatsPageViewStatisticsImplInfo (String pid, String title, String description, ComDayCqWcmCoreStatsPageViewStatisticsImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
