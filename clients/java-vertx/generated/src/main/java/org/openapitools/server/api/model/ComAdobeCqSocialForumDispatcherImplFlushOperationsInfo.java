...
public class ComAdobeCqSocialForumDispatcherImplFlushOperationsInfo   {
  ...
  public ComAdobeCqSocialForumDispatcherImplFlushOperationsInfo (String pid, String title, String description, ComAdobeCqSocialForumDispatcherImplFlushOperationsProperties properties) {
    this.pid = pid;
    this.title = title;
