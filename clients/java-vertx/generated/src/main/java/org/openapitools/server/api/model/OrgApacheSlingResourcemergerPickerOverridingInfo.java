...
public class OrgApacheSlingResourcemergerPickerOverridingInfo   {
  ...
  public OrgApacheSlingResourcemergerPickerOverridingInfo (String pid, String title, String description, OrgApacheSlingResourcemergerPickerOverridingProperties properties, String additionalProperties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
