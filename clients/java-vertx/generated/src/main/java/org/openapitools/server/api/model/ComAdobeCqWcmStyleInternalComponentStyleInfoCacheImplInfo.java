...
public class ComAdobeCqWcmStyleInternalComponentStyleInfoCacheImplInfo   {
  ...
  public ComAdobeCqWcmStyleInternalComponentStyleInfoCacheImplInfo (String pid, String title, String description, ComAdobeCqWcmStyleInternalComponentStyleInfoCacheImplProperties properties) {
    this.pid = pid;
    this.title = title;
