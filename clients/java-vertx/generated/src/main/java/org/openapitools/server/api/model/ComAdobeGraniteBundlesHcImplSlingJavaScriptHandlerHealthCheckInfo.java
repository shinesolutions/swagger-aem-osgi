...
public class ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckInfo   {
  ...
  public ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteBundlesHcImplSlingJavaScriptHandlerHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
