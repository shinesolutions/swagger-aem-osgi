...
public class ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo   {
  ...
  private ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties properties = null;

  public ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo () {

  }

  public ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerInfo (String pid, String title, String description, ComDayCqDamCoreImplHandlerXmpNCommXMPHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
