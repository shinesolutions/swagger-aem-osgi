...
public class ComDayCqWidgetImplWidgetExtensionProviderImplInfo   {
  ...
  public ComDayCqWidgetImplWidgetExtensionProviderImplInfo (String pid, String title, String description, ComDayCqWidgetImplWidgetExtensionProviderImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
