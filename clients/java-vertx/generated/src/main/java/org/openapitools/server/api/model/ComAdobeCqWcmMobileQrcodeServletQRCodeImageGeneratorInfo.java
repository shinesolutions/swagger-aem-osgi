...
public class ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorInfo   {
  ...
  public ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorInfo (String pid, String title, String description, ComAdobeCqWcmMobileQrcodeServletQRCodeImageGeneratorProperties properties) {
    this.pid = pid;
    this.title = title;
