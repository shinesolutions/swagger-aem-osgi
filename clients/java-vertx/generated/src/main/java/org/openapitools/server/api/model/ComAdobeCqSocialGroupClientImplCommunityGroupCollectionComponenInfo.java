...
public class ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo   {
  ...
  public ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenInfo (String pid, String title, String description, ComAdobeCqSocialGroupClientImplCommunityGroupCollectionComponenProperties properties) {
    this.pid = pid;
    this.title = title;
