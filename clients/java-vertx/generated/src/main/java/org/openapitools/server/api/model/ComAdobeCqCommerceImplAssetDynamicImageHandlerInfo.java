...
public class ComAdobeCqCommerceImplAssetDynamicImageHandlerInfo   {
  ...
  public ComAdobeCqCommerceImplAssetDynamicImageHandlerInfo (String pid, String title, String description, ComAdobeCqCommerceImplAssetDynamicImageHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
