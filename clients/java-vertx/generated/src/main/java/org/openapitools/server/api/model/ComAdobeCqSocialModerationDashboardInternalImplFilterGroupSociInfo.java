...
public class ComAdobeCqSocialModerationDashboardInternalImplFilterGroupSociInfo   {
  ...
  public ComAdobeCqSocialModerationDashboardInternalImplFilterGroupSociInfo (String pid, String title, String description, ComAdobeCqSocialModerationDashboardInternalImplFilterGroupSociProperties properties) {
    this.pid = pid;
    this.title = title;
