...
public class ComAdobeGraniteAuthRequirementImplDefaultRequirementHandlerInfo   {
  ...
  public ComAdobeGraniteAuthRequirementImplDefaultRequirementHandlerInfo (String pid, String title, String description, ComAdobeGraniteAuthRequirementImplDefaultRequirementHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
