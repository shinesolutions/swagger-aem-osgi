...
public class OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsIndexSolrOsgiNodeStateSolrServersProperties properties) {
    this.pid = pid;
    this.title = title;
