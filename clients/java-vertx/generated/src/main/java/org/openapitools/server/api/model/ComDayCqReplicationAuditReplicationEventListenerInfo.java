...
public class ComDayCqReplicationAuditReplicationEventListenerInfo   {
  ...
  public ComDayCqReplicationAuditReplicationEventListenerInfo (String pid, String title, String description, ComDayCqReplicationAuditReplicationEventListenerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
