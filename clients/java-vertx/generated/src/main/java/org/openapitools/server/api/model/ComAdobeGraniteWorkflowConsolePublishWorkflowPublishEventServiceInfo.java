...
public class ComAdobeGraniteWorkflowConsolePublishWorkflowPublishEventServiceInfo   {
  ...
  public ComAdobeGraniteWorkflowConsolePublishWorkflowPublishEventServiceInfo (String pid, String title, String description, ComAdobeGraniteWorkflowConsolePublishWorkflowPublishEventServiceProperties properties) {
    this.pid = pid;
    this.title = title;
