...
import org.openapitools.server.api.model.ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties;
...
public class ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleInfo   {
  ...
  private ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties properties = null;

  public ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleInfo () {

  }

  public ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleInfo (String pid, String title, String description, ComDayCqWcmDesignimporterParserTaghandlersFactoryHeadTagHandleProperties properties) {
    this.pid = pid;
    this.title = title;
