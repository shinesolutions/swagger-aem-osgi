...
public class ComDayCqReportingImplConfigServiceImplInfo   {
  ...
  public ComDayCqReportingImplConfigServiceImplInfo (String pid, String title, String description, ComDayCqReportingImplConfigServiceImplProperties properties) {
    this.pid = pid;
    this.title = title;
