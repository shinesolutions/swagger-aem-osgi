...
public class ComDayCqWcmMsmImplServletsAuditLogServletInfo   {
  ...
  public ComDayCqWcmMsmImplServletsAuditLogServletInfo (String pid, String title, String description, ComDayCqWcmMsmImplServletsAuditLogServletProperties properties) {
    this.pid = pid;
    this.title = title;
