...
public class ComDayCqWcmCoreImplEventRepositoryChangeEventListenerInfo   {
  ...
  public ComDayCqWcmCoreImplEventRepositoryChangeEventListenerInfo (String pid, String title, String description, ComDayCqWcmCoreImplEventRepositoryChangeEventListenerProperties properties) {
    this.pid = pid;
    this.title = title;
