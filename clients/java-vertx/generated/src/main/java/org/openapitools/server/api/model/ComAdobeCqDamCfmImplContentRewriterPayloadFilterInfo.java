...
public class ComAdobeCqDamCfmImplContentRewriterPayloadFilterInfo   {
  ...
  public ComAdobeCqDamCfmImplContentRewriterPayloadFilterInfo (String pid, String title, String description, ComAdobeCqDamCfmImplContentRewriterPayloadFilterProperties properties) {
    this.pid = pid;
    this.title = title;
