...
public class ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerInfo   {
  ...
  public ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerInfo (String pid, String title, String description, ComDayCqWcmCoreImplServletsContentfinderPageViewHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
