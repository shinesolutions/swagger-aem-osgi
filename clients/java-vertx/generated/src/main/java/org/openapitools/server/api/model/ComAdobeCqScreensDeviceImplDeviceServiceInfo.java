...
public class ComAdobeCqScreensDeviceImplDeviceServiceInfo   {
  ...
  public ComAdobeCqScreensDeviceImplDeviceServiceInfo (String pid, String title, String description, ComAdobeCqScreensDeviceImplDeviceServiceProperties properties) {
    this.pid = pid;
    this.title = title;
