...
public class OrgApacheJackrabbitOakSegmentStandbyStoreStandbyStoreServiceInfo   {
  ...
  public OrgApacheJackrabbitOakSegmentStandbyStoreStandbyStoreServiceInfo (String pid, String title, String description, OrgApacheJackrabbitOakSegmentStandbyStoreStandbyStoreServiceProperties properties) {
    this.pid = pid;
    this.title = title;
