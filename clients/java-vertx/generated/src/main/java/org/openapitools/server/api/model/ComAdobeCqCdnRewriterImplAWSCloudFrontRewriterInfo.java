...
public class ComAdobeCqCdnRewriterImplAWSCloudFrontRewriterInfo   {
  ...
  public ComAdobeCqCdnRewriterImplAWSCloudFrontRewriterInfo (String pid, String title, String description, ComAdobeCqCdnRewriterImplAWSCloudFrontRewriterProperties properties) {
    this.pid = pid;
    this.title = title;
