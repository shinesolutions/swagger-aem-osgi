...
public class ComAdobeCqUpgradesCleanupImplUpgradeContentCleanupInfo   {
  ...
  public ComAdobeCqUpgradesCleanupImplUpgradeContentCleanupInfo (String pid, String title, String description, ComAdobeCqUpgradesCleanupImplUpgradeContentCleanupProperties properties) {
    this.pid = pid;
    this.title = title;
