...
public class ComDayCqDamCommonsUtilImplAssetCacheImplInfo   {
  ...
  private ComDayCqDamCommonsUtilImplAssetCacheImplProperties properties = null;

  public ComDayCqDamCommonsUtilImplAssetCacheImplInfo () {

  }

  public ComDayCqDamCommonsUtilImplAssetCacheImplInfo (String pid, String title, String description, ComDayCqDamCommonsUtilImplAssetCacheImplProperties properties) {
    this.pid = pid;
    this.title = title;
