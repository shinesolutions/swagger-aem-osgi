...
public class ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo   {
  ...
  public ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplInfo (String pid, String title, String description, ComAdobeCqSocialHandlebarsGuavaTemplateCacheImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
