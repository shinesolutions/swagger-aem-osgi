...
import org.openapitools.server.api.model.OrgApacheSlingTenantInternalTenantProviderImplProperties;
...
public class OrgApacheSlingTenantInternalTenantProviderImplInfo   {
  ...
  public OrgApacheSlingTenantInternalTenantProviderImplInfo (String pid, String title, String description, OrgApacheSlingTenantInternalTenantProviderImplProperties properties) {
    this.pid = pid;
    this.title = title;
