...
public class ComDayCrxSecurityTokenImplTokenCleanupTaskInfo   {
  ...
  public ComDayCrxSecurityTokenImplTokenCleanupTaskInfo (String pid, String title, String description, ComDayCrxSecurityTokenImplTokenCleanupTaskProperties properties) {
    this.pid = pid;
    this.title = title;
