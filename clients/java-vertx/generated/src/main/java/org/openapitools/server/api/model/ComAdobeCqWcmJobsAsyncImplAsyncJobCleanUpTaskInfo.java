...
public class ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo   {
  ...
  public ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskInfo (String pid, String title, String description, ComAdobeCqWcmJobsAsyncImplAsyncJobCleanUpTaskProperties properties) {
    this.pid = pid;
    this.title = title;
