...
public class ComDayCqWcmFoundationImplAdaptiveImageComponentServletInfo   {
  ...
  public ComDayCqWcmFoundationImplAdaptiveImageComponentServletInfo (String pid, String title, String description, ComDayCqWcmFoundationImplAdaptiveImageComponentServletProperties properties) {
    this.pid = pid;
    this.title = title;
