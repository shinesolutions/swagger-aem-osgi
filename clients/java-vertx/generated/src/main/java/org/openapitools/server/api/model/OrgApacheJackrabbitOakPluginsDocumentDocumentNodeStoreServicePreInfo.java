...
public class OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsDocumentDocumentNodeStoreServicePreProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
