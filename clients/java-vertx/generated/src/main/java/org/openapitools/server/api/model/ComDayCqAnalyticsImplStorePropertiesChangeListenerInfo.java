...
public class ComDayCqAnalyticsImplStorePropertiesChangeListenerInfo   {
  ...
  public ComDayCqAnalyticsImplStorePropertiesChangeListenerInfo (String pid, String title, String description, ComDayCqAnalyticsImplStorePropertiesChangeListenerProperties properties) {
    this.pid = pid;
    this.title = title;
