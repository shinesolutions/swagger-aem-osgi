...
public class ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo   {
  ...
  public ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplInfo (String pid, String title, String description, ComDayCqRewriterLinkcheckerImplLinkInfoStorageImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
