...
public class ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterInfo   {
  ...
  public ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterInfo (String pid, String title, String description, ComAdobeGraniteRestAssetsImplAssetContentDispositionFilterProperties properties) {
    this.pid = pid;
    this.title = title;
