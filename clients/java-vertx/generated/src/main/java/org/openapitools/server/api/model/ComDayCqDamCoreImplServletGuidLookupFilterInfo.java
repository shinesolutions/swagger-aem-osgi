...
public class ComDayCqDamCoreImplServletGuidLookupFilterInfo   {
  ...
  public ComDayCqDamCoreImplServletGuidLookupFilterInfo (String pid, String title, String description, ComDayCqDamCoreImplServletGuidLookupFilterProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
