...
public class ComAdobeCqSocialSiteImplSiteConfiguratorImplInfo   {
  ...
  public ComAdobeCqSocialSiteImplSiteConfiguratorImplInfo (String pid, String title, String description, ComAdobeCqSocialSiteImplSiteConfiguratorImplProperties properties) {
    this.pid = pid;
    this.title = title;
