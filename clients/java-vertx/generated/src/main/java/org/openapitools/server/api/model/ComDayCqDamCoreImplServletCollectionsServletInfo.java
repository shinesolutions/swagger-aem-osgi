...
public class ComDayCqDamCoreImplServletCollectionsServletInfo   {
  ...
  public ComDayCqDamCoreImplServletCollectionsServletInfo (String pid, String title, String description, ComDayCqDamCoreImplServletCollectionsServletProperties properties) {
    this.pid = pid;
    this.title = title;
