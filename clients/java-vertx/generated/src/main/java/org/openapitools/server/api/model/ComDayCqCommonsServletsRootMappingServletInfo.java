...
public class ComDayCqCommonsServletsRootMappingServletInfo   {
  ...
  public ComDayCqCommonsServletsRootMappingServletInfo (String pid, String title, String description, ComDayCqCommonsServletsRootMappingServletProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
