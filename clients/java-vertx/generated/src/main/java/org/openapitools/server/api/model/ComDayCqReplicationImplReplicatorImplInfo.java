...
public class ComDayCqReplicationImplReplicatorImplInfo   {
  ...
  public ComDayCqReplicationImplReplicatorImplInfo (String pid, String title, String description, ComDayCqReplicationImplReplicatorImplProperties properties) {
    this.pid = pid;
    this.title = title;
