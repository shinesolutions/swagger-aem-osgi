...
public class ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo   {
  ...
  public ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletInfo (String pid, String title, String description, ComAdobeGraniteOauthServerImplOAuth2RevocationEndpointServletProperties properties) {
    this.pid = pid;
    this.title = title;
