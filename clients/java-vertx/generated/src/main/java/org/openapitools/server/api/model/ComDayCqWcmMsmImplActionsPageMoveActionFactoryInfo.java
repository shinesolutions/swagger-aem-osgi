...
public class ComDayCqWcmMsmImplActionsPageMoveActionFactoryInfo   {
  ...
  public ComDayCqWcmMsmImplActionsPageMoveActionFactoryInfo (String pid, String title, String description, ComDayCqWcmMsmImplActionsPageMoveActionFactoryProperties properties) {
    this.pid = pid;
    this.title = title;
