...
public class OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiInfo   {
  ...
  public OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiInfo (String pid, String title, String description, OrgApacheJackrabbitOakSecurityAuthenticationLdapImplLdapIdentiProperties properties) {
    this.pid = pid;
    this.title = title;
