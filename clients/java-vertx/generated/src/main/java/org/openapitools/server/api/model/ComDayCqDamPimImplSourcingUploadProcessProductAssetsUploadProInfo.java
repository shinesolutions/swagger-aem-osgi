...
public class ComDayCqDamPimImplSourcingUploadProcessProductAssetsUploadProInfo   {
  ...
  public ComDayCqDamPimImplSourcingUploadProcessProductAssetsUploadProInfo (String pid, String title, String description, ComDayCqDamPimImplSourcingUploadProcessProductAssetsUploadProProperties properties) {
    this.pid = pid;
    this.title = title;
