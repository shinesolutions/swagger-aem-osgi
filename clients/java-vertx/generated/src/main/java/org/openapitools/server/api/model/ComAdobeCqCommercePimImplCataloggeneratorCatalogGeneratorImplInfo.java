...
public class ComAdobeCqCommercePimImplCataloggeneratorCatalogGeneratorImplInfo   {
  ...
  public ComAdobeCqCommercePimImplCataloggeneratorCatalogGeneratorImplInfo (String pid, String title, String description, ComAdobeCqCommercePimImplCataloggeneratorCatalogGeneratorImplProperties properties) {
    this.pid = pid;
    this.title = title;
