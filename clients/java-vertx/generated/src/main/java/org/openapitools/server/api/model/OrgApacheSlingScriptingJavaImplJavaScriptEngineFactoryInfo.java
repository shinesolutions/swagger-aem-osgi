...
public class OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo   {
  ...
  public OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryInfo (String pid, String title, String description, OrgApacheSlingScriptingJavaImplJavaScriptEngineFactoryProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
