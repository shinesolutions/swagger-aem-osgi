...
public class ComDayCqDamS7damCommonProcessVideoThumbnailDownloadProcessInfo   {
  ...
  public ComDayCqDamS7damCommonProcessVideoThumbnailDownloadProcessInfo (String pid, String title, String description, ComDayCqDamS7damCommonProcessVideoThumbnailDownloadProcessProperties properties) {
    this.pid = pid;
    this.title = title;
