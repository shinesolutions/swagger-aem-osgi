...
public class ComDayCqDamS7damCommonServletsS7damProductInfoServletInfo   {
  ...
  public ComDayCqDamS7damCommonServletsS7damProductInfoServletInfo (String pid, String title, String description, ComDayCqDamS7damCommonServletsS7damProductInfoServletProperties properties) {
    this.pid = pid;
    this.title = title;
