...
public class ComDayCqStatisticsImplStatisticsServiceImplInfo   {
  ...
  public ComDayCqStatisticsImplStatisticsServiceImplInfo (String pid, String title, String description, ComDayCqStatisticsImplStatisticsServiceImplProperties properties) {
    this.pid = pid;
    this.title = title;
