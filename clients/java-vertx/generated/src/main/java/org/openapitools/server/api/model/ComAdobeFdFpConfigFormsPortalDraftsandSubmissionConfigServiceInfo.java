...
public class ComAdobeFdFpConfigFormsPortalDraftsandSubmissionConfigServiceInfo   {
  ...
  public ComAdobeFdFpConfigFormsPortalDraftsandSubmissionConfigServiceInfo (String pid, String title, String description, ComAdobeFdFpConfigFormsPortalDraftsandSubmissionConfigServiceProperties properties) {
    this.pid = pid;
    this.title = title;
