...
public class ComAdobeGraniteI18nImplBundlePseudoTranslationsInfo   {
  ...
  public ComAdobeGraniteI18nImplBundlePseudoTranslationsInfo (String pid, String title, String description, ComAdobeGraniteI18nImplBundlePseudoTranslationsProperties properties) {
    this.pid = pid;
    this.title = title;
