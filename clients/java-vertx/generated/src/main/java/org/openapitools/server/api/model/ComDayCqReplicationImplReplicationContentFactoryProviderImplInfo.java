...
public class ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo   {
  ...
  public ComDayCqReplicationImplReplicationContentFactoryProviderImplInfo (String pid, String title, String description, ComDayCqReplicationImplReplicationContentFactoryProviderImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
