...
public class OrgApacheSlingEventImplJobsJobConsumerManagerInfo   {
  ...
  public OrgApacheSlingEventImplJobsJobConsumerManagerInfo (String pid, String title, String description, OrgApacheSlingEventImplJobsJobConsumerManagerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
