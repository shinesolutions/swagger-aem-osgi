...
public class ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo   {
  ...
  public ComAdobeXmpWorkerFilesNcommXMPFilesNCommInfo (String pid, String title, String description, ComAdobeXmpWorkerFilesNcommXMPFilesNCommProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
