...
public class ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckInfo   {
  ...
  public ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteBundlesHcImplSlingGetServletHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
