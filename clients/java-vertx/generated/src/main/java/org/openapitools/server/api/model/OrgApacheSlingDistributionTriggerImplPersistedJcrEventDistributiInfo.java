...
public class OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiInfo   {
  ...
  private OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties properties = null;

  public OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiInfo () {

  }

  public OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiInfo (String pid, String title, String description, OrgApacheSlingDistributionTriggerImplPersistedJcrEventDistributiProperties properties) {
    this.pid = pid;
    this.title = title;
