...
public class ComDayCqDamVideoImplServletVideoTestServletInfo   {
  ...
  public ComDayCqDamVideoImplServletVideoTestServletInfo (String pid, String title, String description, ComDayCqDamVideoImplServletVideoTestServletProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
