...
public class MainApiVerticle extends AbstractVerticle {
    ...
    public void deployVerticles(Future<Void> startFuture) {
        ...
        vertx.deployVerticle("org.openapitools.server.api.verticle.ConfigmgrApiVerticle", res -> {
            if (res.succeeded()) {
                LOGGER.info("ConfigmgrApiVerticle : Deployed");
            } else {
                startFuture.fail(res.cause());
                LOGGER.error("ConfigmgrApiVerticle : Deployment failed");
            }
        });
