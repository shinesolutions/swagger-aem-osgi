...
public class ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryInfo   {
  ...
  public ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryInfo (String pid, String title, String description, ComDayCqWcmMsmImplActionsReferencesUpdateActionFactoryProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
