...
public class ComDayCqWcmCoreImplLanguageManagerImplInfo   {
  ...
  public ComDayCqWcmCoreImplLanguageManagerImplInfo (String pid, String title, String description, ComDayCqWcmCoreImplLanguageManagerImplProperties properties) {
    this.pid = pid;
    this.title = title;
