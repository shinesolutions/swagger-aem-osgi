...
public class OrgApacheJackrabbitOakSecurityAuthenticationAuthenticationConfigInfo   {
  ...
  public OrgApacheJackrabbitOakSecurityAuthenticationAuthenticationConfigInfo (String pid, String title, String description, OrgApacheJackrabbitOakSecurityAuthenticationAuthenticationConfigProperties properties) {
    this.pid = pid;
    this.title = title;
