...
public class ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo   {
  ...
  public ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskInfo (String pid, String title, String description, ComAdobeGraniteMaintenanceCrxImplLuceneBinariesCleanupTaskProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
