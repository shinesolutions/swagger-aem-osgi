...
public class ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo   {
  ...
  public ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalInfo (String pid, String title, String description, ComAdobeGraniteAuthOauthImplHelperProviderConfigManagerInternalProperties properties) {
    this.pid = pid;
    this.title = title;
