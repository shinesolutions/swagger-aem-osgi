...
public class OrgApacheSlingFeatureflagsFeatureProperties   {
  ...
  public OrgApacheSlingFeatureflagsFeatureProperties (ConfigNodePropertyString name, ConfigNodePropertyString description, ConfigNodePropertyBoolean enabled) {
    this.name = name;
