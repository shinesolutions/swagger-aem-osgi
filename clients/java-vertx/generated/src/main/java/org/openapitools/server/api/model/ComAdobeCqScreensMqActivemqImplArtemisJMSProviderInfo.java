...
public class ComAdobeCqScreensMqActivemqImplArtemisJMSProviderInfo   {
  ...
  public ComAdobeCqScreensMqActivemqImplArtemisJMSProviderInfo (String pid, String title, String description, ComAdobeCqScreensMqActivemqImplArtemisJMSProviderProperties properties) {
    this.pid = pid;
    this.title = title;
