...
public class OrgApacheSlingScriptingCoreImplScriptCacheImplInfo   {
  ...
  public OrgApacheSlingScriptingCoreImplScriptCacheImplInfo (String pid, String title, String description, OrgApacheSlingScriptingCoreImplScriptCacheImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
