...
public class AdaptiveFormAndInteractiveCommunicationWebChannelThemeConfigurInfo   {
  ...
  public AdaptiveFormAndInteractiveCommunicationWebChannelThemeConfigurInfo (String pid, String title, String description, AdaptiveFormAndInteractiveCommunicationWebChannelThemeConfigurProperties properties) {
    this.pid = pid;
    this.title = title;
