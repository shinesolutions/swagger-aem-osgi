...
public class ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckInfo   {
  ...
  public ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteQueriesImplHcQueryLimitsHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
