...
public class ComDayCqWcmFoundationFormsImplFormChooserServletInfo   {
  ...
  public ComDayCqWcmFoundationFormsImplFormChooserServletInfo (String pid, String title, String description, ComDayCqWcmFoundationFormsImplFormChooserServletProperties properties) {
    this.pid = pid;
    this.title = title;
