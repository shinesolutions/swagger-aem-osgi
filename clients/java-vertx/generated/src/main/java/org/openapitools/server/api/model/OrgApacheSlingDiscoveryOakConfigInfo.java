...
public class OrgApacheSlingDiscoveryOakConfigInfo   {
  ...
  public OrgApacheSlingDiscoveryOakConfigInfo (String pid, String title, String description, OrgApacheSlingDiscoveryOakConfigProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
