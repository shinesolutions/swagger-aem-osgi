...
public class ComDayCqDamStockIntegrationImplConfigurationStockConfigurationInfo   {
  ...
  public ComDayCqDamStockIntegrationImplConfigurationStockConfigurationInfo (String pid, String title, String description, ComDayCqDamStockIntegrationImplConfigurationStockConfigurationProperties properties) {
    this.pid = pid;
    this.title = title;
