...
public class ComDayCqDamCoreImplJmxAssetIndexUpdateMonitorInfo   {
  ...
  public ComDayCqDamCoreImplJmxAssetIndexUpdateMonitorInfo (String pid, String title, String description, ComDayCqDamCoreImplJmxAssetIndexUpdateMonitorProperties properties) {
    this.pid = pid;
    this.title = title;
