...
public class OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo   {
  ...
  public OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvInfo (String pid, String title, String description, OrgApacheSlingScriptingSightlyJsImplJsapiSlyBindingsValuesProvProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
