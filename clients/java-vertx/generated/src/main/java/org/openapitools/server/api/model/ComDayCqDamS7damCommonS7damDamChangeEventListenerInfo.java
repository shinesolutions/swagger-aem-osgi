...
public class ComDayCqDamS7damCommonS7damDamChangeEventListenerInfo   {
  ...
  public ComDayCqDamS7damCommonS7damDamChangeEventListenerInfo (String pid, String title, String description, ComDayCqDamS7damCommonS7damDamChangeEventListenerProperties properties) {
    this.pid = pid;
    this.title = title;
