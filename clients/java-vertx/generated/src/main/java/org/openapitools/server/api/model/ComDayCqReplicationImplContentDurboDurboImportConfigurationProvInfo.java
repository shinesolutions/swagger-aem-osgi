...
public class ComDayCqReplicationImplContentDurboDurboImportConfigurationProvInfo   {
  ...
  public ComDayCqReplicationImplContentDurboDurboImportConfigurationProvInfo (String pid, String title, String description, ComDayCqReplicationImplContentDurboDurboImportConfigurationProvProperties properties) {
    this.pid = pid;
    this.title = title;
