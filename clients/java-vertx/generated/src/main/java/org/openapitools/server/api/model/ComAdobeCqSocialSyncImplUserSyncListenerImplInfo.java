...
import org.openapitools.server.api.model.ComAdobeCqSocialSyncImplUserSyncListenerImplProperties;
...
public class ComAdobeCqSocialSyncImplUserSyncListenerImplInfo   {
  ...
  private ComAdobeCqSocialSyncImplUserSyncListenerImplProperties properties = null;

  public ComAdobeCqSocialSyncImplUserSyncListenerImplInfo () {

  }

  public ComAdobeCqSocialSyncImplUserSyncListenerImplInfo (String pid, String title, String description, ComAdobeCqSocialSyncImplUserSyncListenerImplProperties properties) {
    this.pid = pid;
    this.title = title;
