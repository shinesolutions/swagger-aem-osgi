...
public class OrgApacheSlingJmxProviderImplJMXResourceProviderInfo   {
  ...
  public OrgApacheSlingJmxProviderImplJMXResourceProviderInfo (String pid, String title, String description, OrgApacheSlingJmxProviderImplJMXResourceProviderProperties properties) {
    this.pid = pid;
    this.title = title;
