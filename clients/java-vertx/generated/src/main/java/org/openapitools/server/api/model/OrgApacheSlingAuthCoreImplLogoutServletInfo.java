...
import org.openapitools.server.api.model.OrgApacheSlingAuthCoreImplLogoutServletProperties;
...
public class OrgApacheSlingAuthCoreImplLogoutServletInfo   {
  ...
  public OrgApacheSlingAuthCoreImplLogoutServletInfo (String pid, String title, String description, OrgApacheSlingAuthCoreImplLogoutServletProperties properties) {
    this.pid = pid;
    this.title = title;
