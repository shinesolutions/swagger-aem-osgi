...
public class ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo   {
  ...
  public ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteReplicationHcImplReplicationQueueHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
