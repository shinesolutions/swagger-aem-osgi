...
public class ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo   {
  ...
  public ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerInfo (String pid, String title, String description, ComDayCqAnalyticsTestandtargetImplPushAuthorCampaignPageListenerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
