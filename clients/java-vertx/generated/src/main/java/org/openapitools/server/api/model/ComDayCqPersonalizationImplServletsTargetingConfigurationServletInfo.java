...
public class ComDayCqPersonalizationImplServletsTargetingConfigurationServletInfo   {
  ...
  public ComDayCqPersonalizationImplServletsTargetingConfigurationServletInfo (String pid, String title, String description, ComDayCqPersonalizationImplServletsTargetingConfigurationServletProperties properties) {
    this.pid = pid;
    this.title = title;
