...
public class OrgApacheSlingXssImplXSSFilterImplInfo   {
  ...
  public OrgApacheSlingXssImplXSSFilterImplInfo (String pid, String title, String description, OrgApacheSlingXssImplXSSFilterImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
