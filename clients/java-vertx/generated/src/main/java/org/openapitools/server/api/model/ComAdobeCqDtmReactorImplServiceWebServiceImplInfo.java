...
public class ComAdobeCqDtmReactorImplServiceWebServiceImplInfo   {
  ...
  public ComAdobeCqDtmReactorImplServiceWebServiceImplInfo (String pid, String title, String description, ComAdobeCqDtmReactorImplServiceWebServiceImplProperties properties) {
    this.pid = pid;
    this.title = title;
