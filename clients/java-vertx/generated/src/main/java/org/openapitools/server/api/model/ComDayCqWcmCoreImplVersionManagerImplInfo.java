...
public class ComDayCqWcmCoreImplVersionManagerImplInfo   {
  ...
  public ComDayCqWcmCoreImplVersionManagerImplInfo (String pid, String title, String description, ComDayCqWcmCoreImplVersionManagerImplProperties properties) {
    this.pid = pid;
    this.title = title;
