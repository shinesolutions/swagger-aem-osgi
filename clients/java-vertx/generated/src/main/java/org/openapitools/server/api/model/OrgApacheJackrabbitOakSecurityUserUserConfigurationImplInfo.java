...
public class OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo   {
  ...
  public OrgApacheJackrabbitOakSecurityUserUserConfigurationImplInfo (String pid, String title, String description, OrgApacheJackrabbitOakSecurityUserUserConfigurationImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
