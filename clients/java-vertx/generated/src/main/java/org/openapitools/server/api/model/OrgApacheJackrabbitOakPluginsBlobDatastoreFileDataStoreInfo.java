...
public class OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsBlobDatastoreFileDataStoreProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
