...
public class ComDayCqWcmCoreImplPagePageManagerFactoryImplInfo   {
  ...
  public ComDayCqWcmCoreImplPagePageManagerFactoryImplInfo (String pid, String title, String description, ComDayCqWcmCoreImplPagePageManagerFactoryImplProperties properties) {
    this.pid = pid;
    this.title = title;
