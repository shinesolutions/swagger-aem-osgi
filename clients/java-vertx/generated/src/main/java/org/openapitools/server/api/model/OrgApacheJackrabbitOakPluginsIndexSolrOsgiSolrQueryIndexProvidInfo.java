...
public class OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsIndexSolrOsgiSolrQueryIndexProvidProperties properties) {
    this.pid = pid;
    this.title = title;
