...
public class ComDayCqDamCoreImplDamEventPurgeServiceInfo   {
  ...
  public ComDayCqDamCoreImplDamEventPurgeServiceInfo (String pid, String title, String description, ComDayCqDamCoreImplDamEventPurgeServiceProperties properties) {
    this.pid = pid;
    this.title = title;
