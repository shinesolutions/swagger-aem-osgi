...
public class OrgApacheJackrabbitOakQueryQueryEngineSettingsServiceInfo   {
  ...
  public OrgApacheJackrabbitOakQueryQueryEngineSettingsServiceInfo (String pid, String title, String description, OrgApacheJackrabbitOakQueryQueryEngineSettingsServiceProperties properties) {
    this.pid = pid;
    this.title = title;
