...
public class OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsIndexSolrOsgiOakSolrConfigurationProperties properties) {
    this.pid = pid;
    this.title = title;
