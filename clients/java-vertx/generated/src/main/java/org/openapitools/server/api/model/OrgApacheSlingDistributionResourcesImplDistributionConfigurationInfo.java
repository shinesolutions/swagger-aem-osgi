...
public class OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo   {
  ...
  public OrgApacheSlingDistributionResourcesImplDistributionConfigurationInfo (String pid, String title, String description, OrgApacheSlingDistributionResourcesImplDistributionConfigurationProperties properties) {
    this.pid = pid;
    this.title = title;
