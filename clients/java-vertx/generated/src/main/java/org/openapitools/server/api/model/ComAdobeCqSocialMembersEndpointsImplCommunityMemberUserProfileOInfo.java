...
public class ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOInfo   {
  ...
  public ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOInfo (String pid, String title, String description, ComAdobeCqSocialMembersEndpointsImplCommunityMemberUserProfileOProperties properties) {
    this.pid = pid;
    this.title = title;
