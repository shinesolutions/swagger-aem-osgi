...
public class ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo   {
  ...
  public ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplInfo (String pid, String title, String description, ComAdobeAemUpgradePrechecksMbeanImplPreUpgradeTasksMBeanImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
