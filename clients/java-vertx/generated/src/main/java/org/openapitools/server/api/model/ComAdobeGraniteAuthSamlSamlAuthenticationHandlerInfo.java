...
public class ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo   {
  ...
  public ComAdobeGraniteAuthSamlSamlAuthenticationHandlerInfo (String pid, String title, String description, ComAdobeGraniteAuthSamlSamlAuthenticationHandlerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
