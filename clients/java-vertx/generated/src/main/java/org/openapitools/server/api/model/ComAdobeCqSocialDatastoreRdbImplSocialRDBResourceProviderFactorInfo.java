...
public class ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorInfo   {
  ...
  public ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorInfo (String pid, String title, String description, ComAdobeCqSocialDatastoreRdbImplSocialRDBResourceProviderFactorProperties properties) {
    this.pid = pid;
    this.title = title;
