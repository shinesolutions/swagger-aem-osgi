...
public class ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties   {
  ...
  public ComAdobeCqSocialMessagingClientEndpointsImplMessagingOperationProperties (ConfigNodePropertyArray messageProperties, ConfigNodePropertyInteger messageBoxSizeLimit, ConfigNodePropertyInteger messageCountLimit, ConfigNodePropertyBoolean notifyFailure, ConfigNodePropertyString failureMessageFrom, ConfigNodePropertyString failureTemplatePath, ConfigNodePropertyInteger maxRetries, ConfigNodePropertyInteger minWaitBetweenRetries, ConfigNodePropertyInteger countUpdatePoolSize, ConfigNodePropertyString inboxPath, ConfigNodePropertyString sentitemsPath, ConfigNodePropertyBoolean supportAttachments, ConfigNodePropertyBoolean supportGroupMessaging, ConfigNodePropertyInteger maxTotalRecipients, ConfigNodePropertyInteger batchSize, ConfigNodePropertyInteger maxTotalAttachmentSize, ConfigNodePropertyArray attachmentTypeBlacklist, ConfigNodePropertyArray allowedAttachmentTypes, ConfigNodePropertyString serviceSelector, ConfigNodePropertyArray fieldWhitelist) {
