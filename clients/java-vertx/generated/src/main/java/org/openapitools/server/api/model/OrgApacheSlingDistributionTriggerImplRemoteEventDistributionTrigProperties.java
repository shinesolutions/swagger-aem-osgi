...
public class OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties   {
  ...
  public OrgApacheSlingDistributionTriggerImplRemoteEventDistributionTrigProperties (ConfigNodePropertyString name, ConfigNodePropertyString endpoint, ConfigNodePropertyString transportSecretProviderTarget) {
    this.name = name;
