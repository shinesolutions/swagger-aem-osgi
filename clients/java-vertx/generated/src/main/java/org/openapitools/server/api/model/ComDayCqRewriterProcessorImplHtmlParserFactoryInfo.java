...
public class ComDayCqRewriterProcessorImplHtmlParserFactoryInfo   {
  ...
  public ComDayCqRewriterProcessorImplHtmlParserFactoryInfo (String pid, String title, String description, ComDayCqRewriterProcessorImplHtmlParserFactoryProperties properties) {
    this.pid = pid;
    this.title = title;
