...
public class OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo   {
  ...
  public OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderInfo (String pid, String title, String description, OrgApacheJackrabbitOakPluginsObservationChangeCollectorProviderProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
