...
public class ComDayCqWcmNotificationImplNotificationManagerImplInfo   {
  ...
  public ComDayCqWcmNotificationImplNotificationManagerImplInfo (String pid, String title, String description, ComDayCqWcmNotificationImplNotificationManagerImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
