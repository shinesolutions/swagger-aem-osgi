...
public class ComAdobeGraniteOauthServerAuthImplOAuth2ServerAuthenticationHanInfo   {
  ...
  public ComAdobeGraniteOauthServerAuthImplOAuth2ServerAuthenticationHanInfo (String pid, String title, String description, ComAdobeGraniteOauthServerAuthImplOAuth2ServerAuthenticationHanProperties properties) {
    this.pid = pid;
    this.title = title;
