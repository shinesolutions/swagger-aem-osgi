...
public class OrgApacheSlingEngineImplSlingMainServletInfo   {
  ...
  public OrgApacheSlingEngineImplSlingMainServletInfo (String pid, String title, String description, OrgApacheSlingEngineImplSlingMainServletProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
