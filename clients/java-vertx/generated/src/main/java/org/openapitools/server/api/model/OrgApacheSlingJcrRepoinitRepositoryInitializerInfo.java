...
public class OrgApacheSlingJcrRepoinitRepositoryInitializerInfo   {
  ...
  public OrgApacheSlingJcrRepoinitRepositoryInitializerInfo (String pid, String title, String description, OrgApacheSlingJcrRepoinitRepositoryInitializerProperties properties) {
    this.pid = pid;
    this.title = title;
