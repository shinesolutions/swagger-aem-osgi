...
public class ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo   {
  ...
  public ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteRepositoryHcImplAuthorizableNodeNameHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
