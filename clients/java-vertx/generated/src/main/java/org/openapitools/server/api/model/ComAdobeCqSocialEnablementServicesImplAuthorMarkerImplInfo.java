...
public class ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo   {
  ...
  public ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplInfo (String pid, String title, String description, ComAdobeCqSocialEnablementServicesImplAuthorMarkerImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
