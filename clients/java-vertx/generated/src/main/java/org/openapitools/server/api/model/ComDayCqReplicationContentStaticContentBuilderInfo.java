...
public class ComDayCqReplicationContentStaticContentBuilderInfo   {
  ...
  public ComDayCqReplicationContentStaticContentBuilderInfo (String pid, String title, String description, ComDayCqReplicationContentStaticContentBuilderProperties properties) {
    this.pid = pid;
    this.title = title;
