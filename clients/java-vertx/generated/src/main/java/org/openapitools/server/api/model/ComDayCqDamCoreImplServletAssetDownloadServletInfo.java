...
public class ComDayCqDamCoreImplServletAssetDownloadServletInfo   {
  ...
  public ComDayCqDamCoreImplServletAssetDownloadServletInfo (String pid, String title, String description, ComDayCqDamCoreImplServletAssetDownloadServletProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
