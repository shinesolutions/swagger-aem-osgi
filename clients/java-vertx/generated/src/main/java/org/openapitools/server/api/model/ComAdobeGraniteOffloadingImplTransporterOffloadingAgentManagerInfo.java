...
public class ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerInfo   {
  ...
  public ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerInfo (String pid, String title, String description, ComAdobeGraniteOffloadingImplTransporterOffloadingAgentManagerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
