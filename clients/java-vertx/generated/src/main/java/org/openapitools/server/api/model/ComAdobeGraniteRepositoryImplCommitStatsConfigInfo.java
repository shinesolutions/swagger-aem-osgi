...
public class ComAdobeGraniteRepositoryImplCommitStatsConfigInfo   {
  ...
  public ComAdobeGraniteRepositoryImplCommitStatsConfigInfo (String pid, String title, String description, ComAdobeGraniteRepositoryImplCommitStatsConfigProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
