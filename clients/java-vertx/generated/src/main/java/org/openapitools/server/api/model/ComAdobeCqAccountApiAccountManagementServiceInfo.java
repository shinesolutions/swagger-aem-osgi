...
public class ComAdobeCqAccountApiAccountManagementServiceInfo   {
  ...
  public ComAdobeCqAccountApiAccountManagementServiceInfo (String pid, String title, String description, ComAdobeCqAccountApiAccountManagementServiceProperties properties, String additionalProperties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
