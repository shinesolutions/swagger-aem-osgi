...
public class ComDayCqDamS7damCommonPostServletsSetCreateHandlerInfo   {
  ...
  public ComDayCqDamS7damCommonPostServletsSetCreateHandlerInfo (String pid, String title, String description, ComDayCqDamS7damCommonPostServletsSetCreateHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
