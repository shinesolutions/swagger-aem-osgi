...
public class ComAdobeCqCommerceImplAssetVideoHandlerInfo   {
  ...
  public ComAdobeCqCommerceImplAssetVideoHandlerInfo (String pid, String title, String description, ComAdobeCqCommerceImplAssetVideoHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
