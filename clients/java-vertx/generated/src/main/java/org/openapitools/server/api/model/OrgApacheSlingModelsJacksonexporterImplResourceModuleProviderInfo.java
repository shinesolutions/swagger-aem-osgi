...
public class OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo   {
  ...
  public OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderInfo (String pid, String title, String description, OrgApacheSlingModelsJacksonexporterImplResourceModuleProviderProperties properties) {
    this.pid = pid;
    this.title = title;
