...
public class ComDayCqAnalyticsSitecatalystImplExporterClassificationsExporteInfo   {
  ...
  public ComDayCqAnalyticsSitecatalystImplExporterClassificationsExporteInfo (String pid, String title, String description, ComDayCqAnalyticsSitecatalystImplExporterClassificationsExporteProperties properties) {
    this.pid = pid;
    this.title = title;
