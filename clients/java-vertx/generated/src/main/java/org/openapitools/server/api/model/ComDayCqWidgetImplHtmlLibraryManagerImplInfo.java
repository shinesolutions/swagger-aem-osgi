...
public class ComDayCqWidgetImplHtmlLibraryManagerImplInfo   {
  ...
  public ComDayCqWidgetImplHtmlLibraryManagerImplInfo (String pid, String title, String description, ComDayCqWidgetImplHtmlLibraryManagerImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
