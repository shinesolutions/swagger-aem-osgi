...
import org.openapitools.server.api.model.ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoProperties;
...
public class ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo   {
  ...
  public ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoInfo (String pid, String title, String description, ComAdobeGraniteOffloadingImplTransporterOffloadingDefaultTranspoProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
