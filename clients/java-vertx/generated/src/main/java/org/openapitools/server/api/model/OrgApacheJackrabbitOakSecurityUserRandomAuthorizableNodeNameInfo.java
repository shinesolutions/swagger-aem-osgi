...
public class OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameInfo   {
  ...
  public OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameInfo (String pid, String title, String description, OrgApacheJackrabbitOakSecurityUserRandomAuthorizableNodeNameProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
