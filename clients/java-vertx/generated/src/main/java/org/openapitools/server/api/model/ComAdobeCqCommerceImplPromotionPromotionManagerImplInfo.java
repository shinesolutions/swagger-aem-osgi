...
public class ComAdobeCqCommerceImplPromotionPromotionManagerImplInfo   {
  ...
  public ComAdobeCqCommerceImplPromotionPromotionManagerImplInfo (String pid, String title, String description, ComAdobeCqCommerceImplPromotionPromotionManagerImplProperties properties) {
    this.pid = pid;
    this.title = title;
