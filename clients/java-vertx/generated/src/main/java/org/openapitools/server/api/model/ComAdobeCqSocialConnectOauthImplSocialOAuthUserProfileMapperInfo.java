...
public class ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperInfo   {
  ...
  public ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperInfo (String pid, String title, String description, ComAdobeCqSocialConnectOauthImplSocialOAuthUserProfileMapperProperties properties) {
    this.pid = pid;
    this.title = title;
