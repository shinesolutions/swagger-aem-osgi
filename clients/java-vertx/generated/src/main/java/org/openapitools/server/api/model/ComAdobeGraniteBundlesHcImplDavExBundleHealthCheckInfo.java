...
public class ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckInfo   {
  ...
  public ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckInfo (String pid, String title, String description, ComAdobeGraniteBundlesHcImplDavExBundleHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
