...
public class OrgApacheSlingHcCoreImplServletResultTxtVerboseSerializerInfo   {
  ...
  public OrgApacheSlingHcCoreImplServletResultTxtVerboseSerializerInfo (String pid, String title, String description, OrgApacheSlingHcCoreImplServletResultTxtVerboseSerializerProperties properties) {
    this.pid = pid;
    this.title = title;
