...
public class ComAdobeCqSocialMembersImplCommunityMemberGroupProfileComponentFInfo   {
  ...
  public ComAdobeCqSocialMembersImplCommunityMemberGroupProfileComponentFInfo (String pid, String title, String description, ComAdobeCqSocialMembersImplCommunityMemberGroupProfileComponentFProperties properties) {
    this.pid = pid;
    this.title = title;
