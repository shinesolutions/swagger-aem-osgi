...
public class ComDayCqWcmUndoUndoConfigInfo   {
  ...
  public ComDayCqWcmUndoUndoConfigInfo (String pid, String title, String description, ComDayCqWcmUndoUndoConfigProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
