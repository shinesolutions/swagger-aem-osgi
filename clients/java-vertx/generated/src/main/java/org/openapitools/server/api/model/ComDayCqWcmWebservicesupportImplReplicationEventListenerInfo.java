...
public class ComDayCqWcmWebservicesupportImplReplicationEventListenerInfo   {
  ...
  public ComDayCqWcmWebservicesupportImplReplicationEventListenerInfo (String pid, String title, String description, ComDayCqWcmWebservicesupportImplReplicationEventListenerProperties properties) {
    this.pid = pid;
    this.title = title;
