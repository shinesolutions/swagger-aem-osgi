...
public class ComAdobeGraniteMaintenanceCrxImplRevisionCleanupTaskInfo   {
  ...
  public ComAdobeGraniteMaintenanceCrxImplRevisionCleanupTaskInfo (String pid, String title, String description, ComAdobeGraniteMaintenanceCrxImplRevisionCleanupTaskProperties properties) {
    this.pid = pid;
    this.title = title;
