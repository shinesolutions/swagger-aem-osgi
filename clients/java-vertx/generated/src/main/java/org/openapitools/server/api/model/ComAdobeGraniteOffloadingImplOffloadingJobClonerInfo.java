...
public class ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo   {
  ...
  public ComAdobeGraniteOffloadingImplOffloadingJobClonerInfo (String pid, String title, String description, ComAdobeGraniteOffloadingImplOffloadingJobClonerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
