...
public class ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceInfo   {
  ...
  public ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceInfo (String pid, String title, String description, ComAdobeCqSocialForumClientEndpointsImplForumOperationsServiceProperties properties) {
    this.pid = pid;
    this.title = title;
