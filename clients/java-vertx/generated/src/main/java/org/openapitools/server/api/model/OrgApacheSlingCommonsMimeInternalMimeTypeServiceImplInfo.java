...
public class OrgApacheSlingCommonsMimeInternalMimeTypeServiceImplInfo   {
  ...
  public OrgApacheSlingCommonsMimeInternalMimeTypeServiceImplInfo (String pid, String title, String description, OrgApacheSlingCommonsMimeInternalMimeTypeServiceImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
