...
public class ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo   {
  ...
  public ComDayCqWcmMsmImplActionsVersionCopyActionFactoryInfo (String pid, String title, String description, ComDayCqWcmMsmImplActionsVersionCopyActionFactoryProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
