...
public class OrgApacheSlingInstallerProviderJcrImplJcrInstallerInfo   {
  ...
  public OrgApacheSlingInstallerProviderJcrImplJcrInstallerInfo (String pid, String title, String description, OrgApacheSlingInstallerProviderJcrImplJcrInstallerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
