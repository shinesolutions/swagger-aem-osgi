...
public class OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo   {
  ...
  public OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicInfo (String pid, String title, String description, OrgApacheSlingJcrWebdavImplHandlerDirListingExportHandlerServicProperties properties) {
    this.pid = pid;
    this.title = title;
