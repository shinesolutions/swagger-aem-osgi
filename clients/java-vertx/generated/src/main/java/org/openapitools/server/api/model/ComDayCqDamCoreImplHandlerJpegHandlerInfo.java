...
public class ComDayCqDamCoreImplHandlerJpegHandlerInfo   {
  ...
  public ComDayCqDamCoreImplHandlerJpegHandlerInfo (String pid, String title, String description, ComDayCqDamCoreImplHandlerJpegHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
