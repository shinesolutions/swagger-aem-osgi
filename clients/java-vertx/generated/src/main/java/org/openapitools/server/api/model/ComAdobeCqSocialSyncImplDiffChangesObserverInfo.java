...
public class ComAdobeCqSocialSyncImplDiffChangesObserverInfo   {
  ...
  public ComAdobeCqSocialSyncImplDiffChangesObserverInfo (String pid, String title, String description, ComAdobeCqSocialSyncImplDiffChangesObserverProperties properties) {
    this.pid = pid;
    this.title = title;
