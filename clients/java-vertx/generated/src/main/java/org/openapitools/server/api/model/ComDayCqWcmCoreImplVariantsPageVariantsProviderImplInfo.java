...
public class ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo   {
  ...
  public ComDayCqWcmCoreImplVariantsPageVariantsProviderImplInfo (String pid, String title, String description, ComDayCqWcmCoreImplVariantsPageVariantsProviderImplProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
