...
public class ComDayCqDamCoreImplServletMultipleLicenseAcceptServletInfo   {
  ...
  public ComDayCqDamCoreImplServletMultipleLicenseAcceptServletInfo (String pid, String title, String description, ComDayCqDamCoreImplServletMultipleLicenseAcceptServletProperties properties) {
    this.pid = pid;
    this.title = title;
