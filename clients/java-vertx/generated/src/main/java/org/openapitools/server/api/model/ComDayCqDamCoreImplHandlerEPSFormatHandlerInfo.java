...
public class ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo   {
  ...
  public ComDayCqDamCoreImplHandlerEPSFormatHandlerInfo (String pid, String title, String description, ComDayCqDamCoreImplHandlerEPSFormatHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
