...
public class ComAdobeGraniteSecurityUserUserPropertiesServiceInfo   {
  ...
  public ComAdobeGraniteSecurityUserUserPropertiesServiceInfo (String pid, String title, String description, ComAdobeGraniteSecurityUserUserPropertiesServiceProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
