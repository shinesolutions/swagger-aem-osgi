...
public class ComAdobeCqHcContentPackagesHealthCheckInfo   {
  ...
  public ComAdobeCqHcContentPackagesHealthCheckInfo (String pid, String title, String description, ComAdobeCqHcContentPackagesHealthCheckProperties properties) {
    this.pid = pid;
    this.title = title;
