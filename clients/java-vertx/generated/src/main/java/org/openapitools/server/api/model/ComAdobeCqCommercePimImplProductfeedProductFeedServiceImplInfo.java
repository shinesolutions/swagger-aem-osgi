...
public class ComAdobeCqCommercePimImplProductfeedProductFeedServiceImplInfo   {
  ...
  public ComAdobeCqCommercePimImplProductfeedProductFeedServiceImplInfo (String pid, String title, String description, ComAdobeCqCommercePimImplProductfeedProductFeedServiceImplProperties properties) {
    this.pid = pid;
    this.title = title;
