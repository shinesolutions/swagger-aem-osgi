...
public class OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeInfo   {
  ...
  public OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeInfo (String pid, String title, String description, OrgApacheSlingDistributionTriggerImplScheduledDistributionTriggeProperties properties) {
    this.pid = pid;
    this.title = title;
