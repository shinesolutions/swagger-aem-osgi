...
public class ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCInfo   {
  ...
  public ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCInfo (String pid, String title, String description, ComAdobeGraniteReplicationHcImplReplicationTransportUsersHealthCProperties properties) {
    this.pid = pid;
    this.title = title;
