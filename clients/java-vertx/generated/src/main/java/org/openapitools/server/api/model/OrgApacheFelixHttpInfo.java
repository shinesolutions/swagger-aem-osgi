...
public class OrgApacheFelixHttpInfo   {
  ...
  public OrgApacheFelixHttpInfo (String pid, String title, String description, OrgApacheFelixHttpProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
