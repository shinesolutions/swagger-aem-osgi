...
public class ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoInfo   {
  ...
  public ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoInfo (String pid, String title, String description, ComAdobeCqSocialActivitystreamsClientImplSocialActivityStreamCoProperties properties) {
    this.pid = pid;
    this.title = title;
