...
public class OrgApacheSlingDistributionTriggerImplDistributionEventDistributeInfo   {
  ...
  public OrgApacheSlingDistributionTriggerImplDistributionEventDistributeInfo (String pid, String title, String description, OrgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties properties) {
    this.pid = pid;
    this.title = title;
