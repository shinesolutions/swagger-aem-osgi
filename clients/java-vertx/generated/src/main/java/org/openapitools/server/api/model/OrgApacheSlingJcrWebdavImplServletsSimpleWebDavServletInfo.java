...
public class OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo   {
  ...
  public OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletInfo (String pid, String title, String description, OrgApacheSlingJcrWebdavImplServletsSimpleWebDavServletProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
