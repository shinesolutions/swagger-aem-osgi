...
public class ComAdobeCqWcmLaunchesImplLaunchesEventHandlerInfo   {
  ...
  public ComAdobeCqWcmLaunchesImplLaunchesEventHandlerInfo (String pid, String title, String description, ComAdobeCqWcmLaunchesImplLaunchesEventHandlerProperties properties) {
    this.pid = pid;
    this.title = title;
