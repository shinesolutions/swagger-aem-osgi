...
public class OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo   {
  ...
  public OrgApacheSlingEventImplJobsJcrPersistenceHandlerInfo (String pid, String title, String description, OrgApacheSlingEventImplJobsJcrPersistenceHandlerProperties properties, String bundleLocation, String serviceLocation) {
    this.pid = pid;
    this.title = title;
