...
public class ComDayCqWcmCoreImplServletsFindReplaceServletInfo   {
  ...
  public ComDayCqWcmCoreImplServletsFindReplaceServletInfo (String pid, String title, String description, ComDayCqWcmCoreImplServletsFindReplaceServletProperties properties) {
    this.pid = pid;
    this.title = title;
