...
public class OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiInfo   {
  ...
  public OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiInfo (String pid, String title, String description, OrgApacheSlingDistributionPackagingImplExporterRemoteDistributiProperties properties) {
    this.pid = pid;
    this.title = title;
