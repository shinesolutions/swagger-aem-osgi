...
import org.openapitools.server.api.model.ComAdobeGraniteCsrfImplCSRFServletProperties;
...
public class ComAdobeGraniteCsrfImplCSRFServletInfo   {
  ...
  public ComAdobeGraniteCsrfImplCSRFServletInfo (String pid, String title, String description, ComAdobeGraniteCsrfImplCSRFServletProperties properties) {
    this.pid = pid;
    this.title = title;
