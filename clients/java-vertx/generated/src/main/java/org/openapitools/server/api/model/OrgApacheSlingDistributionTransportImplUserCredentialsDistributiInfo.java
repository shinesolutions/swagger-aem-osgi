...
public class OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo   {
  ...
  public OrgApacheSlingDistributionTransportImplUserCredentialsDistributiInfo (String pid, String title, String description, OrgApacheSlingDistributionTransportImplUserCredentialsDistributiProperties properties) {
    this.pid = pid;
    this.title = title;
