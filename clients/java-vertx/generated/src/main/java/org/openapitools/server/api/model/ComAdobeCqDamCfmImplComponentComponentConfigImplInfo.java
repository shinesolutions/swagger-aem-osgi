...
public class ComAdobeCqDamCfmImplComponentComponentConfigImplInfo   {
  ...
  public ComAdobeCqDamCfmImplComponentComponentConfigImplInfo (String pid, String title, String description, ComAdobeCqDamCfmImplComponentComponentConfigImplProperties properties) {
    this.pid = pid;
    this.title = title;
