...
public class ComAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties {
  ...
  public boolean equals(Object o) {
    ...
    return (this.parameterWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.parameterWhitelist == null : this.parameterWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.parameterWhitelist)) &&
        (this.parameterWhitelistPrefixes == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.parameterWhitelistPrefixes == null : this.parameterWhitelistPrefixes.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.parameterWhitelistPrefixes)) &&
        (this.binaryParameterWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.binaryParameterWhitelist == null : this.binaryParameterWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.binaryParameterWhitelist)) &&
        (this.modifierWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.modifierWhitelist == null : this.modifierWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.modifierWhitelist)) &&
        (this.operationWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.operationWhitelist == null : this.operationWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.operationWhitelist)) &&
        (this.operationWhitelistPrefixes == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.operationWhitelistPrefixes == null : this.operationWhitelistPrefixes.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.operationWhitelistPrefixes)) &&
        (this.typehintWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.typehintWhitelist == null : this.typehintWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.typehintWhitelist)) &&
        (this.resourcetypeWhitelist == null ? comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.resourcetypeWhitelist == null : this.resourcetypeWhitelist.equals(comAdobeCqSocialUgcbaseSecurityImplSaferSlingPostValidatorImplProperties.resourcetypeWhitelist));
  }
