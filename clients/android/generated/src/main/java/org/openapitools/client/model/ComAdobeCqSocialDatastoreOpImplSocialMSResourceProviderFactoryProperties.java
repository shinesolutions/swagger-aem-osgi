...
public class ComAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties {
  ...
  public boolean equals(Object o) {
    ...
    return (this.solrZkTimeout == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.solrZkTimeout == null : this.solrZkTimeout.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.solrZkTimeout)) &&
        (this.solrCommit == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.solrCommit == null : this.solrCommit.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.solrCommit)) &&
        (this.cacheOn == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheOn == null : this.cacheOn.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheOn)) &&
        (this.concurrencyLevel == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.concurrencyLevel == null : this.concurrencyLevel.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.concurrencyLevel)) &&
        (this.cacheStartSize == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheStartSize == null : this.cacheStartSize.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheStartSize)) &&
        (this.cacheTtl == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheTtl == null : this.cacheTtl.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheTtl)) &&
        (this.cacheSize == null ? comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheSize == null : this.cacheSize.equals(comAdobeCqSocialDatastoreOpImplSocialMSResourceProviderFactoryProperties.cacheSize));
  }
