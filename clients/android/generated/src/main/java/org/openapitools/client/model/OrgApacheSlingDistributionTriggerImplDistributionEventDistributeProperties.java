...
public class OrgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? orgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties.name == null : this.name.equals(orgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties.name)) &&
        (this.path == null ? orgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties.path == null : this.path.equals(orgApacheSlingDistributionTriggerImplDistributionEventDistributeProperties.path));
  }
