...
public class OrgApacheSlingFeatureflagsImplConfiguredFeatureProperties {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.name == null : this.name.equals(orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.name)) &&
        (this.description == null ? orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.description == null : this.description.equals(orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.description)) &&
        (this.enabled == null ? orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.enabled == null : this.enabled.equals(orgApacheSlingFeatureflagsImplConfiguredFeatureProperties.enabled));
  }
