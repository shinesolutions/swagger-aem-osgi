...
class OrgApacheJackrabbitOakSegmentSegmentNodeStoreFactoryProperties {
    ...
    /** @var \app\Models\ConfigNodePropertyBoolean $register_descriptors */
    private $register_descriptors;

    /** @var \app\Models\ConfigNodePropertyBoolean $dispatch_changes */
    private $dispatch_changes;
