...
maximum_cache_entries = 1 # int |  (optional)
af_scripting_compatversion = "af.scripting.compatversion_example" # str |  (optional)
...
If the OpenAPI document is large, imports in swaggeraemosgi.apis and swaggeraemosgi.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from swaggeraemosgi.api.default_api import DefaultApi`
- `from swaggeraemosgi.model.pet import Pet`
...
import swaggeraemosgi
from swaggeraemosgi.apis import *
from swaggeraemosgi.models import *
```
